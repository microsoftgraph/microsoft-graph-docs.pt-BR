...
|scheduledInstallDays|Coleção de cadeias de caracteres|Dias na semana para os quais o horário ativo está configurado. Essa coleção pode conter um máximo de 7 elementos.|
