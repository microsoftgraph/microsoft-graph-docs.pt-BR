...
|location|[signInLocation](signinlocation.md)|Fornece a cidade, o estado e o código do país de origem da assinatura.|
...
|riskState|riskState|Relata o status do usuário arriscado, login ou um evento de risco. Os valores possíveis são `none`, `confirmedSafe`, `remediated`, `dismissed`, `atRisk`, `confirmedCompromised`, `unknownFutureValue`.|
