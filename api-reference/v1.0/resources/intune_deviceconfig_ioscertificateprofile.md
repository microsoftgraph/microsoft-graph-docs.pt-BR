...
|:---|:---|:---|
|[Listar iosCertificateProfiles](../api/intune_deviceconfig_ioscertificateprofile_list.md)|Conjunto [iosCertificateProfile](../resources/intune_deviceconfig_ioscertificateprofile.md)|Listar propriedades e relações de objetos de [iosCertificateProfile](../resources/intune_deviceconfig_ioscertificateprofile.md).|
|[Obter iosCertificateProfile](../api/intune_deviceconfig_ioscertificateprofile_get.md)|[iosCertificateProfile](../resources/intune_deviceconfig_ioscertificateprofile.md)|Ler propriedades e relações de objetos de [iosCertificateProfile](../resources/intune_deviceconfig_ioscertificateprofile.md).|
