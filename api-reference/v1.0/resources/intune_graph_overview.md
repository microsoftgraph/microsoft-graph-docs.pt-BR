...
- Explore os [exemplos do PowerShell Intune](https://github.com/microsoftgraph/powershell-intune-samples), que mostram como usar a API do gráfico para Intune no contexto dos exemplos de trabalho.