...
1. Obtenha no Active Directory do Azure uma lista de dispositivos registrados para um usuário: 

    https://graph.microsoft.com/users/{user}/ownedDevices 

2. Em seguida, exiba a lista de aplicativos para seu locatário: 
...
A API do Microsoft Graph controla o acesso a recursos por meio de escopos de permissão. Como desenvolvedor, você deve especificar os escopos de permissão necessários para acessar os recursos do Intune. Normalmente, você deve especificar os escopos de permissão necessários no portal do Azure Active Directory. Para saber mais, veja [Escopos de permissão do Microsoft Graph](https://developer.microsoft.com/en-us/graph/docs/authorization/permission_scopes) e [Escopos de permissão do Intune](https://developer.microsoft.com/en-us/graph/docs/authorization/permission_scopes#permission-scopes-in-preview).

## <a name="next-steps"></a>Próximas etapas

- Saiba [como usar o Azure AD](https://docs.microsoft.com/en-us/intune/intune-graph-apis) para acessar a API do Microsoft Graph para Intune.  
- Explore os [exemplos do PowerShell Intune](https://github.com/microsoftgraph/powershell-intune-samples), que mostram como usar a API do Graph para Intune no contexto dos exemplos de trabalho.