...
| partiallySucceeded | A operação foi concluída, mas houve erros. Para obter detalhes do erro, consulte [resultInfo](../resources/resultinfo.md). |
| Falhou | Falha na operação. Para obter detalhes do erro, consulte [resultInfo](../resources/resultinfo.md). |
