...
|[Aprovar](../api/swapshiftschangerequest-approve.md)|None|Aprovar um **swapShiftsChangeRequest**. |
|[Declínio](../api/swapshiftschangerequest-decline.md)|None|Recusar um **swapShiftsChangeRequest**.|
