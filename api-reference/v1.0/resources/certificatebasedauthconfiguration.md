...
>[!NOTE]
>Não há suporte para a atualização de **certificateBasedAuthConfiguration.** Para alterar um **certificateBasedAuthConfiguration**, primeiro exclua e depois crie um novo **certificateBasedAuthConfiguration**.
