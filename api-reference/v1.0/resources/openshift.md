...
| [Delete](../api/openshift-delete.md) | Nenhum | **Exclua um objeto openShift.** |
...
|schedulingGroupId|Cadeia de caracteres|ID do grupo de agendamento ao que pertence o turno de abertura.|
