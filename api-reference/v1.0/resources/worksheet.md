...
|[Listar gráficos](../api/worksheet-list-charts.md) |Coleção [WorkbookChart](chart.md)| Obtenha a coleção de objetos Chart.|
...
|[Update](../api/worksheet-update.md) | [WorkbookWorksheet](worksheet.md)   |Atualize o objeto Worksheet. |
