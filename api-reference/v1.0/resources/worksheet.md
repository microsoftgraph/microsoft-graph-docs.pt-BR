...
|[Create Chart](../api/worksheet_post_charts.md) |[Chart](chart.md)| Crie um novo Chart postando na coleção de gráficos.|
|[List charts](../api/worksheet_list_charts.md) |Coleção [Chart](chart.md)| Obtenha a coleção de objetos Chart.|
