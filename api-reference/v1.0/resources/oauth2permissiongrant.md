...
| clientId | Cadeia de caracteres | A **id da** entidade de [](serviceprincipal.md) serviço do cliente para o aplicativo que está autorizado a agir em nome de um usuário interno ao acessar uma API. Obrigatório. Suporte para `$filter` (`eq` somente). |
