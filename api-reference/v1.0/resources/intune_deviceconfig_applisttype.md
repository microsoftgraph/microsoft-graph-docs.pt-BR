# <a name="applisttype-enum-type"></a>tipo enumerado appListType
...
|appsInListCompliant|1|A lista representa os aplicativos que serão considerados compatíveis (somente aplicativos na lista são compatíveis).|
