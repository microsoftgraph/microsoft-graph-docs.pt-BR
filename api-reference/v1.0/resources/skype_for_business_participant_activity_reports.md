...
| [Obter contagens de minutos](../api/reportroot_getskypeforbusinessparticipantactivityminutecounts.md) | Fluxo      | Obtenha as tendências de uso da duração em minutos e o tipo de sessões de conferência das quais os usuários de sua organização participaram. Tipos de sessões de conferência incluem áudio/vídeo. |
