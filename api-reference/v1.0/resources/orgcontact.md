...
| givenName                    | Cadeia de caracteres                                                                   | Primeiro nome para esse contato organizacional. Suporte `$filter` (`eq`, `ne`, `not`, `ge`, `le`, `in`, `startsWith`, e `eq` no `null` valores).                                                                                                                                                                                                                |
...
| surname                      | Cadeia de caracteres                                                                   | Sobrenome para esse contato organizacional. Suporte `$filter` (`eq`, `ne`, `not`, `ge`, `le`, `in`, `startsWith`, e `eq` no `null` valores).                                                                                                                                                                                                                 |
