...
Antes de começar com a API do planejador, vale compreensão de como os objetos principais se relacionam entre si, bem como para grupos do Office 365.
...
Toda a ordem é controlada pelos princípios identificados em [Dicas de ordem do Planner](planner-order-hint-format.md).
