...
|complianceManagementPartners|[coleção complianceManagementPartner](../resources/intune-onboarding-compliancemanagementpartner.md)|A lista de Parceiros de Gerenciamento de Conformidade configurada pelo locatário.|
