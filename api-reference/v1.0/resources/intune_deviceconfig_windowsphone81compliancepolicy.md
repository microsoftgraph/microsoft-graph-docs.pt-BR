...
|lastModifiedDateTime|DateTimeOffset|Última modificação de DateTime do objeto. Herdado de [deviceCompliancePolicy](../resources/intune_deviceconfig_devicecompliancepolicy.md)|
