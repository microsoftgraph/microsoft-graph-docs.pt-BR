...
| [dispositivo](../../beta/resources/device.md) | Somente para visualização |
| [group](../../beta/resources/group.md) | Somente para visualização |
| [message](message.md) | GA |
| [organização](../../beta/resources/organization.md) | Somente para visualização |
| [Contato pessoal](contact.md) | GA |
| [usuário](../../beta/resources/user.md) | Somente para visualização |
...
|:---------------|:--------|:----------|
|[Post](../api/opentypeextension_post_opentypeextension.md) | [openTypeExtension](opentypeextension.md) ou [message](../resources/message.md), [event](../resources/event.md) ou [contact](../resources/contact.md) que contém um objeto openTypeExtension. | Crie um objeto openTypeExtension em uma instância de recurso novo ou existente.| 
