...
|[Range](../api/nameditem_range.md)|[Range](range.md)|Retorna o objeto Range associado ao nome. Gera uma exceção se o tipo de item nomeado não for um intervalo.|
...
|value|objeto|Representa a fórmula à qual o nome está definido para fazer referência. Por exemplo, =Plan14!$B$2:$H$12, =4,75, etc. Somente leitura.|
