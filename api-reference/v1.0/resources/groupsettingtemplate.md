...
|:---------------|:--------|:----------|
|[Obter groupSettingTemplate](../api/groupsettingtemplate_get.md) | [groupSettingTemplate](groupsettingtemplate.md) | Leia as propriedades específicas de um dos objetos groupSettingTemplate definidos pelo sistema. |
|[Lista groupSettingTemplate](../api/groupsettingtemplate_list.md) | [Coleção de groupSettingTemplate](groupsettingtemplate.md) |Lista todos os objetos de groupSettingTemplate definidos pelo sistema.|
