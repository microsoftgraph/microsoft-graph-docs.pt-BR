...
Confira [Carregar arquivos grandes com uma sessão de carregamento](../api/driveitem_createuploadsession.md) para saber mais sobre como carregar arquivos usando uma sessão de carregamento.
