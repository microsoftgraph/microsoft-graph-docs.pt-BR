...
|contentUrl|Sequência de caracteres|A URL do conteúdo HTML da página.  Somente leitura.|
|createdByAppId|Sequência de caracteres|O identificador exclusivo do aplicativo que criou a página. Somente leitura.|
...
|id|Sequência de caracteres|O identificador exclusivo da página.  Somente leitura.|
...
|self|Sequência de caracteres|O ponto de extremidade onde você pode obter detalhes sobre a página. Somente leitura.|
|title|Sequência de caracteres|O título da página. |
...
|[Atualizar o conteúdo da página](../api/page_update.md) | Nenhum |Atualizar o conteúdo HTML da página. |
|[Excluir página](../api/page_delete.md) | Nenhum |Exclua a página. |
|[copyToSection](../api/page_copytosection.md)| Nenhum |Copia a página para uma seção específica.|
