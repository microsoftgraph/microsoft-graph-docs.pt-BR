...
|:---------------|:--------|:----------|
|[Obter educationUser](../api/educationuser-get.md) | [educationUser](educationuser.md) |Leia as propriedades e relações de um objeto **educationUser**.|
|[Listar classes](../api/educationuser-list-classes.md) |Coleção [educationClass](educationclass.md)| Obtenha a coleção de objetos **educationClass** da qual o usuário é membro.|
...
|user|[user](user.md)| O usuário de diretório correspondente a esse usuário.|
