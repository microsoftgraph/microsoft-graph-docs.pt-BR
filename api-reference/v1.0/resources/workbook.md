...
|[Fechar Sessão](../api/workbook_closesession.md) | Nenhum |Fechar uma sessão existente.|
|[Atualizar Sessão](../api/workbook_refreshsession.md) | Nenhum |Atualizar uma sessão existente.|
