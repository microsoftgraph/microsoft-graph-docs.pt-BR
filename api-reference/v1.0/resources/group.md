...
Representa um grupo do Azure Active Directory (Azure AD), que pode ser um grupo do Microsoft 365 ou um grupo de segurança.
...
| [Criar grupo](../api/group-post-groups.md)                                 | [group](group.md)                                          | Criar um novo grupo. Pode ser um grupo do Microsoft 365, um grupo dinâmico ou um grupo de segurança.                                                                                                                              |
...
| [Remover proprietário](../api/group-delete-owners.md)                               | Nenhum                                                       | Remover um proprietário de um grupo do Microsoft 365, um grupo de segurança ou um grupo de segurança habilitado para email por meio da propriedade de navegação **Owners** .                                                                           |
...
| [Remover membro](../api/group-delete-members.md)                             | Nenhum                                                       | Remover um membro de um grupo do Microsoft 365, um grupo de segurança ou um grupo de segurança habilitado para email através da propriedade de navegação **Members** . É possível remover usuários ou outros grupos.                                    |
...
| [getMemberObjects](../api/group-getmemberobjects.md)                        | String collection                                          | Retornar todos os grupos dos quais o grupo é um membro. Essa função é transitiva.                                                                                                                               |
...
| [validateProperties](../api/group-validateproperties.md)                    | JSON                                                       | Validar que o nome de exibição ou o apelido de email de um grupo do Microsoft 365 está em conformidade com as políticas de nomenclatura.                                                                                                                  |
...
| [addFavorite](../api/group-addfavorite.md)                                  | Nenhum                                                       | Adicionar o grupo à lista de grupos de favoritos do usuário conectado. Suportado somente para grupos do Microsoft 365.                                                                                                          |
| [removeFavorite](../api/group-removefavorite.md)                            | Nenhum                                                       | Remover o grupo da lista de grupos favoritos do usuário conectado. Suportado somente para grupos do Microsoft 365.                                                                                                     |
...
| [subscribeByMail](../api/group-subscribebymail.md)                          | Nenhum                                                       | Definir a propriedade isSubscribedByMail como **true**. Permitir que o usuário conectado receba conversas por email. Suportado somente para grupos do Microsoft 365.                                                                |
| [unsubscribeByMail](../api/group-unsubscribebymail.md)                      | Nenhum                                                       | Definir a propriedade isSubscribedByMail como **false**. Desabilitar o recebimento de conversas por email do usuário conectado. Suportado somente para grupos do Microsoft 365.                                                            |
| [resetUnseenCount](../api/group-resetunseencount.md)                        | Nenhum                                                       | Redefinir unseenCount como 0 para todas as postagens que o usuário conectado não tenha visto desde a última visita. Suportado somente para grupos do Microsoft 365.                                                                    |
...
|mailEnabled|Booliano|Especifica se o grupo está habilitado para email. <br><br>Retornado por padrão.|
...
|membros|Coleção [directoryObject](directoryobject.md)| Os usuários e grupos que são membros desse grupo. Métodos HTTP: GET (com suporte para todos os grupos), POST (com suporte para grupos de segurança da Microsoft 365, grupos de segurança e grupos de segurança habilitados para email), excluir (com suporte para Microsoft 365 grupos e grupos de segurança) Nullable.|
...
|owners|Coleção [directoryObject](directoryobject.md)|Os proprietários do grupo. Os proprietários são um conjunto de usuários não administradores e que têm permissão para modificar esse objeto. Limitado a 100 proprietários. Métodos HTTP: GET (com suporte para todos os grupos), POST (com suporte para grupos do Microsoft 365, grupos de segurança e grupos de segurança habilitados para email), excluir (com suporte para grupos de segurança e grupos do Microsoft 365). Anulável.|
