...
| [Adicionar membros](../api/group-post-members.md) | Nenhum | Adicione um usuário ou grupo a esse grupo postando na propriedade **membros** navegação (com suporte apenas para grupos de segurança e Microsoft 365 grupos). |
| [Adicionar proprietários](../api/group-post-owners.md) | Nenhum | Adicione um novo proprietário para o grupo postando nos **proprietários** de navegação (com suporte apenas para grupos de segurança e Microsoft 365 grupos). |
