...
| [Obter contagens de minutos](../api/reportroot_getskypeforbusinessorganizeractivityminutecounts.md) | Fluxo      | Obtenha tendências de uso na duração em minutos e tipo de sessões de conferência realizadas e organizadas pelos usuários em sua organização. Tipos de sessões de conferência incluem áudio/vídeo e dial-in/out pela Microsoft. |
