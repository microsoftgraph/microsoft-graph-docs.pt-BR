...
|:---------------|:--------|:----------|
|[Listar linhas](../api/workbookrangeview_list_rows.md) |Coleção [workbookRangeView](workbookrangeview.md)| Obtenha uma coleção de objetos workbookRangeView.|
...
|[Intervalo](../api/workbookrangeview_range.md)|[workbookRange](range.md)|Retorna o objeto de intervalo associado à exibição do intervalo|
...
|valueTypes|Json|Representa o tipo de dados de cada célula. Somente leitura. Os valores possíveis são: desconhecido, vazio, sequência de caracteres, inteiro, duplo, Booleano, erro. |
