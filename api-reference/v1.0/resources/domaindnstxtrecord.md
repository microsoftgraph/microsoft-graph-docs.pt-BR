...
|rótulo|Sequência de caracteres| O valor a ser usado ao configurar a propriedade *name* do registro TXT no host DNS.|
|recordType|Sequência de caracteres| Tipo do registro DNS. Este valor sempre será *Txt*. Chave |
|supportedService|Sequência de caracteres| O Microsoft Online Services ou o recurso que tiver uma dependência neste registro TXT.</br></br>Pode ser um dos seguintes valores: **null**, *Email*, *Sharepoint*, *EmailInternalRelayOnly*, *OfficeCommunicationsOnline*, *SharePointDefaultDomain*, *FullRedelegation*, *SharePointPublic*, *OrgIdAuthentication*, *Yammer*, *Intune* |
|text|Sequência de caracteres| O valor usado ao configurar a propriedade *text* no host DNS. |
