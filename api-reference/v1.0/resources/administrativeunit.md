...
|[Atualização](../api/administrativeunit-update.md) | [administrativeUnit](administrativeunit.md)    |Atualize o objeto administrativeUnit. |
...
|:---------------|:--------|:----------|
|membros|Coleção [directoryObject](directoryobject.md)|Usuários e grupos que são membros dessa unidade de Adminsitrative. Métodos HTTP: GET (listar Membros), POST (adicionar membros), excluir (remover membros).|
