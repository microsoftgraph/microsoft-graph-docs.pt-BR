...
|:---------------|:--------|:----------|
|[Get Range](../api/range_get.md) | [Range](range.md) |Propriedades de leitura e relacionamentos do objeto range.|
|[Update](../api/range_update.md) | [Range](range.md)   |Atualize o objeto Range. |
|[Boundingrect](../api/range_boundingrect.md)|[Range](range.md)|Obtém o menor objeto range que abrange os intervalos determinados. Por exemplo, GetBoundingRect de "B2:C5" e "D10:E15" é "B2:E16".|
...
|[Intersection](../api/range_intersection.md)|[Range](range.md)|Obtém o objeto range que representa a interseção retangular dos intervalos determinados.|
...
|[Usedrange](../api/range_usedrange.md)|[Range](range.md)|Retorna o intervalo usado do objeto range determinado.|
|[Limpar](../api/range_clear.md)|None|Limpe valores de intervalo, formatação, preenchimento, bordas, etc.|
...
|[Merge](../api/range_merge.md)|None|Mescla as células do intervalo em uma região da planilha.|
...
|[Unmerge](../api/range_unmerge.md)|None|Desfaz a mesclagem das células do intervalo em células separadas.|
...
|:---------------|:--------|:----------|
|address|sequência de caracteres|Representa a referência do intervalo no estilo A1. O valor do endereço inclui a referência de planilha (por exemplo, Plan1!A1:B4). Somente leitura.|
|addressLocal|sequência de caracteres|Representa a referência de intervalo para o intervalo especificado no idioma do usuário. Somente leitura.|
...
|worksheet|[WorkbookWorksheet](worksheet.md)|A planilha que contém o intervalo atual. Somente leitura.|
