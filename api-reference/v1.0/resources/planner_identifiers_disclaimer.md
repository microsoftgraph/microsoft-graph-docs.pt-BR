...
Os identificadores de objetos no Planner são sequências de caracteres geradas pelo serviço. Os valores têm 28 caracteres de comprimento e diferenciam maiúsculas de minúsculas. Quando passado na entrada, o serviço fará uma validação simples do formato do identificador, se a validação falhar, os chamadores receberão uma resposta de erro de solicitação incorreta (400) indicando esse problema. Esse erro indica um bug do aplicativo de chamada, como:
