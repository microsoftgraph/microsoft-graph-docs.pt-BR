...
|[Obter mensagens em todos os chats para o usuário](../api/chats-getallmessages.md)| [coleção chat](chat.md)| Obter mensagens de todos os chats em que um usuário é participante, que inclui chats 1:1, chats de grupo e chats de reunião. |
