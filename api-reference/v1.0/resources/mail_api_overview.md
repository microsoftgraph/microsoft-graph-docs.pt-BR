...
| Obtenha dicas de email de status especial de outros dos destinatários, como fora do escritório | o [usuário](../resources/user.md), <br> [dicas de email](../resources/mailtips.md) | [Obtenha dicas de email](../api/user_getmailtips.md) |
