...
|:---------------|:--------|:----------|
|[Aplicar](../api/filter_apply.md)|Nenhum|Aplica os critérios de filtro determinados à coluna fornecida.|
|[Limpar](../api/filter_clear.md)|Nenhum|Limpa o filtro na coluna determinada.|
