...
description: Representa uma solicitação para uma atribuição de função ativa para uma entidade de segurança por meio do PIM. A atribuição de função pode ser permanentemente ativa com ou sem uma data de expiração ou temporariamente ativa após a ativação de uma atribuição qualificada.
author: rkarim-ms
...
Representa uma solicitação para uma atribuição de função ativa para uma entidade de segurança por meio do PIM. A atribuição de função pode ser permanentemente ativa com ou sem uma data de expiração ou temporariamente ativa após a ativação de uma atribuição qualificada. Herda da [solicitação](../resources/request.md).
