...
| :--------------------------------------- | :---------- | :--------------------------------------- |
| [Obter dados de usuário](../api/reportroot_getoffice365activationsuserdetail.md) | Fluxo      | Obtenha dados sobre usuários que ativaram o Office 365. |
| [Obter contagens de ativação](../api/reportroot_getoffice365activationcounts.md) | Fluxo      | Obtenha a contagem de ativações do Office 365 em desktops e dispositivos. |
| [Obter contagens de usuários](../api/reportroot_getoffice365activationsusercounts.md) | Fluxo      | Obtenha a contagem de usuários habilitados e aqueles que ativaram a assinatura do Office no desktop ou nos dispositivos. |
