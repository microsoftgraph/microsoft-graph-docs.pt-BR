...
|[Delete](../api/message_delete.md) | Nenhum |Excluir o objeto message. |
...
|**Anexos**| | |
|[List attachments](../api/message_list_attachments.md) |Coleção [Attachment](attachment.md)| Obtém todos os anexos em uma mensagem.|
