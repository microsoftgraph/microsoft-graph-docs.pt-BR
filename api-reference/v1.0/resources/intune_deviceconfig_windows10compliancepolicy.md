...
|passwordRequired|Booleano|Exige uma senha para desbloquear o dispositivo Windows.|
|passwordBlockSimple|Booleano|Indica se a senha simples deve ou não ser bloqueada.|
|passwordRequiredToUnlockFromIdle|Booleano|Exige uma senha para desbloquear o dispositivo ocioso.|
...
|requireHealthyDeviceReport|Booleano|Exige que os dispositivos sejam indicados como íntegros pelo Atestado de Integridade do Dispositivo Windows.|
