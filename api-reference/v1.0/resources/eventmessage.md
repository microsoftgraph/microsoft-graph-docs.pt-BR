...
|id|String|Identificador exclusivo da mensagem de evento (observe que esse valor pode mudar se uma mensagem for movida ou alterada)|
...
|isDelegated|Booliano|True se essa solicitação de reunião estiver acessível a um representante, caso contrário, false. O padrão é falso.|
