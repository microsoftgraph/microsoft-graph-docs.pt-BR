...
|:----------------------|:-------|:--------------------------------------------
| **sortBy**            | sequência de caracteres | O método pelo qual a pasta deve ser classificada.
| **sortOrder**         | sequência de caracteres | Se for verdadeiro, indica que os itens devem ser classificados em ordem decrescente. Caso contrário, os itens devem ser classificados em ordem crescente.
| **viewType**          | sequência de caracteres | O tipo de modo de exibição que deve ser usado para representar a pasta.
