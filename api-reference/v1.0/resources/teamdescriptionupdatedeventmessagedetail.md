...
Representa os detalhes de uma mensagem de evento sobre uma descrição [da equipe](../resources/team.md) atualizada.
...
|teamDescription|String|A descrição atualizada para a **equipe**.|
