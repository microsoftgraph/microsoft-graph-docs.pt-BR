...
| :--------------------------------------- | :---------- | :--------------------------------------- |
| [Obter dados de usuário](../api/reportroot_getyammerdeviceusageuserdetail.md) | Fluxo      | Obtenha dados sobre o uso do dispositivo Yammer por usuário. |
| [Obter contagens de usuários de distribuição](../api/reportroot_getyammerdeviceusagedistributionusercounts.md) | Fluxo      | Obtenha o número de usuários por tipo de dispositivo.  |
| [Obter contagens de usuários](../api/reportroot_getyammerdeviceusageusercounts.md) | Fluxo      | Obtenha o número de usuários diários por tipo de dispositivo. |
