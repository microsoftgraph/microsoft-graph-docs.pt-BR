...
|scriptContent|String|O conteúdo de script codificado com base64.|
...
|comparisonValue|String|O valor de comparação de saída de script. Não especifique um valor se a regra for usada para detecção.|
