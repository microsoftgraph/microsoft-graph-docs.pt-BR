...
|devicePlatformVersion|String|Versão da plataforma do dispositivo tentando fazer check-in.|
|wasSuccessful|Booliano|Se a última verificação tiver sido bem-sucedida.|
...
|errorMessage|String|Mensagem de erro se alguma associada ao último check-in.|
