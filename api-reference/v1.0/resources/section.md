...
|id|Sequência de caracteres|O identificador exclusivo da seção.  Somente leitura.|
|isDefault|Booleano|Indica se esta é a seção padrão do usuário. Somente leitura.|
...
|displayName|Sequência de caracteres|O nome da seção. |
|pagesUrl|Sequência de caracteres|O ponto de extremidade `pages` onde você pode obter detalhes de todas as páginas na seção. Somente leitura.|
|self|Sequência de caracteres|O ponto de extremidade onde você pode obter detalhes sobre a seção. Somente leitura.|

## <a name="relationships"></a>Relações
| Relação | Tipo   |Descrição|
|:---------------|:--------|:----------|
|páginas|Coleção [OnenotePage](page.md)|Obtém a coleção de páginas da seção.  Somente leitura. Anulável.|
...
|:---------------|:--------|:----------|
|[Get section](../api/section_get.md) | [OnenoteSection](section.md) |Leia as propriedades e as relações da seção.|
...
|[copyToNotebook](../api/section_copytonotebook.md)|Nenhum|Copia a seção para um bloco de anotações específico.|
|[copyToSectionGroup](../api/section_copytosectiongroup.md)|Nenhum|Copia uma seção para um grupo de seção específico.|
