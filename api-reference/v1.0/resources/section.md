...
|pagesUrl|Cadeia de caracteres|O `pages` ponto de extremidade onde você pode obter detalhes de todas as páginas da seção. Somente leitura.|
|própria|Cadeia de caracteres|O ponto de extremidade onde você pode obter detalhes sobre a seção. Somente leitura.|
