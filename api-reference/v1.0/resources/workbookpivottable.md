...
|[Refreshall](../api/workbookpivottable_refreshall.md)|Nenhum|Atualização de todas as tabelas dentro de uma determinada planilha. Observe que esta ação está disponível somente na coleção de tabela dinâmica.|
