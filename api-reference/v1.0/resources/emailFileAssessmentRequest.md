...
|:-------------|:------------|:------------|
|contentData|Cadeia de caracteres|Conteúdo do arquivo de email codificado em base64. eml. O conteúdo do arquivo não pode buscar de volta porque não está armazenado.|
