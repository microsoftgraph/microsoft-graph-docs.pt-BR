...
|rótulo|Sequência de caracteres| O valor usado ao configurar o nome da propriedade do registro DNS no host DNS. |
|recordType|Sequência de caracteres| Indica que tipo de registro DNS a entidade representa.</br></br>O valor pode ser um dos seguintes: *CName*, *Mx*, *Srv* e *Txt*</br></br>Chave |
|supportedService|Sequência de caracteres| O Microsoft Online Services ou o recurso que tiver uma dependência neste registro DNS.</br></br>Pode ser um dos seguintes valores: **null**, *Email*, *Sharepoint*, *EmailInternalRelayOnly*, *OfficeCommunicationsOnline*, *SharePointDefaultDomain*, *FullRedelegation*, *SharePointPublic*, *OrgIdAuthentication*, *Yammer*, *Intune*|
