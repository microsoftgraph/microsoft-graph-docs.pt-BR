...
Leia as propriedades e as relações do objeto [user](../resources/intune_onboarding_user.md).
...
Se tiver êxito, este método retorna o código de resposta `200 OK` e o objeto [user](../resources/intune_onboarding_user.md) no corpo da resposta.
