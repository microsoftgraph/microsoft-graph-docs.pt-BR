...
Se tiver êxito, este método retornará um código `200 OK` de resposta e um objeto [WorkbookTableRow](../resources/workbooktablerow.md) atualizado no corpo da resposta.
