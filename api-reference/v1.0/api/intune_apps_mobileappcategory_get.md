...
Ler propriedades e relações do objeto [mobileAppCategory](../resources/intune_apps_mobileappcategory.md).
...
Se bem-sucedido, este método retornará um código de resposta `200 OK` e um objeto [mobileAppCategory](../resources/intune_apps_mobileappcategory.md) no corpo da resposta.
