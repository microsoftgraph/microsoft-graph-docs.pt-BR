...
Se tiver êxito, este método retornará um código `200 OK` de resposta e um objeto [WorkbookRangeFont](../resources/rangefont.md) no corpo da resposta.
