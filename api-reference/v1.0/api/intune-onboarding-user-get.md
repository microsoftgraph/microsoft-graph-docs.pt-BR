...
Leia as propriedades e as relações do objeto [user](../resources/intune-onboarding-user.md).
...
Se bem-sucedido, este método retorna o código de resposta `200 OK` e o objeto [user](../resources/intune-onboarding-user.md) no corpo da resposta.
