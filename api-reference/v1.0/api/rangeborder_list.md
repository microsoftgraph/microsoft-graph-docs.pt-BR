...
Se bem-sucedido, este método retorna um código de resposta `200 OK` e uma coleção de objetos [WorkbookRangeBorder](../resources/rangeborder.md) no corpo da resposta.
