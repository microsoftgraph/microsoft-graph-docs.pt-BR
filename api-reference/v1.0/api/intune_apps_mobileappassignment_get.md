...
Leia as propriedades e as relações do objeto [mobileAppAssignment](../resources/intune_apps_mobileappassignment.md).
...
Se tiver êxito, este método retornará o código de resposta `200 OK` e o objeto [mobileAppAssignment](../resources/intune_apps_mobileappassignment.md) no corpo da resposta.
