...
Esta função dá suporte Microsoft 365 outros tipos de grupos provisionados no Azure Active Directory (Azure AD). O número máximo de grupos que cada solicitação pode retornar é 2046. 
