# <a name="get-organization"></a>Acessar organização

> **Observação:** O uso das APIs do Microsoft Graph para configurar controles e políticas do Intune ainda exige que o serviço do Intune seja [corretamente licenciado](https://go.microsoft.com/fwlink/?linkid=839381) pelo cliente.

Leia as propriedades e as relações do objeto [organização](../resources/intune_onboarding_organization.md).
...
Se tiver êxito, este método retornará um código de resposta `200 OK` e um objeto [organization](../resources/intune_onboarding_organization.md) no corpo da resposta.
