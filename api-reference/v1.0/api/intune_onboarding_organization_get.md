...
Se bem-sucedido, este método retorna um código de resposta `200 OK` e um objeto [organization](../resources/intune_onboarding_organization.md) no corpo da resposta.
