...
|autoSubscribeNewMembers|Booleano|O padrão é **false**. Indica se novos membros adicionados ao grupo serão automaticamente inscritos para receberem notificações por email.|
...
|mailNickname|Sequência de caracteres|O alias de email do grupo. Essa propriedade deve ser especificada quando um grupo é criado. Oferece suporte a $filter.|
...
|visibilidade|Sequência de caracteres|Especifica a visibilidade de um grupo do Office 365. Os valores possíveis são: **Private**, **Public**, ou em branco (que será interpretado como **Public**).|
