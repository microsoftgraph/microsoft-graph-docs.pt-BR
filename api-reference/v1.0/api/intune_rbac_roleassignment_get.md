...
Ler propriedades e relações do objeto [roleAssignment](../resources/intune_rbac_roleassignment.md).
...
Se bem-sucedido, este método retornará um código de resposta `200 OK` e um objeto [roleAssignment](../resources/intune_rbac_roleassignment.md) no corpo da resposta.
