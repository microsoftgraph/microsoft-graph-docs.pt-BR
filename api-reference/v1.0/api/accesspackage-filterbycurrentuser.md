...
|:---|:---|:---|
|on|accessPackageFilterByCurrentUserOptions|A lista de opções de usuário que podem ser usadas para filtrar na lista de pacotes de acesso. O valor permitido é `allowedRequestor` .|
