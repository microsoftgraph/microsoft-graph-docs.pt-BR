...
Se bem-sucedido, este método retorna um código de resposta `200 OK` e uma coleção de objetos [WorkbookWorksheet](../resources/worksheet.md) no corpo da resposta.
