...
No corpo da solicitação, forneça uma representação JSON do objeto mobileAppContent.

A tabela a seguir mostra as propriedades que são necessárias ao criar mobileAppContent.
...
Se tiver êxito, este método retornará um código de resposta `201 Created` e um objeto [mobileAppContent](../resources/intune-apps-mobileappcontent.md) no corpo da resposta.
