...
Listar configurações de todo o locatário.
...
### <a name="example-2-retrieve-the-group-settings-for-a-specific-group"></a>Exemplo 2: Recuperar as configurações de grupo para um grupo específico
