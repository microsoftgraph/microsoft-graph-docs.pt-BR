...
|acceptedModalities|String collection                         |A lista de aceitar modalidades. Os valores possíveis são: `audio`, `video`, `videoBasedScreenSharing`. Obrigatório para responder a uma chamada. |
