...
Se tiver êxito, este método retornará um `200 OK` código de resposta e um [objeto serviceUpdateMessage](../resources/serviceupdatemessage.md) no corpo da resposta.
