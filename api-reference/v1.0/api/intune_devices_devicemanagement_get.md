...
Ler propriedades e relações do objeto [deviceManagement](../resources/intune_devices_devicemanagement.md).
...
Se bem-sucedido, este método retornará um código de resposta `200 OK` e um objeto [deviceManagement](../resources/intune_devices_devicemanagement.md) no corpo da resposta.
