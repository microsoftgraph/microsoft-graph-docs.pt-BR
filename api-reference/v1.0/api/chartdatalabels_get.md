...
Se bem-sucedido, este método retorna um código de resposta `200 OK` e um objeto [WorkbookChartDataLabels](../resources/chartdatalabels.md) no corpo da resposta.
