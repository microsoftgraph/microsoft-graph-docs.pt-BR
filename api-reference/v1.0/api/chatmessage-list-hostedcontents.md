...
**Obter hostedContents em uma mensagem de canal**
<!-- { "blockType": "ignored" } -->
```http
...
**Obter hostedContents em uma mensagem de chat**
<!-- { "blockType": "ignored" } -->
```http
...
### <a name="example-1-list-hosted-content-for-a-channel-message"></a>Exemplo 1: Listar conteúdo hospedado para uma mensagem de canal
