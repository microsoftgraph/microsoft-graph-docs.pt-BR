...
Ler propriedades e relações do objeto [reportRoot](../resources/intune_deviceconfig_reportroot.md).
...
Se bem-sucedido, este método retornará um código de resposta `200 OK` e um objeto [reportRoot](../resources/intune_deviceconfig_reportroot.md) no corpo da resposta.
