...
Ler propriedades e relações do objeto [managedAppPolicy](../resources/intune_mam_managedapppolicy.md).
...
Se bem-sucedido, este método retornará um código de resposta `200 OK` e um objeto [managedAppPolicy](../resources/intune_mam_managedapppolicy.md) no corpo da resposta.
