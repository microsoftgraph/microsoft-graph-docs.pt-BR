...
Criar um novo objeto [roleAssignment](../resources/intune_rbac_roleassignment.md).
...
Se tiver êxito, este método retornará um código de resposta `201 Created` e um objeto [roleAssignment](../resources/intune_rbac_roleassignment.md) no corpo da resposta.
