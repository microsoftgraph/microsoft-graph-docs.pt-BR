...
Cria um novo objeto [windowsMobileMSI](../resources/intune_apps_windowsmobilemsi.md).
...
No corpo da solicitação, forneça uma representação JSON para o objeto windowsMobileMSI.

A tabela a seguir mostra as propriedades obrigatórias ao criar windowsMobileMSI.
...
Se tiver êxito, este método retornará o código de resposta `201 Created` e o objeto [windowsMobileMSI](../resources/intune_apps_windowsmobilemsi.md) no corpo da resposta.
