...
Ler propriedades e relações do objeto [deviceAppManagement](../resources/intune_apps_deviceappmanagement.md).
...
Se bem-sucedido, este método retornará um código de resposta `200 OK` e um objeto [deviceAppManagement](../resources/intune_apps_deviceappmanagement.md) no corpo da resposta.
