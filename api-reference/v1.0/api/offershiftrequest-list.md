...
Se tiver êxito, este método retornará um `200 OK` código de resposta e os objetos [offerShiftRequest](../resources/offershiftrequest.md) solicitados no corpo da resposta.
