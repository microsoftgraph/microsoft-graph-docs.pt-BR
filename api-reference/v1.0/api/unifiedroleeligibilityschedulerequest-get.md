...
description: No PIM, leia os detalhes de uma solicitação de elegibilidade de função feita por meio do objeto unifiedRoleEligibilityScheduleRequest.
author: rkarim-ms
...
ms.locfileid: "66437692"
---
# <a name="get-unifiedroleeligibilityschedulerequest"></a>Obter unifiedRoleEligibilityScheduleRequest
Namespace: microsoft.graph

No PIM, leia os detalhes de uma solicitação de qualificação de função feita por meio do objeto [unifiedRoleEligibilityScheduleRequest](../resources/unifiedroleeligibilityschedulerequest.md) .
...
Esse método dá suporte aos parâmetros `$select` `$expand` de consulta e OData para ajudar a personalizar a resposta. Todas as relações com suporte podem ser expandidas. Para obter informações gerais, acesse [Parâmetros de consulta OData](/graph/query-parameters).
