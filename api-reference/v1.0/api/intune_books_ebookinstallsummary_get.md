...
Ler propriedades e relações do objeto [eBookInstallSummary](../resources/intune_books_ebookinstallsummary.md).
...
Se bem-sucedido, este método retornará um código de resposta `200 OK` e um objeto [eBookInstallSummary](../resources/intune_books_ebookinstallsummary.md) no corpo da resposta.
