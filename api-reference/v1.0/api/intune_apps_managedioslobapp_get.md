...
Leia as propriedades e as relações do objeto [managedIOSLobApp](../resources/intune_apps_managedioslobapp.md).
...
Se tiver êxito, este método retornará o código de resposta `200 OK` e o objeto [managedIOSLobApp](../resources/intune_apps_managedioslobapp.md) no corpo da resposta.
