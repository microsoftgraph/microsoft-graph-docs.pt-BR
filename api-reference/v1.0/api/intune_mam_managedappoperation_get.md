...
Ler propriedades e relações do objeto [managedAppOperation](../resources/intune_mam_managedappoperation.md).
...
Se bem-sucedido, este método retornará um código de resposta `200 OK` e um objeto [managedAppOperation](../resources/intune_mam_managedappoperation.md) no corpo da resposta.
