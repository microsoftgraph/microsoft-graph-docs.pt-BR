...
Se tiver êxito, essa função retornará um `200 OK` código de resposta e uma coleção de [objetos appConsentRequest](../resources/appconsentrequest.md)  no corpo da resposta.
