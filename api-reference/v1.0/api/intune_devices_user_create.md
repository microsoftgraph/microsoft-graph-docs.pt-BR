...
Criar um novo objeto [user](../resources/intune_devices_user.md).
...
Se tiver êxito, este método retornará um código de resposta `201 Created` e um objeto [user](../resources/intune_devices_user.md) no corpo da resposta.
