...
Cria um novo objeto [deviceCategory](../resources/intune-onboarding-devicecategory.md).
...
Se tiver êxito, este método retornará um código de resposta `201 Created` e um objeto [deviceCategory](../resources/intune-onboarding-devicecategory.md) no corpo da resposta.
