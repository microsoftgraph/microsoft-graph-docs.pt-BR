...
Cria um novo objeto [managedIOSStoreApp](../resources/intune_apps_managediosstoreapp.md).
...
Se tiver êxito, este método retornará o código de resposta `201 Created` e um objeto [managedIOSStoreApp](../resources/intune_apps_managediosstoreapp.md) no corpo da resposta.
