...
Atualizar as propriedades de um objeto [user](../resources/intune_shared_user.md).
...
No corpo da solicitação, forneça uma representação JSON do objeto [user](../resources/intune_shared_user.md).

A tabela a seguir mostra as propriedades que são necessárias ao criar [user](../resources/intune_shared_user.md).
...
Se tiver êxito, este método retornará um código de resposta `200 OK` e um objeto [user](../resources/intune_shared_user.md) atualizado no corpo da resposta.
