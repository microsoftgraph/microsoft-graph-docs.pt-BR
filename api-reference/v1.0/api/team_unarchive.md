...
Restaure uma [equipe](../resources/team.md)de arquivados. Isso restaura a capacidade dos usuários de enviar mensagens e editar a equipe, aceitar pelas configurações de locatário e equipe. As equipes são arquivadas usando o [arquivo morto](team_archive.md) API.
