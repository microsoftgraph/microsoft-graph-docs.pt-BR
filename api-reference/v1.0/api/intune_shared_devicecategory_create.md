...
Cria um novo objeto [deviceCategory](../resources/intune_shared_devicecategory.md).
...
Se tiver êxito, este método retornará um código de resposta `201 Created` e um objeto [deviceCategory](../resources/intune_shared_devicecategory.md) no corpo da resposta.
