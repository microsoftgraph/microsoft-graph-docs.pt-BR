...
description: Cancela a atribuição do usuário de um dispositivo do Autopilot.
author: dougeby
...
Cancela a atribuição do usuário de um dispositivo do Autopilot.
