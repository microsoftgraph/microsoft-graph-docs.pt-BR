...
Ler propriedades e relações do objeto [deviceInstallState](../resources/intune_books_deviceinstallstate.md).
...
Se bem-sucedido, esse método retornará um código de resposta `200 OK` e um objeto [deviceInstallState](../resources/intune_books_deviceinstallstate.md) no corpo da resposta.
