...
Atualizar as propriedades de um objeto [organização](../resources/intune_onboarding_organization.md).
...
A tabela a seguir mostra as propriedades que são necessárias ao criar [organization](../resources/intune_onboarding_organization.md).
...
Se tiver êxito, este método retornará um código de resposta `200 OK` e um objeto [organization](../resources/intune_onboarding_organization.md) atualizado no corpo da resposta.
