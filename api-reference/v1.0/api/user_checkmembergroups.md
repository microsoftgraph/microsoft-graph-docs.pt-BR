...
>**Observação:** esta API atualmente exige permissão Directory.Read.All ou posterior. Usar permissões User.Read.All ou User.ReadWrite.All retornará um erro. Este é um bug conhecido.
