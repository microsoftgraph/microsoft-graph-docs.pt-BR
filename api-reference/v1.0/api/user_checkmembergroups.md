...
> **Observação:** Essa API atualmente requer a permissão `Directory.Read.All` ou superior. Usar as permissões `User.Read.All` ou `User.ReadWrite.All` retornará um erro. Este é um bug conhecido.
...
| :-------- | :---------------- | :-------------------- |
| groupIds  | Conjunto de sequência de caracteres | Uma matriz de IDs de grupo |
