...
Criar um novo objeto [roleDefinition](../resources/intune_rbac_roledefinition.md)
...
Se tiver êxito, este método retornará o código de resposta `201 Created` e um objeto [roleDefinition](../resources/intune_rbac_roledefinition.md) no corpo da resposta.
