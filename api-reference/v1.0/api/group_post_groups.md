...
O seguinte **escopo** é necessário para executar esta API: _Group.ReadWrite.All_ 
...
| mailNickname    | string  | O alias de email do grupo. Esse valor deve ser exclusivo da organização.  |
