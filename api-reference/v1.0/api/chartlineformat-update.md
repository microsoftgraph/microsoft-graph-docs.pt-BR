...
Se tiver êxito, este método retornará um `200 OK` código de resposta e o objeto de [WorkbookChartLineFormat](../resources/chartlineformat.md) atualizado no corpo da resposta.
