...
Se bem-sucedido, este método retorna um `200 OK` código de resposta e um objeto [WorkbookChartLineFormat](../resources/chartlineformat.md) atualizado no corpo da resposta.
