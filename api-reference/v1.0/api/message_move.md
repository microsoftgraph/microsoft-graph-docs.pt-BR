...
|:---------------|:--------|:----------|
|destinationId|Sequência de caracteres|O ID da pasta de destino ou um nome de pasta conhecido. Confira uma lista de nomes de pasta comuns com suporte em [Tipo de recurso mailFolder](../resources/mailfolder.md).|

## <a name="response"></a>Resposta

Se bem-sucedido, este método retorna o código de resposta `201 Created` e um recurso de [mensagem](../resources/message.md) no corpo da resposta.
