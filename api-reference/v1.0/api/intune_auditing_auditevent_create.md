...
Criar um novo objeto [auditEvent](../resources/intune_auditing_auditevent.md).
...
Se tiver êxito, este método retornará um código de resposta `201 Created` e um objeto [auditEvent](../resources/intune_auditing_auditevent.md) no corpo da resposta.
