...
ms.locfileid: "59080314"
---
# <a name="get-chartpoint"></a>Obter ChartPoint

Namespace: microsoft.graph

Recupera as propriedades e os relacionamentos do objeto chartpoint.
...
Se tiver êxito, este método retornará um código `200 OK` de resposta e um objeto [WorkbookChartPoint](../resources/chartpoint.md) no corpo da resposta.
