...
>**Observação:** Use a identificação retornada da chamada [lista publicada apps](./teamsapp_list.md) para referenciar o aplicativo que você gostaria de atualizar. Não use a ID do manifesto do pacote zip app.
