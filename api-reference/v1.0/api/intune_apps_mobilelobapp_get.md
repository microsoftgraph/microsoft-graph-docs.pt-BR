...
Leia as propriedades e as relações do objeto [mobileLobApp](../resources/intune_apps_mobilelobapp.md).
...
Se tiver êxito, este método retornará o código de resposta `200 OK` e o objeto [mobileLobApp](../resources/intune_apps_mobilelobapp.md) no corpo da resposta.
