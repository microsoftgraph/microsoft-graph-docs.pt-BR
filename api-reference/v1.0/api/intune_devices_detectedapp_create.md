...
Criar um novo objeto [detectedApp](../resources/intune_devices_detectedapp.md).
...
Se tiver êxito, este método retornará um código de resposta `201 Created` e um objeto [detectedApp](../resources/intune_devices_detectedapp.md) no corpo da resposta.
