...
### <a name="example-5-create-a-one-on-one-chat-with-a-federated-user-outside-of-own-organization"></a>Exemplo 5: Criar um chat um-para-um com um usuário federado (fora da própria organização)
