...
Atualiza as propriedades de um objeto [iosLobApp](../resources/intune_apps_ioslobapp.md).
...
No corpo da solicitação, forneça uma representação JSON do objeto [iosLobApp](../resources/intune_apps_ioslobapp.md).

A tabela a seguir mostra as propriedades obrigatórias ao criar [iosLobApp.](../resources/intune_apps_ioslobapp.md)
...
Se bem-sucedido, este método retorna um código de resposta `200 OK` e um objeto [iosLobApp](../resources/intune_apps_ioslobapp.md) atualizado no corpo da resposta.
