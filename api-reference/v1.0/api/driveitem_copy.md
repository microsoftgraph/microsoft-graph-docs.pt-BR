...
| name            | sequência de caracteres                                         | Opcional. O novo nome para a cópia. Se isso não for fornecido, será usado o mesmo nome que o original.    |
...
Retorna detalhes sobre como [monitorar o progresso](../../../concepts/long_running_actions_overview.md) da cópia após aceitar a solicitação.
...
Você pode usar essas informações para [determinar quando a cópia terminou](../../../concepts/long_running_actions_overview.md).
