...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto educationRubric](../resources/educationrubric.md) no corpo da resposta. Caso contrário, ele retornará `404 Not Found` um código de resposta.
