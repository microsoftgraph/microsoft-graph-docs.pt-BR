...
Se tiver êxito, este método retornará um código `200 OK` de resposta e um objeto [WorkbookRangeBorder](../resources/rangeborder.md) no corpo da resposta.
