...
Leia as propriedades e as relações do objeto [mobileAppContent](../resources/intune_apps_mobileappcontent.md).
...
Se tiver êxito, este método retornará o código de resposta `200 OK` e o objeto [mobileAppContent](../resources/intune_apps_mobileappcontent.md) no corpo da resposta.
