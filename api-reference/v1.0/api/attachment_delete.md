...
```
Anexos de uma [mensagem](../resources/message.md) contidos em uma [pasta](../resources/mailfolder.md) de nível superior na caixa de correio de um usuário.
<!-- { "blockType": "ignored" } -->
```http
DELETE /me/mailFolders/{id}/messages/{id}/attachments/{id}
DELETE /users/{id | userPrincipalName}/mailFolders/{id}/messages/{id}/attachments/{id}
```
Anexos de uma [mensagem](../resources/message.md) contidos em uma pasta filha de uma [pasta](../resources/mailfolder.md) na caixa de correio do usuário.  O exemplo a seguir mostra um nível de aninhamento, mas uma mensagem pode estar localizada na filha de uma filha e assim por diante.
<!-- { "blockType": "ignored" } -->
```http
