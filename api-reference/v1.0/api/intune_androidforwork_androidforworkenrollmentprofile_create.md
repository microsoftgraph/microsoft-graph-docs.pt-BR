...
Cria um novo objeto [androidForWorkEnrollmentProfile](../resources/intune_androidforwork_androidforworkenrollmentprofile.md).
...
|nome|String|(Preterido) Nome de exibição do perfil de registro.|
...
|qrCode|String|(Preterido) Cadeia de caracteres usada para gerar um código QR para o token.|
...
Se bem-sucedido, este método retornará um código de resposta `201 Created` e o objeto [androidForWorkEnrollmentProfile](../resources/intune_androidforwork_androidforworkenrollmentprofile.md) no corpo da resposta.
