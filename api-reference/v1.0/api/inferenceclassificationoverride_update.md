...
Se houver uma substituição de um remetente e o remetente alterar seu nome de exibição, você poderá usar [POST](inferenceclassification_post_overrides.md) para forçar uma atualização para o campo de nome em uma substituição existente.
...
|:---------------|:--------|:----------|
|classifyAs|sequência de caracteres| Especifica como as mensagens recebidas de um remetente específico devem ser sempre classificadas. Os valores possíveis são: `focused`, `other`.|
