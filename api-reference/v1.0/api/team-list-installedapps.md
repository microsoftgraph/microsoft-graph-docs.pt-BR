...
Este método dá suporte aos `$filter`parâmetros , `$select`e `$expand` [OData Query para](/graph/query-parameters) ajudar a personalizar a resposta.
