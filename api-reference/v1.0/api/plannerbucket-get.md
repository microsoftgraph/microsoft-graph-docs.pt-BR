...
Recupere as propriedades e as relações do **objeto plannerBucket.**
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto plannerBucket](../resources/plannerbucket.md) no corpo da resposta.
