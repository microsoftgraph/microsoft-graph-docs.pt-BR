...
description: Provisione um endereço de email para um canal.
author: anandab-msft
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto provisionChannelEmailResult](../resources/provisionChannelEmailResult.md) no corpo da resposta. O endereço de email provisionado está na `email` propriedade.
