...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto WorkbookTableRow](../resources/tablerow.md) no corpo da resposta.
