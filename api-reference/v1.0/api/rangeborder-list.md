...
Se tiver êxito, este método retornará um `200 OK` código de resposta e a coleção de objetos [WorkbookRangeBorder](../resources/rangeborder.md) no corpo da resposta.
