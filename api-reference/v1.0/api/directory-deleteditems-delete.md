...
Atualmente, a funcionalidade de itens excluídos só tem suporte para recursos de [aplicativo,](../resources/application.md) [servicePrincipal](../resources/serviceprincipal.md), [grupo](../resources/group.md) [e](../resources/user.md) usuário. É possível excluir permanentemente um item de itens excluídos. Mas, uma vez que um item é excluído permanentemente, ele **não pode** ser restaurado.
