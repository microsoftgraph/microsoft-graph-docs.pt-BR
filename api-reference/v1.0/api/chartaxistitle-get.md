...
Se tiver êxito, este método retornará um código `200 OK` de resposta e um objeto [WorkbookChartAxisTitle](../resources/chartaxistitle.md) no corpo da resposta.
