...
Leia as propriedades e as relações do objeto [mobileApp](../resources/intune_apps_mobileapp.md).
...
Se tiver êxito, este método retornará o código de resposta `200 OK` e o objeto [mobileApp](../resources/intune_apps_mobileapp.md) no corpo da resposta.
