...
Leia as propriedades e as relações do objeto [managedEBook](../resources/intune_books_managedebook.md).
...
Se tiver êxito, este método retornará o código de resposta `200 OK` e o objeto [managedEBook](../resources/intune_books_managedebook.md) no corpo da resposta.
