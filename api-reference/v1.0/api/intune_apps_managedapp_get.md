...
Leia as propriedades e as relações do objeto [managedApp](../resources/intune_apps_managedapp.md).
...
Se tiver êxito, este método retornará o código de resposta `200 OK` e o objeto [managedApp](../resources/intune_apps_managedapp.md) no corpo da resposta.
