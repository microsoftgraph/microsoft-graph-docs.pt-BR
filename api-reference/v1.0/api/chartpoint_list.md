...
Se bem-sucedido, este método retorna um código de resposta `200 OK` e uma coleção de objetos [WorkbookChartPoint](../resources/chartpoint.md) no corpo da resposta.
