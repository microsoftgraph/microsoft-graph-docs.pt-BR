...
Leia as propriedades e as relações do objeto [iosCustomConfiguration](../resources/intune_deviceconfig_ioscustomconfiguration.md).
...
Se tiver êxito, este método retornará o código de resposta `200 OK` e o objeto [iosCustomConfiguration](../resources/intune_deviceconfig_ioscustomconfiguration.md) no corpo da resposta.
