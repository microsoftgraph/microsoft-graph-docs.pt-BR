...
Cria um novo objeto [iosVppApp](../resources/intune_apps_iosvppapp.md).
...
|vppTokenAccountType|[vppTokenAccountType](../resources/intune_shared_vpptokenaccounttype.md)|O tipo de programa de compra por volume ao qual o Token do Programa de Compra por Volume da Apple especificado está associado. |||UNTRANSLATED_CONTENT_START|||The possible values are: `business`, `education`.|||UNTRANSLATED_CONTENT_END||| Os valores possíveis são: `business`, `education`.|
...
Se tiver êxito, este método retornará o código de resposta `201 Created` e o objeto [iosVppApp](../resources/intune_apps_iosvppapp.md) no corpo da resposta.
