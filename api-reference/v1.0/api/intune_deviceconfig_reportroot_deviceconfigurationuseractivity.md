...
Metadados para o relatório de atividades do usuário de configuração do dispositivo
...
Se tiver êxito, este método retornará um código de resposta `200 OK` e um [relatório](../resources/intune_deviceconfig_report.md) no corpo da resposta.
