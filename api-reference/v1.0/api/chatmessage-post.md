...
ms.locfileid: "51582893"
---
# <a name="send-chatmessage-in-a-channel-or-a-chat"></a><span data-ttu-id="a3af7-103">Enviar chatMessage em um canal ou chat</span><span class="sxs-lookup"><span data-stu-id="a3af7-103">Send chatMessage in a channel or a chat</span></span>

<span data-ttu-id="a3af7-104">Namespace: microsoft.graph</span><span class="sxs-lookup"><span data-stu-id="a3af7-104">Namespace: microsoft.graph</span></span>

<span data-ttu-id="a3af7-105">Envie um novo [chatMessage](../resources/chatmessage.md) no canal [especificado](../resources/channel.md) ou em um [chat](../resources/chat.md).</span><span class="sxs-lookup"><span data-stu-id="a3af7-105">Send a new [chatMessage](../resources/chatmessage.md) in the specified [channel](../resources/channel.md) or a [chat](../resources/chat.md).</span></span>

> <span data-ttu-id="a3af7-106">**Observação**: não recomendamos que você use essa API para migração de dados.</span><span class="sxs-lookup"><span data-stu-id="a3af7-106">**Note**: We don't recommend that you use this API for data migration.</span></span> <span data-ttu-id="a3af7-107">Ele não tem a produtividade necessária para uma migração típica.</span><span class="sxs-lookup"><span data-stu-id="a3af7-107">It does not have the throughput necessary for a typical migration.</span></span>

> <span data-ttu-id="a3af7-108">**Observação**: é uma violação dos termos [de](/legal/microsoft-apis/terms-of-use) uso usar o Microsoft Teams como um arquivo de log.</span><span class="sxs-lookup"><span data-stu-id="a3af7-108">**Note**: It is a violation of the [terms of use](/legal/microsoft-apis/terms-of-use) to use Microsoft Teams as a log file.</span></span> <span data-ttu-id="a3af7-109">Envie apenas mensagens que as pessoas lerão.</span><span class="sxs-lookup"><span data-stu-id="a3af7-109">Only send messages that people will read.</span></span>

## <a name="permissions"></a><span data-ttu-id="a3af7-110">Permissões</span><span class="sxs-lookup"><span data-stu-id="a3af7-110">Permissions</span></span>

<span data-ttu-id="a3af7-p103">Uma das seguintes permissões é obrigatória para chamar esta API. Para saber mais, incluindo como escolher permissões, confira [Permissões](/graph/permissions-reference).</span><span class="sxs-lookup"><span data-stu-id="a3af7-p103">One of the following permissions is required to call this API. To learn more, including how to choose permissions, see [Permissions](/graph/permissions-reference).</span></span>

### <a name="permissions-for-channel"></a><span data-ttu-id="a3af7-113">Permissões para canal</span><span class="sxs-lookup"><span data-stu-id="a3af7-113">Permissions for channel</span></span>
| <span data-ttu-id="a3af7-114">Tipo de permissão</span><span class="sxs-lookup"><span data-stu-id="a3af7-114">Permission type</span></span>                        | <span data-ttu-id="a3af7-115">Permissões (da com menos para a com mais privilégios)</span><span class="sxs-lookup"><span data-stu-id="a3af7-115">Permissions (from least to most privileged)</span></span> |
|:---------------------------------------|:--------------------------------------------|
| <span data-ttu-id="a3af7-116">Delegado (conta corporativa ou de estudante)</span><span class="sxs-lookup"><span data-stu-id="a3af7-116">Delegated (work or school account)</span></span>     | <span data-ttu-id="a3af7-117">ChannelMessage.Send</span><span class="sxs-lookup"><span data-stu-id="a3af7-117">ChannelMessage.Send</span></span> |
| <span data-ttu-id="a3af7-118">Delegado (conta pessoal da Microsoft)</span><span class="sxs-lookup"><span data-stu-id="a3af7-118">Delegated (personal Microsoft account)</span></span> | <span data-ttu-id="a3af7-119">Sem suporte.</span><span class="sxs-lookup"><span data-stu-id="a3af7-119">Not supported.</span></span> |
| <span data-ttu-id="a3af7-120">Aplicativo</span><span class="sxs-lookup"><span data-stu-id="a3af7-120">Application</span></span>                            | <span data-ttu-id="a3af7-121">Sem suporte.</span><span class="sxs-lookup"><span data-stu-id="a3af7-121">Not supported.</span></span> |

### <a name="permissions-for-chat"></a><span data-ttu-id="a3af7-122">Permissões para chat</span><span class="sxs-lookup"><span data-stu-id="a3af7-122">Permissions for chat</span></span>
| <span data-ttu-id="a3af7-123">Tipo de permissão</span><span class="sxs-lookup"><span data-stu-id="a3af7-123">Permission type</span></span>                        | <span data-ttu-id="a3af7-124">Permissões (da com menos para a com mais privilégios)</span><span class="sxs-lookup"><span data-stu-id="a3af7-124">Permissions (from least to most privileged)</span></span> |
|:---------------------------------------|:--------------------------------------------|
| <span data-ttu-id="a3af7-125">Delegado (conta corporativa ou de estudante)</span><span class="sxs-lookup"><span data-stu-id="a3af7-125">Delegated (work or school account)</span></span>     | <span data-ttu-id="a3af7-126">ChatMessage.Send, Chat.ReadWrite</span><span class="sxs-lookup"><span data-stu-id="a3af7-126">ChatMessage.Send, Chat.ReadWrite</span></span> |
| <span data-ttu-id="a3af7-127">Delegado (conta pessoal da Microsoft)</span><span class="sxs-lookup"><span data-stu-id="a3af7-127">Delegated (personal Microsoft account)</span></span> | <span data-ttu-id="a3af7-128">Sem suporte.</span><span class="sxs-lookup"><span data-stu-id="a3af7-128">Not supported.</span></span> |
| <span data-ttu-id="a3af7-129">Aplicativo</span><span class="sxs-lookup"><span data-stu-id="a3af7-129">Application</span></span>                            | <span data-ttu-id="a3af7-130">Sem suporte.</span><span class="sxs-lookup"><span data-stu-id="a3af7-130">Not supported.</span></span> |

## <a name="http-request"></a><span data-ttu-id="a3af7-131">Solicitação HTTP</span><span class="sxs-lookup"><span data-stu-id="a3af7-131">HTTP request</span></span>

<span data-ttu-id="a3af7-132">**Enviar mensagem em um canal**</span><span class="sxs-lookup"><span data-stu-id="a3af7-132">**Sending message in a channel**</span></span>
<!-- { "blockType": "ignored" } -->
```http
POST /teams/{team-id}/channels/{channel-id}/messages
```

<span data-ttu-id="a3af7-133">**Enviando respostas em um canal**</span><span class="sxs-lookup"><span data-stu-id="a3af7-133">**Sending replies in a channel**</span></span>
<!-- { "blockType": "ignored" } -->
```http
POST /teams/{team-id}/channels/{channel-id}/messages/{message-id}/replies
```

<span data-ttu-id="a3af7-134">**Enviar mensagem em um chat**</span><span class="sxs-lookup"><span data-stu-id="a3af7-134">**Sending message in a chat**</span></span>
<!-- { "blockType": "ignored" } -->
```http
POST /chats/{chat-id}/messages
```

## <a name="request-headers"></a><span data-ttu-id="a3af7-135">Cabeçalhos de solicitação</span><span class="sxs-lookup"><span data-stu-id="a3af7-135">Request headers</span></span>

| <span data-ttu-id="a3af7-136">Nome</span><span class="sxs-lookup"><span data-stu-id="a3af7-136">Name</span></span>          | <span data-ttu-id="a3af7-137">Descrição</span><span class="sxs-lookup"><span data-stu-id="a3af7-137">Description</span></span>   |
|:--------------|:--------------|
| <span data-ttu-id="a3af7-138">Autorização</span><span class="sxs-lookup"><span data-stu-id="a3af7-138">Authorization</span></span> | <span data-ttu-id="a3af7-139">Portador {código}.</span><span class="sxs-lookup"><span data-stu-id="a3af7-139">Bearer {code}.</span></span> <span data-ttu-id="a3af7-140">Obrigatório.</span><span class="sxs-lookup"><span data-stu-id="a3af7-140">Required.</span></span> |
| <span data-ttu-id="a3af7-141">Content-type</span><span class="sxs-lookup"><span data-stu-id="a3af7-141">Content-type</span></span> | <span data-ttu-id="a3af7-p105">application/json. Obrigatório.</span><span class="sxs-lookup"><span data-stu-id="a3af7-p105">application/json. Required.</span></span> |

## <a name="request-body"></a><span data-ttu-id="a3af7-144">Corpo da solicitação</span><span class="sxs-lookup"><span data-stu-id="a3af7-144">Request body</span></span>

<span data-ttu-id="a3af7-145">No corpo da solicitação, fornece uma representação JSON de um [objeto chatMessage.](../resources/chatmessage.md)</span><span class="sxs-lookup"><span data-stu-id="a3af7-145">In the request body, supply a JSON representation of a [chatMessage](../resources/chatmessage.md) object.</span></span> <span data-ttu-id="a3af7-146">Somente a propriedade body é obrigatória; outras propriedades são opcionais.</span><span class="sxs-lookup"><span data-stu-id="a3af7-146">Only the body property is mandatory; other properties are optional.</span></span>


## <a name="response"></a><span data-ttu-id="a3af7-147">Resposta</span><span class="sxs-lookup"><span data-stu-id="a3af7-147">Response</span></span>

<span data-ttu-id="a3af7-148">Se tiver êxito, este método retornará um código de resposta e um `201 Created` novo [objeto chatMessage](../resources/chatmessage.md) no corpo da resposta.</span><span class="sxs-lookup"><span data-stu-id="a3af7-148">If successful, this method returns a `201 Created` response code and a new [chatMessage](../resources/chatmessage.md) object in the response body.</span></span>

## <a name="examples"></a><span data-ttu-id="a3af7-149">Exemplos</span><span class="sxs-lookup"><span data-stu-id="a3af7-149">Examples</span></span>

<span data-ttu-id="a3af7-150">Nos exemplos a seguir, [a](channel-post-messages.md)URL pode usar a sintaxe [HTTP](#http-request) descrita para enviar uma mensagem para um [chat,](chat-post-messages.md)enviar uma mensagem para um canal ou enviar [resposta para um canal](chatmessage-post-replies.md).</span><span class="sxs-lookup"><span data-stu-id="a3af7-150">In the following examples, the URL can use the [HTTP syntax](#http-request) described to [send a message to a chat](chat-post-messages.md), [send a message to a channel](channel-post-messages.md), or [send reply to a channel](chatmessage-post-replies.md).</span></span>

### <a name="example-1-send-a-hello-world-message-in-a-channel"></a><span data-ttu-id="a3af7-151">Exemplo 1: Enviar uma mensagem hello world em um canal</span><span class="sxs-lookup"><span data-stu-id="a3af7-151">Example 1: Send a Hello World message in a channel</span></span>

#### <a name="request"></a><span data-ttu-id="a3af7-152">Solicitação</span><span class="sxs-lookup"><span data-stu-id="a3af7-152">Request</span></span>
<span data-ttu-id="a3af7-153">Este é um exemplo de solicitação.</span><span class="sxs-lookup"><span data-stu-id="a3af7-153">The following is an example of the request.</span></span>
...
#### <a name="response"></a><span data-ttu-id="a3af7-154">Resposta</span><span class="sxs-lookup"><span data-stu-id="a3af7-154">Response</span></span>

<span data-ttu-id="a3af7-155">Este é um exemplo de resposta.</span><span class="sxs-lookup"><span data-stu-id="a3af7-155">The following is an example of the response.</span></span>
...
### <a name="example-2-mentions-a-user-in-a-channel-message"></a><span data-ttu-id="a3af7-156">Exemplo 2: @mentions um usuário em uma mensagem de canal</span><span class="sxs-lookup"><span data-stu-id="a3af7-156">Example 2: @mentions a user in a channel message</span></span>

#### <a name="request"></a><span data-ttu-id="a3af7-157">Solicitação</span><span class="sxs-lookup"><span data-stu-id="a3af7-157">Request</span></span>
<span data-ttu-id="a3af7-158">Este é um exemplo de solicitação.</span><span class="sxs-lookup"><span data-stu-id="a3af7-158">The following is an example of the request.</span></span>
...
#### <a name="response"></a><span data-ttu-id="a3af7-159">Resposta</span><span class="sxs-lookup"><span data-stu-id="a3af7-159">Response</span></span>

<span data-ttu-id="a3af7-160">Este é um exemplo de resposta.</span><span class="sxs-lookup"><span data-stu-id="a3af7-160">The following is an example of the response.</span></span>
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "microsoft.graph.chatMessage"
...
### <a name="example-3-send-message-containing-cards"></a><span data-ttu-id="a3af7-161">Exemplo 3: Enviar mensagem contendo cartões</span><span class="sxs-lookup"><span data-stu-id="a3af7-161">Example 3: Send message containing cards</span></span>

#### <a name="request"></a><span data-ttu-id="a3af7-162">Solicitação</span><span class="sxs-lookup"><span data-stu-id="a3af7-162">Request</span></span>
<span data-ttu-id="a3af7-163">Este é um exemplo de solicitação.</span><span class="sxs-lookup"><span data-stu-id="a3af7-163">The following is an example of the request.</span></span>

> <span data-ttu-id="a3af7-164">**Observação:** A ID do anexo deve ser exclusiva e pode ser um novo GUID gerado aleatoriamente.</span><span class="sxs-lookup"><span data-stu-id="a3af7-164">**Note:** The attachment's ID must be unique and can be a new randomly generated GUID.</span></span> <span data-ttu-id="a3af7-165">No entanto, a ID do anexo deve ser a mesma no _corpo_ e nos _elementos anexos._</span><span class="sxs-lookup"><span data-stu-id="a3af7-165">However, the attachment's ID must be the same in the _body_ and _attachments_ elements.</span></span>
...
#### <a name="response"></a><span data-ttu-id="a3af7-166">Resposta</span><span class="sxs-lookup"><span data-stu-id="a3af7-166">Response</span></span>

<span data-ttu-id="a3af7-167">Este é um exemplo de resposta.</span><span class="sxs-lookup"><span data-stu-id="a3af7-167">The following is an example of the response.</span></span>
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "microsoft.graph.chatMessage"
...
### <a name="example-4-send-a-message-with-file-attachment-in-it"></a><span data-ttu-id="a3af7-168">Exemplo 4: Enviar uma mensagem com anexo de arquivo nele</span><span class="sxs-lookup"><span data-stu-id="a3af7-168">Example 4: Send a message with file attachment in it</span></span>

#### <a name="request"></a><span data-ttu-id="a3af7-169">Solicitação</span><span class="sxs-lookup"><span data-stu-id="a3af7-169">Request</span></span>
<span data-ttu-id="a3af7-170">Este é um exemplo de solicitação.</span><span class="sxs-lookup"><span data-stu-id="a3af7-170">The following is an example of the request.</span></span>

><span data-ttu-id="a3af7-171">**Observação:** O arquivo já deve estar no SharePoint.</span><span class="sxs-lookup"><span data-stu-id="a3af7-171">**Note:** The file must already be in SharePoint.</span></span> <span data-ttu-id="a3af7-172">Para encontrar as propriedades do arquivo, GET **the driveItem** for the file.</span><span class="sxs-lookup"><span data-stu-id="a3af7-172">To find the file properties, GET the **driveItem** for the file.</span></span> <span data-ttu-id="a3af7-173">Por exemplo, /drives/{id}/items/{id}.</span><span class="sxs-lookup"><span data-stu-id="a3af7-173">For example, /drives/{id}/items/{id}.</span></span> <span data-ttu-id="a3af7-174">Sua ID de anexo é o GUID na **eTag** do **driveItem**, seu **contentURL** de anexo é o **webUrl** da pasta **do driveItem** mais o nome do **driveItem** e seu nome de anexo é o nome **do driveItem.**</span><span class="sxs-lookup"><span data-stu-id="a3af7-174">Your attachment ID is the GUID in the **eTag** of the **driveItem**, your attachment **contentURL** is the **webUrl** of the **driveItem**'s folder plus the **driveItem**'s name, and your attachment name is the **driveItem**'s name.</span></span>
...
#### <a name="response"></a><span data-ttu-id="a3af7-175">Resposta</span><span class="sxs-lookup"><span data-stu-id="a3af7-175">Response</span></span>

<span data-ttu-id="a3af7-176">Este é um exemplo de resposta.</span><span class="sxs-lookup"><span data-stu-id="a3af7-176">The following is an example of the response.</span></span>
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "microsoft.graph.chatMessage"
...
### <a name="example-5-send-inline-images-along-with-the-message"></a><span data-ttu-id="a3af7-177">Exemplo 5: Enviar imagens em linha juntamente com a mensagem</span><span class="sxs-lookup"><span data-stu-id="a3af7-177">Example 5: Send inline images along with the message</span></span>

#### <a name="request"></a><span data-ttu-id="a3af7-178">Solicitação</span><span class="sxs-lookup"><span data-stu-id="a3af7-178">Request</span></span>
<span data-ttu-id="a3af7-179">Este é um exemplo de solicitação.</span><span class="sxs-lookup"><span data-stu-id="a3af7-179">The following is an example of the request.</span></span>

> <span data-ttu-id="a3af7-180">**Observação:** A **temporaryId** na **coleção hostedContents** é uma ID aleatória, mas deve ser a mesma no corpo e nos elementos **hostedContents.** </span><span class="sxs-lookup"><span data-stu-id="a3af7-180">**Note:** The **temporaryId** in the **hostedContents** collection is a random ID, but must be same across the **body** and **hostedContents** elements.</span></span> <span data-ttu-id="a3af7-181">(Observe o **conjunto temporaryId** como **1** e a referência no corpo como `../hostedContents/1/$value` .)</span><span class="sxs-lookup"><span data-stu-id="a3af7-181">(Notice the **temporaryId** set to **1** and the reference in body as `../hostedContents/1/$value`.)</span></span>

<span data-ttu-id="a3af7-182">**contentBytes** deve ser definido como bytes binários codificados em cadeia de caracteres Base64.</span><span class="sxs-lookup"><span data-stu-id="a3af7-182">**contentBytes** must be set to binary string Base64-encoded bytes.</span></span> <span data-ttu-id="a3af7-183">Você pode fazer isso em C# usando `Convert.ToBase64String(File.ReadAllBytes("image.png"));`</span><span class="sxs-lookup"><span data-stu-id="a3af7-183">You can do this in C# by using `Convert.ToBase64String(File.ReadAllBytes("image.png"));`</span></span>
...
#### <a name="response"></a><span data-ttu-id="a3af7-184">Resposta</span><span class="sxs-lookup"><span data-stu-id="a3af7-184">Response</span></span>

<span data-ttu-id="a3af7-185">Este é um exemplo de resposta.</span><span class="sxs-lookup"><span data-stu-id="a3af7-185">The following is an example of the response.</span></span>
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "microsoft.graph.chatMessage"
...
### <a name="example-6-send-a-card-with-inline-images"></a><span data-ttu-id="a3af7-186">Exemplo 6: Enviar um cartão com imagens em linha</span><span class="sxs-lookup"><span data-stu-id="a3af7-186">Example 6: Send a card with inline images</span></span>

#### <a name="request"></a><span data-ttu-id="a3af7-187">Solicitação</span><span class="sxs-lookup"><span data-stu-id="a3af7-187">Request</span></span>
<span data-ttu-id="a3af7-188">Este é um exemplo de solicitação.</span><span class="sxs-lookup"><span data-stu-id="a3af7-188">The following is an example of the request.</span></span>

> <span data-ttu-id="a3af7-189">**Observação:** A **temporaryId** na coleção **hostedContents** é uma ID aleatória, mas deve ser a mesma em todo o conteúdo **(em** **anexos**) e **elementos hostedContents.**</span><span class="sxs-lookup"><span data-stu-id="a3af7-189">**Note:** The **temporaryId** in the **hostedContents** collection is a random ID, but must be same across the **content** (in **attachments**) and **hostedContents** elements.</span></span> <span data-ttu-id="a3af7-190">(Observe a **temporaryId** definida como **1** e a referência no conteúdo como `../hostedContents/1/$value` .)</span><span class="sxs-lookup"><span data-stu-id="a3af7-190">(Notice the **temporaryId** set to **1** and the reference in content as `../hostedContents/1/$value`.)</span></span>

<span data-ttu-id="a3af7-191">**contentBytes** deve ser definido como bytes binários codificados em cadeia de caracteres Base64.</span><span class="sxs-lookup"><span data-stu-id="a3af7-191">**contentBytes** must be set to binary string Base64-encoded bytes.</span></span> <span data-ttu-id="a3af7-192">Você pode fazer isso em C# usando `Convert.ToBase64String(File.ReadAllBytes("image.png"));`</span><span class="sxs-lookup"><span data-stu-id="a3af7-192">You can do this in C# by using `Convert.ToBase64String(File.ReadAllBytes("image.png"));`</span></span>
...
#### <a name="response"></a><span data-ttu-id="a3af7-193">Resposta</span><span class="sxs-lookup"><span data-stu-id="a3af7-193">Response</span></span>
...
## <a name="see-also"></a><span data-ttu-id="a3af7-194">Confira também</span><span class="sxs-lookup"><span data-stu-id="a3af7-194">See also</span></span>

- [<span data-ttu-id="a3af7-195">Referência de cartões</span><span class="sxs-lookup"><span data-stu-id="a3af7-195">Cards reference</span></span>](/microsoftteams/platform/concepts/cards/cards-reference)
