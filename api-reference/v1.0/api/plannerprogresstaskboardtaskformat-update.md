...
|:---------------|:--------|:----------|
|orderHint|String|Valor de dica usado para ordenar a tarefa no modo de exibição Progresso do Quadro de Tarefas. O formato é definido como descrito [aqui](../resources/planner-order-hint-format.md).|
