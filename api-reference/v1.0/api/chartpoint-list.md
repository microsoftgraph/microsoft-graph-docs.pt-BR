...
Se tiver êxito, este método retornará um `200 OK` código de resposta e a coleção de objetos [WorkbookChartPoint](../resources/chartpoint.md) no corpo da resposta.
