...
Ler propriedades de leitura e relações do objeto [deviceCategory](../resources/intune-devices-devicecategory.md).
...
Se tiver êxito, este método retornará um código de resposta `200 OK` e um objeto [deviceCategory](../resources/intune-devices-devicecategory.md) no corpo da resposta.
