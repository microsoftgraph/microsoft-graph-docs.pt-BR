...
Ler propriedades e relações do objeto [deviceAppManagement](../resources/intune_mam_deviceappmanagement.md).
...
Se bem-sucedido, este método retornará um código de resposta `200 OK` e um objeto [deviceAppManagement](../resources/intune_mam_deviceappmanagement.md) no corpo da resposta.
