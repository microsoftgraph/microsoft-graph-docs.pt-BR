...
Ler propriedades e relações do objeto [resourceOperation](../resources/intune_rbac_resourceoperation.md).
...
Se tiver êxito, este método retornará um código de resposta `200 OK` e um objeto [resourceOperation](../resources/intune_rbac_resourceoperation.md) no corpo da resposta.
