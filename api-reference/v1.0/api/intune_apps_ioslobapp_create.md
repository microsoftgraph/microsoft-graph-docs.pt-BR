...
Cria um novo objeto [iosLobApp](../resources/intune_apps_ioslobapp.md).
...
Se tiver êxito, este método retornará o código de resposta `201 Created` e um objeto [iosLobApp](../resources/intune_apps_ioslobapp.md) no corpo da resposta.
