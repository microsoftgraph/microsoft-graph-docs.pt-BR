...
Cria um novo objeto [iosCustomConfiguration](../resources/intune_deviceconfig_ioscustomconfiguration.md).
...
Se tiver êxito, este método retornará um código de resposta `201 Created` e um objeto [iosCustomConfiguration](../resources/intune_deviceconfig_ioscustomconfiguration.md) no corpo da resposta.
