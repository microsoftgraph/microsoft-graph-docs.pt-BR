...
Criar um novo objeto [mobileAppContentFile](../resources/intune_apps_mobileappcontentfile.md).
...
Se tiver êxito, este método retornará um código de resposta `201 Created` e um objeto [mobileAppContentFile](../resources/intune_apps_mobileappcontentfile.md) no corpo da resposta.
