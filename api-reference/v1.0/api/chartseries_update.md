...
Se bem-sucedido, este método retorna um código de resposta `200 OK` e um objeto [WorkbookChartSeries](../resources/chartseries.md) atualizado no corpo da resposta.
