# <a name="create-managedappstatusraw"></a>Criar managedAppStatusRaw

> **Observação:** O uso das APIs do Microsoft Graph para configurar controles e políticas do Intune ainda exige que o serviço do Intune seja [corretamente licenciado](https://go.microsoft.com/fwlink/?linkid=839381) pelo cliente.

Criar um novo objeto [managedAppStatusRaw](../resources/intune_mam_managedappstatusraw.md).
...
No corpo da solicitação, forneça uma representação JSON do objeto managedAppStatusRaw.

A tabela a seguir mostra as propriedades que são necessárias ao criar managedAppStatusRaw.
...
Se tiver êxito, este método retornará um código de resposta `201 Created` e um objeto [managedAppStatusRaw](../resources/intune_mam_managedappstatusraw.md) no corpo da resposta.
