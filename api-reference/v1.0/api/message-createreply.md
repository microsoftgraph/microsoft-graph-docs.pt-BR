...
No entanto, para criar um rascunho de resposta usando o formato MIME, forneça o conteúdo MIME com os headers de mensagem da Internet aplicáveis, todos codificados no **formato base64** no corpo da solicitação.
...
### <a name="example-1-create-a-draft-message-in-json-format-to-reply-to-an-existing-message"></a>Exemplo 1: Criar uma mensagem de rascunho no formato JSON para responder a uma mensagem existente.
