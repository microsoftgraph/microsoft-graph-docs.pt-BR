...
ms.locfileid: "60947004"
---
# <a name="get-chartdatalabels"></a>Obter ChartDataLabels

Namespace: microsoft.graph

Lê as propriedades e os relacionamentos do objeto chartdatalabels.
...
Se tiver êxito, este método retornará um código `200 OK` de resposta e um objeto [WorkbookChartDataLabels](../resources/chartdatalabels.md) no corpo da resposta.
