...
description: Saiba como recuperar uma lista de objetos nameditem.
...
Se bem-sucedido, este método retorna um código `200 OK` de resposta e uma coleção de [objetos WorkbookNamedItem](../resources/nameditem.md) no corpo da resposta.
