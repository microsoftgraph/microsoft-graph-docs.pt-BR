...
Obtém o objeto de intervalo especificado pelo nome ou endereço.
...
Se o opcional `address` parâmetro não for especificado, essa função retorna o intervalo de planilha inteira.
