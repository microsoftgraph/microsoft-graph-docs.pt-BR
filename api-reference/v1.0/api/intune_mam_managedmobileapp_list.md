...
Listar propriedades e relações dos objetos [managedMobileApp](../resources/intune_mam_managedmobileapp.md).
...
Se tiver êxito, este método retornará um código de resposta `200 OK` e uma coleção de objetos [managedMobileApp](../resources/intune_mam_managedmobileapp.md) no corpo da resposta.
