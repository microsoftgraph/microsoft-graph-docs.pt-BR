...
Se tiver êxito, essa função retornará um `200 OK` código de resposta e uma coleção de [objetos userConsentRequest](../resources/userconsentrequest.md) no corpo da resposta.
