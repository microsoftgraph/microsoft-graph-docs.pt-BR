...
|:----------|:-------|:---------------------------------------------------------------|
| _formato_  | sequência de caracteres | Especifique o formato em que o conteúdo do item deve ser baixado. |


### <a name="format-options"></a>Opções de formato

Os seguintes valores são válidos para o parâmetro de **formato**:
