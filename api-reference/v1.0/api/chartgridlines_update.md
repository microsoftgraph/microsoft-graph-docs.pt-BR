...
Se bem-sucedido, este método retorna um código de resposta `200 OK` e o objeto [WorkbookChartGridlines](../resources/chartgridlines.md) atualizado no corpo da resposta.
