...
Ler propriedades e relações do objeto [managedDevice](../resources/intune_deviceconfig_manageddevice.md).
...
Se bem-sucedido, este método retornará um código de resposta `200 OK` e um objeto [managedDevice](../resources/intune_deviceconfig_manageddevice.md) no corpo da resposta.
