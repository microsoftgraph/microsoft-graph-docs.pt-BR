...
Criar um novo objeto [managedDevice](../resources/intune_devices_manageddevice.md).
...
Se tiver êxito, este método retornará o código de resposta `201 Created` e o objeto [managedDevice](../resources/intune_devices_manageddevice.md) no corpo da resposta.
