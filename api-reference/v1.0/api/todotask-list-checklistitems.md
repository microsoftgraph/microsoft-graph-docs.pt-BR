...
description: Obtenha os recursos checklistItem associados a um todoTask da propriedade de navegação checklistItems.
author: avijityadav
...
ms.locfileid: "65821306"
---
# <a name="list-checklistitems"></a>Listar checklistItems
Namespace: microsoft.graph

Obtenha os [recursos checklistItem](../resources/checklistitem.md) associados a um [todoTask](../resources/todoTask.md) da propriedade de navegação checklistItems.
