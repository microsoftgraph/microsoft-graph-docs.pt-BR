...
Criar um novo objeto [mobileAppCategory](../resources/intune_apps_mobileappcategory.md).
...
Se tiver êxito, este método retornará um código de resposta `201 Created` e um objeto [mobileAppCategory](../resources/intune_apps_mobileappcategory.md) no corpo da resposta.
