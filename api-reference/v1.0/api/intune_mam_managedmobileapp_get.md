...
Leia as propriedades e as relações do objeto [managedMobileApp](../resources/intune_mam_managedmobileapp.md).
...
Se tiver êxito, este método retornará o código de resposta `200 OK` e o objeto [managedMobileApp](../resources/intune_mam_managedmobileapp.md) no corpo da resposta.
