# <a name="get-managedappstatus"></a>Obter managedAppStatus

> **Observação:** O uso das APIs do Microsoft Graph para configurar controles e políticas do Intune ainda exige que o serviço do Intune seja [corretamente licenciado](https://go.microsoft.com/fwlink/?linkid=839381) pelo cliente.

Ler propriedades e relações do objeto [managedAppStatus](../resources/intune_mam_managedappstatus.md).
...
Se bem-sucedido, este método retornará um código de resposta `200 OK` e um objeto [managedAppStatus](../resources/intune_mam_managedappstatus.md) no corpo da resposta.
