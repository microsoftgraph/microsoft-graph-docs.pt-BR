# <a name="update-deviceconfigurationstate"></a>Atualizar deviceConfigurationState

> **Observação:** O uso das APIs do Microsoft Graph para configurar controles e políticas do Intune ainda exige que o serviço do Intune seja [corretamente licenciado](https://go.microsoft.com/fwlink/?linkid=839381) pelo cliente.

Atualizar as propriedades de um objeto [deviceConfigurationState](../resources/intune_deviceconfig_deviceconfigurationstate.md).
...
No corpo da solicitação, forneça uma representação JSON do objeto [deviceConfigurationState](../resources/intune_deviceconfig_deviceconfigurationstate.md).

A tabela a seguir mostra as propriedades que são necessárias ao criar [deviceConfigurationState](../resources/intune_deviceconfig_deviceconfigurationstate.md).
...
Se tiver êxito, este método retornará um código de resposta `200 OK` e um objeto [deviceConfigurationState](../resources/intune_deviceconfig_deviceconfigurationstate.md) atualizado no corpo da resposta.
