...
ms.locfileid: "61021304"
---
# <a name="create-sectiongroup"></a>Criar sectionGroup

Namespace: microsoft.graph

Crie um novo [grupo de seção](../resources/sectiongroup.md) no grupo da seção especificado.
...
Se bem-sucedido, este método retorna o código de resposta `201 Created` e um objeto [sectionGroup](../resources/sectiongroup.md) no corpo da resposta.
