# <a name="requestremoteassistance-action"></a><span data-ttu-id="bcc7f-101">Ação requestRemoteAssistance</span><span class="sxs-lookup"><span data-stu-id="bcc7f-101">requestRemoteAssistance action</span></span>
