...
Cria um novo objeto [microsoftStoreForBusinessApp](../resources/intune_apps_microsoftstoreforbusinessapp.md).
...
|licenseType|String|O tipo de licença do aplicativo Os valores possíveis são: `offline`, `online`.|
|packageIdentityName|String|O identificador do pacote do aplicativo|



## <a name="response"></a>Resposta
Se bem-sucedido, este método retornará um código de resposta `201 Created` e um objeto [microsoftStoreForBusinessApp](../resources/intune_apps_microsoftstoreforbusinessapp.md) no corpo da resposta.
