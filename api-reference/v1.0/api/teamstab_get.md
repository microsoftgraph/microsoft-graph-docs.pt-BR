...
> Atualmente, somente [permissões delegadas](../../../concepts/permissions_reference.md) têm suporte para esta operação.
...
Este método oferece suporte a $select e $expand [OData parâmetros de consulta](../../../concepts/query_parameters.md) para ajudar a personalizar a resposta.
