...
Leia as propriedades e as relações do objeto [webApp](../resources/intune_apps_webapp.md).
...
Se tiver êxito, este método retornará o código de resposta `200 OK` e o objeto [webApp](../resources/intune_apps_webapp.md) no corpo da resposta.
