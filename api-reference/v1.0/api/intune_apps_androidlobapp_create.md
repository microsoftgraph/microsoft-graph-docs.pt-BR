...
Cria um novo objeto [androidLobApp](../resources/intune_apps_androidlobapp.md).
...
Se tiver êxito, este método retornará o código de resposta `201 Created` e um objeto [androidLobApp](../resources/intune_apps_androidlobapp.md) no corpo da resposta.
