...
Se bem-sucedido, este método retorna um `200 OK` código de resposta e um objeto [WorkbookWorksheetProtection](../resources/worksheetprotection.md) no corpo da resposta.
