...
Se tiver êxito, este método retornará um `200 OK` código de resposta e o objeto [WorkbookWorksheetProtection](../resources/worksheetprotection.md) no corpo da resposta.
