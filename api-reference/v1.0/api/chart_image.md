# <a name="chart-image"></a>Gráfico: Imagem
...
|fittingMode|sequência de caracteres|O método usado para dimensionar o gráfico para as dimensões especificadas (se a altura e largura estiverem definidas)."  Os valores possíveis são: `Fit`, `FitAndCenter`, `Fill`.|
