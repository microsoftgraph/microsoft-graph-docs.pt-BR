...
Criar um novo objeto [managedMobileApp](../resources/intune_mam_managedmobileapp.md).
...
Se tiver êxito, este método retornará um código de resposta `201 Created` e um objeto [managedMobileApp](../resources/intune_mam_managedmobileapp.md) no corpo da resposta.
