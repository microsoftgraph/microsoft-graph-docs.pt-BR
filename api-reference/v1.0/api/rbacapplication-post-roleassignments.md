...
### <a name="example-3--create-a-role-assignment-with-application-scope"></a>Exemplo 3: Criar uma atribuição de função com o escopo do aplicativo
