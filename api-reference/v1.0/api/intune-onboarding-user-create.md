...
Criar um novo objeto [user](../resources/intune-onboarding-user.md).
...
Se tiver êxito, este método retornará um código de resposta `201 Created` e um objeto [user](../resources/intune-onboarding-user.md) no corpo da resposta.
