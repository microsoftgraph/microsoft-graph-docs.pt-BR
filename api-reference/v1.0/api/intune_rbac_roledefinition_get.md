...
Leia as propriedades e as relações do objeto [roleDefinition](../resources/intune_rbac_roledefinition.md).
...
Se tiver êxito, este método retornará o código de resposta `200 OK` e o objeto [roleDefinition](../resources/intune_rbac_roledefinition.md) no corpo da resposta.
