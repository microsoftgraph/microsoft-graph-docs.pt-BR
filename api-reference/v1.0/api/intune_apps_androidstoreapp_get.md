...
Ler propriedades e relações do objeto [androidStoreApp](../resources/intune_apps_androidstoreapp.md).
...
Se bem-sucedido, este método retornará um código de resposta `200 OK` e um objeto [androidStoreApp](../resources/intune_apps_androidstoreapp.md) no corpo da resposta.
