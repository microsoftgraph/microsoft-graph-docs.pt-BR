...
Criar um novo objeto [managedAppOperation](../resources/intune_mam_managedappoperation.md).
...
Se tiver êxito, este método retornará um código de resposta `201 Created` e um objeto [managedAppOperation](../resources/intune_mam_managedappoperation.md) no corpo da resposta.
