...
ms.locfileid: "60934994"
---
# <a name="list-chartcollection"></a>Listar ChartCollection

Namespace: microsoft.graph

Recupere uma lista de objetos de gráfico.
...
Se tiver êxito, este método retornará um código `200 OK` de resposta e uma coleção de objetos [WorkbookChart](../resources/chart.md) no corpo da resposta.
