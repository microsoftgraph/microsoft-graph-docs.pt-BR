...
|:---|:---|:---|
|key|String|A **operationId** fornecida na **resposta workbookOperation** retornada na solicitação [Get workbookOperation](./workbookoperation-get.md) anterior.|
