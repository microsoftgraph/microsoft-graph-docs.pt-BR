...
Criar um novo objeto [mobileAppAssignment](../resources/intune_apps_mobileappassignment.md).
...
Se tiver êxito, este método retornará um código de resposta `201 Created` e um objeto [mobileAppAssignment](../resources/intune_apps_mobileappassignment.md) no corpo da resposta.
