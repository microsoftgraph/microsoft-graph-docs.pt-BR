...
## <a name="http-request"></a><span data-ttu-id="e8eed-117">Solicitação HTTP</span><span class="sxs-lookup"><span data-stu-id="e8eed-117">HTTP Request</span></span>
<!-- {
  "blockType": "ignored"
}
-->
