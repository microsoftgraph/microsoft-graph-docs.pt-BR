# <a name="get-thumbnailset"></a>Obter thumbnailSet
...
Se bem-sucedido, este método retorna o código de resposta `200 OK` e o objeto [thumbnailSet](../resources/thumbnailset.md) no corpo da resposta.
