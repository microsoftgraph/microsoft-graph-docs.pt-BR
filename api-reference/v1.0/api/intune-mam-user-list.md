...
Listar propriedades e relações de objetos de [usuário](../resources/intune-mam-user.md).
...
Se tiver êxito, este método retornará o código de resposta `200 OK` e a coleção de objetos [user](../resources/intune-mam-user.md) no corpo da resposta.
