...
> **Observação**: não há um problema conhecido com permissões de aplicativo e essa API. Para obter detalhes, consulte a [lista de problemas conhecidos do](../../../concepts/known_issues.md#application-permissions).
