...
Um dos seguintes **escopos** é necessário para executar esta API: *Directory.Read.All*, *Directory.ReadWrite.All*, *Directory.AccessAsUser.All* ou *Device.ReadWrite.All*
