...
>**Observação:** esta API atualmente exige permissão Directory.Read.All ou posterior. Usar a permissão Group.Read.All sozinha ou em combinação com uma permissão Usuário retornará um erro. Este é um bug conhecido.
