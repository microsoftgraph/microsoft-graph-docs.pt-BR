...
> **Observação:** Essa API atualmente requer a permissão `Directory.Read.All` ou superior. Usar a permissão Group.Read.All sozinha ou em combinação com uma permissão `User.` retornará um erro. Este é um bug conhecido.
