...
Se tiver êxito, este método retornará um código `200 OK` de resposta [e um objeto WorkbookNamedItem](../resources/nameditem.md) no corpo da resposta.
