...
|bluetoothAllowedServices|Coleção de cadeias de caracteres|Especifica uma lista de serviços e perfis Bluetooth permitidos em cadeias de caracteres de formato hexadecimal.|
