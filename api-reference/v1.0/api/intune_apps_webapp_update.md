...
Atualiza as propriedades de um objeto [webApp](../resources/intune_apps_webapp.md).
...
No corpo da solicitação, forneça uma representação JSON do objeto [webApp](../resources/intune_apps_webapp.md).

A tabela a seguir mostra as propriedades obrigatórias ao criar o [webApp](../resources/intune_apps_webapp.md).
...
Se bem-sucedido, este método retorna um código de resposta `200 OK` e um objeto [webApp](../resources/intune_apps_webapp.md) atualizado no corpo da resposta.
