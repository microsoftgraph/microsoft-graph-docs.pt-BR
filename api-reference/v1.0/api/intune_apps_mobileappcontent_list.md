...
Listar propriedades e relações dos objetos [mobileAppContent](../resources/intune_apps_mobileappcontent.md).
...
Se tiver êxito, este método retornará um código de resposta `200 OK` e uma coleção de objetos [mobileAppContent](../resources/intune_apps_mobileappcontent.md) no corpo da resposta.
