...
Atualiza as propriedades do objeto de gráfico.
...
|name|sequência de caracteres|Representa o nome de um objeto Chart.|
...
Se bem-sucedido, este método retorna o código de resposta `200 OK` e o objeto atualizado[WorkbookChart](../resources/chart.md) no corpo da resposta.
