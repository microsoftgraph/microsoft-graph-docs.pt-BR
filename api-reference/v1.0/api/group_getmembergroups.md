...
Retorne todos os grupos dos quais o grupo especificado é membro. A verificação é transitiva, diferentemente da leitura da propriedade de navegação [memberOf](../api/group_list_memberof.md), que retorna somente os grupos dos quais o grupo é membro direto.
...
>**Observação:** esta API atualmente exige permissão Directory.Read.All ou posterior. Usar a permissão Group.Read.All retornará um erro. Este é um bug conhecido.
