...
Listar propriedades e relações dos objetos [windowsStoreApp.](../resources/intune-apps-windowsstoreapp.md)
...
Se tiver êxito, este método retornará um código de resposta e uma `200 OK` coleção de [objetos windowsStoreApp](../resources/intune-apps-windowsstoreapp.md) no corpo da resposta.
