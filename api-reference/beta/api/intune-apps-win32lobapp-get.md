...
ms.locfileid: "51862964"
---
# <a name="get-win32lobapp"></a><span data-ttu-id="292ca-103">Obter win32LobApp</span><span class="sxs-lookup"><span data-stu-id="292ca-103">Get win32LobApp</span></span>
...
<span data-ttu-id="292ca-107">Leia propriedades e relações do [objeto win32LobApp.](../resources/intune-apps-win32lobapp.md)</span><span class="sxs-lookup"><span data-stu-id="292ca-107">Read properties and relationships of the [win32LobApp](../resources/intune-apps-win32lobapp.md) object.</span></span>
...
|<span data-ttu-id="292ca-117">Application</span><span class="sxs-lookup"><span data-stu-id="292ca-117">Application</span></span>|<span data-ttu-id="292ca-118">DeviceManagementApps.Read.All, DeviceManagementApps.ReadWrite.All</span><span class="sxs-lookup"><span data-stu-id="292ca-118">DeviceManagementApps.Read.All, DeviceManagementApps.ReadWrite.All</span></span>|
...
<span data-ttu-id="292ca-132">Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto win32LobApp](../resources/intune-apps-win32lobapp.md) no corpo da resposta.</span><span class="sxs-lookup"><span data-stu-id="292ca-132">If successful, this method returns a `200 OK` response code and [win32LobApp](../resources/intune-apps-win32lobapp.md) object in the response body.</span></span>
