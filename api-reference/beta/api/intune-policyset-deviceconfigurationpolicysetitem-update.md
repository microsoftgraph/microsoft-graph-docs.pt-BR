...
ms.locfileid: "60492930"
---
# <a name="update-deviceconfigurationpolicysetitem"></a>Atualizar deviceConfigurationPolicySetItem
...
Atualize as propriedades de [um objeto deviceConfigurationPolicySetItem.](../resources/intune-policyset-deviceconfigurationpolicysetitem.md)
...
No corpo da solicitação, fornece uma representação JSON para o [objeto deviceConfigurationPolicySetItem.](../resources/intune-policyset-deviceconfigurationpolicysetitem.md)

A tabela a seguir mostra as propriedades que são necessárias ao criar [deviceConfigurationPolicySetItem](../resources/intune-policyset-deviceconfigurationpolicysetitem.md).
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto deviceConfigurationPolicySetItem](../resources/intune-policyset-deviceconfigurationpolicysetitem.md) atualizado no corpo da resposta.
