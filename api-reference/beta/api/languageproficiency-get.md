...
Se tiver êxito, este método retornará `200 OK` um código de resposta e o objeto [languageProficiency](../resources/languageproficiency.md) solicitado no corpo da resposta.
