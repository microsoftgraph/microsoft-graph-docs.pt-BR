...
Recupere as propriedades e os relacionamentos de um objeto [languageProficiency](../resources/languageproficiency.md) no [perfil](../resources/profile.md)de um usuário.
...
Se tiver êxito, este método retornará um `200 OK` código de resposta e o objeto [languageProficiency](../resources/languageproficiency.md) solicitado no corpo da resposta.
