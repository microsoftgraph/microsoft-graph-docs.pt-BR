...
|kioskModeMediaVolumeConfigurationEnabled|Booleano|Se um usuário pode ou não alterar o volume de mídia no Modo de Quiosque.|
|kioskModeShowDeviceInfo|Booleano|Se um usuário pode ou não acessar informações básicas do dispositivo.|
|kioskModeManagedSettingsEntryDisabled|Booleano|Se o ponto de entrada configurações gerenciadas deve ou não ser exibido na tela inicial gerenciada no Modo de Quiosque.|
...
|usersBlockAdd|Booleano|Indica se a adição de usuários e perfis está desabilitada ou não.|
...
|wifiBlockEditConfigurations|Booleano|Indica se o usuário deve ou não impedir a edição das configurações de conexão wi-fi.|
