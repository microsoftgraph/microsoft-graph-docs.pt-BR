...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto workbookChartPoint](../resources/workbookchartpoint.md) no corpo da resposta.
