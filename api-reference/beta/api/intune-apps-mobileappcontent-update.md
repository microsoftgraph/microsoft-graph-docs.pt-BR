...
ms.locfileid: "36329233"
---
# <a name="update-mobileappcontent"></a><span data-ttu-id="cb123-103">Atualizar mobileAppContent</span><span class="sxs-lookup"><span data-stu-id="cb123-103">Update mobileAppContent</span></span>
...
<span data-ttu-id="cb123-106">Atualizar as propriedades de um objeto [mobileAppContent](../resources/intune-apps-mobileappcontent.md).</span><span class="sxs-lookup"><span data-stu-id="cb123-106">Update the properties of a [mobileAppContent](../resources/intune-apps-mobileappcontent.md) object.</span></span>
...
<span data-ttu-id="cb123-p101">Uma das seguintes permissões é obrigatória para chamar esta API. Para saber mais, incluindo como escolher permissões, confira [Permissões](/graph/permissions-reference).</span><span class="sxs-lookup"><span data-stu-id="cb123-p101">One of the following permissions is required to call this API. To learn more, including how to choose permissions, see [Permissions](/graph/permissions-reference).</span></span>
...
|:---|:---|
|<span data-ttu-id="cb123-112">Delegado (conta corporativa ou de estudante)</span><span class="sxs-lookup"><span data-stu-id="cb123-112">Delegated (work or school account)</span></span>|<span data-ttu-id="cb123-113">DeviceManagementApps.ReadWrite.All</span><span class="sxs-lookup"><span data-stu-id="cb123-113">DeviceManagementApps.ReadWrite.All</span></span>|
...
|<span data-ttu-id="cb123-116">Aplicativo</span><span class="sxs-lookup"><span data-stu-id="cb123-116">Application</span></span>|<span data-ttu-id="cb123-117">DeviceManagementApps.ReadWrite.All</span><span class="sxs-lookup"><span data-stu-id="cb123-117">DeviceManagementApps.ReadWrite.All</span></span>|
...
<span data-ttu-id="cb123-127">No corpo da solicitação, forneça uma representação JSON do objeto [mobileAppContent](../resources/intune-apps-mobileappcontent.md).</span><span class="sxs-lookup"><span data-stu-id="cb123-127">In the request body, supply a JSON representation for the [mobileAppContent](../resources/intune-apps-mobileappcontent.md) object.</span></span>

<span data-ttu-id="cb123-128">A tabela a seguir mostra as propriedades que são necessárias ao criar [mobileAppContent](../resources/intune-apps-mobileappcontent.md).</span><span class="sxs-lookup"><span data-stu-id="cb123-128">The following table shows the properties that are required when you create the [mobileAppContent](../resources/intune-apps-mobileappcontent.md).</span></span>
...
|:---|:---|:---|
|<span data-ttu-id="cb123-132">id</span><span class="sxs-lookup"><span data-stu-id="cb123-132">id</span></span>|<span data-ttu-id="cb123-133">String</span><span class="sxs-lookup"><span data-stu-id="cb123-133">String</span></span>|<span data-ttu-id="cb123-134">A versão do conteúdo do aplicativo.</span><span class="sxs-lookup"><span data-stu-id="cb123-134">The app content version.</span></span>|



## <a name="response"></a><span data-ttu-id="cb123-135">Resposta</span><span class="sxs-lookup"><span data-stu-id="cb123-135">Response</span></span>
<span data-ttu-id="cb123-136">Se tiver êxito, este método retornará um código de resposta `200 OK` e um objeto [mobileAppContent](../resources/intune-apps-mobileappcontent.md) atualizado no corpo da resposta.</span><span class="sxs-lookup"><span data-stu-id="cb123-136">If successful, this method returns a `200 OK` response code and an updated [mobileAppContent](../resources/intune-apps-mobileappcontent.md) object in the response body.</span></span>

## <a name="example"></a><span data-ttu-id="cb123-137">Exemplo</span><span class="sxs-lookup"><span data-stu-id="cb123-137">Example</span></span>

### <a name="request"></a><span data-ttu-id="cb123-138">Solicitação</span><span class="sxs-lookup"><span data-stu-id="cb123-138">Request</span></span>
<span data-ttu-id="cb123-139">Este é um exemplo da solicitação.</span><span class="sxs-lookup"><span data-stu-id="cb123-139">Here is an example of the request.</span></span>
``` http
...
### <a name="response"></a><span data-ttu-id="cb123-140">Resposta</span><span class="sxs-lookup"><span data-stu-id="cb123-140">Response</span></span>
