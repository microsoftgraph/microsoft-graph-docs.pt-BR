...
Se tiver êxito, esta ação retornará um código de resposta e uma `200 OK` coleção [roleScopeTagAutoAssignment](../resources/intune-rbac-rolescopetagautoassignment.md) no corpo da resposta.
