---
title: Criar oemWarrantyInformationOnboarding
description: Crie um novo objeto oemWarrantyInformationOnboarding.
author: dougeby
...
---
# <a name="create-oemwarrantyinformationonboarding"></a>Criar oemWarrantyInformationOnboarding
...
Crie um novo [objeto oemWarrantyInformationOnboarding](../resources/intune-devices-oemwarrantyinformationonboarding.md) .
...
No corpo da solicitação, fornece uma representação JSON para o objeto oemWarrantyInformationOnboarding.

A tabela a seguir mostra as propriedades que são necessárias ao criar oemWarrantyInformationOnboarding.
...
Se tiver êxito, este método retornará `201 Created` um código de resposta e um [objeto oemWarrantyInformationOnboarding](../resources/intune-devices-oemwarrantyinformationonboarding.md) no corpo da resposta.
