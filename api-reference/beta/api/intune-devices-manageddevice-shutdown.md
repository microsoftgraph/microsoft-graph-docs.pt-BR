...
ms.locfileid: "34958260"
---
# <a name="shutdown-action"></a><span data-ttu-id="7215c-103">Ação shutDown</span><span class="sxs-lookup"><span data-stu-id="7215c-103">shutDown action</span></span>
...
<span data-ttu-id="7215c-106">Desligar o dispositivo</span><span class="sxs-lookup"><span data-stu-id="7215c-106">Shut down device</span></span>
...
|:---|:---|
|<span data-ttu-id="7215c-112">Delegado (conta corporativa ou de estudante)</span><span class="sxs-lookup"><span data-stu-id="7215c-112">Delegated (work or school account)</span></span>|<span data-ttu-id="7215c-113">DeviceManagementManagedDevices.PriviligedOperation.All</span><span class="sxs-lookup"><span data-stu-id="7215c-113">DeviceManagementManagedDevices.PriviligedOperation.All</span></span>|
...
<span data-ttu-id="7215c-127">Não forneça um corpo de solicitação para esse método.</span><span class="sxs-lookup"><span data-stu-id="7215c-127">Do not supply a request body for this method.</span></span>

## <a name="response"></a><span data-ttu-id="7215c-128">Resposta</span><span class="sxs-lookup"><span data-stu-id="7215c-128">Response</span></span>
<span data-ttu-id="7215c-129">Se tiver êxito, esta ação retornará um código de resposta `204 No Content`.</span><span class="sxs-lookup"><span data-stu-id="7215c-129">If successful, this action returns a `204 No Content` response code.</span></span>

## <a name="example"></a><span data-ttu-id="7215c-130">Exemplo</span><span class="sxs-lookup"><span data-stu-id="7215c-130">Example</span></span>

### <a name="request"></a><span data-ttu-id="7215c-131">Solicitação</span><span class="sxs-lookup"><span data-stu-id="7215c-131">Request</span></span>
<span data-ttu-id="7215c-132">Este é um exemplo da solicitação.</span><span class="sxs-lookup"><span data-stu-id="7215c-132">Here is an example of the request.</span></span>
``` http
POST https://graph.microsoft.com/beta/deviceManagement/managedDevices/{managedDeviceId}/shutDown
```

### <a name="response"></a><span data-ttu-id="7215c-133">Resposta</span><span class="sxs-lookup"><span data-stu-id="7215c-133">Response</span></span>
