...
---
# <a name="application-calculate"></a>Aplicativo: calcular
...
|:---------------|:--------|:----------|
|calculationType|string|Especifica o tipo de cálculo a ser usado.  Os valores possíveis são: `Recalculate`, `Full`, `FullRebuild`.|
