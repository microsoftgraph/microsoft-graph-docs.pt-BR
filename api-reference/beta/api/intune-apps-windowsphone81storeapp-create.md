...
Crie um novo [objeto windowsPhone81StoreApp.](../resources/intune-apps-windowsphone81storeapp.md)
...
No corpo da solicitação, fornece uma representação JSON para o objeto windowsPhone81StoreApp.

A tabela a seguir mostra as propriedades necessárias ao criar o windowsPhone81StoreApp.
...
Se tiver êxito, este método retornará um código de resposta e um `201 Created` [objeto windowsPhone81StoreApp](../resources/intune-apps-windowsphone81storeapp.md) no corpo da resposta.
