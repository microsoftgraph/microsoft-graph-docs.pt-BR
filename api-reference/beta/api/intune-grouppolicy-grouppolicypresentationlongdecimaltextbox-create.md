...
Crie um novo [objeto groupPolicyPresentationLongDecimalTextBox.](../resources/intune-grouppolicy-grouppolicypresentationlongdecimaltextbox.md)
...
No corpo da solicitação, fornece uma representação JSON para o objeto groupPolicyPresentationLongDecimalTextBox.

A tabela a seguir mostra as propriedades que são necessárias ao criar o groupPolicyPresentationLongDecimalTextBox.
...
Se tiver êxito, este método retornará um código de resposta e um `201 Created` [objeto groupPolicyPresentationLongDecimalTextBox](../resources/intune-grouppolicy-grouppolicypresentationlongdecimaltextbox.md) no corpo da resposta.
