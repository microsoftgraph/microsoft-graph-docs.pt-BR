...
Se bem-sucedido, este método retorna um código de resposta e um `200 OK` **[objeto sharePointActivityUserDetail](../resources/sharepointactivityuserdetail.md)** no corpo da resposta.
