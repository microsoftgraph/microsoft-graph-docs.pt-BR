...
Se tiver êxito, este método retornará um `201 Created` código de resposta e um [objeto conector](../resources/connector.md) no corpo da resposta.
