...
Crie um novo objeto de [iosScepCertificateProfile](../resources/intune-deviceconfig-iosscepcertificateprofile.md) .
...
A tabela a seguir mostra as propriedades que são necessárias quando você cria o iosScepCertificateProfile.
...
Se tiver êxito, este método retornará um `201 Created` código de resposta e um objeto [iosScepCertificateProfile](../resources/intune-deviceconfig-iosscepcertificateprofile.md) no corpo da resposta.
