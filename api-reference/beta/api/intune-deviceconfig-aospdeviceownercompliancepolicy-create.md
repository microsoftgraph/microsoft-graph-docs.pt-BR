...
ms.locfileid: "58800965"
---
# <a name="create-aospdeviceownercompliancepolicy"></a>Criar aospDeviceOwnerCompliancePolicy
...
Crie um [novo objeto aospDeviceOwnerCompliancePolicy.](../resources/intune-deviceconfig-aospdeviceownercompliancepolicy.md)
...
No corpo da solicitação, fornece uma representação JSON para o objeto aospDeviceOwnerCompliancePolicy.

A tabela a seguir mostra as propriedades que são necessárias ao criar o aospDeviceOwnerCompliancePolicy.
...
Se tiver êxito, este método retornará um código de resposta e um `201 Created` [objeto aospDeviceOwnerCompliancePolicy](../resources/intune-deviceconfig-aospdeviceownercompliancepolicy.md) no corpo da resposta.
