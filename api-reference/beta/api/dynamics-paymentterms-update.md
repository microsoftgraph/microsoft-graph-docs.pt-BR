...
Atualize as propriedades de um objeto de termos de pagamento para o Dynamics 365 Business Central.
...
Se tiver êxito, este método retornará um código de resposta e um objeto `200 OK` **paymentTerms** atualizado no corpo da resposta.
