---
title: Atualizar windowsWiredNetworkConfiguration
description: Atualize as propriedades de um objeto windowsWiredNetworkConfiguration.
author: dougeby
...
ms.locfileid: "64630999"
---
# <a name="update-windowswirednetworkconfiguration"></a>Atualizar windowsWiredNetworkConfiguration
...
Atualize as propriedades de um [objeto windowsWiredNetworkConfiguration](../resources/intune-deviceconfig-windowswirednetworkconfiguration.md) .
...
No corpo da solicitação, fornece uma representação JSON para o [objeto windowsWiredNetworkConfiguration](../resources/intune-deviceconfig-windowswirednetworkconfiguration.md) .

A tabela a seguir mostra as propriedades que são necessárias ao criar [o windowsWiredNetworkConfiguration](../resources/intune-deviceconfig-windowswirednetworkconfiguration.md).
...
Se tiver êxito, este método retornará um `200 OK` código de resposta e um [objeto windowsWiredNetworkConfiguration](../resources/intune-deviceconfig-windowswirednetworkconfiguration.md) atualizado no corpo da resposta.
