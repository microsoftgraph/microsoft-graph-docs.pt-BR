---
title: Atualizar deviceEnrollmentNotificationConfiguration
description: Atualize as propriedades de um objeto deviceEnrollmentNotificationConfiguration.
author: dougeby
...
ms.locfileid: "65212967"
---
# <a name="update-deviceenrollmentnotificationconfiguration"></a>Atualizar deviceEnrollmentNotificationConfiguration
...
Atualize as propriedades de [um objeto deviceEnrollmentNotificationConfiguration](../resources/intune-onboarding-deviceenrollmentnotificationconfiguration.md) .
...
No corpo da solicitação, forneça uma representação JSON do [objeto deviceEnrollmentNotificationConfiguration](../resources/intune-onboarding-deviceenrollmentnotificationconfiguration.md) .

A tabela a seguir mostra as propriedades que são necessárias ao criar [deviceEnrollmentNotificationConfiguration](../resources/intune-onboarding-deviceenrollmentnotificationconfiguration.md).
...
Se tiver êxito, este método retornará um `200 OK` código de resposta e um objeto [deviceEnrollmentNotificationConfiguration](../resources/intune-onboarding-deviceenrollmentnotificationconfiguration.md) atualizado no corpo da resposta.
