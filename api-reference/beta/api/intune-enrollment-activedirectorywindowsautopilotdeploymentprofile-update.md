...
|hybridAzureADJoinSkipConnectivityCheck|Booleano|O fluxo de junção do Azure AD híbrido do Autopilot continuará mesmo que ele não estabeleça a conectividade do controlador de domínio durante o OOBE.|
