...
A tabela a seguir mostra as propriedades que são necessárias ao criar [o iosLobAppProvisioningConfigurationAssignment](../resources/intune-apps-ioslobappprovisioningconfigurationassignment.md).
...
Se tiver êxito, este método retornará um código de resposta e um objeto `200 OK` [iosLobAppProvisioningConfigurationAssignment](../resources/intune-apps-ioslobappprovisioningconfigurationassignment.md) atualizado no corpo da resposta.
