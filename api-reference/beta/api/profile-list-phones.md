...
Recupere uma lista de objetos de [Multiphone](../resources/itemphone.md) do [perfil](../resources/profile.md)do usuário.
...
Se tiver êxito, este método retornará `200 OK` um código de resposta e uma coleção de objetos de [Tel](../resources/itemphone.md) no corpo da resposta.
