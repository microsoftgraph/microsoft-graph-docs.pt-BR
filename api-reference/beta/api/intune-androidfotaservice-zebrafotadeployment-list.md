---
title: Listar zebraFotaDeployments
description: Listar propriedades e relações dos objetos zebraFotaDeployment.
author: dougeby
...
ms.locfileid: "65212974"
---
# <a name="list-zebrafotadeployments"></a>Listar zebraFotaDeployments
...
Listar propriedades e relações dos objetos [zebraFotaDeployment](../resources/intune-androidfotaservice-zebrafotadeployment.md) .
...
Se tiver êxito, este método retornará um `200 OK` código de resposta e uma coleção de [objetos zebraFotaDeployment](../resources/intune-androidfotaservice-zebrafotadeployment.md) no corpo da resposta.
