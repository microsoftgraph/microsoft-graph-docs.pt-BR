...
A tabela a seguir mostra as propriedades que são necessárias ao criar [o androidForWorkApp](../resources/intune-apps-androidforworkapp.md).
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto androidForWorkApp](../resources/intune-apps-androidforworkapp.md) atualizado no corpo da resposta.
