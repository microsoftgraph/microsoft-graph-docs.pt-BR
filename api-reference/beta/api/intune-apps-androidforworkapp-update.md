...
Atualize as propriedades de um objeto [androidForWorkApp](../resources/intune-apps-androidforworkapp.md) .
...
No corpo da solicitação, fornece uma representação JSON para o objeto [androidForWorkApp](../resources/intune-apps-androidforworkapp.md) .

A tabela a seguir mostra as propriedades que são necessárias quando você cria o [androidForWorkApp](../resources/intune-apps-androidforworkapp.md).
...
Se tiver êxito, este método retornará um `200 OK` código de resposta e um objeto atualizado [androidForWorkApp](../resources/intune-apps-androidforworkapp.md) no corpo da resposta.
