...
- Tamanho do item excluído (Byte)
- Período de Relatório

### <a name="json"></a>JSON

Se tiver êxito, este método retornará `200 OK` um código de resposta e um objeto **[mailboxUsageDetail](../resources/mailboxusagedetail.md)** no corpo da resposta.
