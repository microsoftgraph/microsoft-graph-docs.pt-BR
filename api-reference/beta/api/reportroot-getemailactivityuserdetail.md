...
Se bem-sucedido, este método retorna um código de resposta e um `200 OK` **[objeto emailActivityUserDetail](../resources/emailactivityuserdetail.md)** no corpo da resposta.
