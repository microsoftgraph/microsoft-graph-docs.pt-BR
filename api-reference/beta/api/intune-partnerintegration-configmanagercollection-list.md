...
ms.locfileid: "54131637"
---
# <a name="list-configmanagercollections"></a>Listar configManagerCollections
...
Listar propriedades e relações dos [objetos configManagerCollection.](../resources/intune-partnerintegration-configmanagercollection.md)
...
Se tiver êxito, este método retornará um código de resposta e uma `200 OK` coleção [de objetos configManagerCollection](../resources/intune-partnerintegration-configmanagercollection.md) no corpo da resposta.
