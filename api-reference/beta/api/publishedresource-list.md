...
Se bem-sucedido, este método retorna um código de resposta e uma `200 OK` coleção de [objetos publishedResource](../resources/publishedresource.md) no corpo da resposta.
