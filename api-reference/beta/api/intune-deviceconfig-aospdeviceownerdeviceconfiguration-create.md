...
ms.locfileid: "59077542"
---
# <a name="create-aospdeviceownerdeviceconfiguration"></a>Criar aospDeviceOwnerDeviceConfiguration
...
Crie um novo [objeto aospDeviceOwnerDeviceConfiguration.](../resources/intune-deviceconfig-aospdeviceownerdeviceconfiguration.md)
...
No corpo da solicitação, fornece uma representação JSON para o objeto aospDeviceOwnerDeviceConfiguration.

A tabela a seguir mostra as propriedades que são necessárias ao criar o aospDeviceOwnerDeviceConfiguration.
...
Se tiver êxito, este método retornará um código de resposta e um `201 Created` [objeto aospDeviceOwnerDeviceConfiguration](../resources/intune-deviceconfig-aospdeviceownerdeviceconfiguration.md) no corpo da resposta.
