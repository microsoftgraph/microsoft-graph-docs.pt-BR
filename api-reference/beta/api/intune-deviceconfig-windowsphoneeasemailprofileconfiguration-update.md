...
|syncCalendar|Booleano|Se deve ou não sincronizar o calendário.|
|syncContacts|Booleano|Se deve ou não sincronizar contatos.|
|syncTasks|Booleano|Se deve ou não sincronizar tarefas.|
