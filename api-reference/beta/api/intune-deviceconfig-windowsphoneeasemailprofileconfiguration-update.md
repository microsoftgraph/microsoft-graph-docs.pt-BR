...
Atualize as propriedades de um [objeto windowsPhoneEASEmailProfileConfiguration.](../resources/intune-deviceconfig-windowsphoneeasemailprofileconfiguration.md)
...
No corpo da solicitação, fornece uma representação JSON para o [objeto windowsPhoneEASEmailProfileConfiguration.](../resources/intune-deviceconfig-windowsphoneeasemailprofileconfiguration.md)

A tabela a seguir mostra as propriedades que são necessárias ao criar [o windowsPhoneEASEmailProfileConfiguration](../resources/intune-deviceconfig-windowsphoneeasemailprofileconfiguration.md).
...
|syncCalendar|Boleano|Se deve ou não sincronizar o calendário.|
|syncContacts|Boleano|Se deve ou não sincronizar contatos.|
|syncTasks|Boleano|Se deve ou não sincronizar tarefas.|
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto windowsPhoneEASEmailProfileConfiguration](../resources/intune-deviceconfig-windowsphoneeasemailprofileconfiguration.md) atualizado no corpo da resposta.
