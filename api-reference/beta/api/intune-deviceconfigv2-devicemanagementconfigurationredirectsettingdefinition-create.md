---
title: Criar deviceManagementConfigurationRedirectSettingDefinition
description: Crie um novo objeto deviceManagementConfigurationRedirectSettingDefinition.
author: dougeby
...
ms.locfileid: "66669410"
---
# <a name="create-devicemanagementconfigurationredirectsettingdefinition"></a>Criar deviceManagementConfigurationRedirectSettingDefinition
...
Crie um novo [objeto deviceManagementConfigurationRedirectSettingDefinition](../resources/intune-deviceconfigv2-devicemanagementconfigurationredirectsettingdefinition.md) .
...
No corpo da solicitação, forneça uma representação JSON do objeto deviceManagementConfigurationRedirectSettingDefinition.

A tabela a seguir mostra as propriedades que são necessárias ao criar deviceManagementConfigurationRedirectSettingDefinition.
...
Se tiver êxito, este método `201 Created` retornará um código de resposta e um objeto [deviceManagementConfigurationRedirectSettingDefinition](../resources/intune-deviceconfigv2-devicemanagementconfigurationredirectsettingdefinition.md) no corpo da resposta.
