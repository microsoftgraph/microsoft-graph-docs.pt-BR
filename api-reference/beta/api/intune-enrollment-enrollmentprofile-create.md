...
Criar um novo objeto [enrollmentProfile](../resources/intune-enrollment-enrollmentprofile.md) .
...
No corpo da solicitação, forneça uma representação JSON do objeto enrollmentProfile.

A tabela a seguir mostra as propriedades que são necessárias ao criar enrollmentProfile.
...
Se tiver êxito, este método retornará `201 Created` um código de resposta e um objeto [enrollmentProfile](../resources/intune-enrollment-enrollmentprofile.md) no corpo da resposta.
