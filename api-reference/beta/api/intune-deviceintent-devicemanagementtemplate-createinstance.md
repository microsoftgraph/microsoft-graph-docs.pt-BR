...
ms.locfileid: "42771135"
---
# <a name="createinstance-action"></a><span data-ttu-id="28e6c-103">ação createInstance</span><span class="sxs-lookup"><span data-stu-id="28e6c-103">createInstance action</span></span>
...
<span data-ttu-id="28e6c-106">Ainda não documentado</span><span class="sxs-lookup"><span data-stu-id="28e6c-106">Not yet documented</span></span>
...
<span data-ttu-id="28e6c-127">No corpo da solicitação, forneça uma representação JSON dos parâmetros.</span><span class="sxs-lookup"><span data-stu-id="28e6c-127">In the request body, supply JSON representation of the parameters.</span></span>

<span data-ttu-id="28e6c-128">A tabela a seguir mostra os parâmetros que podem ser usados com esta ação.</span><span class="sxs-lookup"><span data-stu-id="28e6c-128">The following table shows the parameters that can be used with this action.</span></span>

|<span data-ttu-id="28e6c-129">Propriedade</span><span class="sxs-lookup"><span data-stu-id="28e6c-129">Property</span></span>|<span data-ttu-id="28e6c-130">Tipo</span><span class="sxs-lookup"><span data-stu-id="28e6c-130">Type</span></span>|<span data-ttu-id="28e6c-131">Descrição</span><span class="sxs-lookup"><span data-stu-id="28e6c-131">Description</span></span>|
|:---|:---|:---|
|<span data-ttu-id="28e6c-132">displayName</span><span class="sxs-lookup"><span data-stu-id="28e6c-132">displayName</span></span>|<span data-ttu-id="28e6c-133">Cadeia de caracteres</span><span class="sxs-lookup"><span data-stu-id="28e6c-133">String</span></span>|<span data-ttu-id="28e6c-134">Ainda não documentado</span><span class="sxs-lookup"><span data-stu-id="28e6c-134">Not yet documented</span></span>|
|<span data-ttu-id="28e6c-135">description</span><span class="sxs-lookup"><span data-stu-id="28e6c-135">description</span></span>|<span data-ttu-id="28e6c-136">String</span><span class="sxs-lookup"><span data-stu-id="28e6c-136">String</span></span>|<span data-ttu-id="28e6c-137">Ainda não documentado</span><span class="sxs-lookup"><span data-stu-id="28e6c-137">Not yet documented</span></span>|
|<span data-ttu-id="28e6c-138">settingsDelta</span><span class="sxs-lookup"><span data-stu-id="28e6c-138">settingsDelta</span></span>|<span data-ttu-id="28e6c-139">coleção [deviceManagementSettingInstance](../resources/intune-deviceintent-devicemanagementsettinginstance.md)</span><span class="sxs-lookup"><span data-stu-id="28e6c-139">[deviceManagementSettingInstance](../resources/intune-deviceintent-devicemanagementsettinginstance.md) collection</span></span>|<span data-ttu-id="28e6c-140">Ainda não documentado</span><span class="sxs-lookup"><span data-stu-id="28e6c-140">Not yet documented</span></span>|
|<span data-ttu-id="28e6c-141">roleScopeTagIds</span><span class="sxs-lookup"><span data-stu-id="28e6c-141">roleScopeTagIds</span></span>|<span data-ttu-id="28e6c-142">String collection</span><span class="sxs-lookup"><span data-stu-id="28e6c-142">String collection</span></span>|<span data-ttu-id="28e6c-143">Ainda não documentado</span><span class="sxs-lookup"><span data-stu-id="28e6c-143">Not yet documented</span></span>|



## <a name="response"></a><span data-ttu-id="28e6c-144">Resposta</span><span class="sxs-lookup"><span data-stu-id="28e6c-144">Response</span></span>
<span data-ttu-id="28e6c-145">Se tiver êxito, esta ação retornará `200 OK` um código de resposta e um [deviceManagementIntent](../resources/intune-deviceintent-devicemanagementintent.md) no corpo da resposta.</span><span class="sxs-lookup"><span data-stu-id="28e6c-145">If successful, this action returns a `200 OK` response code and a [deviceManagementIntent](../resources/intune-deviceintent-devicemanagementintent.md) in the response body.</span></span>

## <a name="example"></a><span data-ttu-id="28e6c-146">Exemplo</span><span class="sxs-lookup"><span data-stu-id="28e6c-146">Example</span></span>

### <a name="request"></a><span data-ttu-id="28e6c-147">Solicitação</span><span class="sxs-lookup"><span data-stu-id="28e6c-147">Request</span></span>
<span data-ttu-id="28e6c-148">Este é um exemplo da solicitação.</span><span class="sxs-lookup"><span data-stu-id="28e6c-148">Here is an example of the request.</span></span>
``` http
...
### <a name="response"></a><span data-ttu-id="28e6c-149">Resposta</span><span class="sxs-lookup"><span data-stu-id="28e6c-149">Response</span></span>
