...
## <a name="http-request"></a><span data-ttu-id="a043e-119">Solicitação HTTP</span><span class="sxs-lookup"><span data-stu-id="a043e-119">HTTP Request</span></span>
<!-- {
  "blockType": "ignored"
}
-->
