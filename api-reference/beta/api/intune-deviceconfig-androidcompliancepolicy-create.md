...
|securityBlockDeviceAdministratorManagedDevices|Boolean|Bloquear dispositivos gerenciados pelo administrador de dispositivos.|
...
|conditionStatementId|Cadeia de Caracteres|ID da instrução de condição.|
