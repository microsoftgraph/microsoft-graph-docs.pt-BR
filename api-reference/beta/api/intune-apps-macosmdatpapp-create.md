...
Criar um novo objeto [macOSMdatpApp](../resources/intune-apps-macosmdatpapp.md) .
...
No corpo da solicitação, forneça uma representação JSON do objeto macOSMdatpApp.

A tabela a seguir mostra as propriedades que são necessárias ao criar macOSMdatpApp.
...
Se tiver êxito, este método retornará um `201 Created` código de resposta e um objeto [macOSMdatpApp](../resources/intune-apps-macosmdatpapp.md) no corpo da resposta.
