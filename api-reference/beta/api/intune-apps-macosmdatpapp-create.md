...
ms.locfileid: "59018891"
---
# <a name="create-macosmdatpapp"></a>Criar macOSMdatpApp
...
Crie um novo [objeto macOSMdatpApp.](../resources/intune-apps-macosmdatpapp.md)
...
No corpo da solicitação, fornece uma representação JSON para o objeto macOSMdatpApp.

A tabela a seguir mostra as propriedades que são necessárias ao criar o macOSMdatpApp.
...
Se tiver êxito, este método retornará um código de resposta e um `201 Created` [objeto macOSMdatpApp](../resources/intune-apps-macosmdatpapp.md) no corpo da resposta.
