...
Função para obter o número de correções por scripts de saúde de um dispositivo
...
Se tiver êxito, essa função retornará um código de resposta e um `200 OK` [deviceHealthScriptRemediationHistory](../resources/intune-devices-devicehealthscriptremediationhistory.md) no corpo da resposta.
