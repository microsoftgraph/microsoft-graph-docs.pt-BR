---
title: Criar aospDeviceOwnerScepCertificateProfile
description: Crie um novo objeto aospDeviceOwnerScepCertificateProfile.
author: dougeby
...
ms.locfileid: "64630989"
---
# <a name="create-aospdeviceownerscepcertificateprofile"></a>Criar aospDeviceOwnerScepCertificateProfile
...
Crie um novo [objeto aospDeviceOwnerScepCertificateProfile](../resources/intune-deviceconfig-aospdeviceownerscepcertificateprofile.md) .
...
No corpo da solicitação, fornece uma representação JSON para o objeto aospDeviceOwnerScepCertificateProfile.

A tabela a seguir mostra as propriedades que são necessárias ao criar o aospDeviceOwnerScepCertificateProfile.
...
Se tiver êxito, este método retornará `201 Created` um código de resposta e um [objeto aospDeviceOwnerScepCertificateProfile](../resources/intune-deviceconfig-aospdeviceownerscepcertificateprofile.md) no corpo da resposta.
