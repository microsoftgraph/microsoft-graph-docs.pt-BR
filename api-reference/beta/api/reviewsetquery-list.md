...
Recupere uma lista de objetos de [reviewSetQuery](../resources/reviewsetquery.md) de descoberta eletrônica.
...
Se tiver êxito, este método retornará um `200 OK` código de resposta e uma coleção de objetos [reviewSetQuery](../resources/reviewsetquery.md) no corpo da resposta.
