...
---
# <a name="get-macossoftwareupdatestatesummary"></a>Obter macOSSoftwareUpdateStateSummary
...
Leia as propriedades e as relações do objeto [macOSSoftwareUpdateStateSummary](../resources/intune-deviceconfig-macossoftwareupdatestatesummary.md) .
...
Se bem-sucedido, este método retorna um `200 OK` código de resposta e um objeto [macOSSoftwareUpdateStateSummary](../resources/intune-deviceconfig-macossoftwareupdatestatesummary.md) no corpo da resposta.
