...
Crie um objeto de funcionário no Dynamics 365 Business Central.
...
No corpo da solicitação, fornece uma representação JSON de um **objeto employees.**

## <a name="response"></a>Resposta
Se tiver êxito, este método retornará ```201 Created``` o código de resposta e um objeto **employees** no corpo da resposta.
