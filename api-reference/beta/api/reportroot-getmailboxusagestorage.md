...
Se tiver êxito, este método retornará um código `200 OK` de resposta e um objeto **[mailboxUsageStorage](../resources/mailboxusagestorage.md)** no corpo da resposta.
