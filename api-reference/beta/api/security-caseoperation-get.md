...
Se bem-sucedido, este método retorna um código `200 OK` de resposta e um [objeto caseOperation](../resources/security-caseoperation.md) no corpo da resposta.
