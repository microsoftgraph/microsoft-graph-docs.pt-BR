...
Crie um novo [objeto androidWorkProfileScepCertificateProfile.](../resources/intune-deviceconfig-androidworkprofilescepcertificateprofile.md)
...
No corpo da solicitação, fornece uma representação JSON para o objeto androidWorkProfileScepCertificateProfile.

A tabela a seguir mostra as propriedades necessárias ao criar o androidWorkProfileScepCertificateProfile.
...
Se tiver êxito, este método retornará um código de resposta e um `201 Created` [objeto androidWorkProfileScepCertificateProfile](../resources/intune-deviceconfig-androidworkprofilescepcertificateprofile.md) no corpo da resposta.
