...
Leia propriedades e relações do [objeto androidDeviceOwnerCertificateProfileBase.](../resources/intune-deviceconfig-androiddeviceownercertificateprofilebase.md)
...
Se tiver êxito, este método retornará um código de resposta e o `200 OK` [objeto androidDeviceOwnerCertificateProfileBase](../resources/intune-deviceconfig-androiddeviceownercertificateprofilebase.md) no corpo da resposta.
