...
Se bem-sucedido, este método retorna um código de resposta e um `200 OK` **[objeto oneDriveActivityUserDetail](../resources/onedriveactivityuserdetail.md)** no corpo da resposta.
