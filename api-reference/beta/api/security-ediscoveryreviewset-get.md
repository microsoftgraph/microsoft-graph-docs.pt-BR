---
title: Obter ediscoveryReviewSet
description: Leia as propriedades e as relações de um objeto ediscoveryReviewSet.
author: SeunginLyu
...
ms.locfileid: "66837412"
---
# <a name="get-ediscoveryreviewset"></a>Obter ediscoveryReviewSet
Namespace: microsoft.graph.security

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Leia as propriedades e as relações de um [objeto ediscoveryReviewSet](../resources/security-ediscoveryreviewset.md) .
...
Se tiver êxito, este método retornará `200 OK` um código de resposta e um [objeto microsoft.graph.security.ediscoveryReviewSet](../resources/security-ediscoveryreviewset.md) no corpo da resposta.
