...
Se tiver êxito, este método retornará um `200 OK` código de resposta [e um objeto ediscoveryReviewSet](../resources/security-ediscoveryreviewset.md) no corpo da resposta.
