...
ms.locfileid: "54188817"
---
# <a name="create-androiddeviceownerpkcscertificateprofile"></a>Criar androidDeviceOwnerPkcsCertificateProfile
...
Crie um novo [objeto androidDeviceOwnerPkcsCertificateProfile.](../resources/intune-deviceconfig-androiddeviceownerpkcscertificateprofile.md)
...
No corpo da solicitação, fornece uma representação JSON para o objeto androidDeviceOwnerPkcsCertificateProfile.

A tabela a seguir mostra as propriedades que são necessárias ao criar o androidDeviceOwnerPkcsCertificateProfile.
...
Se tiver êxito, este método retornará um código de resposta e um `201 Created` [objeto androidDeviceOwnerPkcsCertificateProfile](../resources/intune-deviceconfig-androiddeviceownerpkcscertificateprofile.md) no corpo da resposta.
