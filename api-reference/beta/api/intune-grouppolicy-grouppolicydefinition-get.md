...
Leia as propriedades e os relacionamentos do objeto [groupPolicyDefinition](../resources/intune-grouppolicy-grouppolicydefinition.md) .
...
Se tiver êxito, este método retornará um `200 OK` objeto response de código e [groupPolicyDefinition](../resources/intune-grouppolicy-grouppolicydefinition.md) no corpo da resposta.
