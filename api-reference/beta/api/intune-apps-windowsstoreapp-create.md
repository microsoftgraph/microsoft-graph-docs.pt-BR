...
Crie um novo objeto de [windowsStoreApp](../resources/intune-apps-windowsstoreapp.md) .
...
A tabela a seguir mostra as propriedades que são necessárias quando você cria o windowsStoreApp.
...
Se tiver êxito, este método retornará um `201 Created` código de resposta e um objeto [windowsStoreApp](../resources/intune-apps-windowsstoreapp.md) no corpo da resposta.
