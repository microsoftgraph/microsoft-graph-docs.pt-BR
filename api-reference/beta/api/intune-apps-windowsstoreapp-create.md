...
Criar um novo objeto [windowsStoreApp](../resources/intune-apps-windowsstoreapp.md) .
...
No corpo da solicitação, forneça uma representação JSON do objeto windowsStoreApp.

A tabela a seguir mostra as propriedades que são necessárias ao criar windowsStoreApp.
...
Se tiver êxito, este método retornará `201 Created` um código de resposta e um objeto [windowsStoreApp](../resources/intune-apps-windowsstoreapp.md) no corpo da resposta.
