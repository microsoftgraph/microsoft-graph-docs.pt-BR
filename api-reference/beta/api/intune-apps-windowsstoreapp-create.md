...
ms.locfileid: "59077836"
---
# <a name="create-windowsstoreapp"></a>Criar windowsStoreApp
...
Crie um novo [objeto windowsStoreApp.](../resources/intune-apps-windowsstoreapp.md)
...
No corpo da solicitação, fornece uma representação JSON para o objeto windowsStoreApp.

A tabela a seguir mostra as propriedades necessárias ao criar o windowsStoreApp.
...
Se tiver êxito, este método retornará um código de resposta e um `201 Created` [objeto windowsStoreApp](../resources/intune-apps-windowsstoreapp.md) no corpo da resposta.
