...
ms.locfileid: "63397985"
---
# <a name="delete-smsauthenticationmethodconfiguration"></a>Excluir smsAuthenticationMethodConfiguration
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Remova as alterações feitas na política de método de [autenticação](../resources/smsauthenticationmethodconfiguration.md) de Mensagem de Texto revertendo a política para sua configuração padrão.
