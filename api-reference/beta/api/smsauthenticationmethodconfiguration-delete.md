...
Remova as alterações feitas na política de método de [autenticação de Mensagem de](../resources/smsauthenticationmethodconfiguration.md) Texto revertendo a política para sua configuração padrão.
