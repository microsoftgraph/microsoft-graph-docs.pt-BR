...
Listar propriedades e relações dos objetos [macOSMdatpApp.](../resources/intune-apps-macosmdatpapp.md)
...
Se tiver êxito, este método retornará um código de resposta e uma `200 OK` coleção de [objetos macOSMdatpApp](../resources/intune-apps-macosmdatpapp.md) no corpo da resposta.
