...
Obtenha o número total de grupos que existiam e quantos incluíam atividade de conversação em grupo.
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` **[objeto yammerGroupsActivityGroupCounts](../resources/yammergroupsactivitygroupcounts.md)** no corpo da resposta.
