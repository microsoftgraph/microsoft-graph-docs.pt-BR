---
title: Criar aospDeviceOwnerWiFiConfiguration
description: Crie um novo objeto aospDeviceOwnerWiFiConfiguration.
author: dougeby
...
ms.locfileid: "64630961"
---
# <a name="create-aospdeviceownerwificonfiguration"></a>Criar aospDeviceOwnerWiFiConfiguration
...
Crie um novo [objeto aospDeviceOwnerWiFiConfiguration](../resources/intune-deviceconfig-aospdeviceownerwificonfiguration.md) .
...
No corpo da solicitação, fornece uma representação JSON para o objeto aospDeviceOwnerWiFiConfiguration.

A tabela a seguir mostra as propriedades que são necessárias ao criar o aospDeviceOwnerWiFiConfiguration.
...
Se tiver êxito, este método retornará `201 Created` um código de resposta e um [objeto aospDeviceOwnerWiFiConfiguration](../resources/intune-deviceconfig-aospdeviceownerwificonfiguration.md) no corpo da resposta.
