...
description: Obtenha um relatório que forneça a tendência no número de usuários ativos para cada aplicativo – Outlook, Word, Excel, PowerPoint, OneNote e Teams – em sua organização.
...
Obtenha um relatório que forneça a tendência no número de usuários ativos para cada aplicativo – Outlook, Word, Excel, PowerPoint, OneNote e Teams – em sua organização.
