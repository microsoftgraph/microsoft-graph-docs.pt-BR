...
Obtenha dados sobre as atividades do Yammer por usuário.
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` **[objeto yammerActivityUserDetail](../resources/yammeractivityuserdetail.md)** no corpo da resposta.
