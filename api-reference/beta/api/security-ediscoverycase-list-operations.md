...
Se tiver êxito, este método retornará um `200 OK` código de resposta e uma coleção de [objetos microsoft.graph.security.caseOperation](../resources/security-caseoperation.md) no corpo da resposta.
