...
Crie um novo [bookingService](../resources/bookingservice.md) para o especificado [bookingbusiness](../resources/bookingbusiness.md).
...
Se tiver êxito, este método retornará `201, Created` objeto response de código e [bookingService](../resources/bookingservice.md) no corpo da resposta.
