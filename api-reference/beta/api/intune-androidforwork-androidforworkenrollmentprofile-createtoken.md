...
ms.locfileid: "48701176"
---
# <a name="createtoken-action"></a><span data-ttu-id="e9063-103">Ação createToken</span><span class="sxs-lookup"><span data-stu-id="e9063-103">createToken action</span></span>
...
<span data-ttu-id="e9063-107">Ainda não documentado</span><span class="sxs-lookup"><span data-stu-id="e9063-107">Not yet documented</span></span>
...
|:---|:---|
|<span data-ttu-id="e9063-113">Delegado (conta corporativa ou de estudante)</span><span class="sxs-lookup"><span data-stu-id="e9063-113">Delegated (work or school account)</span></span>|<span data-ttu-id="e9063-114">DeviceManagementConfiguration.ReadWrite.All</span><span class="sxs-lookup"><span data-stu-id="e9063-114">DeviceManagementConfiguration.ReadWrite.All</span></span>|
...
|<span data-ttu-id="e9063-117">Aplicativo</span><span class="sxs-lookup"><span data-stu-id="e9063-117">Application</span></span>|<span data-ttu-id="e9063-118">DeviceManagementConfiguration.ReadWrite.All</span><span class="sxs-lookup"><span data-stu-id="e9063-118">DeviceManagementConfiguration.ReadWrite.All</span></span>|
...
<span data-ttu-id="e9063-128">No corpo da solicitação, forneça uma representação JSON dos parâmetros.</span><span class="sxs-lookup"><span data-stu-id="e9063-128">In the request body, supply JSON representation of the parameters.</span></span>

<span data-ttu-id="e9063-129">A tabela a seguir mostra os parâmetros que podem ser usados com esta ação.</span><span class="sxs-lookup"><span data-stu-id="e9063-129">The following table shows the parameters that can be used with this action.</span></span>

|<span data-ttu-id="e9063-130">Propriedade</span><span class="sxs-lookup"><span data-stu-id="e9063-130">Property</span></span>|<span data-ttu-id="e9063-131">Tipo</span><span class="sxs-lookup"><span data-stu-id="e9063-131">Type</span></span>|<span data-ttu-id="e9063-132">Descrição</span><span class="sxs-lookup"><span data-stu-id="e9063-132">Description</span></span>|
|:---|:---|:---|
|<span data-ttu-id="e9063-133">tokenValidityInSeconds</span><span class="sxs-lookup"><span data-stu-id="e9063-133">tokenValidityInSeconds</span></span>|<span data-ttu-id="e9063-134">Int32</span><span class="sxs-lookup"><span data-stu-id="e9063-134">Int32</span></span>|<span data-ttu-id="e9063-135">Ainda não documentado</span><span class="sxs-lookup"><span data-stu-id="e9063-135">Not yet documented</span></span>|



## <a name="response"></a><span data-ttu-id="e9063-136">Resposta</span><span class="sxs-lookup"><span data-stu-id="e9063-136">Response</span></span>
<span data-ttu-id="e9063-137">Se tiver êxito, esta ação retornará um código de resposta `204 No Content`.</span><span class="sxs-lookup"><span data-stu-id="e9063-137">If successful, this action returns a `204 No Content` response code.</span></span>

## <a name="example"></a><span data-ttu-id="e9063-138">Exemplo</span><span class="sxs-lookup"><span data-stu-id="e9063-138">Example</span></span>

### <a name="request"></a><span data-ttu-id="e9063-139">Solicitação</span><span class="sxs-lookup"><span data-stu-id="e9063-139">Request</span></span>
<span data-ttu-id="e9063-140">Este é um exemplo da solicitação.</span><span class="sxs-lookup"><span data-stu-id="e9063-140">Here is an example of the request.</span></span>
``` http
...
### <a name="response"></a><span data-ttu-id="e9063-141">Resposta</span><span class="sxs-lookup"><span data-stu-id="e9063-141">Response</span></span>
