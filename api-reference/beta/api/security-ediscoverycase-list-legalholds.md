...
Se tiver êxito, este método `200 OK` retornará um código de resposta e uma coleção de objetos [microsoft.graph.security.ediscoveryHoldPolicy](../resources/security-ediscoveryholdpolicy.md) no corpo da resposta.
