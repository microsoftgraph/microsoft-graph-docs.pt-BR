...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto samlOrWsFedExternalDomainFederation](../resources/samlorwsfedexternaldomainfederation.md) no corpo da resposta.
