...
Leia as propriedades e os relacionamentos do objeto [importedAppleDeviceIdentity](../resources/intune-enrollment-importedappledeviceidentity.md) .
...
Se tiver êxito, este método retornará um `200 OK` objeto response de código e [importedAppleDeviceIdentity](../resources/intune-enrollment-importedappledeviceidentity.md) no corpo da resposta.
