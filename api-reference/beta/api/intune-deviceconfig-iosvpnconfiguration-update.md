...
|Excludelistpara|Coleção String|Zscaler apenas. Lista de endereços de rede que não são enviados pela nuvem do Zscaler.|



## <a name="response"></a>Resposta
Se tiver êxito, este método retornará `200 OK` um código de resposta e um objeto [iosVpnConfiguration](../resources/intune-deviceconfig-iosvpnconfiguration.md) atualizado no corpo da resposta.
