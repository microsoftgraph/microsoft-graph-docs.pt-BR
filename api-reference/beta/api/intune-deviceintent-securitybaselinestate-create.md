...
---
# <a name="create-securitybaselinestate"></a>Criar securityBaselineState

> **Importante:** As APIs do Microsoft Graph na versão/beta estão sujeitas a alterações; Não há suporte para o uso de produção.

> **Observação:** A API do Microsoft Graph para Intune requer uma [licença do Active Intune](https://go.microsoft.com/fwlink/?linkid=839381) para o locatário.

Criar um novo objeto [securityBaselineState](../resources/intune-deviceintent-securitybaselinestate.md) .
...
No corpo da solicitação, forneça uma representação JSON do objeto securityBaselineState.

A tabela a seguir mostra as propriedades que são necessárias ao criar securityBaselineState.
...
Se tiver êxito, este método retornará `201 Created` um código de resposta e um objeto [securityBaselineState](../resources/intune-deviceintent-securitybaselinestate.md) no corpo da resposta.
