...
Este método lista apenas as respostas da mensagem especificada, se alguma. Para obter a mensagem em si, basta chamar [obter mensagem de canal](chatmessage-get.md).
