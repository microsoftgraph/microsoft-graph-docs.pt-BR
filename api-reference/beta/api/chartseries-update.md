...
Se tiver êxito, este método retornará um `200 OK` código de resposta e o objeto atualizado [workbookChartSeries](../resources/chartseries.md) no corpo da resposta.
