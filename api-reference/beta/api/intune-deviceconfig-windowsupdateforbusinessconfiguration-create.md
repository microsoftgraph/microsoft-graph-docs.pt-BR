...
|skipChecksBeforeRestart|Booleano|Desmarcar todas as verificações antes da reinicialização: Nível da bateria = 40%, Presença do usuário, Exibição Necessária, Modo de Apresentação, modo de tela inteira, estado de chamada telefônica, modo de jogo etc. |
...
|qualityUpdatesWillBeRolledBack|Booleano|Especifica se as Atualizações de Qualidade de rebaixamento no próximo dispositivo de check-in|
|featureUpdatesWillBeRolledBack|Booleano|Especifica se as Atualizações de Recursos de rebaixamento no próximo dispositivo de check-in|
...
|postponeRebootUntilAfterDeadline|Booleano|Especifica se o dispositivo deve esperar até o prazo final para reiniciar fora do horário ativo|
...
|userWindowsUpdateScanAccess|[enablement](../resources/intune-shared-enablement.md)|Especifica se o acesso do usuário deve ser desabilitado para verificar o Windows Update. Os valores possíveis são: `notConfigured`, `enabled`, `disabled`.|
|updateNotificationLevel|[windowsUpdateNotificationDisplayOption](../resources/intune-deviceconfig-windowsupdatenotificationdisplayoption.md)|Especifica o que os usuários de notificações do Windows Update veem. Os valores possíveis são: `notConfigured`, `defaultNotifications`, `restartWarningsOnly`, `disableAllNotifications`.|
