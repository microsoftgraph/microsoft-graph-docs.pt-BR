...
Se tiver êxito, este método retornará um código `200 OK` de resposta e um objeto [printConnector](../resources/printconnector.md) no corpo da resposta.
