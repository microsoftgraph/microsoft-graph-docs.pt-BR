...
A tabela a seguir mostra as propriedades que são necessárias ao criar o advancedThreatProtectionOnboardingDeviceSettingState.
...
Se tiver êxito, este método retornará um código de resposta e um `201 Created` [objeto advancedThreatProtectionOnboardingDeviceSettingState](../resources/intune-deviceconfig-advancedthreatprotectiononboardingdevicesettingstate.md) no corpo da resposta.
