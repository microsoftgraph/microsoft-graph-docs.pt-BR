...
Crie um novo [objeto managedAppProtectionPolicySetItem.](../resources/intune-policyset-managedappprotectionpolicysetitem.md)
...
No corpo da solicitação, fornece uma representação JSON para o objeto managedAppProtectionPolicySetItem.

A tabela a seguir mostra as propriedades que são necessárias ao criar managedAppProtectionPolicySetItem.
...
Se tiver êxito, este método retornará um código de resposta e um `201 Created` [objeto managedAppProtectionPolicySetItem](../resources/intune-policyset-managedappprotectionpolicysetitem.md) no corpo da resposta.
