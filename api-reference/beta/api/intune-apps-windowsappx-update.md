...
Atualizar as propriedades de um [objeto windowsAppX.](../resources/intune-apps-windowsappx.md)
...
No corpo da solicitação, fornece uma representação JSON do [objeto windowsAppX.](../resources/intune-apps-windowsappx.md)

A tabela a seguir mostra as propriedades que são necessárias ao criar [windowsAppX](../resources/intune-apps-windowsappx.md).
...
Se bem-sucedido, este método retorna um código `200 OK` de resposta e um objeto [windowsAppX](../resources/intune-apps-windowsappx.md) atualizado no corpo da resposta.
