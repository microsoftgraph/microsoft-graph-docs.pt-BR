...
A tabela a seguir mostra as propriedades que são necessárias ao criar [o windowsAppX](../resources/intune-apps-windowsappx.md).
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto windowsAppX](../resources/intune-apps-windowsappx.md) atualizado no corpo da resposta.
