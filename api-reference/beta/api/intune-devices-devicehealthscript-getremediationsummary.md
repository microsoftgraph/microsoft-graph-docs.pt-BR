...
Se tiver êxito, essa função retornará um código de resposta e um `200 OK` [deviceHealthScriptRemediationSummary](../resources/intune-devices-devicehealthscriptremediationsummary.md) no corpo da resposta.
