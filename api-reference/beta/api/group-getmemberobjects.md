...
Retorna todos os grupos e unidades administrativas dos quais o grupo é membro. A seleção é transitiva. Observação: Grupos não podem ser membros das funções de diretório, portanto nenhuma função de diretório será retornada.
