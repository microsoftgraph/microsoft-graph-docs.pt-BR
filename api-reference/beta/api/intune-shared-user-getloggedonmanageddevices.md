...
Se tiver êxito, essa função retornará um `200 OK` código de resposta e um conjunto de [managedDevice](../resources/intune-devices-manageddevice.md) no corpo da resposta.
