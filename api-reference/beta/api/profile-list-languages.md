...
Recupere uma lista de [objetos languageProficiency](../resources/languageproficiency.md) do perfil de um [usuário.](../resources/profile.md)
...
Se tiver êxito, este método retornará um código de resposta e uma `200 OK` coleção de [objetos languageProficiency](../resources/languageproficiency.md) no corpo da resposta.
