...
Leia propriedades e relações do [objeto deviceLogCollectionResponse.](../resources/intune-devices-devicelogcollectionresponse.md)
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto deviceLogCollectionResponse](../resources/intune-devices-devicelogcollectionresponse.md) no corpo da resposta.
