...
---
# <a name="list-grouppolicyoperations"></a>Listar groupPolicyOperations
...
Listar propriedades e relações dos [objetos groupPolicyOperation.](../resources/intune-grouppolicy-grouppolicyoperation.md)
...
Se tiver êxito, este método retornará um código de resposta e uma `200 OK` coleção [de objetos groupPolicyOperation](../resources/intune-grouppolicy-grouppolicyoperation.md) no corpo da resposta.
