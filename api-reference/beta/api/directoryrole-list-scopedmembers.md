...
### <a name="example-1--get-the-scoped-members-of-a-directory-role-using-role-id"></a>Exemplo 1: Obter os membros com escopo de uma função de diretório usando a id de função

#### <a name="request"></a>Solicitação
A seguir está um exemplo de uma solicitação para uma **id de função de diretório**`41d12a2f-caa8-4e3e-ba14-05e5102ce085`.
