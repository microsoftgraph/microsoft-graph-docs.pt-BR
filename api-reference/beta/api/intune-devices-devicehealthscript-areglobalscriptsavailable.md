...
Se tiver êxito, essa função retornará um código de resposta e `200 OK` [um globalDeviceHealthScriptState](../resources/intune-devices-globaldevicehealthscriptstate.md) no corpo da resposta.
