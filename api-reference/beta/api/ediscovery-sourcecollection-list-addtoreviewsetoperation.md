...
---
# <a name="list-addtoreviewsetoperation"></a>Listar addToReviewSetOperation

Namespace: microsoft.graph.ediscovery

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Obter o último [objeto addToReviewSetOperation](../resources/ediscovery-addtoreviewsetoperation.md) associado a uma coleção de origem. 
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto microsoft.graph.ediscovery.addToReviewSetOperation](../resources/ediscovery-addtoreviewsetoperation.md) no corpo da resposta.
