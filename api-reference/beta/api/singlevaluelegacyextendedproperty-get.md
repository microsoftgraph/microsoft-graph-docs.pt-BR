...
Obtenha uma instância de **outlookTask** :
<!-- { "blockType": "ignored" } -->
```http
...
```
Obtenha uma instância de **outlookTaskFolder** :
<!-- { "blockType": "ignored" } -->
```http
