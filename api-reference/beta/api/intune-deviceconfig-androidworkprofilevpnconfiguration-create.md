...
Crie um novo [objeto androidWorkProfileVpnConfiguration.](../resources/intune-deviceconfig-androidworkprofilevpnconfiguration.md)
...
A tabela a seguir mostra as propriedades que são necessárias ao criar o androidWorkProfileVpnConfiguration.
...
|targetedPackageIds|String collection|IDs de pacote de aplicativo direcionado.|
...
|alwaysOn|Booliano|Se deve ou não habilitar a conexão VPN sempre ativa.|
|alwaysOnLockdown|Booliano|Se a conexão VPN sempre ativa estiver habilitada, se o tráfego de rede será ou não travado quando essa VPN estiver desconectada.|
|microsoftTunnelSiteId|Cadeia de caracteres|Microsoft Tunnel ID do site.|



## <a name="response"></a>Resposta
Se tiver êxito, este método retornará um código de resposta e um `201 Created` [objeto androidWorkProfileVpnConfiguration](../resources/intune-deviceconfig-androidworkprofilevpnconfiguration.md) no corpo da resposta.
