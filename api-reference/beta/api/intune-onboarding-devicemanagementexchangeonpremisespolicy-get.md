...
description: Ler propriedades e relações do objeto deviceManagementExchangeOnPremisesPolicy.
author: dougeby
...
Ler propriedades e relações do [objeto deviceManagementExchangeOnPremisesPolicy](../resources/intune-onboarding-devicemanagementexchangeonpremisespolicy.md) .
...
Se tiver êxito, este método retornará `200 OK` um código de resposta e [um objeto deviceManagementExchangeOnPremisesPolicy](../resources/intune-onboarding-devicemanagementexchangeonpremisespolicy.md) no corpo da resposta.
