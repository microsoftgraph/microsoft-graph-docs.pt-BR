...
---
# <a name="create-macoswirednetworkconfiguration"></a>Criar macOSWiredNetworkConfiguration
...
Criar um novo objeto [macOSWiredNetworkConfiguration](../resources/intune-deviceconfig-macoswirednetworkconfiguration.md) .
...
No corpo da solicitação, forneça uma representação JSON do objeto macOSWiredNetworkConfiguration.

A tabela a seguir mostra as propriedades que são necessárias ao criar macOSWiredNetworkConfiguration.
...
Se tiver êxito, este método retornará `201 Created` um código de resposta e um objeto [macOSWiredNetworkConfiguration](../resources/intune-deviceconfig-macoswirednetworkconfiguration.md) no corpo da resposta.
