...
Se tiver êxito, essa função retornará um `200 OK` código de resposta e uma coleção [microsoft.graph.ediscovery.tag](../resources/ediscovery-tag.md) no corpo da resposta.
