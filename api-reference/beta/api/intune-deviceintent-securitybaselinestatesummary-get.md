...
Leia propriedades e relações do [objeto securityBaselineStateSummary.](../resources/intune-deviceintent-securitybaselinestatesummary.md)
...
Se tiver êxito, este método retornará um código de resposta e `200 OK` [um objeto securityBaselineStateSummary](../resources/intune-deviceintent-securitybaselinestatesummary.md) no corpo da resposta.
