...
Obtenha uma política específica.
...
Se bem-sucedido, este método retorna um `200 OK` código de resposta e um objeto [conjuntoofficeclientconfiguration](../resources/intune-cirrus-officeclientconfiguration.md) no corpo da resposta.
