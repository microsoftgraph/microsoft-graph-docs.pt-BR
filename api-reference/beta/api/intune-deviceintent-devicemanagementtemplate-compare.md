...
Se tiver êxito, essa função retornará um código de resposta e uma `200 OK` [coleção deviceManagementSettingComparison](../resources/intune-deviceintent-devicemanagementsettingcomparison.md) no corpo da resposta.
