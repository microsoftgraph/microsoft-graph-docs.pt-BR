...
ms.locfileid: "37176377"
---
# <a name="delete-androidforworktrustedrootcertificate"></a><span data-ttu-id="4e02c-103">Excluir androidForWorkTrustedRootCertificate</span><span class="sxs-lookup"><span data-stu-id="4e02c-103">Delete androidForWorkTrustedRootCertificate</span></span>
...
<span data-ttu-id="4e02c-106">Exclui [androidForWorkTrustedRootCertificate](../resources/intune-deviceconfig-androidforworktrustedrootcertificate.md).</span><span class="sxs-lookup"><span data-stu-id="4e02c-106">Deletes a [androidForWorkTrustedRootCertificate](../resources/intune-deviceconfig-androidforworktrustedrootcertificate.md).</span></span>
...
|<span data-ttu-id="4e02c-116">Aplicativo</span><span class="sxs-lookup"><span data-stu-id="4e02c-116">Application</span></span>|<span data-ttu-id="4e02c-117">DeviceManagementConfiguration.ReadWrite.All</span><span class="sxs-lookup"><span data-stu-id="4e02c-117">DeviceManagementConfiguration.ReadWrite.All</span></span>|
...
<span data-ttu-id="4e02c-127">Não forneça um corpo de solicitação para esse método.</span><span class="sxs-lookup"><span data-stu-id="4e02c-127">Do not supply a request body for this method.</span></span>

## <a name="response"></a><span data-ttu-id="4e02c-128">Resposta</span><span class="sxs-lookup"><span data-stu-id="4e02c-128">Response</span></span>
<span data-ttu-id="4e02c-129">Se tiver êxito, este método retornará um código de resposta `204 No Content`.</span><span class="sxs-lookup"><span data-stu-id="4e02c-129">If successful, this method returns a `204 No Content` response code.</span></span>

## <a name="example"></a><span data-ttu-id="4e02c-130">Exemplo</span><span class="sxs-lookup"><span data-stu-id="4e02c-130">Example</span></span>

### <a name="request"></a><span data-ttu-id="4e02c-131">Solicitação</span><span class="sxs-lookup"><span data-stu-id="4e02c-131">Request</span></span>
<span data-ttu-id="4e02c-132">Este é um exemplo da solicitação.</span><span class="sxs-lookup"><span data-stu-id="4e02c-132">Here is an example of the request.</span></span>
``` http
...
### <a name="response"></a><span data-ttu-id="4e02c-133">Resposta</span><span class="sxs-lookup"><span data-stu-id="4e02c-133">Response</span></span>
