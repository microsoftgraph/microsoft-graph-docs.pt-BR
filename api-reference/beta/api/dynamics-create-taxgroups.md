...
No corpo da solicitação, forneça uma representação JSON de um objeto **taxGroups** .

## <a name="response"></a>Resposta
Se bem-sucedido, este método retorna ```201 Created``` um código de resposta e um objeto **taxGroups** no corpo da resposta.
