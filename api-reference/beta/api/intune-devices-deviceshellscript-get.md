...
Leia propriedades e relações do [objeto deviceShellScript.](../resources/intune-devices-deviceshellscript.md)
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto deviceShellScript](../resources/intune-devices-deviceshellscript.md) no corpo da resposta.
