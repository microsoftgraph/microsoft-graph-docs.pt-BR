...
Crie um novo objeto de [officeSuiteApp](../resources/intune-apps-officesuiteapp.md) .
...
A tabela a seguir mostra as propriedades que são necessárias quando você cria o officeSuiteApp.
...
Se tiver êxito, este método retornará um `201 Created` código de resposta e um objeto [officeSuiteApp](../resources/intune-apps-officesuiteapp.md) no corpo da resposta.
