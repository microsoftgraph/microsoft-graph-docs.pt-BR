...
Gera um token da Web que é usado em um componente inbeddável.
...
|:---|:---|:---|
|parentUri|Cadeia de Caracteres|O caminho https da página que hospeda o componente.|
