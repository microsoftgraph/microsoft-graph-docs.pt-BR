...
Obtenha a coleção de [sitePages](../resources/sitepage.md) de de páginas do site [lista](../resources/list.md) em um [site](../resources/site.md)do site. Todas as páginas no site são retornadas (com paginação).
