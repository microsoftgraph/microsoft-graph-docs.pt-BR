...
Se tiver êxito, essa função retornará um `200 OK` código de resposta e uma [operaçãoApprovalRequest](../resources/intune-rbac-operationapprovalrequest.md) no corpo da resposta.
