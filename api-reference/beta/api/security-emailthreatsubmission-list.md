---
title: Listar emailThreatSubmissions
description: Obtenha uma lista dos objetos emailThreatSubmission e suas propriedades.
author: caigen
...
ms.locfileid: "66856460"
---
# <a name="list-emailthreatsubmissions"></a>Listar emailThreatSubmissions
Namespace: microsoft.graph.security

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Obtenha uma lista dos [objetos emailThreatSubmission](../resources/security-emailthreatsubmission.md) e suas propriedades.
...
Se tiver êxito, este método retornará um código `200 OK` de resposta e uma coleção de [objetos emailThreatSubmission](../resources/security-emailthreatsubmission.md) no corpo da resposta.
