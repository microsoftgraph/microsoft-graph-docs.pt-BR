...
description: Libere um guardião de um caso.
author: SeunginLyu
...
Libere um guardião de um caso. Para obter detalhes, [consulte Liberar um guardião de um caso](/microsoft-365/compliance/manage-new-custodians#release-a-custodian-from-a-case).
