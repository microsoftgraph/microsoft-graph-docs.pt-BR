---
title: Criar macOSDmgApp
description: Crie um novo objeto macOSDmgApp.
author: dougeby
...
ms.locfileid: "61712118"
---
# <a name="create-macosdmgapp"></a>Criar macOSDmgApp
...
Crie um novo [objeto macOSDmgApp.](../resources/intune-apps-macosdmgapp.md)
...
No corpo da solicitação, fornece uma representação JSON para o objeto macOSDmgApp.

A tabela a seguir mostra as propriedades necessárias ao criar o macOSDmgApp.
...
Se tiver êxito, este método retornará um código de resposta e um `201 Created` [objeto macOSDmgApp](../resources/intune-apps-macosdmgapp.md) no corpo da resposta.
