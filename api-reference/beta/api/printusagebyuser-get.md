...
Se tiver êxito, este método retornará um `200 OK` código de resposta e um [objeto printUsageByUser](../resources/printUsageByUser.md) no corpo da resposta.
