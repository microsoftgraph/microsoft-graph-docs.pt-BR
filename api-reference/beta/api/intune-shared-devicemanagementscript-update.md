...
Atualizar as propriedades de um [objeto deviceManagementScript.](../resources/intune-shared-devicemanagementscript.md)
...
No corpo da solicitação, fornece uma representação JSON do [objeto deviceManagementScript.](../resources/intune-shared-devicemanagementscript.md)
...
Se bem-sucedido, este método retorna um código de resposta e um objeto `200 OK` [deviceManagementScript](../resources/intune-shared-devicemanagementscript.md) atualizado no corpo da resposta.
