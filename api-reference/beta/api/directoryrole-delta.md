...
Se tiver êxito, este método retornará um código `200 OK` de resposta e um [objeto da coleção directoryRole](../resources/directoryrole.md) no corpo da resposta. A resposta também inclui uma URL do nextLink ou uma URL deltaLink. 
