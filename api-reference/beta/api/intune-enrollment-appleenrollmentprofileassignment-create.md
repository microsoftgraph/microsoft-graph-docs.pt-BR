...
ms.locfileid: "54217586"
---
# <a name="create-appleenrollmentprofileassignment"></a>Criar appleEnrollmentProfileAssignment
...
Crie um novo [objeto appleEnrollmentProfileAssignment.](../resources/intune-enrollment-appleenrollmentprofileassignment.md)
...
No corpo da solicitação, fornece uma representação JSON para o objeto appleEnrollmentProfileAssignment.

A tabela a seguir mostra as propriedades que são necessárias ao criar appleEnrollmentProfileAssignment.
...
Se tiver êxito, este método retornará um código de resposta e um `201 Created` [objeto appleEnrollmentProfileAssignment](../resources/intune-enrollment-appleenrollmentprofileassignment.md) no corpo da resposta.
