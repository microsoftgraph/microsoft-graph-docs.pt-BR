...
Recupere as propriedades e as relações de um [objeto personName](../resources/personname.md) no perfil de um [usuário.](../resources/profile.md)
...
Se tiver êxito, este método retornará um código de `200 OK` resposta e o objeto [personName](../resources/personname.md) solicitado no corpo da resposta.
