...
Criar um novo [canal](../resources/channel.md) em uma equipe da Microsoft, conforme especificado no corpo da solicitação.
...
Se bem-sucedido, este método retorna `201 Created` o código de resposta e o objeto [Channel](../resources/channel.md) no corpo da resposta.
