...
| onPremisesPublishing    | [onPremisesPublishing](../resources/onpremisespublishing.md)                | Representa o conjunto de propriedades para configurar o Proxy de Aplicativo [do Azure AD](https://aka.ms/whyappproxy) para um aplicativo local. Essa propriedade só poderá ser definida depois que o aplicativo tiver sido criado.                                                                                                                                                                                                                                                                                                                                                       |
