...
| onPremisesPublishing    | [onPremisesPublishing](../resources/onpremisespublishing.md)                | Representa o conjunto de propriedades para configurar o [Azure AD Proxy de Aplicativo](/azure/active-directory/app-proxy/what-is-application-proxy) para um aplicativo local. Essa propriedade só pode ser definida após a criação do aplicativo e não pode ser atualizada na mesma solicitação que outras propriedades do aplicativo.                                                                                                                                                                                                                                                                                                                                                       |
