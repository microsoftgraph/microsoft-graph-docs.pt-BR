...
No corpo da solicitação, fornece uma representação JSON do objeto windowsPhone81AppX.
...
Se bem-sucedido, este método retorna um código de resposta e um objeto `201 Created` [windowsPhone81AppX](../resources/intune-apps-windowsphone81appx.md) no corpo da resposta.
