...
Leia propriedades e relações do [objeto embeddedSIMDeviceState.](../resources/intune-esim-embeddedsimdevicestate.md)
...
Se tiver êxito, este método retornará um código `200 OK` de resposta e um [objetoSIMDeviceState](../resources/intune-esim-embeddedsimdevicestate.md) incorporado no corpo da resposta.
