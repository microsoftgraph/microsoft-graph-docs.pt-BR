...
Se tiver êxito, este método retornará `200 OK` um código de resposta e um objeto [educationOutcome](../resources/educationoutcome.md) atualizado no corpo da resposta.
