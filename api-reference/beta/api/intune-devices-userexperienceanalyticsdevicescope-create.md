...
Crie um [novo objeto userExperienceAnalyticsDeviceScope](../resources/intune-devices-userexperienceanalyticsdevicescope.md) .
...
Se tiver êxito, este método retornará `201 Created` um código de resposta e um [objeto userExperienceAnalyticsDeviceScope](../resources/intune-devices-userexperienceanalyticsdevicescope.md) no corpo da resposta.
