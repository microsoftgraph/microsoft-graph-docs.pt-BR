...
Se tiver êxito, este método retornará um código de resposta e um objeto `200 OK` [WorkbookChartLineFormat](../resources/workbookchartlineformat.md) no corpo da resposta.
