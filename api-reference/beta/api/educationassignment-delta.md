...
description: Obter uma lista de atribuições recém-criadas ou atualizadas sem precisar executar um pronto completo da coleção.
...
Obter uma lista de atribuições recém-criadas ou [atualizadas](../resources/educationassignment.md) sem precisar executar um pronto completo da coleção.
...
### <a name="example-1-get-assignments-with-delta-query-support"></a>Exemplo 1: Obter atribuições com suporte à consulta delta

#### <a name="request"></a>Solicitação

Este é um exemplo de solicitação. 

Use o `$top` parâmetro para especificar o número de atribuições a serem retornadas. O parâmetro é opcional, mas use-o preferencialmente quando você tiver uma longa lista de atribuições; caso contrário, você receberá todas as atribuições na classe.
...
>**Observação:** Pegue o `@odata.nextLink` da resposta para fazer outra chamada e obter o próximo conjunto de atribuições.
