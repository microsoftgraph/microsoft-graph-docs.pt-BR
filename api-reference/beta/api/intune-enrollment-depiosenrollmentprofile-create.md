...
|restoreCompletedScreenDisabled|Boolean|Indica se a tela do weclome está desabilitada|
|updateCompleteScreenDisabled|Boolean|Indica se a tela do weclome está desabilitada|
