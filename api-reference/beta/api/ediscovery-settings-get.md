...
Leia as propriedades e as relações de um [objeto settings.](../resources/ediscovery-settings.md)
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto settings](../resources/ediscovery-settings.md) no corpo da resposta.
