...
Ler propriedades e relações do [objeto macOsVppAppAssignedLicense.](../resources/intune-apps-macosvppappassignedlicense.md)
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto macOsVppAppAssignedLicense](../resources/intune-apps-macosvppappassignedlicense.md) no corpo da resposta.
