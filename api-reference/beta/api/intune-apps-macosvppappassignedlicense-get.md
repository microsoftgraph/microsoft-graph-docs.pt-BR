...
Leia as propriedades e os relacionamentos do objeto [macOsVppAppAssignedLicense](../resources/intune-apps-macosvppappassignedlicense.md) .
...
Se tiver êxito, este método retornará um `200 OK` objeto response de código e [macOsVppAppAssignedLicense](../resources/intune-apps-macosvppappassignedlicense.md) no corpo da resposta.
