...
description: Dispara uma indexOperation para tornar uma fonte de dados não custodiante e sua fonte de dados associada pesquisável.
author: SeunginLyu
...
Dispara uma [indexOperation](../resources/security-ediscoveryIndexOperation.md)
