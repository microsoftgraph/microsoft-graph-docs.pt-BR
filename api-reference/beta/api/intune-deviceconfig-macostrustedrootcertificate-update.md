...
A tabela a seguir mostra as propriedades que são necessárias ao criar [o macOSTrustedRootCertificate](../resources/intune-deviceconfig-macostrustedrootcertificate.md).
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto macOSTrustedRootCertificate](../resources/intune-deviceconfig-macostrustedrootcertificate.md) atualizado no corpo da resposta.
