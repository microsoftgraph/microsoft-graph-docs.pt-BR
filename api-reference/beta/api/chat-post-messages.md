...
Envie um [novo chatMessage](../resources/chatmessage.md) no chat [especificado](../resources/chat.md). Essa API não pode criar um novo chat; você deve usar o [método de chats de](chat-list.md) lista para recuperar a ID de um chat existente antes de criar uma mensagem de chat.
