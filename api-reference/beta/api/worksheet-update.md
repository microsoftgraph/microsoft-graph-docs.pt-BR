...
Se tiver êxito, este método retornará um código `200 OK` de resposta e um objeto [workbookWorksheet](../resources/workbookworksheet.md) atualizado no corpo da resposta.
