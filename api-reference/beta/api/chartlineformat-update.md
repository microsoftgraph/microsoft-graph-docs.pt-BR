...
Se tiver êxito, este método retornará um `200 OK` código de resposta e o objeto atualizado [workbookChartLineFormat](../resources/chartlineformat.md) no corpo da resposta.
