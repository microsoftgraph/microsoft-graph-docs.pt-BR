...
Se tiver êxito, este método retornará um código de resposta `200 OK` e um objeto [workbookChartLineFormat](../resources/workbookchartlineformat.md) atualizado no corpo da resposta.
