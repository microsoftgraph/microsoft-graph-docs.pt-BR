...
Leia propriedades e relações do [objeto mobileAppInstallSummary.](../resources/intune-apps-mobileappinstallsummary.md)
...
Se tiver êxito, este método retornará um código `200 OK` de resposta e um objeto [mobileAppInstallSummary](../resources/intune-apps-mobileappinstallsummary.md) no corpo da resposta.
