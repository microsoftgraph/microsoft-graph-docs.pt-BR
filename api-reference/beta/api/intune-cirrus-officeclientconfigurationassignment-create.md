...
A tabela a seguir mostra as propriedades que são necessárias ao criar o officeClientConfigurationAssignment.
...
Se tiver êxito, este método retornará um código de resposta e um `200 Created` [objeto officeClientConfigurationAssignment](../resources/intune-cirrus-officeclientconfigurationassignment.md) no corpo da resposta.
