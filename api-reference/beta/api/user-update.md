...
|pastProjects|String collection|Uma lista para o usuário enumerar seus projetos anteriores.|
...
|schools|String collection|Uma lista para o usuário enumerar as escolas que ele frequentou.|
