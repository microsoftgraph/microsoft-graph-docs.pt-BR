...
description: Atualize as propriedades de um objeto PasswordlessMicrosoftAuthenticatorAuthenticationMethodConfiguration.
author: mmcla
...
>**Nota:** A `@odata.type` propriedade com um valor deve `#microsoft.graph.passwordlessMicrosoftAuthenticatorAuthenticationMethodConfiguration` ser incluída no corpo.
