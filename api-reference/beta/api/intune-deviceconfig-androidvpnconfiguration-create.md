...
No corpo da solicitação, fornece uma representação JSON do objeto androidVpnConfiguration.
...
Se bem-sucedido, este método retorna um código de resposta e um `201 Created` [objeto androidVpnConfiguration](../resources/intune-deviceconfig-androidvpnconfiguration.md) no corpo da resposta.
