...
ms.locfileid: "36310203"
---
# <a name="enablelostmode-action"></a><span data-ttu-id="5f045-103">Ação enableLostMode</span><span class="sxs-lookup"><span data-stu-id="5f045-103">enableLostMode action</span></span>
...
<span data-ttu-id="5f045-106">Habilitar modo perdido</span><span class="sxs-lookup"><span data-stu-id="5f045-106">Enable lost mode</span></span>
...
|:---|:---|
|<span data-ttu-id="5f045-112">Delegado (conta corporativa ou de estudante)</span><span class="sxs-lookup"><span data-stu-id="5f045-112">Delegated (work or school account)</span></span>|<span data-ttu-id="5f045-113">DeviceManagementManagedDevices.PriviligedOperation.All</span><span class="sxs-lookup"><span data-stu-id="5f045-113">DeviceManagementManagedDevices.PriviligedOperation.All</span></span>|
...
|<span data-ttu-id="5f045-116">Aplicativo</span><span class="sxs-lookup"><span data-stu-id="5f045-116">Application</span></span>|<span data-ttu-id="5f045-117">DeviceManagementManagedDevices.PriviligedOperation.All</span><span class="sxs-lookup"><span data-stu-id="5f045-117">DeviceManagementManagedDevices.PriviligedOperation.All</span></span>|
...
<span data-ttu-id="5f045-127">No corpo da solicitação, forneça uma representação JSON dos parâmetros.</span><span class="sxs-lookup"><span data-stu-id="5f045-127">In the request body, supply JSON representation of the parameters.</span></span>

<span data-ttu-id="5f045-128">A tabela a seguir mostra os parâmetros que podem ser usados com esta ação.</span><span class="sxs-lookup"><span data-stu-id="5f045-128">The following table shows the parameters that can be used with this action.</span></span>
...
|:---|:---|:---|
|<span data-ttu-id="5f045-132">mensagem</span><span class="sxs-lookup"><span data-stu-id="5f045-132">message</span></span>|<span data-ttu-id="5f045-133">String</span><span class="sxs-lookup"><span data-stu-id="5f045-133">String</span></span>|<span data-ttu-id="5f045-134">Ainda não documentado</span><span class="sxs-lookup"><span data-stu-id="5f045-134">Not yet documented</span></span>|
|<span data-ttu-id="5f045-135">phoneNumber</span><span class="sxs-lookup"><span data-stu-id="5f045-135">phoneNumber</span></span>|<span data-ttu-id="5f045-136">String</span><span class="sxs-lookup"><span data-stu-id="5f045-136">String</span></span>|<span data-ttu-id="5f045-137">Ainda não documentado</span><span class="sxs-lookup"><span data-stu-id="5f045-137">Not yet documented</span></span>|
|<span data-ttu-id="5f045-138">cabeçalho</span><span class="sxs-lookup"><span data-stu-id="5f045-138">footer</span></span>|<span data-ttu-id="5f045-139">String</span><span class="sxs-lookup"><span data-stu-id="5f045-139">String</span></span>|<span data-ttu-id="5f045-140">Ainda não documentado</span><span class="sxs-lookup"><span data-stu-id="5f045-140">Not yet documented</span></span>|



## <a name="response"></a><span data-ttu-id="5f045-141">Resposta</span><span class="sxs-lookup"><span data-stu-id="5f045-141">Response</span></span>
<span data-ttu-id="5f045-142">Se tiver êxito, esta ação retornará um código de resposta `204 No Content`.</span><span class="sxs-lookup"><span data-stu-id="5f045-142">If successful, this action returns a `204 No Content` response code.</span></span>

## <a name="example"></a><span data-ttu-id="5f045-143">Exemplo</span><span class="sxs-lookup"><span data-stu-id="5f045-143">Example</span></span>

### <a name="request"></a><span data-ttu-id="5f045-144">Solicitação</span><span class="sxs-lookup"><span data-stu-id="5f045-144">Request</span></span>
<span data-ttu-id="5f045-145">Este é um exemplo da solicitação.</span><span class="sxs-lookup"><span data-stu-id="5f045-145">Here is an example of the request.</span></span>
``` http
...
### <a name="response"></a><span data-ttu-id="5f045-146">Resposta</span><span class="sxs-lookup"><span data-stu-id="5f045-146">Response</span></span>
<span data-ttu-id="5f045-p102">Veja a seguir um exemplo da resposta. Observação: o objeto response mostrado aqui pode estar truncado por motivos de concisão. Todas as propriedades serão retornadas de uma chamada real.</span><span class="sxs-lookup"><span data-stu-id="5f045-p102">Here is an example of the response. Note: The response object shown here may be truncated for brevity. All of the properties will be returned from an actual call.</span></span>
``` http
