...
Obter uma lista dos [objetos unifiedGroupSource](../resources/ediscovery-unifiedgroupsource.md) e suas propriedades.
...
Se tiver êxito, este método retornará um código de resposta e uma coleção de objetos `200 OK` [microsoft.graph.ediscovery.unifiedGroupSource](../resources/ediscovery-unifiedgroupsource.md) no corpo da resposta.
