...
Crie um novo objeto de [groupPolicyDefinitionValue](../resources/intune-grouppolicy-grouppolicydefinitionvalue.md) .
...
A tabela a seguir mostra as propriedades que são necessárias quando você cria o groupPolicyDefinitionValue.
