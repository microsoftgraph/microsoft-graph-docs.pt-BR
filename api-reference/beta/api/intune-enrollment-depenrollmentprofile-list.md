...
Listar propriedades e relações dos [objetos depEnrollmentProfile.](../resources/intune-enrollment-depenrollmentprofile.md)
...
Se tiver êxito, este método retornará um código de resposta e uma `200 OK` coleção [de objetos depEnrollmentProfile](../resources/intune-enrollment-depenrollmentprofile.md) no corpo da resposta.
