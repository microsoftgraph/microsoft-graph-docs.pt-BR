...
Ler propriedades e relações do objeto [intuneBrandingProfile.](../resources/intune-wip-intunebrandingprofile.md)
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto intuneBrandingProfile](../resources/intune-wip-intunebrandingprofile.md) no corpo da resposta.
