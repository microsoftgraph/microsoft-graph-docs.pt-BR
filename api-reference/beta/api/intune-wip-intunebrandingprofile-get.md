...
Leia as propriedades e os relacionamentos do objeto [intuneBrandingProfile](../resources/intune-wip-intunebrandingprofile.md) .
...
Se tiver êxito, este método retornará um `200 OK` objeto response de código e [intuneBrandingProfile](../resources/intune-wip-intunebrandingprofile.md) no corpo da resposta.
