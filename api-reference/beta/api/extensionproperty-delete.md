...
[Exclua um objeto extensionProperty](../resources/extensionproperty.md). Você pode excluir somente as propriedades que não são sincronizadas do Active Directory local.
