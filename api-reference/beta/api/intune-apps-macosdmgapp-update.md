---
title: Atualizar macOSDmgApp
description: Atualize as propriedades de um objeto macOSDmgApp.
author: dougeby
...
ms.locfileid: "61712125"
---
# <a name="update-macosdmgapp"></a>Atualizar macOSDmgApp
...
Atualize as propriedades de um [objeto macOSDmgApp.](../resources/intune-apps-macosdmgapp.md)
...
No corpo da solicitação, fornece uma representação JSON para o [objeto macOSDmgApp.](../resources/intune-apps-macosdmgapp.md)

A tabela a seguir mostra as propriedades que são necessárias ao criar [o macOSDmgApp](../resources/intune-apps-macosdmgapp.md).
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto macOSDmgApp](../resources/intune-apps-macosdmgapp.md) atualizado no corpo da resposta.
