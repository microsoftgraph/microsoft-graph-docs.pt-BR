...
|passwordBlockIrisUnlock|Boolean|Indica se o desbloqueio de íris deve ou não ser bloqueado.|
...
|workProfileAllowAppInstallsFromUnknownSources|Boolean|Indica se é possível permitir a instalação de aplicativos de fontes desconhecidas.|
...
|workProfileBlockCrossProfileCallerId|Boolean|Bloqueie a ID do chamador de perfil de trabalho de exibição no perfil pessoal.|
|workProfileBlockCamera|Boolean|Bloquear a câmera de perfil de trabalho.|
|workProfileBlockCrossProfileContactsSearch|Boolean|Bloquear a disponibilidade de contatos de perfil de trabalho no perfil pessoal.|
|workProfileBlockCrossProfileCopyPaste|Boolean|Boolean que indica se a configuração não permitir cópia/colar entre perfis está habilitada.|
...
|workProfilePasswordBlockFingerprintUnlock|Boolean|Indica se o desbloqueio de impressão digital deve ou não ser bloqueado para o perfil de trabalho.|
|workProfilePasswordBlockIrisUnlock|Boolean|Indica se o desbloqueio de íris deve ou não ser bloqueado para o perfil de trabalho.|
|workProfilePasswordBlockTrustAgents|Boolean|Indica se o Smart Lock deve ou não ser bloqueado e outros agentes de confiança para o perfil de trabalho.|
