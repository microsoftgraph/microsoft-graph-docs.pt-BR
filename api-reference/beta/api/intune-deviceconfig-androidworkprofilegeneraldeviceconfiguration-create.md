...
|passwordBlockIrisUnlock|Booleano|Indica se o desbloqueio de íris deve ou não ser bloqueado.|
...
|workProfileAllowAppInstallsFromUnknownSources|Booleano|Indica se é possível permitir a instalação de aplicativos de fontes desconhecidas.|
...
|workProfileBlockNotificationsWhileDeviceLocked|Booleano|Indica se as notificações são bloqueadas ou não enquanto o dispositivo está bloqueado.|
...
|workProfileBlockCrossProfileCallerId|Booleano|Bloqueie a ID do chamador de perfil de trabalho de exibição no perfil pessoal.|
|workProfileBlockCamera|Booleano|Bloquear a câmera de perfil de trabalho.|
|workProfileBlockCrossProfileContactsSearch|Booleano|Bloquear a disponibilidade de contatos de perfil de trabalho no perfil pessoal.|
|workProfileBlockCrossProfileCopyPaste|Booleano|Boolean que indica se a configuração não permitir cópia/colar entre perfis está habilitada.|
...
|workProfilePasswordBlockFingerprintUnlock|Booleano|Indica se o desbloqueio de impressão digital deve ou não ser bloqueado para o perfil de trabalho.|
...
|vpnEnableAlwaysOnLockdownMode|Booleano|Habilitar o modo de bloqueio para VPN always-on.|
