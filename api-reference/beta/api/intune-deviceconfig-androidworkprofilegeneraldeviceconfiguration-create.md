...
No corpo da solicitação, fornece uma representação JSON do objeto androidWorkProfileGeneralDeviceConfiguration.
...
Se tiver êxito, este método retornará um código de resposta e um objeto `201 Created` [androidWorkProfileGeneralDeviceConfiguration](../resources/intune-deviceconfig-androidworkprofilegeneraldeviceconfiguration.md) no corpo da resposta.
