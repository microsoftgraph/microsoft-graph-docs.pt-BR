...
description: Leia as propriedades e as relações do objeto userExperienceAnalyticsModelScores.
author: dougeby
...
Leia as propriedades e as relações do [objeto userExperienceAnalyticsModelScores](../resources/intune-devices-userexperienceanalyticsmodelscores.md) .
...
Se bem-sucedido, este método retorna `200 OK` um código de resposta [e o objeto userExperienceAnalyticsModelScores](../resources/intune-devices-userexperienceanalyticsmodelscores.md) no corpo da resposta.
