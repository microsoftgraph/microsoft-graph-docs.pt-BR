...
Recupere uma lista de [plannerPlans marcados](../resources/plannerplan.md) como favoritos por um usuário. Você pode marcar um plano como favorito [atualizando o recurso plannerUser](planneruser-update.md).
