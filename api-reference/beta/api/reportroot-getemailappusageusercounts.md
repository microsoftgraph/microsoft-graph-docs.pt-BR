...
Se tiver êxito, este método retornará um `200 OK` código de resposta e um objeto **[emailAppUsageUserCounts](../resources/emailappusageusercounts.md)** no corpo da resposta.
