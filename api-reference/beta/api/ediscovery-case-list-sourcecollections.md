...
Obter a lista [de sourceCollections](../resources/ediscovery-sourcecollection.md) de um [objeto case.](../resources/ediscovery-case.md)
...
Se tiver êxito, este método retornará um código de resposta e uma `200 OK` coleção de [objetos microsoft.graph.ediscovery.sourceCollection](../resources/ediscovery-sourcecollection.md) no corpo da resposta.
