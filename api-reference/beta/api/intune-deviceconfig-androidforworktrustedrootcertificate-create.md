...
## <a name="http-request"></a><span data-ttu-id="a8bf8-119">Solicitação HTTP</span><span class="sxs-lookup"><span data-stu-id="a8bf8-119">HTTP Request</span></span>
<!-- {
  "blockType": "ignored"
}
-->
