...
A tabela a seguir mostra as propriedades que são necessárias ao criar [o macOSVpnConfiguration](../resources/intune-deviceconfig-macosvpnconfiguration.md).
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto macOSVpnConfiguration](../resources/intune-deviceconfig-macosvpnconfiguration.md) atualizado no corpo da resposta.
