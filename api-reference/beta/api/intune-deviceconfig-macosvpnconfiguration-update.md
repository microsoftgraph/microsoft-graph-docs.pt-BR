...
Atualizar as propriedades de um [objeto macOSVpnConfiguration.](../resources/intune-deviceconfig-macosvpnconfiguration.md)
...
No corpo da solicitação, fornece uma representação JSON do [objeto macOSVpnConfiguration.](../resources/intune-deviceconfig-macosvpnconfiguration.md)
...
Se bem-sucedido, este método retorna um código de resposta e um objeto `200 OK` [macOSVpnConfiguration](../resources/intune-deviceconfig-macosvpnconfiguration.md) atualizado no corpo da resposta.
