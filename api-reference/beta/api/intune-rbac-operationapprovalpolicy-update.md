...
A tabela a seguir mostra as propriedades necessárias ao criar [operationApprovalPolicy](../resources/intune-rbac-operationapprovalpolicy.md).
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto operationApprovalPolicy](../resources/intune-rbac-operationapprovalpolicy.md) atualizado no corpo da resposta.
