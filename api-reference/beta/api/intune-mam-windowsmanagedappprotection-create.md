...
No corpo da solicitação, forneça uma representação JSON do objeto windowsManagedAppProtection.

A tabela a seguir mostra as propriedades que são necessárias ao criar o windowsManagedAppProtection.
