...
Crie um novo [objeto targetedManagedAppConfigurationPolicySetItem.](../resources/intune-policyset-targetedmanagedappconfigurationpolicysetitem.md)
...
No corpo da solicitação, fornece uma representação JSON para o objeto targetedManagedAppConfigurationPolicySetItem.
...
Se tiver êxito, este método retornará um código de resposta e um `201 Created` [objeto targetedManagedAppConfigurationPolicySetItem](../resources/intune-policyset-targetedmanagedappconfigurationpolicysetitem.md) no corpo da resposta.
