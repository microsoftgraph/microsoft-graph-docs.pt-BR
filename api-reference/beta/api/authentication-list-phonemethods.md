...
Recupere uma lista de objetos [do método de autenticação de](../resources/phoneauthenticationmethod.md) telefone. Isso retornará até três objetos, pois um usuário pode ter até três telefones para autenticação. Esse método está disponível apenas para usuários padrão do Azure AD e B2B, mas não para usuários B2C.
