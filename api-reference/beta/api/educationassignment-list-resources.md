...
Obter todos os [objetos educationAssignmentResource](../resources/educationassignmentresource.md) associados a uma [atribuição](../resources/educationassignment.md).
