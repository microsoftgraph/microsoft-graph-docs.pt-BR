...
---
# <a name="create-windows81scepcertificateprofile"></a>Criar windows81SCEPCertificateProfile
...
Crie um novo [objeto windows81SCEPCertificateProfile.](../resources/intune-deviceconfig-windows81scepcertificateprofile.md)
...
No corpo da solicitação, fornece uma representação JSON para o objeto windows81SCEPCertificateProfile.

A tabela a seguir mostra as propriedades necessárias ao criar o windows81SCEPCertificateProfile.
...
Se tiver êxito, este método retornará um código de resposta e um `201 Created` [objeto windows81SCEPCertificateProfile](../resources/intune-deviceconfig-windows81scepcertificateprofile.md) no corpo da resposta.
