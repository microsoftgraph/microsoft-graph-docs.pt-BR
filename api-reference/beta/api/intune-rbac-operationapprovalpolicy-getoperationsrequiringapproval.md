---
title: função getOperationsRequiringApproval
...
ms.locfileid: "60486826"
---
# <a name="getoperationsrequiringapproval-function"></a>função getOperationsRequiringApproval
...
Se tiver êxito, essa função retornará um código de resposta e uma `200 OK` [coleção operationApprovalPolicySet](../resources/intune-rbac-operationapprovalpolicyset.md) no corpo da resposta.
