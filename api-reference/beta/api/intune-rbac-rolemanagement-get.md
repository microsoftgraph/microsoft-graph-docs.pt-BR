...
Ler propriedades e relações do [objeto roleManagement.](../resources/intune-rbac-rolemanagement.md)
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto roleManagement](../resources/intune-rbac-rolemanagement.md) no corpo da resposta.
