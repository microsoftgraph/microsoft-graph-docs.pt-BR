...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` **[objeto yammerDeviceUsageDistributionUserCounts](../resources/yammerdeviceusagedistributionusercounts.md)** no corpo da resposta.
