...
ms.locfileid: "61424790"
---
# <a name="get-basetask"></a>Obter baseTask
...
Se tiver êxito, este método retornará um código `200 OK` de resposta e um objeto [baseTask](../resources/basetask.md) no corpo da resposta.
