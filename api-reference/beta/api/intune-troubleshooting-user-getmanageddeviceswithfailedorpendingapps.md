...
Recupera a lista de dispositivos com aplicativos com falha ou pendentes
...
Se tiver êxito, essa função retornará um código de resposta e uma `200 OK` [coleção managedDeviceSummarizedAppState](../resources/intune-troubleshooting-manageddevicesummarizedappstate.md) no corpo da resposta.
