...
Leia propriedades e relações do [objeto windowsCertificateProfileBase](../resources/intune-deviceconfig-windowscertificateprofilebase.md) .
...
Se tiver êxito, este método retornará um `200 OK` código de resposta e um [objeto windowsCertificateProfileBase](../resources/intune-deviceconfig-windowscertificateprofilebase.md) no corpo da resposta.
