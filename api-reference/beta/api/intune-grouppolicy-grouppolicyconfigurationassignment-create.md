...
No corpo da solicitação, fornece uma representação JSON do objeto groupPolicyConfigurationAssignment.
...
Se tiver êxito, este método retornará um código de resposta e um objeto `201 Created` [groupPolicyConfigurationAssignment](../resources/intune-grouppolicy-grouppolicyconfigurationassignment.md) no corpo da resposta.
