...
Leia propriedades e relações do [objeto importedDeviceIdentity.](../resources/intune-enrollment-importeddeviceidentity.md)
...
Se tiver êxito, este método retornará um código `200 OK` de resposta e um objeto [importedDeviceIdentity](../resources/intune-enrollment-importeddeviceidentity.md) no corpo da resposta.
