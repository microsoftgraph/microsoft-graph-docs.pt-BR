---
title: Atualizar zebraFotaDeployment
description: Atualize as propriedades de um objeto zebraFotaDeployment.
author: dougeby
...
ms.locfileid: "65213003"
---
# <a name="update-zebrafotadeployment"></a>Atualizar zebraFotaDeployment
...
Atualize as propriedades de um [objeto zebraFotaDeployment](../resources/intune-androidfotaservice-zebrafotadeployment.md) .
...
No corpo da solicitação, forneça uma representação JSON do objeto [zebraFotaDeployment](../resources/intune-androidfotaservice-zebrafotadeployment.md) .

A tabela a seguir mostra as propriedades que são necessárias ao criar [o zebraFotaDeployment](../resources/intune-androidfotaservice-zebrafotadeployment.md).
...
Se tiver êxito, este método retornará um código `200 OK` de resposta e um objeto [zebraFotaDeployment](../resources/intune-androidfotaservice-zebrafotadeployment.md) atualizado no corpo da resposta.
