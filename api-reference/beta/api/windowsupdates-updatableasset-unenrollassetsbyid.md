...
|ids|Coleção de cadeias de caracteres|Lista de identificadores correspondentes aos **recursos updatableAsset** a ser desempaculado do gerenciamento de atualizações pelo serviço para a **determinada updateCategory**.|
