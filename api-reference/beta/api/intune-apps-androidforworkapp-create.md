...
Crie um novo [objeto androidForWorkApp.](../resources/intune-apps-androidforworkapp.md)
...
A tabela a seguir mostra as propriedades que são necessárias ao criar o androidForWorkApp.
...
Se tiver êxito, este método retornará um código `201 Created` de resposta e um objeto [androidForWorkApp](../resources/intune-apps-androidforworkapp.md) no corpo da resposta.
