...
Criar um novo objeto [androidForWorkApp](../resources/intune-apps-androidforworkapp.md) .
...
No corpo da solicitação, forneça uma representação JSON do objeto androidForWorkApp.

A tabela a seguir mostra as propriedades que são necessárias ao criar androidForWorkApp.
