...
## <a name="http-request"></a><span data-ttu-id="ffccc-119">Solicitação HTTP</span><span class="sxs-lookup"><span data-stu-id="ffccc-119">HTTP Request</span></span>
<!-- {
  "blockType": "ignored"
}
-->
