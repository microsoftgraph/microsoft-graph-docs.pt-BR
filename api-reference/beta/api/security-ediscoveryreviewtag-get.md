...
Se bem-sucedido, este método retorna um código `200 OK` de resposta [e um objeto ediscoveryReviewTag](../resources/security-ediscoveryreviewtag.md) no corpo da resposta.
