...
No corpo da solicitação, fornece uma representação JSON do objeto androidDeviceOwnerEnrollmentProfile.
...
Se tiver êxito, este método retornará um código de resposta e um objeto `201 Created` [androidDeviceOwnerEnrollmentProfile](../resources/intune-androidforwork-androiddeviceownerenrollmentprofile.md) no corpo da resposta.
