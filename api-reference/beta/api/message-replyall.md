...
Como alternativa, [crie um rascunho para responder a tudo a uma mensagem](../api/message-createreplyall.md) e [envie-a](../api/message-send.md) mais tarde.
