...
Se tiver êxito, este método retornará um `200 OK` código de resposta [e um objeto ediscoveryReviewSetQuery](../resources/security-ediscoveryreviewsetquery.md) no corpo da resposta.
