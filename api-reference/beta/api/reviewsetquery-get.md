...
Recupere as propriedades e os relacionamentos de um objeto de [reviewSetQuery](../resources/reviewsetquery.md) de descoberta eletrônica.
...
Se tiver êxito, este método retornará um `200 OK` código de resposta e o objeto [reviewSetQuery](../resources/reviewsetquery.md) solicitado no corpo da resposta.
