...
Atualize as propriedades de [um objeto payloadCompatibleAssignmentFilter.](../resources/intune-policyset-payloadcompatibleassignmentfilter.md)
...
No corpo da solicitação, fornece uma representação JSON para o [objeto payloadCompatibleAssignmentFilter.](../resources/intune-policyset-payloadcompatibleassignmentfilter.md)

A tabela a seguir mostra as propriedades que são necessárias ao criar [o payloadCompatibleAssignmentFilter](../resources/intune-policyset-payloadcompatibleassignmentfilter.md).
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto payloadCompatibleAssignmentFilter](../resources/intune-policyset-payloadcompatibleassignmentfilter.md) atualizado no corpo da resposta.
