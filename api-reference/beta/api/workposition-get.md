...
Recupere as propriedades e as relações de um [objeto workPosition](../resources/workposition.md) no perfil de um [usuário.](../resources/profile.md)
...
Se tiver êxito, este método retornará um código `200 OK` de resposta e o objeto [workPosition](../resources/workposition.md) solicitado no corpo da resposta.
