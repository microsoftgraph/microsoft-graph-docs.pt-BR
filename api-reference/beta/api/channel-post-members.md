...
```
### <a name="example-6-add-a-user-who-is-part-of-the-same-or-a-different-tenant-as-a-member-to-a-shared-channel-using-user-principal-name"></a>Exemplo 6: Adicionar um usuário que faz parte do mesmo locatário ou de um locatário diferente de um membro a um canal compartilhado usando o nome principal do usuário
