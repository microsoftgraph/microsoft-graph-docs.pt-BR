...
Se tiver êxito, este método retornará um `200 OK` código de resposta e um [objeto customSecurityAttributeDefinition](../resources/customsecurityattributedefinition.md) no corpo da resposta.
