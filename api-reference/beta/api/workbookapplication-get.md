...
Recupere as propriedades e os relacionamentos do objeto workbookApplication.
...
Se bem-sucedido, este método retorna um `200 OK` código de resposta e um objeto [workbookApplication](../resources/workbookapplication.md) no corpo da resposta.
