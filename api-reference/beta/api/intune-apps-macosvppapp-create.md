...
Crie um novo [objeto macOsVppApp.](../resources/intune-apps-macosvppapp.md)
...
A tabela a seguir mostra as propriedades que são necessárias ao criar o macOsVppApp.
...
Se tiver êxito, este método retornará um código de resposta e um `201 Created` [objeto macOsVppApp](../resources/intune-apps-macosvppapp.md) no corpo da resposta.
