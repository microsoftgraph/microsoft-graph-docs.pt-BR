...
Recupere uma lista de objetos de [ispatente](../resources/itempatent.md) de um [perfil](../resources/profile.md)de usuário.
...
Se tiver êxito, este método retornará um `200 OK` código de resposta e uma coleção de objetos de [ispatente](../resources/itempatent.md) no corpo da resposta.
