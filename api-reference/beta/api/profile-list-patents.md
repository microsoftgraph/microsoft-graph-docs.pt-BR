...
description: Obter os itempatents da propriedade de navegação de patentes.
...
ms.locfileid: "62136957"
---
# <a name="list-patents"></a>Listar patentes

Namespace: microsoft.graph

Recuperar uma lista de [objetos itemPatent](../resources/itempatent.md) do perfil de um [usuário.](../resources/profile.md)
...
Se tiver êxito, este método retornará um código de resposta e uma `200 OK` coleção [de objetos itemPatent](../resources/itempatent.md) no corpo da resposta.
