...
Leia propriedades e relações do [objeto mobileAppRelationship.](../resources/intune-apps-mobileapprelationship.md)
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto mobileAppRelationship](../resources/intune-apps-mobileapprelationship.md) no corpo da resposta.
