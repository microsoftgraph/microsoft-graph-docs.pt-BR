...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto workbookTableSort](../resources/workbooktablesort.md) no corpo da resposta.
