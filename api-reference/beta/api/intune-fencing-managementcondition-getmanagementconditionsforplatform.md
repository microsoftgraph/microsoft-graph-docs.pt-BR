...
Se tiver êxito, essa função retornará um `200 OK` código de resposta e uma coleção [managementCondition](../resources/intune-fencing-managementcondition.md) no corpo da resposta.
