...
Se tiver êxito, essa função retornará um código de resposta e uma `200 OK` [coleção managementCondition](../resources/intune-fencing-managementcondition.md) no corpo da resposta.
