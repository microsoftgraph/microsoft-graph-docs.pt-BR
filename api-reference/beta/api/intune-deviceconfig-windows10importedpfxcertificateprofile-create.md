...
Crie um novo [objeto windows10ImportedPFXCertificateProfile.](../resources/intune-deviceconfig-windows10importedpfxcertificateprofile.md)
...
No corpo da solicitação, fornece uma representação JSON para o objeto windows10ImportedPFXCertificateProfile.

A tabela a seguir mostra as propriedades necessárias ao criar o windows10ImportedPFXCertificateProfile.
...
Se tiver êxito, este método retornará um código de resposta e um `201 Created` [objeto windows10ImportedPFXCertificateProfile](../resources/intune-deviceconfig-windows10importedpfxcertificateprofile.md) no corpo da resposta.
