...
Listar propriedades e relações dos [objetos macOSCertificateProfileBase.](../resources/intune-deviceconfig-macoscertificateprofilebase.md)
...
Se tiver êxito, este método retornará um código de resposta e uma `200 OK` coleção de [objetos macOSCertificateProfileBase](../resources/intune-deviceconfig-macoscertificateprofilebase.md) no corpo da resposta.
