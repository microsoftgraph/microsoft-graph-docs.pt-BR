...
Crie um novo objeto de [roleScopeTag](../resources/intune-rbac-rolescopetag.md) .
...
A tabela a seguir mostra as propriedades que são necessárias quando você cria o roleScopeTag.
