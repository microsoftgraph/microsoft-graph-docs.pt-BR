...
|killChain|Coleção de cadeias de caracteres|Uma matriz JSON de cadeias de caracteres que descreve o ponto ou os pontos na cadeia de Kill que este indicador aponta. Consulte "valores de killChain" abaixo para ver os valores exatos.|
...
|tlpLevel|string| Valor do protocolo de luz de tráfego para o indicador. Os valores possíveis são: `unknown`, `white`, `green`, `amber`, `red`.|
