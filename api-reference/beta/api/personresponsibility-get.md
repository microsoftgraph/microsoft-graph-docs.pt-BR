...
description: Leia as propriedades e as relações de um objeto personResponsibility.
...
Leia as propriedades e as relações de [um objeto personResponsibility](../resources/personresponsibility.md) no perfil de um [usuário.](../resources/profile.md)
...
Se tiver êxito, este método retornará um código `200 OK` de resposta e um objeto [personResponsibility](../resources/personresponsibility.md) no corpo da resposta.
