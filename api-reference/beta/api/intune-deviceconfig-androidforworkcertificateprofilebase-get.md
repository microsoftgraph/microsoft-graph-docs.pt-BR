...
Leia propriedades e relações do [objeto androidForWorkCertificateProfileBase.](../resources/intune-deviceconfig-androidforworkcertificateprofilebase.md)
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto androidForWorkCertificateProfileBase](../resources/intune-deviceconfig-androidforworkcertificateprofilebase.md) no corpo da resposta.
