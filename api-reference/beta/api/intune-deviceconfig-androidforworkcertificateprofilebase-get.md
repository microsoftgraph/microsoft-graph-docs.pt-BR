...
Leia as propriedades e os relacionamentos do objeto [androidForWorkCertificateProfileBase](../resources/intune-deviceconfig-androidforworkcertificateprofilebase.md) .
...
Se tiver êxito, este método retornará um `200 OK` objeto response de código e [androidForWorkCertificateProfileBase](../resources/intune-deviceconfig-androidforworkcertificateprofilebase.md) no corpo da resposta.
