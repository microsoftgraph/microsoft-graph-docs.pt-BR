...
---
# <a name="update-workbookchartaxis"></a>Atualizar a workbookChartAxis
...
Se tiver êxito, este método retornará um código de resposta e `200 OK` um objeto [workbookChartAxis](../resources/workbookchartaxis.md) atualizado no corpo da resposta.
