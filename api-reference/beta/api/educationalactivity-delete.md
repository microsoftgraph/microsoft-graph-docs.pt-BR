...
description: Exclua um objeto educationalActivity de um perfil de usuário.
...
Excluir um [objeto educationalActivity](../resources/educationalactivity.md) do perfil de um [usuário.](../resources/profile.md)
