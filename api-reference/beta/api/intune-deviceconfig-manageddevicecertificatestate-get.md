...
ms.locfileid: "34976474"
---
# <a name="get-manageddevicecertificatestate"></a><span data-ttu-id="e11cd-103">Obter managedDeviceCertificateState</span><span class="sxs-lookup"><span data-stu-id="e11cd-103">Get managedDeviceCertificateState</span></span>
...
<span data-ttu-id="e11cd-106">Leia as propriedades e as relações do objeto [managedDeviceCertificateState](../resources/intune-deviceconfig-manageddevicecertificatestate.md) .</span><span class="sxs-lookup"><span data-stu-id="e11cd-106">Read properties and relationships of the [managedDeviceCertificateState](../resources/intune-deviceconfig-manageddevicecertificatestate.md) object.</span></span>
...
|:---|:---|
|<span data-ttu-id="e11cd-112">Delegado (conta corporativa ou de estudante)</span><span class="sxs-lookup"><span data-stu-id="e11cd-112">Delegated (work or school account)</span></span>|<span data-ttu-id="e11cd-113">DeviceManagementConfiguration.ReadWrite.All, DeviceManagementConfiguration.Read.All</span><span class="sxs-lookup"><span data-stu-id="e11cd-113">DeviceManagementConfiguration.ReadWrite.All, DeviceManagementConfiguration.Read.All</span></span>|
...
## <a name="optional-query-parameters"></a><span data-ttu-id="e11cd-119">Parâmetros de consulta opcionais</span><span class="sxs-lookup"><span data-stu-id="e11cd-119">Optional query parameters</span></span>
<span data-ttu-id="e11cd-120">Este método dá suporte a [Parâmetros de consulta OData](https://docs.microsoft.com/en-us/graph/query-parameters) para ajudar a personalizar a resposta.</span><span class="sxs-lookup"><span data-stu-id="e11cd-120">This method supports the [OData Query Parameters](https://docs.microsoft.com/en-us/graph/query-parameters) to help customize the response.</span></span>

## <a name="request-headers"></a><span data-ttu-id="e11cd-121">Cabeçalhos de solicitação</span><span class="sxs-lookup"><span data-stu-id="e11cd-121">Request headers</span></span>
|<span data-ttu-id="e11cd-122">Cabeçalho</span><span class="sxs-lookup"><span data-stu-id="e11cd-122">Header</span></span>|<span data-ttu-id="e11cd-123">Valor</span><span class="sxs-lookup"><span data-stu-id="e11cd-123">Value</span></span>|
|:---|:---|
|<span data-ttu-id="e11cd-124">Autorização</span><span class="sxs-lookup"><span data-stu-id="e11cd-124">Authorization</span></span>|<span data-ttu-id="e11cd-125">&lt;Token&gt; de portador obrigatório.</span><span class="sxs-lookup"><span data-stu-id="e11cd-125">Bearer &lt;token&gt; Required.</span></span>|
|<span data-ttu-id="e11cd-126">Aceitar</span><span class="sxs-lookup"><span data-stu-id="e11cd-126">Accept</span></span>|<span data-ttu-id="e11cd-127">application/json</span><span class="sxs-lookup"><span data-stu-id="e11cd-127">application/json</span></span>|

## <a name="request-body"></a><span data-ttu-id="e11cd-128">Corpo da solicitação</span><span class="sxs-lookup"><span data-stu-id="e11cd-128">Request body</span></span>
<span data-ttu-id="e11cd-129">Não forneça um corpo de solicitação para esse método.</span><span class="sxs-lookup"><span data-stu-id="e11cd-129">Do not supply a request body for this method.</span></span>

## <a name="response"></a><span data-ttu-id="e11cd-130">Resposta</span><span class="sxs-lookup"><span data-stu-id="e11cd-130">Response</span></span>
<span data-ttu-id="e11cd-131">Se bem-sucedido, este método retorna um `200 OK` código de resposta e um objeto [managedDeviceCertificateState](../resources/intune-deviceconfig-manageddevicecertificatestate.md) no corpo da resposta.</span><span class="sxs-lookup"><span data-stu-id="e11cd-131">If successful, this method returns a `200 OK` response code and [managedDeviceCertificateState](../resources/intune-deviceconfig-manageddevicecertificatestate.md) object in the response body.</span></span>

## <a name="example"></a><span data-ttu-id="e11cd-132">Exemplo</span><span class="sxs-lookup"><span data-stu-id="e11cd-132">Example</span></span>

### <a name="request"></a><span data-ttu-id="e11cd-133">Solicitação</span><span class="sxs-lookup"><span data-stu-id="e11cd-133">Request</span></span>
<span data-ttu-id="e11cd-134">Este é um exemplo da solicitação.</span><span class="sxs-lookup"><span data-stu-id="e11cd-134">Here is an example of the request.</span></span>
``` http
...
### <a name="response"></a><span data-ttu-id="e11cd-135">Resposta</span><span class="sxs-lookup"><span data-stu-id="e11cd-135">Response</span></span>
