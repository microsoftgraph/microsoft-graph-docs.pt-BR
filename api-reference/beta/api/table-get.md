...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto workbookTable](../resources/workbooktable.md) no corpo da resposta.
