...
Ao usar o formato JSON, você pode incluir um [anexo](../resources/attachment.md) e [](../resources/mention.md) usar uma menção para chamar outro usuário na nova mensagem.
