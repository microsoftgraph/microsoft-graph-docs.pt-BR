...
Se tiver êxito, este método retornará `200 OK` um código de resposta e o objeto [projectParticipation](../resources/projectparticipation.md) solicitado no corpo da resposta.
