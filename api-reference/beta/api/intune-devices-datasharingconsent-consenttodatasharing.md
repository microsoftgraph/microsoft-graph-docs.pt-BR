...
Se tiver êxito, essa ação retornará um `200 OK` código de resposta e um [dataSharingConsent](../resources/intune-devices-datasharingconsent.md) no corpo da resposta.
