...
Se tiver êxito, essa ação retornará um código de resposta e um `200 OK` [dataSharingConsent](../resources/intune-devices-datasharingconsent.md) no corpo da resposta.
