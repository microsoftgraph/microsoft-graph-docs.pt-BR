...
---
# <a name="consenttodatasharing-action"></a><span data-ttu-id="4e2c8-103">Ação consentToDataSharing</span><span class="sxs-lookup"><span data-stu-id="4e2c8-103">consentToDataSharing action</span></span>
...
<span data-ttu-id="4e2c8-107">Ainda não documentado</span><span class="sxs-lookup"><span data-stu-id="4e2c8-107">Not yet documented</span></span>
...
|:---|:---|
|<span data-ttu-id="4e2c8-113">Delegado (conta corporativa ou de estudante)</span><span class="sxs-lookup"><span data-stu-id="4e2c8-113">Delegated (work or school account)</span></span>|<span data-ttu-id="4e2c8-114">DeviceManagementServiceConfig.ReadWrite.All</span><span class="sxs-lookup"><span data-stu-id="4e2c8-114">DeviceManagementServiceConfig.ReadWrite.All</span></span>|
...
|<span data-ttu-id="4e2c8-117">Aplicativo</span><span class="sxs-lookup"><span data-stu-id="4e2c8-117">Application</span></span>|<span data-ttu-id="4e2c8-118">DeviceManagementServiceConfig.ReadWrite.All</span><span class="sxs-lookup"><span data-stu-id="4e2c8-118">DeviceManagementServiceConfig.ReadWrite.All</span></span>|
...
<span data-ttu-id="4e2c8-130">Se tiver êxito, esta ação retornará `200 OK` um código de resposta e um [dataSharingConsent](../resources/intune-devices-datasharingconsent.md) no corpo da resposta.</span><span class="sxs-lookup"><span data-stu-id="4e2c8-130">If successful, this action returns a `200 OK` response code and a [dataSharingConsent](../resources/intune-devices-datasharingconsent.md) in the response body.</span></span>
