...
Obter as propriedades e as relações do grupo de tarefas Outlook especificado.
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto outlookTaskGroup](../resources/outlooktaskgroup.md) no corpo da resposta.
