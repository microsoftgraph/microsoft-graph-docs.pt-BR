...
Se bem-sucedido, este método retorna um código de resposta e um objeto `200 OK` **[teamsUserActivityCounts](../resources/teamsuseractivitycounts.md)** no corpo da resposta.
