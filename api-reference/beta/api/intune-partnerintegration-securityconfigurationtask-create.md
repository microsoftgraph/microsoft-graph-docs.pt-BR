...
Criar um novo objeto [securityConfigurationTask](../resources/intune-partnerintegration-securityconfigurationtask.md) .
...
No corpo da solicitação, forneça uma representação JSON do objeto securityConfigurationTask.

A tabela a seguir mostra as propriedades que são necessárias ao criar securityConfigurationTask.
...
|assignedTo|Cadeia de caracteres|O nome ou email do administrador ao qual esta tarefa é atribuída. Herdado de [deviceAppManagementTask](../resources/intune-partnerintegration-deviceappmanagementtask.md)|
...
Se tiver êxito, este método retornará um `201 Created` código de resposta e um objeto [securityConfigurationTask](../resources/intune-partnerintegration-securityconfigurationtask.md) no corpo da resposta.
