...
Crie um novo [objeto securityConfigurationTask.](../resources/intune-partnerintegration-securityconfigurationtask.md)
...
No corpo da solicitação, fornece uma representação JSON para o objeto securityConfigurationTask.

A tabela a seguir mostra as propriedades que são necessárias ao criar o securityConfigurationTask.
...
Se tiver êxito, este método retornará um código `201 Created` de resposta e um objeto [securityConfigurationTask](../resources/intune-partnerintegration-securityconfigurationtask.md) no corpo da resposta.
