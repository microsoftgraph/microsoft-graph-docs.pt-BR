...
Se bem-sucedido, este método retorna um código de resposta e uma coleção de `200 OK` [objetos iosikEv2VpnConfiguration](../resources/intune-deviceconfig-iosikev2vpnconfiguration.md) no corpo da resposta.
