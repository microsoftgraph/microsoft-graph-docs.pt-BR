...
Crie um novo [objeto macOSScepCertificateProfile.](../resources/intune-deviceconfig-macosscepcertificateprofile.md)
...
A tabela a seguir mostra as propriedades que são necessárias ao criar o macOSScepCertificateProfile.
...
Se tiver êxito, este método retornará um código de resposta e um `201 Created` [objeto macOSScepCertificateProfile](../resources/intune-deviceconfig-macosscepcertificateprofile.md) no corpo da resposta.
