...
Se tiver êxito, essa função retornará um código de resposta e um `200 OK` [comanagedDevicesSummary](../resources/intune-devices-comanageddevicessummary.md) no corpo da resposta.
