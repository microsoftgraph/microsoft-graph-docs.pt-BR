...
Se tiver êxito, este método retornará `200 OK` um código de resposta e o objeto [personInterest](../resources/personinterest.md) solicitado no corpo da resposta.
