...
Se tiver êxito, este método retornará um código `200 OK` de resposta [e um objeto windowsUpdateState](../resources/intune-shared-windowsupdatestate.md) no corpo da resposta.
