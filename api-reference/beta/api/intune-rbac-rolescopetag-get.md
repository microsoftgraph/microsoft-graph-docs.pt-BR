...
Leia as propriedades e os relacionamentos do objeto [roleScopeTag](../resources/intune-rbac-rolescopetag.md) .
...
Se tiver êxito, este método retornará um `200 OK` objeto response de código e [roleScopeTag](../resources/intune-rbac-rolescopetag.md) no corpo da resposta.
