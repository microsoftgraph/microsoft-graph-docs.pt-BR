...
ms.locfileid: "60489322"
---
# <a name="create-mobileapppolicysetitem"></a>Criar mobileAppPolicySetItem
...
Crie um novo [objeto mobileAppPolicySetItem.](../resources/intune-policyset-mobileapppolicysetitem.md)
...
No corpo da solicitação, fornece uma representação JSON para o objeto mobileAppPolicySetItem.

A tabela a seguir mostra as propriedades que são necessárias ao criar o mobileAppPolicySetItem.
...
Se tiver êxito, este método retornará um código de resposta e um `201 Created` [objeto mobileAppPolicySetItem](../resources/intune-policyset-mobileapppolicysetitem.md) no corpo da resposta.
