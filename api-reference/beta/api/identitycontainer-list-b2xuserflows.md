...
Se tiver êxito, este método retornará um `200 OK` código de resposta e uma coleção de objetos [b2xIdentityUserFlow](../resources/b2xidentityuserflow.md) no corpo da resposta.
