...
Recupere uma lista de [objetos personName](../resources/personname.md) do perfil de um [usuário.](../resources/profile.md)
...
Se tiver êxito, este método retornará um código de resposta e uma `200 OK` coleção de [objetos personName](../resources/personname.md) no corpo da resposta.
