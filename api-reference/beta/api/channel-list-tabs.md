...
### <a name="example-2-list-all-the-tabs-belonging-to-a-specific-app-in-a-channel"></a>Exemplo 2: listar todas as guias pertencentes a um aplicativo específico em um canal
#### <a name="request"></a>Solicitação
Este é um exemplo de solicitação.
