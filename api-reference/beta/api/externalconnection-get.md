...
Se tiver êxito, este método retornará um `200 OK` código de resposta e o objeto [externalConnection](../resources/externalconnection.md) solicitado no corpo da resposta.
