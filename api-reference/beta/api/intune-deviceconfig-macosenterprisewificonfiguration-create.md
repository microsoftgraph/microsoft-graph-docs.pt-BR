...
## <a name="http-request"></a><span data-ttu-id="cdca9-119">Solicitação HTTP</span><span class="sxs-lookup"><span data-stu-id="cdca9-119">HTTP Request</span></span>
<!-- {
  "blockType": "ignored"
}
-->
