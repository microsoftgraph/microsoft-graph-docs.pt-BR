...
Exclua um objeto de termos de pagamento do Dynamics 365 Business Central.
...
|If-Match       |Obrigatório. Quando esse header de solicitação for incluído e a eTag fornecida não corresponder à marca atual nos **paymentTerms,** os **paymentTerms** não serão atualizados. |
