...
Leia as propriedades e os relacionamentos do objeto [deviceConfigurationUserStateSummary](../resources/intune-deviceconfig-deviceconfigurationuserstatesummary.md) .
...
Se tiver êxito, este método retornará um `200 OK` objeto response de código e [deviceConfigurationUserStateSummary](../resources/intune-deviceconfig-deviceconfigurationuserstatesummary.md) no corpo da resposta.
