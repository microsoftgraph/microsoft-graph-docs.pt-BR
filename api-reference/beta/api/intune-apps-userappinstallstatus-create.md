...
Crie um novo objeto de [userAppInstallStatus](../resources/intune-apps-userappinstallstatus.md) .
...
A tabela a seguir mostra as propriedades que são necessárias quando você cria o userAppInstallStatus.
