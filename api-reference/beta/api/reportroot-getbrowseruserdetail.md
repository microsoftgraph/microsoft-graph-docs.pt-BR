...
description: Obter um relatório que fornece os navegadores (Microsoft Edge, Versão Prévia do Microsoft Edge e Internet Explorer) usados pelos usuários quando acessam os serviços de Microsoft 365 em um período selecionado.
...
Obter um relatório que fornece os navegadores (Microsoft Edge, Versão Prévia do Microsoft Edge e Internet Explorer) usados pelos usuários quando acessam os serviços de Microsoft 365 em um período selecionado.
