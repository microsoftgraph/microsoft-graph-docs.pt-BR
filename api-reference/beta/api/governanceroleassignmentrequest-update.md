...
|:-------------|:----------------------|:--------|:----------|
|Reason        |String                 |✓        |O motivo fornecido pelo administrador para a sua decisão.|
...
|Schedule      |[governanceSchedule](../resources/governanceschedule.md)|        | O agendamento da solicitação de atribuição de função. Status da `AdminApproved`, é necessário.|
