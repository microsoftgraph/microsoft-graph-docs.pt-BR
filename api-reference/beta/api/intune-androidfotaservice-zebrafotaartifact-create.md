---
title: Criar zebraFotaArtifact
description: Crie um novo objeto zebraFotaArtifact.
author: dougeby
...
ms.locfileid: "65212949"
---
# <a name="create-zebrafotaartifact"></a>Criar zebraFotaArtifact
...
Crie um novo [objeto zebraFotaArtifact](../resources/intune-androidfotaservice-zebrafotaartifact.md) .
...
No corpo da solicitação, forneça uma representação JSON do objeto zebraFotaArtifact.

A tabela a seguir mostra as propriedades que são necessárias ao criar o zebraFotaArtifact.
...
Se tiver êxito, este método retornará um código `201 Created` de resposta e um [objeto zebraFotaArtifact](../resources/intune-androidfotaservice-zebrafotaartifact.md) no corpo da resposta.
