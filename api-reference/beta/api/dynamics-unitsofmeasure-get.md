...
Recupere as propriedades e as relações de um objeto measure para o Dynamics 365 Business Central.
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` **objeto unitsOfMeasure** no corpo da resposta.
