...
Atualizar as propriedades de um [objeto roleScopeTagAutoAssignment.](../resources/intune-rbac-rolescopetagautoassignment.md)
...
No corpo da solicitação, fornece uma representação JSON do [objeto roleScopeTagAutoAssignment.](../resources/intune-rbac-rolescopetagautoassignment.md)
...
Se tiver êxito, este método retornará um código de resposta e um objeto `200 OK` [roleScopeTagAutoAssignment](../resources/intune-rbac-rolescopetagautoassignment.md) atualizado no corpo da resposta.
