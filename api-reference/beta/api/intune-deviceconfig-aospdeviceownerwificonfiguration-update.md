---
title: Atualizar aospDeviceOwnerWiFiConfiguration
description: Atualize as propriedades de um objeto aospDeviceOwnerWiFiConfiguration.
author: dougeby
...
ms.locfileid: "64630988"
---
# <a name="update-aospdeviceownerwificonfiguration"></a>Atualizar aospDeviceOwnerWiFiConfiguration
...
Atualize as propriedades de um [objeto aospDeviceOwnerWiFiConfiguration](../resources/intune-deviceconfig-aospdeviceownerwificonfiguration.md) .
...
No corpo da solicitação, fornece uma representação JSON para o [objeto aospDeviceOwnerWiFiConfiguration](../resources/intune-deviceconfig-aospdeviceownerwificonfiguration.md) .

A tabela a seguir mostra as propriedades que são necessárias ao criar [o aospDeviceOwnerWiFiConfiguration](../resources/intune-deviceconfig-aospdeviceownerwificonfiguration.md).
...
Se tiver êxito, este método retornará `200 OK` um código de resposta e um [objeto aospDeviceOwnerWiFiConfiguration](../resources/intune-deviceconfig-aospdeviceownerwificonfiguration.md) atualizado no corpo da resposta.
