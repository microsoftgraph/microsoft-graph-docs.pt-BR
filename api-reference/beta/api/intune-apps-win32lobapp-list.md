...
Se bem-sucedido, este método retorna um código de resposta e uma coleção de `200 OK` [objetos win32LobApp](../resources/intune-apps-win32lobapp.md) no corpo da resposta.
