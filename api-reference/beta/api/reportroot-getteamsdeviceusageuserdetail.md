...
Se bem-sucedido, este método retorna um código de resposta e um objeto `200 OK` **[teamsDeviceUsageUserDetail](../resources/teamsdeviceusageuserdetail.md)** no corpo da resposta.
