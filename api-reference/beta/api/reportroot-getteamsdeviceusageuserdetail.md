...
- Usou Windows
- Usado o sistema operacional Chrome
- Linux usado
- É Licenciado
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` **[objeto teamsDeviceUsageUserDetail](../resources/teamsdeviceusageuserdetail.md)** no corpo da resposta.
