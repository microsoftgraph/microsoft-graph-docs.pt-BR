...
### <a name="example-3-list-all-the-chats-that-have-a-member-with-a-specific-display-name"></a>Exemplo 3: listar todos os chats que têm um membro com um nome de exibição específico
