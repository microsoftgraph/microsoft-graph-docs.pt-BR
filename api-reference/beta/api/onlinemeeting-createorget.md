...
## <a name="http-request"></a><span data-ttu-id="37adb-120">Solicitação HTTP</span><span class="sxs-lookup"><span data-stu-id="37adb-120">HTTP request</span></span>
<!-- { "blockType": "ignored" } -->
```http
