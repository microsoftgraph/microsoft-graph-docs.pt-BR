...
Atualiza as propriedades de um objeto [macOSMdatpApp](../resources/intune-apps-macosmdatpapp.md) .
...
No corpo da solicitação, forneça uma representação JSON do objeto [macOSMdatpApp](../resources/intune-apps-macosmdatpapp.md) .

A tabela a seguir mostra as propriedades que são necessárias ao criar [macOSMdatpApp](../resources/intune-apps-macosmdatpapp.md).
...
Se tiver êxito, este método retornará um `200 OK` código de resposta e um objeto [macOSMdatpApp](../resources/intune-apps-macosmdatpapp.md) atualizado no corpo da resposta.
