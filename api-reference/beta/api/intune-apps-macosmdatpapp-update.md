...
Atualize as propriedades de um [objeto macOSMdatpApp.](../resources/intune-apps-macosmdatpapp.md)
...
No corpo da solicitação, fornece uma representação JSON para o [objeto macOSMdatpApp.](../resources/intune-apps-macosmdatpapp.md)

A tabela a seguir mostra as propriedades que são necessárias ao criar [o macOSMdatpApp](../resources/intune-apps-macosmdatpapp.md).
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto macOSMdatpApp](../resources/intune-apps-macosmdatpapp.md) atualizado no corpo da resposta.
