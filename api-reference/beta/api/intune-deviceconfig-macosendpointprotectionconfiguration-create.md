...
|advancedThreatProtectionRealTime|[enablement](../resources/intune-shared-enablement.md)|Determina se a proteção em tempo real do Microsoft Defender for Endpoint (anteriormente Microsoft Defender ATP) no macOS é habilitada ou não. Os valores possíveis são: `notConfigured`, `enabled`, `disabled`.|
