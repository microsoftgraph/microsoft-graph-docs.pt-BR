...
Se tiver êxito, este método retornará `200 OK` um código de resposta e uma coleção de objetos [educationOutcome](../resources/educationoutcome.md) no corpo da resposta.
