...
Use essa API para criar uma nova TableColumn.
...
Se tiver êxito, este método retornará o código de resposta e o objeto `201 Created` [workbookTableColumn](../resources/workbooktablecolumn.md) no corpo da resposta.
