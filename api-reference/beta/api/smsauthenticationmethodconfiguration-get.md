...
Se tiver êxito, este método retornará um `200 OK` código de resposta e um [objeto smsAuthenticationMethodConfiguration](../resources/smsauthenticationmethodconfiguration.md) no corpo da resposta.
