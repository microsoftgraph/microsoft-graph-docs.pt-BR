...
Atualize as propriedades de [um objeto projectParticipation](../resources/projectParticipation.md) no perfil de um [usuário.](../resources/profile.md)
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto projectParticipation](../resources/projectparticipation.md) atualizado no corpo da resposta.
