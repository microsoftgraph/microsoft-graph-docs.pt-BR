---
title: Listar oemWarrantyInformationOnboardings
description: Listar propriedades e relações dos objetos oemWarrantyInformationOnboarding.
author: dougeby
...
ms.locfileid: "62290200"
---
# <a name="list-oemwarrantyinformationonboardings"></a>Listar oemWarrantyInformationOnboardings
...
Listar propriedades e relações dos [objetos oemWarrantyInformationOnboarding](../resources/intune-devices-oemwarrantyinformationonboarding.md) .
...
Se tiver êxito, este método retornará `200 OK` um código de resposta e uma coleção de [objetos oemWarrantyInformationOnboarding](../resources/intune-devices-oemwarrantyinformationonboarding.md) no corpo da resposta.
