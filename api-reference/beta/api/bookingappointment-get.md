...
Obtenha as propriedades e relacionamentos de um objeto [bookingAppointment](../resources/bookingappointment.md) no especificado [bookingbusiness](../resources/bookingbusiness.md).

As propriedades **start** e **end** sempre são retornadas em UTC.
...
Se tiver êxito, este método retornará um `200 OK` objeto response de código e [bookingAppointment](../resources/bookingappointment.md) no corpo da resposta.
