---
title: Atualizar deviceManagementConfigurationPolicyPolicySetItem
description: Atualize as propriedades de um objeto deviceManagementConfigurationPolicyPolicySetItem.
author: dougeby
...
ms.locfileid: "60494014"
---
# <a name="update-devicemanagementconfigurationpolicypolicysetitem"></a>Atualizar deviceManagementConfigurationPolicyPolicySetItem
...
Atualize as propriedades de [um objeto deviceManagementConfigurationPolicyPolicySetItem.](../resources/intune-policyset-devicemanagementconfigurationpolicypolicysetitem.md)
...
No corpo da solicitação, fornece uma representação JSON para o [objeto deviceManagementConfigurationPolicyPolicySetItem.](../resources/intune-policyset-devicemanagementconfigurationpolicypolicysetitem.md)

A tabela a seguir mostra as propriedades que são necessárias ao criar [deviceManagementConfigurationPolicyPolicySetItem](../resources/intune-policyset-devicemanagementconfigurationpolicypolicysetitem.md).
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto deviceManagementConfigurationPolicyPolicySetItem](../resources/intune-policyset-devicemanagementconfigurationpolicypolicysetitem.md) atualizado no corpo da resposta.
