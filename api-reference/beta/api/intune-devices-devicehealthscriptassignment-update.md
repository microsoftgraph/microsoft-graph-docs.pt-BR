...
Atualizar as propriedades de um [objeto deviceHealthScriptAssignment.](../resources/intune-devices-devicehealthscriptassignment.md)
...
No corpo da solicitação, fornece uma representação JSON do [objeto deviceHealthScriptAssignment.](../resources/intune-devices-devicehealthscriptassignment.md)
...
Se bem-sucedido, este método retorna um código de resposta e um objeto `200 OK` [deviceHealthScriptAssignment](../resources/intune-devices-devicehealthscriptassignment.md) atualizado no corpo da resposta.
