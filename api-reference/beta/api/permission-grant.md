...
Se o link for [um link de acesso](../resources/permission.md#existing-access-link) existente, permissões adicionais serão retornadas representando o seguinte:
