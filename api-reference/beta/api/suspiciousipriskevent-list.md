...
---
# <a name="list-suspiciousipriskevents"></a>Lista suspiciousIpRiskEvents
...
Se tiver êxito, este método retornará um `200 OK` código de resposta e a coleção de objetos [suspiciousIpRiskEvent](../resources/suspiciousipriskevent.md) no corpo da resposta.
