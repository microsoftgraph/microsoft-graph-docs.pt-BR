---
title: Criar aospDeviceOwnerPkcsCertificateProfile
description: Crie um novo objeto aospDeviceOwnerPkcsCertificateProfile.
author: dougeby
...
---
# <a name="create-aospdeviceownerpkcscertificateprofile"></a>Criar aospDeviceOwnerPkcsCertificateProfile
...
Crie um novo [objeto aospDeviceOwnerPkcsCertificateProfile](../resources/intune-deviceconfig-aospdeviceownerpkcscertificateprofile.md) .
...
No corpo da solicitação, fornece uma representação JSON para o objeto aospDeviceOwnerPkcsCertificateProfile.

A tabela a seguir mostra as propriedades que são necessárias ao criar o aospDeviceOwnerPkcsCertificateProfile.
...
Se tiver êxito, este método retornará `201 Created` um código de resposta e um [objeto aospDeviceOwnerPkcsCertificateProfile](../resources/intune-deviceconfig-aospdeviceownerpkcscertificateprofile.md) no corpo da resposta.
