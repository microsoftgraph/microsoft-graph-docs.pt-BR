...
No corpo da solicitação, fornece uma representação JSON do objeto windowsManagedDevice.
...
Se bem-sucedido, este método retorna um código de resposta e um objeto `201 Created` [windowsManagedDevice](../resources/intune-devices-windowsmanageddevice.md) no corpo da resposta.
