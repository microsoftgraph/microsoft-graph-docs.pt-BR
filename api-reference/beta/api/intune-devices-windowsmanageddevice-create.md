...
Crie um novo objeto de [windowsManagedDevice](../resources/intune-devices-windowsmanageddevice.md) .
...
A tabela a seguir mostra as propriedades que são necessárias quando você cria o windowsManagedDevice.
