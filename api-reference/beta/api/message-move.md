...
Mover uma mensagem para outra pasta dentro da caixa de correio do usuário especificado. Isso cria uma nova cópia da mensagem na pasta de destino e remove a mensagem original.
