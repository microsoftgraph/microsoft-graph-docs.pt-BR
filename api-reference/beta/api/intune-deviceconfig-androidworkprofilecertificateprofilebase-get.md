...
Leia propriedades e relações do [objeto androidWorkProfileCertificateProfileBase.](../resources/intune-deviceconfig-androidworkprofilecertificateprofilebase.md)
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto androidWorkProfileCertificateProfileBase](../resources/intune-deviceconfig-androidworkprofilecertificateprofilebase.md) no corpo da resposta.
