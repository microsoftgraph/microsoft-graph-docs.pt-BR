...
ms.locfileid: "59018758"
---
# <a name="list-windowsmicrosoftedgeapps"></a>Listar windowsMicrosoftEdgeApps
...
Listar propriedades e relações dos [objetos windowsMicrosoftEdgeApp.](../resources/intune-apps-windowsmicrosoftedgeapp.md)
...
Se tiver êxito, este método retornará um código de resposta e uma coleção de objetos `200 OK` [windowsMicrosoftEdgeApp](../resources/intune-apps-windowsmicrosoftedgeapp.md) no corpo da resposta.
