...
Criar um novo objeto [cloudPcOnPremisesConnection](../resources/cloudpconpremisesconnection.md) para provisionar PCs em nuvem.
...
**Observação:** Veja um exemplo da resposta. O objeto de resposta mostrado aqui pode estar truncado por brevidade. Todas as propriedades serão retornadas de uma chamada real.
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "microsoft.graph.cloudPcOnPremisesConnection"
