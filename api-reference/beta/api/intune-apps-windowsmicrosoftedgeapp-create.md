...
---
# <a name="create-windowsmicrosoftedgeapp"></a>Criar windowsMicrosoftEdgeApp
...
Crie um novo [objeto windowsMicrosoftEdgeApp.](../resources/intune-apps-windowsmicrosoftedgeapp.md)
...
No corpo da solicitação, fornece uma representação JSON para o objeto windowsMicrosoftEdgeApp.

A tabela a seguir mostra as propriedades necessárias ao criar o windowsMicrosoftEdgeApp.
...
Se tiver êxito, este método retornará um código de resposta e um `201 Created` [objeto windowsMicrosoftEdgeApp](../resources/intune-apps-windowsmicrosoftedgeapp.md) no corpo da resposta.
