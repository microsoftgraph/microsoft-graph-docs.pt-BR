...
Recupere as propriedades de um objeto connectorGroup.
...
Se tiver êxito, este método retornará um `200 OK` objeto response de código e [connectorGroup](../resources/connectorgroup.md) no corpo da resposta.
