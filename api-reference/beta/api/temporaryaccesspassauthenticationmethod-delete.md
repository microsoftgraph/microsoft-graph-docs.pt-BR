...
Embora a passagem de acesso temporário atual do usuário seja válida, ela precisa ser excluída antes que um novo Acesso Temporário possa ser criado no usuário.
