...
Recupere as propriedades e os relacionamentos de um objeto [ediscoveryCase](../resources/ediscoverycase.md) .
...
Se tiver êxito, este método retornará um `200 OK` código de resposta e o objeto [ediscoveryCase](../resources/ediscoverycase.md) solicitado no corpo da resposta.
