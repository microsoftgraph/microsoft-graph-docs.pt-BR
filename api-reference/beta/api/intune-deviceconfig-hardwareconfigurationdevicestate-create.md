...
Se tiver êxito, este método retornará um `201 Created` código de resposta e um [objeto hardwareConfigurationDeviceState](../resources/intune-deviceconfig-hardwareconfigurationdevicestate.md) no corpo da resposta.
