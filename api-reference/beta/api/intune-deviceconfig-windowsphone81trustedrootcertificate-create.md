...
Crie um novo [objeto windowsPhone81TrustedRootCertificate.](../resources/intune-deviceconfig-windowsphone81trustedrootcertificate.md)
...
No corpo da solicitação, fornece uma representação JSON para o objeto windowsPhone81TrustedRootCertificate.

A tabela a seguir mostra as propriedades necessárias ao criar o windowsPhone81TrustedRootCertificate.
...
Se tiver êxito, este método retornará um código de resposta e um `201 Created` [objeto windowsPhone81TrustedRootCertificate](../resources/intune-deviceconfig-windowsphone81trustedrootcertificate.md) no corpo da resposta.
