---
title: Atualizar windowsWebApp
description: Atualize as propriedades de um objeto windowsWebApp.
author: dougeby
...
ms.locfileid: "65858492"
---
# <a name="update-windowswebapp"></a>Atualizar windowsWebApp
...
Atualize as propriedades de um [objeto windowsWebApp](../resources/intune-apps-windowswebapp.md) .
...
No corpo da solicitação, forneça uma representação JSON do [objeto windowsWebApp](../resources/intune-apps-windowswebapp.md) .

A tabela a seguir mostra as propriedades que são necessárias ao criar [o windowsWebApp](../resources/intune-apps-windowswebapp.md).
...
Se bem-sucedido, este método retorna um código `200 OK` de resposta e um objeto [windowsWebApp](../resources/intune-apps-windowswebapp.md) atualizado no corpo da resposta.
