...
|:--------------------------------------|:---------------------------------------------------------|
|Delegado (conta corporativa ou de estudante)     | AccessReview. ReadWrite. All, e também deve ter ProgramControl. ReadWrite. All para concluir o cenário com uma chamada para excluir um programControl |
