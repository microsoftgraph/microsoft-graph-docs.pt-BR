...
Adicione uma credencial de chave a um [aplicativo](../resources/application.md). Esse método, junto com o [RemoveKey](application-removekey.md), pode ser usado por um aplicativo para automatizar as chaves de expiração.

> [!NOTE]
> Você pode continuar a usar as operações [criar aplicativo](../api/application-post-applications.md) e [Atualizar](../api/application-update.md) aplicativo de aplicativo para adicionar e atualizar as principais credenciais de qualquer aplicativo com ou sem o contexto de um usuário. 
