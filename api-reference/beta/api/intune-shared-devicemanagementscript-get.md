...
description: Ler propriedades e relações do objeto deviceManagementScript.
author: dougeby
...
Ler propriedades e relações do [objeto deviceManagementScript](../resources/intune-shared-devicemanagementscript.md) .
...
Se tiver êxito, este método retornará um código `200 OK` de resposta e um [objeto deviceManagementScript](../resources/intune-shared-devicemanagementscript.md) no corpo da resposta.
