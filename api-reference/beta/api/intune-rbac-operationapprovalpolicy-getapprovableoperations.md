---
title: Função getApprovableOperations
...
ms.locfileid: "65212947"
---
# <a name="getapprovableoperations-function"></a>Função getApprovableOperations
...
Se tiver êxito, essa função retornará um `200 OK` código de resposta e uma [coleção operationApprovalPolicySet](../resources/intune-rbac-operationapprovalpolicyset.md) no corpo da resposta.
