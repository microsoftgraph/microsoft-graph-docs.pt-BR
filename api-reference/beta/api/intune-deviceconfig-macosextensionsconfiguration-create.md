...
Criar um novo objeto [macOSExtensionsConfiguration](../resources/intune-deviceconfig-macosextensionsconfiguration.md) .
...
No corpo da solicitação, forneça uma representação JSON do objeto macOSExtensionsConfiguration.

A tabela a seguir mostra as propriedades que são necessárias ao criar macOSExtensionsConfiguration.
...
|kernelExtensionAllowedTeamIdentifiers|String collection|Todas as extensões de kernel assinadas com validade pelos identificadores de equipe nesta lista poderão ser carregadas.|
...
Se tiver êxito, este método retornará `201 Created` um código de resposta e um objeto [macOSExtensionsConfiguration](../resources/intune-deviceconfig-macosextensionsconfiguration.md) no corpo da resposta.
