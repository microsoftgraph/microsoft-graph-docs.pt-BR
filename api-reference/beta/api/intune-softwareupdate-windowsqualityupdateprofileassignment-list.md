...
Se bem-sucedido, este método retorna um código de resposta e uma coleção de `200 OK` [objetos windowsQualityUpdateProfileAssignment](../resources/intune-softwareupdate-windowsqualityupdateprofileassignment.md) no corpo da resposta.
