...
Crie um novo objeto de [androidDeviceOwnerWiFiConfiguration](../resources/intune-deviceconfig-androiddeviceownerwificonfiguration.md) .
...
A tabela a seguir mostra as propriedades que são necessárias quando você cria o androidDeviceOwnerWiFiConfiguration.
...
|preSharedKeyIsSet|Booliano|Esta é a chave pré compartilhada para rede Wi-Fi WPA Pessoal.|
