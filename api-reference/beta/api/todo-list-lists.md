...
Se tiver êxito, este método retornará um código de resposta e uma `200 OK` coleção de [objetos todoTaskList](../resources/todotasklist.md) no corpo da resposta.
