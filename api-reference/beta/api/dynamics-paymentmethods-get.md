...
---
# <a name="get-paymentmethods"></a>Obter pagamentoMethods

Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Recupere as propriedades e as relações de um objeto de método de pagamento do Dynamics 365 Business Central.
...
Se tiver êxito, este método retornará um código `200 OK` de resposta e um objeto **paymentMethods** no corpo da resposta.
