---
title: Listar fileThreatSubmissions
description: Obtenha uma lista dos objetos fileThreatSubmission e suas propriedades.
author: caigen
...
ms.locfileid: "66856469"
---
# <a name="list-filethreatsubmissions"></a>Listar fileThreatSubmissions
Namespace: microsoft.graph.security

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Obtenha uma lista dos [objetos fileThreatSubmission](../resources/security-filethreatsubmission.md) e suas propriedades.
...
Se bem-sucedido, este método retorna um `200 OK` código de resposta e uma coleção de [objetos fileThreatSubmission](../resources/security-filethreatsubmission.md) no corpo da resposta.
