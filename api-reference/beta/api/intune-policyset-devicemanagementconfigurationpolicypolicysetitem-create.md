---
title: Criar deviceManagementConfigurationPolicyPolicySetItem
description: Crie um novo objeto deviceManagementConfigurationPolicyPolicySetItem.
author: dougeby
...
ms.locfileid: "58263316"
---
# <a name="create-devicemanagementconfigurationpolicypolicysetitem"></a>Criar deviceManagementConfigurationPolicyPolicySetItem
...
Crie um novo [objeto deviceManagementConfigurationPolicyPolicySetItem.](../resources/intune-policyset-devicemanagementconfigurationpolicypolicysetitem.md)
...
No corpo da solicitação, fornece uma representação JSON para o objeto deviceManagementConfigurationPolicyPolicySetItem.

A tabela a seguir mostra as propriedades que são necessárias ao criar deviceManagementConfigurationPolicyPolicySetItem.
...
Se tiver êxito, este método retornará um código de resposta e um `201 Created` [objeto deviceManagementConfigurationPolicyPolicySetItem](../resources/intune-policyset-devicemanagementconfigurationpolicypolicysetitem.md) no corpo da resposta.
