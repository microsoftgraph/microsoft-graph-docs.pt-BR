...
|localStorage|[enablement](../resources/intune-shared-enablement.md)|Especifica se o armazenamento local é permitido em um PC compartilhado. Os valores possíveis são: `notConfigured`, `enabled`, `disabled`.|
|allowLocalStorage|Boolean|Especifica se o armazenamento local é permitido em um PC compartilhado.|
|setAccountManager|[enablement](../resources/intune-shared-enablement.md)|Desabilita o gerente de contas para o modo de PC compartilhado. Os valores possíveis são: `notConfigured`, `enabled`, `disabled`.|
|disableAccountManager|Boolean|Desabilita o gerente de contas para o modo de PC compartilhado.|
|setEduPolicies|[enablement](../resources/intune-shared-enablement.md)|Especifica se as políticas de ambiente de educação do computador compartilhado padrão devem ser habilitadas/desabilitadas/não configuradas. Para o Windows 10 RS2 e posterior, essa política será aplicada sem configurar Enabled como true. Os valores possíveis são: `notConfigured`, `enabled`, `disabled`.|
...
|setPowerPolicies|[enablement](../resources/intune-shared-enablement.md)|Especifica se as políticas de energia do computador compartilhado padrão devem ser habilitadas/desabilitadas. Os valores possíveis são: `notConfigured`, `enabled`, `disabled`.|
|disablePowerPolicies|Boolean|Especifica se as políticas padrão de energia do PC compartilhado devem ser desabilitadas.|
|signInOnResume|[enablement](../resources/intune-shared-enablement.md)|Especifica o requisito de entrar sempre que o dispositivo acordar do modo de sono. Os valores possíveis são: `notConfigured`, `enabled`, `disabled`.|
...
|fastFirstSignIn|[enablement](../resources/intune-shared-enablement.md)|Especifica se as novas contas não administrativas do Azure AD serão conectadas automaticamente a contas locais de candidatos pré-configurados. Os valores possíveis são: `notConfigured`, `enabled`, `disabled`.|
