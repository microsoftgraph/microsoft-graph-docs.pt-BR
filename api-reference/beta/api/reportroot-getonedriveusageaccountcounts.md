...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` **[objeto oneDriveUsageAccounts](../resources/onedriveusageaccountcounts.md)** no corpo da resposta.
