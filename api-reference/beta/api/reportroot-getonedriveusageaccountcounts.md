...
Se bem-sucedido, este método retorna um código de resposta e um `200 OK` **[objeto oneDriveUsageAccountCounts](../resources/onedriveusageaccountcounts.md)** no corpo da resposta.
