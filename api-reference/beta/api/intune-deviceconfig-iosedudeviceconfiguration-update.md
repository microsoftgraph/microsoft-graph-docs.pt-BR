...
A tabela a seguir mostra as propriedades que são necessárias ao criar [o iosEduDeviceConfiguration](../resources/intune-deviceconfig-iosedudeviceconfiguration.md).
...
Se tiver êxito, este método retornará um código de resposta e um objeto `200 OK` [iosEduDeviceConfiguration](../resources/intune-deviceconfig-iosedudeviceconfiguration.md) atualizado no corpo da resposta.
