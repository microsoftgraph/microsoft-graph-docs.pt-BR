...
ms.locfileid: "58797968"
---
# <a name="list-userexperienceanalyticsdevicewithoutcloudidentities"></a>Listar userExperienceAnalyticsDeviceWithoutCloudIdentities
...
Listar propriedades e relações dos [objetos userExperienceAnalyticsDeviceWithoutCloudIdentity.](../resources/intune-devices-userexperienceanalyticsdevicewithoutcloudidentity.md)
...
Se tiver êxito, este método retornará um código de resposta e uma coleção de `200 OK` [objetos userExperienceAnalyticsDeviceWithoutCloudIdentity](../resources/intune-devices-userexperienceanalyticsdevicewithoutcloudidentity.md) no corpo da resposta.
