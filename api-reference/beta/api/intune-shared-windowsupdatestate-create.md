...
Se bem-sucedido, este método retorna um código `201 Created` de resposta e um [objeto windowsUpdateState](../resources/intune-shared-windowsupdatestate.md) no corpo da resposta.
