...
Recupere uma lista de [objetos onPremisesAgentGroup.](../resources/onpremisesagentgroup.md)
...
Se tiver êxito, este método retornará um código de resposta `200 OK` e uma coleção de objetos [onPremisesAgentGroup](../resources/onpremisesagentgroup.md) no corpo da resposta.
