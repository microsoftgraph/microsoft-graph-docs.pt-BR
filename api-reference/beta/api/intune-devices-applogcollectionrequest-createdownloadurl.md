...
---
# <a name="createdownloadurl-action"></a>ação de createDownloadUrl
...
Se tiver êxito, essa ação retornará um `200 OK` código de resposta e um [appLogCollectionDownloadDetails](../resources/intune-devices-applogcollectiondownloaddetails.md) no corpo da resposta.
