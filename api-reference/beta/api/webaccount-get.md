...
---
# <a name="get-webaccount"></a>Obter webaccount

Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Recupere as propriedades e os relacionamentos de um objeto [webaccount](../resources/webaccount.md) do [perfil](../resources/profile.md)de um usuário.
...
Se tiver êxito, este método retornará um `200 OK` código de resposta e o objeto [webaccount](../resources/webaccount.md) solicitado no corpo da resposta.
