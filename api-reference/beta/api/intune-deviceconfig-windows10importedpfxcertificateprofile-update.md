...
## <a name="http-request"></a><span data-ttu-id="1e6aa-118">Solicitação HTTP</span><span class="sxs-lookup"><span data-stu-id="1e6aa-118">HTTP Request</span></span>
<!-- {
  "blockType": "ignored"
}
-->
