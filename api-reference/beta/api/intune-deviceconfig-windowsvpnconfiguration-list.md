...
Se tiver êxito, este método retornará `200 OK` um código de resposta e uma coleção de objetos [windowsVpnConfiguration](../resources/intune-deviceconfig-windowsvpnconfiguration.md) no corpo da resposta.
