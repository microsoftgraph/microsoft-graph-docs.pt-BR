...
Recupere as propriedades e os relacionamentos de um objeto [MyPhone](../resources/itemphone.md) no [perfil](../resources/profile.md)de um usuário.
...
Se tiver êxito, este método retornará `200 OK` um código de resposta e o objeto [MyPhone](../resources/itemphone.md) solicitado no corpo da resposta.
