...
Se tiver êxito, este método retornará um código `200 OK` de resposta e uma coleção [de objetos workbookNamedItem](../resources/workbooknameditem.md) no corpo da resposta.
