...
---
# <a name="getconfigurationpolicynoncompliancereport-action"></a>Ação getConfigurationPolicyNonComplianceReport
...
Se bem-sucedida, esta ação retorna `200 OK` um código de resposta e um Stream no corpo da resposta.
