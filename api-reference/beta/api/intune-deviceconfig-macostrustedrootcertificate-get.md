...
Leia propriedades e relações do [objeto macOSTrustedRootCertificate.](../resources/intune-deviceconfig-macostrustedrootcertificate.md)
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto macOSTrustedRootCertificate](../resources/intune-deviceconfig-macostrustedrootcertificate.md) no corpo da resposta.
