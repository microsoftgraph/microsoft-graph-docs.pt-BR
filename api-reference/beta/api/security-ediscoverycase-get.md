...
Se tiver êxito, este método retornará `200 OK` um código de resposta [e um objeto ediscoveryCase](../resources/security-ediscoverycase.md) no corpo da resposta.
