...
## <a name="http-request"></a><span data-ttu-id="b8b5d-119">Solicitação HTTP</span><span class="sxs-lookup"><span data-stu-id="b8b5d-119">HTTP Request</span></span>
<!-- {
  "blockType": "ignored"
}
-->
