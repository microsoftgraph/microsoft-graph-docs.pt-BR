...
A tabela a seguir mostra as propriedades que são necessárias ao criar [o appLogCollectionRequest](../resources/intune-devices-applogcollectionrequest.md).

|Propriedade|Tipo|Descrição|
|:---|:---|:---|
|id|String|O Identificador exclusivo. Esta é userId_DeviceId_AppId id.|
...
|errorMessage|String|Mensagem de erro se alguma durante o processo de carregamento|
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto appLogCollectionRequest](../resources/intune-devices-applogcollectionrequest.md) atualizado no corpo da resposta.
