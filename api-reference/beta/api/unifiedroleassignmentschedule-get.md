...
Se tiver êxito, este método retornará um `200 OK` código de resposta e um [objeto unifiedRoleAssignmentSchedule](../resources/unifiedroleassignmentschedule.md) no corpo da resposta.
