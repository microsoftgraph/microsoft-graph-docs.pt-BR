...
Se tiver êxito, este método retornará um `200 OK` código de resposta e o objeto atualizado [privilegedApproval](../resources/privilegedapproval.md) no corpo da resposta.
