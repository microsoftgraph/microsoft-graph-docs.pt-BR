---
title: Criar iosiPadOSWebClip
description: Crie um novo objeto iosiPadOSWebClip.
author: dougeby
...
ms.locfileid: "65858493"
---
# <a name="create-iosipadoswebclip"></a>Criar iosiPadOSWebClip
...
Crie um novo [objeto iosiPadOSWebClip](../resources/intune-apps-iosipadoswebclip.md) .
...
No corpo da solicitação, forneça uma representação JSON do objeto iosiPadOSWebClip.

A tabela a seguir mostra as propriedades que são necessárias ao criar o iosiPadOSWebClip.
...
Se tiver êxito, este método retornará um código `201 Created` de resposta e um [objeto iosiPadOSWebClip](../resources/intune-apps-iosipadoswebclip.md) no corpo da resposta.
