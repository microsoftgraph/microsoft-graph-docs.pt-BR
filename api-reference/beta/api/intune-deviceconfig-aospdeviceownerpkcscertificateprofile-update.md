---
title: Atualizar aospDeviceOwnerPkcsCertificateProfile
description: Atualize as propriedades de um objeto aospDeviceOwnerPkcsCertificateProfile.
author: dougeby
...
---
# <a name="update-aospdeviceownerpkcscertificateprofile"></a>Atualizar aospDeviceOwnerPkcsCertificateProfile
...
Atualize as propriedades de um [objeto aospDeviceOwnerPkcsCertificateProfile](../resources/intune-deviceconfig-aospdeviceownerpkcscertificateprofile.md) .
...
No corpo da solicitação, fornece uma representação JSON para o [objeto aospDeviceOwnerPkcsCertificateProfile](../resources/intune-deviceconfig-aospdeviceownerpkcscertificateprofile.md) .

A tabela a seguir mostra as propriedades que são necessárias ao criar [o aospDeviceOwnerPkcsCertificateProfile](../resources/intune-deviceconfig-aospdeviceownerpkcscertificateprofile.md).
...
Se tiver êxito, este método retornará `200 OK` um código de resposta e um [objeto aospDeviceOwnerPkcsCertificateProfile](../resources/intune-deviceconfig-aospdeviceownerpkcscertificateprofile.md) atualizado no corpo da resposta.
