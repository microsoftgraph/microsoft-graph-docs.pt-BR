...
Crie um novo [objeto windowsAppX.](../resources/intune-apps-windowsappx.md)
...
No corpo da solicitação, fornece uma representação JSON para o objeto windowsAppX.

A tabela a seguir mostra as propriedades necessárias ao criar o windowsAppX.
...
Se tiver êxito, este método retornará um código `201 Created` de resposta e um objeto [windowsAppX](../resources/intune-apps-windowsappx.md) no corpo da resposta.
