...
No corpo da solicitação, fornece uma representação JSON do objeto windowsAppX.
...
Se bem-sucedido, este método retorna um código de resposta e um `201 Created` [objeto windowsAppX](../resources/intune-apps-windowsappx.md) no corpo da resposta.
