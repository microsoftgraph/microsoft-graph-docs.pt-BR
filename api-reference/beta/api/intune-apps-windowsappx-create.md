...
Criar um novo objeto [windowsAppX](../resources/intune-apps-windowsappx.md) .
...
No corpo da solicitação, forneça uma representação JSON do objeto windowsAppX.

A tabela a seguir mostra as propriedades que são necessárias ao criar windowsAppX.
...
Se tiver êxito, este método retornará `201 Created` um código de resposta e um objeto [windowsAppX](../resources/intune-apps-windowsappx.md) no corpo da resposta.
