...
Se tiver êxito, este método retornará um `200 OK` código de resposta e uma coleção de [objetos Endpoint](../resources/endpoint.md) no corpo da resposta.
