...
description: Recuperar uma lista de objetos de ponto de extremidade.
author: psaffaie
...
Recuperar uma lista de [objetos de ponto de](../resources/endpoint.md) extremidade.
...
Se bem-sucedido, este método retorna um código `200 OK` de resposta e uma coleção de objetos [de](../resources/endpoint.md) ponto de extremidade no corpo da resposta.
