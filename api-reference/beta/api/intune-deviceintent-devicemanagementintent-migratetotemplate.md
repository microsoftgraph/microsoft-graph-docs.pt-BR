...
ms.locfileid: "58804369"
---
# <a name="migratetotemplate-action"></a>Ação migrateToTemplate
...
|:---|:---|:---|
|newTemplateId|String|Ainda não documentado|
|preserveCustomValues|Booliano|Ainda não documentado|
