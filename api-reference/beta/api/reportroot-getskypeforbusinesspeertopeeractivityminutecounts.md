...
Se tiver êxito, este método retornará um código de resposta e um objeto `200 OK` **[skypeForBusinessPeerToPeerActivityMinuteCounts](../resources/skypeforbusinesspeertopeeractivityminutecounts.md)** no corpo da resposta.
