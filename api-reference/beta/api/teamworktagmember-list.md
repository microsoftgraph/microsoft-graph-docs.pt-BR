...
Se tiver êxito, este método retornará um `200 OK` código de resposta e uma coleção de objetos [teamworkTagMember](../resources/teamworktagmember.md) no corpo da resposta.
