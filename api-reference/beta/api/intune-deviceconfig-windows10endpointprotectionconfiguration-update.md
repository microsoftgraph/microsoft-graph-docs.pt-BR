...
|defenderGuardedFoldersAllowedAppPaths|Conjunto de cadeias de caracteres|Lista de caminhos para execução com permissão para acessar as pastas protegidas|
