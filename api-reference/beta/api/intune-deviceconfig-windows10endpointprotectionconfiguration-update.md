...
|localSecurityOptionsEnableAdministratorAccount|Boolean|Determina se a conta de Administrador Local está habilitada ou desabilitada.|
...
|localSecurityOptionsEnableGuestAccount|Boolean|Determina se a conta de convidado está habilitada ou desabilitada.|
...
|lanManagerWorkstationEnableInsecureGuestLogons|Boolean|Se for habilitada, o cliente SMB permitirá que os logons de convidado inseguros. Se não estiver configurado, o cliente SMB rejeitará logons de convidado inseguros.|
