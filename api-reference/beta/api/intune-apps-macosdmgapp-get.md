---
title: Obter macOSDmgApp
description: Leia propriedades e relações do objeto macOSDmgApp.
author: dougeby
...
ms.locfileid: "61712116"
---
# <a name="get-macosdmgapp"></a>Obter macOSDmgApp
...
Leia propriedades e relações do [objeto macOSDmgApp.](../resources/intune-apps-macosdmgapp.md)
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto macOSDmgApp](../resources/intune-apps-macosdmgapp.md) no corpo da resposta.
