...
Se tiver êxito, este método retornará um código de resposta e `200 OK` [um objeto workbookChart](../resources/workbookchart.md) no corpo da resposta.
