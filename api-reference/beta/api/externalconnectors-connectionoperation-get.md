...
Se bem-sucedido, este método retorna um `200 OK` código de resposta e o objeto [connectionOperation solicitado](../resources/externalconnectors-connectionoperation.md) no corpo da resposta.
