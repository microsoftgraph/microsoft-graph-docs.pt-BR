...
Leia as propriedades e os relacionamentos do objeto [appLogCollectionRequest](../resources/intune-devices-applogcollectionrequest.md) .
...
Se tiver êxito, este método retornará um `200 OK` objeto response de código e [appLogCollectionRequest](../resources/intune-devices-applogcollectionrequest.md) no corpo da resposta.
