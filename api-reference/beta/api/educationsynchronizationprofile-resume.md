...
Retome a sincronização de um perfil de [sincronização de dados escolares específico](../resources/educationsynchronizationprofile.md) no locatário.
