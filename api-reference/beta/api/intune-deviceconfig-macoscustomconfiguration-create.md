...
Cria um novo objeto [macOSCustomConfiguration](../resources/intune-deviceconfig-macoscustomconfiguration.md).
...
No corpo da solicitação, forneça uma representação JSON do objeto macOSCustomConfiguration.

A tabela a seguir mostra as propriedades que são necessárias ao criar macOSCustomConfiguration.
...
|deploymentChannel|[appleDeploymentChannel](../resources/intune-deviceconfig-appledeploymentchannel.md)|Indica o canal usado para implantar o perfil de configuração. As opções disponíveis são DeviceChannel, UserChannel. Os valores possíveis são: `deviceChannel` e `userChannel`.|



## <a name="response"></a>Resposta
Se tiver êxito, este método retornará um código de resposta `201 Created` e um objeto [macOSCustomConfiguration](../resources/intune-deviceconfig-macoscustomconfiguration.md) no corpo da resposta.
