...
Se tiver êxito, este método retornará um `200 OK` código de resposta e um objeto [anonymousIpRiskEvent](../resources/anonymousipriskevent.md) no valor do corpo da resposta.
