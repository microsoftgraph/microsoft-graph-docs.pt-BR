...
Obter as propriedades e as relações de um [objeto bookingCustomer.](../resources/bookingcustomer.md)
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto bookingCustomer](../resources/bookingcustomer.md) no corpo da resposta.
