...
| displayName                  | String                                                                   | O nome de exibição da política padrão. Herdado do [policyBase](../resources/policybase.md). |
| descrição                  | String                                                                   | A descrição da política padrão. Herdado do [policyBase](../resources/policybase.md).  |
