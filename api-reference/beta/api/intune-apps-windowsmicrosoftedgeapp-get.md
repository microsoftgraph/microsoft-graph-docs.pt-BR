...
Ler propriedades e relações do [objeto windowsMicrosoftEdgeApp.](../resources/intune-apps-windowsmicrosoftedgeapp.md)
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto windowsMicrosoftEdgeApp](../resources/intune-apps-windowsmicrosoftedgeapp.md) no corpo da resposta.
