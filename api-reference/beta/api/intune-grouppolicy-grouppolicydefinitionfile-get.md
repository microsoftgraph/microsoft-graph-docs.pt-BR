...
Leia as propriedades e os relacionamentos do objeto [groupPolicyDefinitionFile](../resources/intune-grouppolicy-grouppolicydefinitionfile.md) .
...
Se tiver êxito, este método retornará um `200 OK` objeto response de código e [groupPolicyDefinitionFile](../resources/intune-grouppolicy-grouppolicydefinitionfile.md) no corpo da resposta.
