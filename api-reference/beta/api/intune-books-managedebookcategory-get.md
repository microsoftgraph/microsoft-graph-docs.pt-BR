...
Leia propriedades e relações do [objeto managedEBookCategory.](../resources/intune-books-managedebookcategory.md)
...
Se tiver êxito, este método retornará um código `200 OK` de resposta e um objeto [managedEBookCategory](../resources/intune-books-managedebookcategory.md) no corpo da resposta.
