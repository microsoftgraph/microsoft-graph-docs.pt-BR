...
Crie um novo [objeto iosEduDeviceConfiguration.](../resources/intune-deviceconfig-iosedudeviceconfiguration.md)
...
A tabela a seguir mostra as propriedades que são necessárias ao criar o iosEduDeviceConfiguration.
...
Se tiver êxito, este método retornará um código de resposta e um `201 Created` [objeto iosEduDeviceConfiguration](../resources/intune-deviceconfig-iosedudeviceconfiguration.md) no corpo da resposta.
