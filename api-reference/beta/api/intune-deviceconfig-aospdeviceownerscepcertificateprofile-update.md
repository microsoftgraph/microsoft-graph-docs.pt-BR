---
title: Atualizar aospDeviceOwnerScepCertificateProfile
description: Atualize as propriedades de um objeto aospDeviceOwnerScepCertificateProfile.
author: dougeby
...
ms.locfileid: "64630973"
---
# <a name="update-aospdeviceownerscepcertificateprofile"></a>Atualizar aospDeviceOwnerScepCertificateProfile
...
Atualize as propriedades de um [objeto aospDeviceOwnerScepCertificateProfile](../resources/intune-deviceconfig-aospdeviceownerscepcertificateprofile.md) .
...
No corpo da solicitação, fornece uma representação JSON para [o objeto aospDeviceOwnerScepCertificateProfile](../resources/intune-deviceconfig-aospdeviceownerscepcertificateprofile.md) .

A tabela a seguir mostra as propriedades que são necessárias ao criar [o aospDeviceOwnerScepCertificateProfile](../resources/intune-deviceconfig-aospdeviceownerscepcertificateprofile.md).
...
|certificateStore|[certificateStore](../resources/intune-shared-certificatestore.md)|Certificado de armazenamento de destino. Esta coleção pode conter um máximo de 500 elementos. Os valores possíveis são: `user` e `machine`.|
...
Se tiver êxito, este método retornará `200 OK` um código de resposta e um [objeto aospDeviceOwnerScepCertificateProfile](../resources/intune-deviceconfig-aospdeviceownerscepcertificateprofile.md) atualizado no corpo da resposta.
