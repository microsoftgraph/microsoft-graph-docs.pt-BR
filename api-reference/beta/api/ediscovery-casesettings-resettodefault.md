...
description: Redefinir um objeto caseSetting para os valores padrão.
author: mahage-msft
...
Redefinir [um objeto caseSettings](../resources/ediscovery-caseSettings.md) para os valores padrão.
