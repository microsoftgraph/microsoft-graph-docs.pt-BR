...
Se bem-sucedido, este método retorna um código de resposta e um `200 OK` **[objeto sharePointSiteUsageFileCounts](../resources/sharepointsiteusagefilecounts.md)** no corpo da resposta.
