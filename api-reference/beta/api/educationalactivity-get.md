...
Recupere as propriedades e as relações de um [objeto educationalActivity](../resources/educationalactivity.md) de um perfil de usuários.
...
Se tiver êxito, este método retornará um código `200 OK` de resposta e o objeto [educationalActivity](../resources/educationalactivity.md) solicitado no corpo da resposta.
