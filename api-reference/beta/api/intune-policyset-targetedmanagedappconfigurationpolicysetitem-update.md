...
ms.locfileid: "60489034"
---
# <a name="update-targetedmanagedappconfigurationpolicysetitem"></a>Atualizar targetedManagedAppConfigurationPolicySetItem
...
Atualize as propriedades de [um objeto targetedManagedAppConfigurationPolicySetItem.](../resources/intune-policyset-targetedmanagedappconfigurationpolicysetitem.md)
...
No corpo da solicitação, fornece uma representação JSON para [o objeto targetedManagedAppConfigurationPolicySetItem.](../resources/intune-policyset-targetedmanagedappconfigurationpolicysetitem.md)

A tabela a seguir mostra as propriedades que são necessárias ao criar [targetedManagedAppConfigurationPolicySetItem](../resources/intune-policyset-targetedmanagedappconfigurationpolicysetitem.md).
...
Se tiver êxito, este método retornará um código de resposta e um objeto `200 OK` [targetedManagedAppConfigurationPolicySetItem](../resources/intune-policyset-targetedmanagedappconfigurationpolicysetitem.md) atualizado no corpo da resposta.
