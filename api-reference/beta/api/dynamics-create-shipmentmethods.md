...
No corpo da solicitação, forneça uma representação JSON de um objeto **shipmentMethods** .

## <a name="response"></a>Resposta
Se bem-sucedido, este método retorna ```201 Created``` um código de resposta e um objeto **shipmentMethods** no corpo da resposta.
