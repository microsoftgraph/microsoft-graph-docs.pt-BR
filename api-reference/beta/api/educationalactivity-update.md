...
ms.locfileid: "62123713"
---
# <a name="update-educationalactivity"></a>Atualizar a atividade educacional

Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Atualize as propriedades de [um objeto educationalActivity](../resources/educationalactivity.md) no perfil de um [usuário.](../resources/profile.md)
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` objeto [educationalActivity](../resources/educationalactivity.md) atualizado no corpo da resposta.
