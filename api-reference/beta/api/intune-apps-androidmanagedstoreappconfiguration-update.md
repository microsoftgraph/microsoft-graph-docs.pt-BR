...
A tabela a seguir mostra as propriedades que são necessárias quando você cria o [androidManagedStoreAppConfiguration](../resources/intune-apps-androidmanagedstoreappconfiguration.md).
...
|packageId|Cadeia de caracteres|Android Enterprise app configuração id do pacote.|
|payloadJson|Cadeia de caracteres|Carga dos JSON de configuração de aplicativo do Android Enterprise.|
...
Se tiver êxito, este método retornará um `200 OK` código de resposta e um objeto atualizado [androidManagedStoreAppConfiguration](../resources/intune-apps-androidmanagedstoreappconfiguration.md) no corpo da resposta.
