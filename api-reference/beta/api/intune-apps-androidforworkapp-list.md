...
Se tiver êxito, este método retornará um código de resposta e uma `200 OK` coleção de [objetos androidForWorkApp](../resources/intune-apps-androidforworkapp.md) no corpo da resposta.
