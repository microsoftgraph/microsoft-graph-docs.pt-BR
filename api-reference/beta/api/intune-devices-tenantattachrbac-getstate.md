...
ms.locfileid: "64630979"
---
# <a name="getstate-function"></a>função getState
...
Se tiver êxito, essa função retornará um `200 OK` código de resposta e um [tenantAttachRBACState](../resources/intune-devices-tenantattachrbacstate.md) no corpo da resposta.
