...
Recupere uma lista de objetos de configuração do diretório.
...
<!-- { "blockType": "ignored" } -->Listar todo o locatário ou configurações de grupo
```http
GET /settings
...
Se tiver êxito, este método retornará um `200 OK` código de resposta e a coleção de objetos [directorySetting](../resources/directorysetting.md) no corpo da resposta.
