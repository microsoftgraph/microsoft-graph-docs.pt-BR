...
description: Obter um relatório que fornece a tendência de uso para o número de usuários ativos usando o Microsoft Edge, Versão Prévia do Microsoft Edge e o Internet Explorer quando usado para acessar os serviços Microsoft 365 por um período selecionado.
...
Obter um relatório que fornece a tendência de uso para o número de usuários ativos usando o Microsoft Edge, Versão Prévia do Microsoft Edge e o Internet Explorer quando usado para acessar os serviços Microsoft 365 por um período selecionado.
