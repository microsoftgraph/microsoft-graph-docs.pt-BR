...
Se tiver êxito, este método retornará um código de resposta e uma `200 OK` coleção de [objetos windowsAppX](../resources/intune-apps-windowsappx.md) no corpo da resposta.
