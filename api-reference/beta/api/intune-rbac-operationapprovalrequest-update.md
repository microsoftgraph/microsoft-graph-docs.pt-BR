...
No corpo da solicitação, forneça uma representação JSON do [objeto operationApprovalRequest](../resources/intune-rbac-operationapprovalrequest.md) .
...
Se tiver êxito, este método retornará um código `200 OK` de resposta e um objeto [operationApprovalRequest](../resources/intune-rbac-operationapprovalrequest.md) atualizado no corpo da resposta.
