...
Crie um novo [objeto androidPkcsCertificateProfile.](../resources/intune-deviceconfig-androidpkcscertificateprofile.md)
...
A tabela a seguir mostra as propriedades necessárias ao criar o androidPkcsCertificateProfile.
...
Se tiver êxito, este método retornará um código de resposta e um `201 Created` [objeto androidPkcsCertificateProfile](../resources/intune-deviceconfig-androidpkcscertificateprofile.md) no corpo da resposta.
