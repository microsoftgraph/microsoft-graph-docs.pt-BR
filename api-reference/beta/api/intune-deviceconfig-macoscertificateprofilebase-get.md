...
Leia propriedades e relações do [objeto macOSCertificateProfileBase.](../resources/intune-deviceconfig-macoscertificateprofilebase.md)
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto macOSCertificateProfileBase](../resources/intune-deviceconfig-macoscertificateprofilebase.md) no corpo da resposta.
