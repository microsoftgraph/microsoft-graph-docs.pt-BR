...
Atualize as propriedades de [um objeto certificateConnectorDetails.](../resources/intune-raimportcerts-certificateconnectordetails.md)
...
No corpo da solicitação, fornece uma representação JSON para o [objeto certificateConnectorDetails.](../resources/intune-raimportcerts-certificateconnectordetails.md)

A tabela a seguir mostra as propriedades que são necessárias ao criar [o certificateConnectorDetails](../resources/intune-raimportcerts-certificateconnectordetails.md).
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto certificateConnectorDetails](../resources/intune-raimportcerts-certificateconnectordetails.md) atualizado no corpo da resposta.
