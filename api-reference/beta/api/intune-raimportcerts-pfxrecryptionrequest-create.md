...
Crie um novo [objeto pfxRecryptionRequest.](../resources/intune-raimportcerts-pfxrecryptionrequest.md)
...
No corpo da solicitação, fornece uma representação JSON para o objeto pfxRecryptionRequest.

A tabela a seguir mostra as propriedades que são necessárias ao criar o pfxRecryptionRequest.
...
Se tiver êxito, este método retornará um código de resposta e um `201 Created` [objeto pfxRecryptionRequest](../resources/intune-raimportcerts-pfxrecryptionrequest.md) no corpo da resposta.
