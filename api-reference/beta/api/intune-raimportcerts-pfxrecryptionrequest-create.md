...
Criar um novo objeto [pfxRecryptionRequest](../resources/intune-raimportcerts-pfxrecryptionrequest.md) .
...
No corpo da solicitação, forneça uma representação JSON do objeto pfxRecryptionRequest.

A tabela a seguir mostra as propriedades que são necessárias ao criar pfxRecryptionRequest.
