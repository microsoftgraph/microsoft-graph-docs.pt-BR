...
ms.locfileid: "30972274"
---
# <a name="sync-action"></a><span data-ttu-id="f0756-103">Ação sync</span><span class="sxs-lookup"><span data-stu-id="f0756-103">sync action</span></span>
...
<span data-ttu-id="f0756-106">Ainda não documentado</span><span class="sxs-lookup"><span data-stu-id="f0756-106">Not yet documented</span></span>
...
|:---|:---|
|<span data-ttu-id="f0756-112">Delegado (conta corporativa ou de estudante)</span><span class="sxs-lookup"><span data-stu-id="f0756-112">Delegated (work or school account)</span></span>|<span data-ttu-id="f0756-113">DeviceManagementServiceConfig.ReadWrite.All</span><span class="sxs-lookup"><span data-stu-id="f0756-113">DeviceManagementServiceConfig.ReadWrite.All</span></span>|
...
|<span data-ttu-id="f0756-116">Aplicativo</span><span class="sxs-lookup"><span data-stu-id="f0756-116">Application</span></span>|<span data-ttu-id="f0756-117">Sem suporte.</span><span class="sxs-lookup"><span data-stu-id="f0756-117">Not supported.</span></span>|
...
<span data-ttu-id="f0756-127">No corpo da solicitação, forneça uma representação JSON dos parâmetros.</span><span class="sxs-lookup"><span data-stu-id="f0756-127">In the request body, supply JSON representation of the parameters.</span></span>

<span data-ttu-id="f0756-128">A tabela a seguir mostra os parâmetros que podem ser usados com esta ação.</span><span class="sxs-lookup"><span data-stu-id="f0756-128">The following table shows the parameters that can be used with this action.</span></span>

|<span data-ttu-id="f0756-129">Propriedade</span><span class="sxs-lookup"><span data-stu-id="f0756-129">Property</span></span>|<span data-ttu-id="f0756-130">Tipo</span><span class="sxs-lookup"><span data-stu-id="f0756-130">Type</span></span>|<span data-ttu-id="f0756-131">Descrição</span><span class="sxs-lookup"><span data-stu-id="f0756-131">Description</span></span>|
|:---|:---|:---|
|<span data-ttu-id="f0756-132">syncType</span><span class="sxs-lookup"><span data-stu-id="f0756-132">syncType</span></span>|[<span data-ttu-id="f0756-133">deviceManagementExchangeConnectorSyncType</span><span class="sxs-lookup"><span data-stu-id="f0756-133">deviceManagementExchangeConnectorSyncType</span></span>](../resources/intune-onboarding-devicemanagementexchangeconnectorsynctype.md)|<span data-ttu-id="f0756-134">O tipo de sincronização que será executado: sincronização completa ou sincronização delta.</span><span class="sxs-lookup"><span data-stu-id="f0756-134">The type of sync which will be executed, full sync or delta sync.</span></span>|



## <a name="response"></a><span data-ttu-id="f0756-135">Resposta</span><span class="sxs-lookup"><span data-stu-id="f0756-135">Response</span></span>
<span data-ttu-id="f0756-136">Se tiver êxito, esta ação retornará um código de resposta `204 No Content`.</span><span class="sxs-lookup"><span data-stu-id="f0756-136">If successful, this action returns a `204 No Content` response code.</span></span>

## <a name="example"></a><span data-ttu-id="f0756-137">Exemplo</span><span class="sxs-lookup"><span data-stu-id="f0756-137">Example</span></span>

### <a name="request"></a><span data-ttu-id="f0756-138">Solicitação</span><span class="sxs-lookup"><span data-stu-id="f0756-138">Request</span></span>
<span data-ttu-id="f0756-139">Este é um exemplo da solicitação.</span><span class="sxs-lookup"><span data-stu-id="f0756-139">Here is an example of the request.</span></span>
``` http
...
### <a name="response"></a><span data-ttu-id="f0756-140">Resposta</span><span class="sxs-lookup"><span data-stu-id="f0756-140">Response</span></span>
