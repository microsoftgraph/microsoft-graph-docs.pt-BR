...
### <a name="example-5-create-a-group-chat-with-tenant-guest-user"></a>Exemplo 5: Criar um chat em grupo com o usuário convidado do locatário
...
### <a name="example-6-create-a-one-on-one-chat-with-a-federated-user-outside-of-own-organization"></a>Exemplo 6: Criar um chat um-para-um com um usuário federado (fora da própria organização)
