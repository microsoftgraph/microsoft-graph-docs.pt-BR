...
Leia as propriedades e os relacionamentos do objeto [groupPolicyDefinitionValue](../resources/intune-grouppolicy-grouppolicydefinitionvalue.md) .
...
Se tiver êxito, este método retornará um `200 OK` objeto response de código e [groupPolicyDefinitionValue](../resources/intune-grouppolicy-grouppolicydefinitionvalue.md) no corpo da resposta.
