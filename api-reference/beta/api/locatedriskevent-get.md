...
Recupere as propriedades e relacionamentos de um objeto locatedriskevent.
...
Se tiver êxito, este método retornará um `200 OK` objeto response de código e [locatedRiskEvent](../resources/locatedriskevent.md) no corpo da resposta.
