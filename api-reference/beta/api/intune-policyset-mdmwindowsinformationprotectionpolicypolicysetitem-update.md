...
---
# <a name="update-mdmwindowsinformationprotectionpolicypolicysetitem"></a>Atualizar mdmWindowsInformationProtectionPolicyPolicySetItem
...
Atualize as propriedades de [um objeto mdmWindowsInformationProtectionPolicyPolicySetItem.](../resources/intune-policyset-mdmwindowsinformationprotectionpolicypolicysetitem.md)
...
No corpo da solicitação, fornece uma representação JSON para o [objeto mdmWindowsInformationProtectionPolicyPolicySetItem.](../resources/intune-policyset-mdmwindowsinformationprotectionpolicypolicysetitem.md)

A tabela a seguir mostra as propriedades que são necessárias ao criar [mdmWindowsInformationProtectionPolicyPolicySetItem](../resources/intune-policyset-mdmwindowsinformationprotectionpolicypolicysetitem.md).
...
Se tiver êxito, este método retornará um código de resposta e um objeto `200 OK` [mdmWindowsInformationProtectionPolicyPolicySetItem](../resources/intune-policyset-mdmwindowsinformationprotectionpolicypolicysetitem.md) atualizado no corpo da resposta.
