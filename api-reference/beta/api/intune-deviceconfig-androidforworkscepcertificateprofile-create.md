...
Crie um novo [objeto androidForWorkScepCertificateProfile.](../resources/intune-deviceconfig-androidforworkscepcertificateprofile.md)
...
No corpo da solicitação, fornece uma representação JSON para o objeto androidForWorkScepCertificateProfile.

A tabela a seguir mostra as propriedades que são necessárias ao criar o androidForWorkScepCertificateProfile.
...
Se tiver êxito, este método retornará um código de resposta e um `201 Created` [objeto androidForWorkScepCertificateProfile](../resources/intune-deviceconfig-androidforworkscepcertificateprofile.md) no corpo da resposta.
