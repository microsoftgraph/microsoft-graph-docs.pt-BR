...
Se tiver êxito, essa função retornará um código de resposta e uma `200 OK` [coleção operationApprovalRequest](../resources/intune-rbac-operationapprovalrequest.md) no corpo da resposta.
