...
Listar propriedades e relações dos [objetos depOnboardingSetting.](../resources/intune-enrollment-deponboardingsetting.md)
...
Se tiver êxito, este método retornará um código de resposta e uma `200 OK` coleção [de objetos depOnboardingSetting](../resources/intune-enrollment-deponboardingsetting.md) no corpo da resposta.
