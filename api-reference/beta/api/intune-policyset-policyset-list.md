...
ms.locfileid: "58819742"
---
# <a name="list-policysets"></a>Listar policySets
...
Listar propriedades e relações dos [objetos policySet.](../resources/intune-policyset-policyset.md)
...
Se tiver êxito, este método retornará um código de resposta e uma `200 OK` coleção de [objetos policySet](../resources/intune-policyset-policyset.md) no corpo da resposta.
