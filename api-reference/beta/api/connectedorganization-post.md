...
Criar um novo objeto [connectedOrganization](../resources/connectedorganization.md) .
...
Se tiver êxito, este método retornará um `201 Created` código de resposta e um novo objeto [connectedOrganization](../resources/connectedorganization.md) no corpo da resposta.
