...
Se bem-sucedido, este método retorna um código de resposta e um objeto `200 OK` [appleEnrollmentProfileAssignment](../resources/intune-enrollment-appleenrollmentprofileassignment.md) no corpo da resposta.
