...
|:---|:---|:---|
|isGroupOwnerManagementEnabled|Booliano|Se `true` , os proprietários do grupo podem criar e gerenciar avaliações de acesso nos grupos que eles próprios têm.|
