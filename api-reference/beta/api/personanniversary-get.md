...
ms.locfileid: "62118757"
---
# <a name="get-personanniversary"></a>Obter personAnniversary

Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Recupere as propriedades e as relações de [um objeto personAnniversary](../resources/personanniversary.md) no perfil de um [usuário.](../resources/profile.md)
...
Se tiver êxito, este método retornará um código de `200 OK` resposta e o objeto [personAnniversary](../resources/personanniversary.md) solicitado no corpo da resposta.
