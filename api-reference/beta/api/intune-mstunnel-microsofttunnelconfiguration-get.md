...
---
# <a name="get-microsofttunnelconfiguration"></a>Obter microsoftTunnelConfiguration
...
Leia as propriedades e as relações do objeto [microsoftTunnelConfiguration](../resources/intune-mstunnel-microsofttunnelconfiguration.md) .
...
Se bem-sucedido, este método retorna um `200 OK` código de resposta e um objeto [microsoftTunnelConfiguration](../resources/intune-mstunnel-microsofttunnelconfiguration.md) no corpo da resposta.
