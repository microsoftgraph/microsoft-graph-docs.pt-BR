...
Crie um novo objeto de [iosWiFiConfiguration](../resources/intune-deviceconfig-ioswificonfiguration.md) .
...
A tabela a seguir mostra as propriedades que são necessárias quando você cria o iosWiFiConfiguration.
