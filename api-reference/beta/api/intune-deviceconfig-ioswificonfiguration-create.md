...
ms.locfileid: "59031016"
---
# <a name="create-ioswificonfiguration"></a>Criar iosWiFiConfiguration
...
Crie um novo [objeto iosWiFiConfiguration.](../resources/intune-deviceconfig-ioswificonfiguration.md)
...
No corpo da solicitação, fornece uma representação JSON para o objeto iosWiFiConfiguration.

A tabela a seguir mostra as propriedades que são necessárias ao criar o iosWiFiConfiguration.
...
|proxyAutomaticConfigurationUrl|String|URL do script de configuração automática do servidor proxy quando a configuração automática é selecionada. Normalmente, essa URL é o local do arquivo PAC (Configuração Automática de Proxy).|
...
Se tiver êxito, este método retornará um código de resposta e um `201 Created` [objeto iosWiFiConfiguration](../resources/intune-deviceconfig-ioswificonfiguration.md) no corpo da resposta.
