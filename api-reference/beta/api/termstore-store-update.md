...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto de armazenamento](../resources/termstore-store.md) atualizado no corpo da resposta.
