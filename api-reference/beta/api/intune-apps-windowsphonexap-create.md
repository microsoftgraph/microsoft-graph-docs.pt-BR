...
Criar um novo objeto [windowsPhoneXAP](../resources/intune-apps-windowsphonexap.md) .
...
No corpo da solicitação, forneça uma representação JSON do objeto windowsPhoneXAP.

A tabela a seguir mostra as propriedades que são necessárias ao criar windowsPhoneXAP.
...
Se tiver êxito, este método retornará `201 Created` um código de resposta e um objeto [windowsPhoneXAP](../resources/intune-apps-windowsphonexap.md) no corpo da resposta.
