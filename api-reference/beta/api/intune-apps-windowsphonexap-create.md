...
Crie um novo [objeto windowsPhoneXAP.](../resources/intune-apps-windowsphonexap.md)
...
A tabela a seguir mostra as propriedades necessárias ao criar o windowsPhoneXAP.
...
Se tiver êxito, este método retornará um código de resposta e um `201 Created` [objeto windowsPhoneXAP](../resources/intune-apps-windowsphonexap.md) no corpo da resposta.
