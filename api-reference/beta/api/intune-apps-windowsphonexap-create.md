...
No corpo da solicitação, fornece uma representação JSON do objeto windowsPhoneXAP.
...
Se bem-sucedido, este método retorna um código de resposta e um objeto `201 Created` [windowsPhoneXAP](../resources/intune-apps-windowsphonexap.md) no corpo da resposta.
