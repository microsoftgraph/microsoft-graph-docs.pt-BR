...
Listar [os objetos tokenLifetimePolicy](../resources/tokenlifetimepolicy.md) que são atribuídos a um [aplicativo](../resources/application.md) ou [servicePrincipal](../resources/servicePrincipal.md)..
...
Se tiver êxito, este método retornará um código de resposta e uma coleção de `200 OK` [objetos tokenLifetimePolicy](../resources/tokenLifetimePolicy.md) no corpo da resposta.
