...
Se tiver êxito, essa ação retornará um código de `200 OK` resposta e um [deviceManagementConfigurationPolicy](../resources/intune-deviceconfigv2-devicemanagementconfigurationpolicy.md) no corpo da resposta.
