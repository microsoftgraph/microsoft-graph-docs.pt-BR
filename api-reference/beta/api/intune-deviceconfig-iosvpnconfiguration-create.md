...
No corpo da solicitação, fornece uma representação JSON do objeto iosVpnConfiguration.
...
Se bem-sucedido, este método retorna um código de resposta e um objeto `201 Created` [iosVpnConfiguration](../resources/intune-deviceconfig-iosvpnconfiguration.md) no corpo da resposta.
