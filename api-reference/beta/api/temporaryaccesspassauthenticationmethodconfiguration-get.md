...
Leia os detalhes da política de Passagem de Acesso Temporário para o locatário Azure Active Directory (Azure AD), representado por um objeto [temporaryAccessPassAuthenticationMethodConfiguration](../resources/temporaryaccesspassauthenticationmethodconfiguration.md).
