...
Se tiver êxito, este método retornará um `200 OK` código de resposta e uma coleção de objetos [de](../resources/application.md) aplicativo no corpo da resposta.
