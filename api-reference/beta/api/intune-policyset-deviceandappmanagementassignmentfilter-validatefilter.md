...
Se tiver êxito, esta ação retornará `200 OK` um código de resposta e um [assignmentFilterValidationResult](../resources/intune-policyset-assignmentfiltervalidationresult.md) no corpo da resposta.
