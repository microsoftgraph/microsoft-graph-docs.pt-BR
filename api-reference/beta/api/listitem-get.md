...
> **Observação**: a permissão do aplicativo Sites.Manage.All será necessária se a lista do SharePoint tiver as configurações de aprovação de conteúdo ativadas. Caso contrário, Graph Microsoft não recuperará itens de lista que tenham um status de aprovação diferente de Aprovado.
