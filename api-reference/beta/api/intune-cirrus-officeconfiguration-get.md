...
---
# <a name="get-officeconfiguration"></a>Obter officeConfiguration

> **Importante:** As APIs do Microsoft Graph na versão/beta estão sujeitas a alterações; Não há suporte para o uso de produção.

> **Observação:** A API do Microsoft Graph para Intune requer uma [licença do Active Intune](https://go.microsoft.com/fwlink/?linkid=839381) para o locatário.

Leia as propriedades e as relações do objeto [officeConfiguration](../resources/intune-cirrus-officeconfiguration.md) .
...
Se bem-sucedido, este método retorna um `200 OK` código de resposta e um objeto [officeConfiguration](../resources/intune-cirrus-officeconfiguration.md) no corpo da resposta.
