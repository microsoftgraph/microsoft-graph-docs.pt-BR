...
Leia as propriedades e os relacionamentos do objeto [importedDeviceIdentityResult](../resources/intune-enrollment-importeddeviceidentityresult.md) .
...
Se tiver êxito, este método retornará um `200 OK` objeto response de código e [importedDeviceIdentityResult](../resources/intune-enrollment-importeddeviceidentityresult.md) no corpo da resposta.
