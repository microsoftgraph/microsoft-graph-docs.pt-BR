...
Atualize as propriedades de um [objeto deviceShellScript.](../resources/intune-devices-deviceshellscript.md)
...
No corpo da solicitação, fornece uma representação JSON para o [objeto deviceShellScript.](../resources/intune-devices-deviceshellscript.md)

A tabela a seguir mostra as propriedades que são necessárias ao criar [o deviceShellScript](../resources/intune-devices-deviceshellscript.md).
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto deviceShellScript](../resources/intune-devices-deviceshellscript.md) atualizado no corpo da resposta.
