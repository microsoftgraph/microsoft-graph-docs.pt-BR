...
ms.locfileid: "54199057"
---
# <a name="update-windowsphone81importedpfxcertificateprofile"></a>Atualizar windowsPhone81ImportedPFXCertificateProfile
...
Atualize as propriedades de um [objeto windowsPhone81ImportedPFXCertificateProfile.](../resources/intune-deviceconfig-windowsphone81importedpfxcertificateprofile.md)
...
No corpo da solicitação, fornece uma representação JSON para o [objeto windowsPhone81ImportedPFXCertificateProfile.](../resources/intune-deviceconfig-windowsphone81importedpfxcertificateprofile.md)

A tabela a seguir mostra as propriedades que são necessárias ao criar o [windowsPhone81ImportedPFXCertificateProfile](../resources/intune-deviceconfig-windowsphone81importedpfxcertificateprofile.md).
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto windowsPhone81ImportedPFXCertificateProfile](../resources/intune-deviceconfig-windowsphone81importedpfxcertificateprofile.md) atualizado no corpo da resposta.
