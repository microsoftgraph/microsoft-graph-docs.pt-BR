...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto workbookTableColumn](../resources/workbooktablecolumn.md) no corpo da resposta.
