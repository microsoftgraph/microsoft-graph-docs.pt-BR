...
Obtenha as propriedades e relacionamentos de um objeto [bookingService](../resources/bookingservice.md) no especificado [bookingbusiness](../resources/bookingbusiness.md).
...
Se tiver êxito, este método retornará um `200 OK` objeto response de código e [bookingService](../resources/bookingservice.md) no corpo da resposta.
