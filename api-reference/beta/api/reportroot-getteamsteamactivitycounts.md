...
description: Obtenha o número de atividades da equipe em Microsoft Teams. Os tipos de atividade estão relacionados a reuniões e mensagens.
...
Obtenha o número de atividades da equipe em Microsoft Teams. Os tipos de atividade estão relacionados a reuniões e mensagens.
...
| data      | Data   | Especifica a data para a qual você deseja exibir detalhes sobre as atividades entre as equipes. {date_value} deve ter um formato de AAAA-MM-DD. Como este relatório está disponível apenas para os últimos 30 dias, {date_value} deve ser uma data desse intervalo. |
