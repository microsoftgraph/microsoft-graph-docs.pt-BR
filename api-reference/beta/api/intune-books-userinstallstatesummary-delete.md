...
ms.locfileid: "32483023"
---
# <a name="delete-userinstallstatesummary"></a><span data-ttu-id="8f70d-103">Excluir userInstallStateSummary</span><span class="sxs-lookup"><span data-stu-id="8f70d-103">Delete userInstallStateSummary</span></span>
...
<span data-ttu-id="8f70d-106">Exclui [userInstallStateSummary](../resources/intune-books-userinstallstatesummary.md).</span><span class="sxs-lookup"><span data-stu-id="8f70d-106">Deletes a [userInstallStateSummary](../resources/intune-books-userinstallstatesummary.md).</span></span>
...
|:---|:---|
|<span data-ttu-id="8f70d-112">Delegado (conta corporativa ou de estudante)</span><span class="sxs-lookup"><span data-stu-id="8f70d-112">Delegated (work or school account)</span></span>|<span data-ttu-id="8f70d-113">DeviceManagementApps.ReadWrite.All</span><span class="sxs-lookup"><span data-stu-id="8f70d-113">DeviceManagementApps.ReadWrite.All</span></span>|
...
<span data-ttu-id="8f70d-127">Não forneça um corpo de solicitação para esse método.</span><span class="sxs-lookup"><span data-stu-id="8f70d-127">Do not supply a request body for this method.</span></span>

## <a name="response"></a><span data-ttu-id="8f70d-128">Resposta</span><span class="sxs-lookup"><span data-stu-id="8f70d-128">Response</span></span>
<span data-ttu-id="8f70d-129">Se tiver êxito, este método retornará um código de resposta `204 No Content`.</span><span class="sxs-lookup"><span data-stu-id="8f70d-129">If successful, this method returns a `204 No Content` response code.</span></span>

## <a name="example"></a><span data-ttu-id="8f70d-130">Exemplo</span><span class="sxs-lookup"><span data-stu-id="8f70d-130">Example</span></span>

### <a name="request"></a><span data-ttu-id="8f70d-131">Solicitação</span><span class="sxs-lookup"><span data-stu-id="8f70d-131">Request</span></span>
<span data-ttu-id="8f70d-132">Este é um exemplo da solicitação.</span><span class="sxs-lookup"><span data-stu-id="8f70d-132">Here is an example of the request.</span></span>
``` http
...
### <a name="response"></a><span data-ttu-id="8f70d-133">Resposta</span><span class="sxs-lookup"><span data-stu-id="8f70d-133">Response</span></span>
<span data-ttu-id="8f70d-p102">Veja a seguir um exemplo da resposta. Observação: o objeto response mostrado aqui pode estar truncado por motivos de concisão. Todas as propriedades serão retornadas de uma chamada real.</span><span class="sxs-lookup"><span data-stu-id="8f70d-p102">Here is an example of the response. Note: The response object shown here may be truncated for brevity. All of the properties will be returned from an actual call.</span></span>
``` http
