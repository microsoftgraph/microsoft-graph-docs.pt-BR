...
Se tiver êxito, essa função retornará um código de resposta e um `200 OK` [comanagementEligibleDevicesSummary](../resources/intune-devices-comanagementeligibledevicessummary.md) no corpo da resposta.
