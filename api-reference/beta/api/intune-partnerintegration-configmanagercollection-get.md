...
ms.locfileid: "54170969"
---
# <a name="get-configmanagercollection"></a>Obter configManagerCollection
...
Ler propriedades e relações do [objeto configManagerCollection.](../resources/intune-partnerintegration-configmanagercollection.md)
...
Se tiver êxito, este método retornará um código `200 OK` de resposta e um objeto [configManagerCollection](../resources/intune-partnerintegration-configmanagercollection.md) no corpo da resposta.
