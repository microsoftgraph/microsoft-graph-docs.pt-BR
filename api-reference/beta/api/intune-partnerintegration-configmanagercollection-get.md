...
Leia as propriedades e as relações do objeto [configManagerCollection](../resources/intune-partnerintegration-configmanagercollection.md) .
...
Se bem-sucedido, este método retorna um `200 OK` código de resposta e um objeto [configManagerCollection](../resources/intune-partnerintegration-configmanagercollection.md) no corpo da resposta.
