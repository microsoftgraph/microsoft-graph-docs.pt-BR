...
Se tiver êxito, este método retornará um `200 OK` código de resposta e o objeto [accessPackageAssignmentRequest](../resources/accesspackageassignmentrequest.md) solicitado no corpo da resposta.
