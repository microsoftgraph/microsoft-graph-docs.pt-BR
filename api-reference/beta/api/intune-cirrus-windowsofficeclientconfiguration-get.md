...
Obtenha um objeto de [windowsOfficeClientConfiguration](../resources/intune-cirrus-windowsofficeclientconfiguration.md) políticas específicas de não relacionadas à segurança.
...
Se tiver êxito, este método retornará um `200 OK` objeto response de código e [windowsOfficeClientConfiguration](../resources/intune-cirrus-windowsofficeclientconfiguration.md) no corpo da resposta.
