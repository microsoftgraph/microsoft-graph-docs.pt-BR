---
title: Listar seções
description: Recupere uma lista de objetos de seção do bloco de anotações especificado.
...
Recupere uma lista de [objetos de](../resources/onenotesection.md) seção do bloco de anotações especificado.
