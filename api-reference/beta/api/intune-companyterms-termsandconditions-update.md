...
## <a name="http-request"></a><span data-ttu-id="2b9a9-119">Solicitação HTTP</span><span class="sxs-lookup"><span data-stu-id="2b9a9-119">HTTP Request</span></span>
<!-- {
  "blockType": "ignored"
}
-->
