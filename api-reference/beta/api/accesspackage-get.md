...
Se tiver êxito, este método retornará `200 OK` um código de resposta e o objeto [accessPackage](../resources/accesspackage.md) solicitado no corpo da resposta.
