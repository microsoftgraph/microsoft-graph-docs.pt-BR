...
Ler propriedades e relações do [objeto iosCertificateProfileBase.](../resources/intune-deviceconfig-ioscertificateprofilebase.md)
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto iosCertificateProfileBase](../resources/intune-deviceconfig-ioscertificateprofilebase.md) no corpo da resposta.
