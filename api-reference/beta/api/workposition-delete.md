...
description: Exclua um objeto workPosition do perfil de um usuário.
...
Exclua um [objeto workPosition](../resources/workposition.md) específico do perfil de um [usuário.](../resources/profile.md)
