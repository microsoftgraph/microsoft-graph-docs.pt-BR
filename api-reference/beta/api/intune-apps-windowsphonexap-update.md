...
A tabela a seguir mostra as propriedades que são necessárias quando você cria o [windowsPhoneXAP](../resources/intune-apps-windowsphonexap.md).
...
|productIdentifier|Cadeia de caracteres|O identificador do produto.|
|identityVersion|Cadeia de caracteres|A versão da identidade.|



## <a name="response"></a>Resposta
Se tiver êxito, este método retornará um `200 OK` código de resposta e um objeto atualizado [windowsPhoneXAP](../resources/intune-apps-windowsphonexap.md) no corpo da resposta.
