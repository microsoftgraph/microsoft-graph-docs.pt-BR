...
Atualizar as propriedades de um [objeto windowsPhoneXAP.](../resources/intune-apps-windowsphonexap.md)
...
No corpo da solicitação, fornece uma representação JSON do [objeto windowsPhoneXAP.](../resources/intune-apps-windowsphonexap.md)
...
Se bem-sucedido, este método retorna um código de resposta e um objeto `200 OK` [windowsPhoneXAP](../resources/intune-apps-windowsphonexap.md) atualizado no corpo da resposta.
