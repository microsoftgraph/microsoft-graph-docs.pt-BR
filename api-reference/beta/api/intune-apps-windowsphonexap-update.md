...
ms.locfileid: "59077850"
---
# <a name="update-windowsphonexap"></a>Atualizar windowsPhoneXAP
...
Atualize as propriedades de um [objeto windowsPhoneXAP.](../resources/intune-apps-windowsphonexap.md)
...
No corpo da solicitação, fornece uma representação JSON para o [objeto windowsPhoneXAP.](../resources/intune-apps-windowsphonexap.md)

A tabela a seguir mostra as propriedades que são necessárias ao criar [o windowsPhoneXAP](../resources/intune-apps-windowsphonexap.md).
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` objeto [windowsPhoneXAP](../resources/intune-apps-windowsphonexap.md) atualizado no corpo da resposta.
