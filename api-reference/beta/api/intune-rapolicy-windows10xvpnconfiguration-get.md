...
Leia as propriedades e as relações do objeto [windows10XVpnConfiguration](../resources/intune-rapolicy-windows10xvpnconfiguration.md) .
...
Se bem-sucedido, este método retorna um `200 OK` código de resposta e um objeto [windows10XVpnConfiguration](../resources/intune-rapolicy-windows10xvpnconfiguration.md) no corpo da resposta.
