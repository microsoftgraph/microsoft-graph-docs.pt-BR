---
title: Listar ediscoveryNoncustodialDataSource
description: Obtenha uma lista do objeto ediscoveryNoncustodialDataSource.
author: SeunginLyu
...
---
# <a name="list-ediscoverynoncustodialdatasource"></a>Listar ediscoveryNoncustodialDataSource
Namespace: microsoft.graph.security

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Obtenha uma lista dos [objetos de fontes de](../resources/security-ediscoverynoncustodialdatasource.md) dados não custodiais e suas propriedades.
...
Se bem-sucedido, este método `200 OK` retorna um código de resposta e uma coleção de  [objeto ediscoveryNoncustodialDataSource](../resources/security-ediscoverynoncustodialdatasource.md) no corpo da resposta.
