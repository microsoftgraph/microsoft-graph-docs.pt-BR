...
Criar um novo objeto [reviewSetQuery](../resources/reviewsetquery.md) .
...
No corpo da solicitação, forneça uma representação JSON do objeto [reviewSetQuery](../resources/reviewsetquery.md) . A tabela a seguir lista as propriedades necessárias.
...
Se tiver êxito, este método retornará um `201 Created` código de resposta e um novo objeto [reviewSetQuery](../resources/reviewsetquery.md) no corpo da resposta.
