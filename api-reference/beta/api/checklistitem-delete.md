...
### <a name="delete-a-checklistitem-associated-to-a-specified-todotask"></a>Excluir um checklistItem associado a um todoTask especificado
...
```
### <a name="delete-a-checklistitem-associated-to-a-specified-basetask-deprecated"></a>Excluir um checklistItem associado a uma baseTask especificada (preterida)
...
Aqui está um exemplo para excluir um **checklistItem** associado a um **todoTask**.
...
Aqui está um exemplo para excluir **um checklistItem** associado a uma **baseTask** (preterido).
