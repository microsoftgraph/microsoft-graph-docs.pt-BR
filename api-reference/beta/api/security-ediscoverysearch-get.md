...
Se tiver êxito, este método retornará `200 OK` um código de resposta e um [objeto microsoft.graph.security.ediscoverySearch](../resources/security-ediscoverysearch.md) no corpo da resposta.
