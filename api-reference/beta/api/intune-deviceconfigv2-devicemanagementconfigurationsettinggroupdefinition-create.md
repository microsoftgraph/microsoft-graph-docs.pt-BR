...
ms.locfileid: "66669739"
---
# <a name="create-devicemanagementconfigurationsettinggroupdefinition"></a>Criar deviceManagementConfigurationSettingGroupDefinition
...
Crie um novo [objeto deviceManagementConfigurationSettingGroupDefinition](../resources/intune-deviceconfigv2-devicemanagementconfigurationsettinggroupdefinition.md) .
...
No corpo da solicitação, forneça uma representação JSON do objeto deviceManagementConfigurationSettingGroupDefinition.

A tabela a seguir mostra as propriedades que são necessárias ao criar deviceManagementConfigurationSettingGroupDefinition.
...
|childIds|String collection|Configurações filho dependentes para esse grupo de configurações|
...
Se bem-sucedido, este método `201 Created` retorna um código de resposta e um objeto [deviceManagementConfigurationSettingGroupDefinition](../resources/intune-deviceconfigv2-devicemanagementconfigurationsettinggroupdefinition.md) no corpo da resposta.
