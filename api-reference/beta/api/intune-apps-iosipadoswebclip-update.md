---
title: Atualizar iosiPadOSWebClip
description: Atualize as propriedades de um objeto iosiPadOSWebClip.
author: dougeby
...
---
# <a name="update-iosipadoswebclip"></a>Atualizar iosiPadOSWebClip
...
Atualize as propriedades de um [objeto iosiPadOSWebClip](../resources/intune-apps-iosipadoswebclip.md) .
...
No corpo da solicitação, forneça uma representação JSON do objeto [iosiPadOSWebClip](../resources/intune-apps-iosipadoswebclip.md) .

A tabela a seguir mostra as propriedades que são necessárias ao criar [o iosiPadOSWebClip](../resources/intune-apps-iosipadoswebclip.md).
...
Se tiver êxito, este método retornará um código `200 OK` de resposta e um objeto [iosiPadOSWebClip](../resources/intune-apps-iosipadoswebclip.md) atualizado no corpo da resposta.
