...
Se bem-sucedido, este método retorna um código de resposta e uma coleção `200 OK` de [objetos appleVpnConfiguration](../resources/intune-deviceconfig-applevpnconfiguration.md) no corpo da resposta.
