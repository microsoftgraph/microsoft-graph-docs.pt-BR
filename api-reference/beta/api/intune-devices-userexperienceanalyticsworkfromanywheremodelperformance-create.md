---
title: Criar userExperienceAnalyticsWorkFromAnywhereModelPerformance
description: Crie um novo objeto userExperienceAnalyticsWorkFromAnywhereModelPerformance.
author: dougeby
...
ms.locfileid: "62292265"
---
# <a name="create-userexperienceanalyticsworkfromanywheremodelperformance"></a>Criar userExperienceAnalyticsWorkFromAnywhereModelPerformance
...
Crie um novo [objeto userExperienceAnalyticsWorkFromAnywhereModelPerformance](../resources/intune-devices-userexperienceanalyticsworkfromanywheremodelperformance.md) .
...
No corpo da solicitação, fornece uma representação JSON para o objeto userExperienceAnalyticsWorkFromAnywhereModelPerformance.

A tabela a seguir mostra as propriedades que são necessárias ao criar o userExperienceAnalyticsWorkFromAnywhereModelPerformance.
...
Se tiver êxito, este método `201 Created` retornará um código de resposta e um [objeto userExperienceAnalyticsWorkFromAnywhereModelPerformance](../resources/intune-devices-userexperienceanalyticsworkfromanywheremodelperformance.md) no corpo da resposta.
