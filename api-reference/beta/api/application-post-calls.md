...
#### <a name="notification---content-sharing-updated"></a>Notificação – compartilhamento de conteúdo atualizado
...
> **Nota:** Este exemplo precisa da `Calls.JoinGroupCallsAsGuest.All` permissão.
