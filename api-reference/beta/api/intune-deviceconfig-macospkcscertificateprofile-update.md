...
Atualize as propriedades de [um objeto macOSPkcsCertificateProfile.](../resources/intune-deviceconfig-macospkcscertificateprofile.md)
...
No corpo da solicitação, fornece uma representação JSON para o [objeto macOSPkcsCertificateProfile.](../resources/intune-deviceconfig-macospkcscertificateprofile.md)

A tabela a seguir mostra as propriedades que são necessárias ao criar [o macOSPkcsCertificateProfile](../resources/intune-deviceconfig-macospkcscertificateprofile.md).
...
|allowAllAppsAccess|Boleano|Configuração AllowAllAppsAccess|



## <a name="response"></a>Resposta
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto macOSPkcsCertificateProfile](../resources/intune-deviceconfig-macospkcscertificateprofile.md) atualizado no corpo da resposta.
