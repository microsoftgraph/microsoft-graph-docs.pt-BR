---
title: Atualizar aospDeviceOwnerTrustedRootCertificate
description: Atualize as propriedades de um objeto aospDeviceOwnerTrustedRootCertificate.
author: dougeby
...
ms.locfileid: "64630286"
---
# <a name="update-aospdeviceownertrustedrootcertificate"></a>Atualizar aospDeviceOwnerTrustedRootCertificate
...
Atualize as propriedades de um [objeto aospDeviceOwnerTrustedRootCertificate](../resources/intune-deviceconfig-aospdeviceownertrustedrootcertificate.md) .
...
No corpo da solicitação, fornece uma representação JSON para [o objeto aospDeviceOwnerTrustedRootCertificate](../resources/intune-deviceconfig-aospdeviceownertrustedrootcertificate.md) .

A tabela a seguir mostra as propriedades que são necessárias ao criar [o aospDeviceOwnerTrustedRootCertificate](../resources/intune-deviceconfig-aospdeviceownertrustedrootcertificate.md).
...
Se tiver êxito, este método retornará `200 OK` um código de resposta e um [objeto aospDeviceOwnerTrustedRootCertificate](../resources/intune-deviceconfig-aospdeviceownertrustedrootcertificate.md) atualizado no corpo da resposta.
