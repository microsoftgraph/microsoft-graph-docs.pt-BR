...
Se tiver êxito, este método retornará um código de resposta e uma coleção de objetos `200 OK` [workbookChartSeries](../resources/workbookchartseries.md) no corpo da resposta.
