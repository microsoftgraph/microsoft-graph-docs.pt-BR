...
Se tiver êxito, este método retornará um `200 OK` código de resposta e um objeto **[sharePointActivityPages](../resources/sharepointactivitypages.md)** no corpo da resposta.
