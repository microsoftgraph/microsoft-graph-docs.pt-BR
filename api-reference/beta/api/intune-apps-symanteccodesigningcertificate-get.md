...
Leia propriedades e relações do [objeto symantecCodeSigningCertificate.](../resources/intune-apps-symanteccodesigningcertificate.md)
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto symantecCodeSigningCertificate](../resources/intune-apps-symanteccodesigningcertificate.md) no corpo da resposta.
