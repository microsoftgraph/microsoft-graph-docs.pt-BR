...
Crie um novo [objeto macOSLobApp.](../resources/intune-apps-macoslobapp.md)
...
No corpo da solicitação, fornece uma representação JSON para o objeto macOSLobApp.

A tabela a seguir mostra as propriedades que são necessárias ao criar o macOSLobApp.
...
Se tiver êxito, este método retornará um código `201 Created` de resposta e um objeto [macOSLobApp](../resources/intune-apps-macoslobapp.md) no corpo da resposta.
