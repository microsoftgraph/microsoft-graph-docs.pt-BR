...
Crie um novo objeto de [macOSLobApp](../resources/intune-apps-macoslobapp.md) .
...
A tabela a seguir mostra as propriedades que são necessárias quando você cria o macOSLobApp.
...
Se tiver êxito, este método retornará um `201 Created` código de resposta e um objeto [macOSLobApp](../resources/intune-apps-macoslobapp.md) no corpo da resposta.
