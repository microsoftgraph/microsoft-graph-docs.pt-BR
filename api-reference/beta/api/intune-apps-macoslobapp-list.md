...
Se tiver êxito, este método retornará um código de resposta e uma `200 OK` coleção de [objetos macOSLobApp](../resources/intune-apps-macoslobapp.md) no corpo da resposta.
