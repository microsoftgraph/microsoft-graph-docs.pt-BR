...
Ler propriedades e relações do [objeto onPremEncryptedPayload.](../resources/intune-raimportcerts-onpremencryptedpayload.md)
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto onPremEncryptedPayload](../resources/intune-raimportcerts-onpremencryptedpayload.md) no corpo da resposta.
