...
Crie um novo [objeto macOSVpnConfiguration.](../resources/intune-deviceconfig-macosvpnconfiguration.md)
...
No corpo da solicitação, fornece uma representação JSON para o objeto macOSVpnConfiguration.

A tabela a seguir mostra as propriedades que são necessárias ao criar o macOSVpnConfiguration.
...
Se tiver êxito, este método retornará um código de resposta e um `201 Created` [objeto macOSVpnConfiguration](../resources/intune-deviceconfig-macosvpnconfiguration.md) no corpo da resposta.
