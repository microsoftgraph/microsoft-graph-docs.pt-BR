...
No corpo da solicitação, fornece uma representação JSON do objeto macOSVpnConfiguration.
...
Se bem-sucedido, este método retorna um código de resposta e um `201 Created` [objeto macOSVpnConfiguration](../resources/intune-deviceconfig-macosvpnconfiguration.md) no corpo da resposta.
