...
Atualizar as propriedades de um objeto [emailAuthenticationMethodConfiguration](../resources/emailauthenticationmethodconfiguration.md) , que representa a política de [método de autenticação](../resources/authenticationmethodspolicies-overview.md) de OTP de email para o locatário do Azure Active Directory (Azure AD).
...
>**Observação:** A `@odata.type` propriedade com um valor de `#microsoft.graph.emailAuthenticationMethodConfiguration` deve ser incluída no corpo.
