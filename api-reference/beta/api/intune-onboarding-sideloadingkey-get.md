...
Ler propriedades e relações do objeto [sideLoadingKey](../resources/intune-onboarding-sideloadingkey.md) .
...
Se tiver êxito, este método retornará um código `200 OK` de resposta e um [objeto sideLoadingKey](../resources/intune-onboarding-sideloadingkey.md) no corpo da resposta.
