...
---
# <a name="generateencryptionpublickey-action"></a><span data-ttu-id="f144c-103">ação generateEncryptionPublicKey</span><span class="sxs-lookup"><span data-stu-id="f144c-103">generateEncryptionPublicKey action</span></span>
...
<span data-ttu-id="f144c-107">Gerar uma chave pública para usar para criptografar o token do programa de registro de dispositivo Apple</span><span class="sxs-lookup"><span data-stu-id="f144c-107">Generate a public key to use to encrypt the Apple device enrollment program token</span></span>
...
|:---|:---|
|<span data-ttu-id="f144c-113">Delegado (conta corporativa ou de estudante)</span><span class="sxs-lookup"><span data-stu-id="f144c-113">Delegated (work or school account)</span></span>|<span data-ttu-id="f144c-114">DeviceManagementServiceConfig.ReadWrite.All, DeviceManagementServiceConfig.Read.All</span><span class="sxs-lookup"><span data-stu-id="f144c-114">DeviceManagementServiceConfig.ReadWrite.All, DeviceManagementServiceConfig.Read.All</span></span>|
|<span data-ttu-id="f144c-115">Delegado (conta pessoal da Microsoft)</span><span class="sxs-lookup"><span data-stu-id="f144c-115">Delegated (personal Microsoft account)</span></span>|<span data-ttu-id="f144c-116">Sem suporte.</span><span class="sxs-lookup"><span data-stu-id="f144c-116">Not supported.</span></span>|
|<span data-ttu-id="f144c-117">Aplicativo</span><span class="sxs-lookup"><span data-stu-id="f144c-117">Application</span></span>|<span data-ttu-id="f144c-118">DeviceManagementServiceConfig.ReadWrite.All, DeviceManagementServiceConfig.Read.All</span><span class="sxs-lookup"><span data-stu-id="f144c-118">DeviceManagementServiceConfig.ReadWrite.All, DeviceManagementServiceConfig.Read.All</span></span>|
...
<span data-ttu-id="f144c-130">Se tiver êxito, esta ação retornará um código de resposta `200 OK` e uma cadeia de caracteres no corpo da resposta.</span><span class="sxs-lookup"><span data-stu-id="f144c-130">If successful, this action returns a `200 OK` response code and a String in the response body.</span></span>
