...
|:---|:---|:---|
|metricName|String|Ainda não documentado|
...
Se tiver êxito, essa ação retornará um código de resposta e uma `200 OK` coleção [metricTimeSeriesDataPoint](../resources/intune-mstunnel-metrictimeseriesdatapoint.md) no corpo da resposta.
