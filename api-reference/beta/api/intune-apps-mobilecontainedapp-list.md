...
Listar propriedades e relações dos objetos [mobileContainedApp.](../resources/intune-apps-mobilecontainedapp.md)
...
Se tiver êxito, este método retornará um código de resposta e uma `200 OK` coleção de [objetos mobileContainedApp](../resources/intune-apps-mobilecontainedapp.md) no corpo da resposta.
