...
---
# <a name="update-aospdeviceownerdeviceconfiguration"></a>Atualizar aospDeviceOwnerDeviceConfiguration
...
Atualize as propriedades de um [objeto aospDeviceOwnerDeviceConfiguration.](../resources/intune-deviceconfig-aospdeviceownerdeviceconfiguration.md)
...
No corpo da solicitação, fornece uma representação JSON para o [objeto aospDeviceOwnerDeviceConfiguration.](../resources/intune-deviceconfig-aospdeviceownerdeviceconfiguration.md)

A tabela a seguir mostra as propriedades que são necessárias ao criar [o aospDeviceOwnerDeviceConfiguration](../resources/intune-deviceconfig-aospdeviceownerdeviceconfiguration.md).
...
|storageAllowUsb|Booleano|Indica se o armazenamento USB deve ou não ser bloqueado.|
...
|backupBlocked|Booleano|Indica se o serviço de backup deve ou não ser bloqueado.|
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto aospDeviceOwnerDeviceConfiguration](../resources/intune-deviceconfig-aospdeviceownerdeviceconfiguration.md) atualizado no corpo da resposta.
