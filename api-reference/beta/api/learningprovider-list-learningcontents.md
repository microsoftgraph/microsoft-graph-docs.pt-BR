---
title: Listar learningContents
description: Obtenha uma lista dos objetos learningContent e suas propriedades.
author: malabikaroy
...
ms.locfileid: "66883242"
---
# <a name="list-learningcontents"></a>Listar learningContents
Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Obtenha uma lista dos recursos [learningContent](../resources/learningcontent.md) e suas propriedades.

Essa lista representa os metadados do conteúdo do provedor especificado em Aprendizagem do Viva.
...
Se tiver êxito, este método retornará um código `200 OK` de resposta e uma coleção de [objetos learningContent](../resources/learningcontent.md) no corpo da resposta.
