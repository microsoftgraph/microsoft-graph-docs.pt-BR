...
Leia propriedades e relações do [objeto macOSLobApp.](../resources/intune-apps-macoslobapp.md)
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto macOSLobApp](../resources/intune-apps-macoslobapp.md) no corpo da resposta.
