...
---
# <a name="update-openshiftchangerequest"></a>Atualizar openshiftchangerequest

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Atualiza as propriedades de um objeto [openShiftChangeRequest](../resources/openshiftchangerequest.md) .
...
Se tiver êxito, este método retornará `200 OK` um código de resposta e um objeto [openShiftChangeRequest](../resources/openshiftchangerequest.md) atualizado no corpo da resposta.
