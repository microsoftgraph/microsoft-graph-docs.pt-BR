...
Leia as propriedades e os relacionamentos do objeto [officeClientConfigurationAssignment](../resources/intune-cirrus-officeclientconfigurationassignment.md) .
...
Se tiver êxito, este método retornará um `200 OK` objeto response de código e [officeClientConfigurationAssignment](../resources/intune-cirrus-officeclientconfigurationassignment.md) no corpo da resposta.
