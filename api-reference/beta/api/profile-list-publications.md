...
description: Obter o itemPublications da propriedade de navegação de publicações.
...
ms.locfileid: "61019357"
---
# <a name="list-publications"></a>Listar publicações
Namespace: microsoft.graph

Recupere uma lista de [objetos itemPublication](../resources/itempublication.md) do perfil de um [usuário.](../resources/profile.md)
...
Se tiver êxito, este método retornará um código de resposta e uma `200 OK` coleção [de objetos itemPublication](../resources/itempublication.md) no corpo da resposta.
