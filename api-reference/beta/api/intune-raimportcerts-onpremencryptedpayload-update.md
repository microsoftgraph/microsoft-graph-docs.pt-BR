...
Atualize as propriedades de [um objeto onPremEncryptedPayload.](../resources/intune-raimportcerts-onpremencryptedpayload.md)
...
No corpo da solicitação, fornece uma representação JSON para o [objeto onPremEncryptedPayload.](../resources/intune-raimportcerts-onpremencryptedpayload.md)

A tabela a seguir mostra as propriedades que são necessárias ao criar [o onPremEncryptedPayload](../resources/intune-raimportcerts-onpremencryptedpayload.md).
...
Se tiver êxito, este método retornará um código de resposta e um `200 OK` [objeto onPremEncryptedPayload](../resources/intune-raimportcerts-onpremencryptedpayload.md) atualizado no corpo da resposta.
