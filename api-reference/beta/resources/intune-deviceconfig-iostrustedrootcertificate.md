...
description: Perfil de configuração do Certificado Raiz Confiável do iOS.
author: dougeby
...
Perfil de configuração do Certificado Raiz Confiável do iOS.
...
|[Obter iosTrustedRootCertificate](../api/intune-deviceconfig-iostrustedrootcertificate-get.md)|[iosTrustedRootCertificate](../resources/intune-deviceconfig-iostrustedrootcertificate.md)|Ler propriedades e relações do objeto [iosTrustedRootCertificate](../resources/intune-deviceconfig-iostrustedrootcertificate.md) .|
