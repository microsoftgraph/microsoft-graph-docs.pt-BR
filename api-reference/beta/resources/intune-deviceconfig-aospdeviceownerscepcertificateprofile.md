---
title: tipo de recurso aospDeviceOwnerScepCertificateProfile
description: Perfil de certificado SCEP do proprietário do dispositivo AOSP
author: dougeby
...
ms.locfileid: "66667905"
---
# <a name="aospdeviceownerscepcertificateprofile-resource-type"></a>tipo de recurso aospDeviceOwnerScepCertificateProfile
...
Perfil de certificado SCEP do proprietário do dispositivo AOSP
...
|:---|:---|:---|
|[Listar aospDeviceOwnerScepCertificateProfiles](../api/intune-deviceconfig-aospdeviceownerscepcertificateprofile-list.md)|[coleção aospDeviceOwnerScepCertificateProfile](../resources/intune-deviceconfig-aospdeviceownerscepcertificateprofile.md)|Listar propriedades e relações dos [objetos aospDeviceOwnerScepCertificateProfile](../resources/intune-deviceconfig-aospdeviceownerscepcertificateprofile.md) .|
|[Obter aospDeviceOwnerScepCertificateProfile](../api/intune-deviceconfig-aospdeviceownerscepcertificateprofile-get.md)|[aospDeviceOwnerScepCertificateProfile](../resources/intune-deviceconfig-aospdeviceownerscepcertificateprofile.md)|Ler propriedades e relações do [objeto aospDeviceOwnerScepCertificateProfile](../resources/intune-deviceconfig-aospdeviceownerscepcertificateprofile.md) .|
|[Criar aospDeviceOwnerScepCertificateProfile](../api/intune-deviceconfig-aospdeviceownerscepcertificateprofile-create.md)|[aospDeviceOwnerScepCertificateProfile](../resources/intune-deviceconfig-aospdeviceownerscepcertificateprofile.md)|Crie um [novo objeto aospDeviceOwnerScepCertificateProfile](../resources/intune-deviceconfig-aospdeviceownerscepcertificateprofile.md) .|
|[Excluir aospDeviceOwnerScepCertificateProfile](../api/intune-deviceconfig-aospdeviceownerscepcertificateprofile-delete.md)|Nenhum|Exclui um [aospDeviceOwnerScepCertificateProfile](../resources/intune-deviceconfig-aospdeviceownerscepcertificateprofile.md).|
|[Atualizar aospDeviceOwnerScepCertificateProfile](../api/intune-deviceconfig-aospdeviceownerscepcertificateprofile-update.md)|[aospDeviceOwnerScepCertificateProfile](../resources/intune-deviceconfig-aospdeviceownerscepcertificateprofile.md)|Atualize as propriedades de um [objeto aospDeviceOwnerScepCertificateProfile](../resources/intune-deviceconfig-aospdeviceownerscepcertificateprofile.md) .|
...
|Certificatestore|[Certificatestore](../resources/intune-shared-certificatestore.md)|Certificado do repositório de destino. Esta coleção pode conter um máximo de 500 elementos. Os valores possíveis são: `user` e `machine`.|
