...
|ipAddress|String|O endereço IP do cliente de onde a conexão ocorreu.|
...
|tokenIssuerType|String|O tipo de provedor de identidade. Valores possíveis: `AzureAD`, `ADFederationServices`, ou `UnknownFutureValue`.|
