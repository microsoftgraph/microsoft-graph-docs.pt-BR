...
|enableExpeditedCheckin|Boolean|Obtém ou define se é para habilitar check-ins de dispositivos expedidos. herdado de [appleExpeditedCheckinConfigurationBase](../resources/intune-deviceconfig-appleexpeditedcheckinconfigurationbase.md)|
