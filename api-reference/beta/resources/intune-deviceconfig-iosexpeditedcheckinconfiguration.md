...
|enableExpeditedCheckin|Boleano|Obtém ou define se deve habilitar check-ins de dispositivos rápidos. Herdado [do appleExpeditedCheckinConfigurationBase](../resources/intune-deviceconfig-appleexpeditedcheckinconfigurationbase.md)|
