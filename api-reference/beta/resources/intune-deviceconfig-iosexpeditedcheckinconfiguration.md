...
description: Perfil experimental para aumentar a taxa de check-ins de dispositivos por dia de dispositivos iOS.
author: dougeby
...
Perfil experimental para aumentar a taxa de check-ins de dispositivos por dia de dispositivos iOS.
...
|[Obter iosExpeditedCheckinConfiguration](../api/intune-deviceconfig-iosexpeditedcheckinconfiguration-get.md)|[iosExpeditedCheckinConfiguration](../resources/intune-deviceconfig-iosexpeditedcheckinconfiguration.md)|Ler propriedades e relações do objeto [iosExpeditedCheckinConfiguration](../resources/intune-deviceconfig-iosexpeditedcheckinconfiguration.md) .|
|[Criar iosExpeditedCheckinConfiguration](../api/intune-deviceconfig-iosexpeditedcheckinconfiguration-create.md)|[iosExpeditedCheckinConfiguration](../resources/intune-deviceconfig-iosexpeditedcheckinconfiguration.md)|Crie um novo [objeto iosExpeditedCheckinConfiguration](../resources/intune-deviceconfig-iosexpeditedcheckinconfiguration.md) .|
|[Excluir iosExpeditedCheckinConfiguration](../api/intune-deviceconfig-iosexpeditedcheckinconfiguration-delete.md)|Nenhum|Exclui um [iosExpeditedCheckinConfiguration](../resources/intune-deviceconfig-iosexpeditedcheckinconfiguration.md).|
|[Atualizar iosExpeditedCheckinConfiguration](../api/intune-deviceconfig-iosexpeditedcheckinconfiguration-update.md)|[iosExpeditedCheckinConfiguration](../resources/intune-deviceconfig-iosexpeditedcheckinconfiguration.md)|Atualize as propriedades de [um objeto iosExpeditedCheckinConfiguration](../resources/intune-deviceconfig-iosexpeditedcheckinconfiguration.md) .|
...
|enableExpeditedCheckin|Boolean|Obtém ou define se os check-ins de dispositivo agilizarão devem ser habilitados. Herdado [de appleExpeditedCheckinConfigurationBase](../resources/intune-deviceconfig-appleexpeditedcheckinconfigurationbase.md)|
