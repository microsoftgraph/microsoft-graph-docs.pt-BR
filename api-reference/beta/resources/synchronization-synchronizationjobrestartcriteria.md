...
|:---------------|:--------|:----------|
|resetScope|Cadeia de caracteres| Combinação de separada por vírgulas dos seguintes valores: `Full`, `QuarantineState`, `Watermark`, `Escrows`, `ConnectorDataStore`. Uso `Full` se desejar que todas as opções.|
