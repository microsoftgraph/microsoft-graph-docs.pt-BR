...
|categories|String collection|As categorias associadas à postagem. Cada categoria corresponde à propriedade **displayName** de uma [outlookCategory](outlookcategory.md) que foi definida para um usuário.|
...
|importance | importância| A importância de uma postagem de grupo: `low` , `normal` , `high` . |
...
|:---------------|:--------|:----------|
|attachments|Coleção [Attachment](attachment.md)|A coleção [de anexos fileAttachment,](fileattachment.md) [itemAttachment](itemattachment.md)e [referenceAttachment](referenceattachment.md) para a postagem. Somente leitura. Anulável. Suporta o `$expand`.|
...
|inReplyTo|[Post](post.md)|A postagem anterior à que esta postagem está respondendo na [conversaThread](conversationthread.md). Somente leitura. Oferece suporte para `$expand`.|
