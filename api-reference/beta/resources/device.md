...
| [getMemberGroups](../api/directoryobject-getmembergroups.md) | String collection | Retorne todos os grupos dos que o dispositivo é membro. A verificação é transitiva. |
