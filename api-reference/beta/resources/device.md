...
|deviceOwnership|String|Propriedade do dispositivo. Essa propriedade é definida por Intune. Os valores possíveis são: `unknown`, `company`, `personal`.|
...
|Hostnames|Coleção String| Lista de hostNames para o dispositivo.|
...
|nome| String | Nome amigável de um dispositivo. Retornado somente se o usuário entrar com uma conta da Microsoft como parte do Project Rome. |
|status | String| O dispositivo é `online` ou `offline`. Retornado somente se o usuário entrar com uma conta da Microsoft como parte do Project Rome. |
|plataforma |String|Plataforma do dispositivo. Retornado somente se o usuário entrar com uma conta da Microsoft como parte do Project Rome. Retornado somente se o usuário entrar com uma conta da Microsoft como parte do Project Rome.|
|Tipo| String| Fator forma do dispositivo. Retornado somente se o usuário entrar com uma conta da Microsoft como parte do Project Rome. |
