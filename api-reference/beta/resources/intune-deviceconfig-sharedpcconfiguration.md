...
|Localstorage|[Capacitação](../resources/intune-deviceconfig-enablement.md)|Especifica se o armazenamento local é permitido em um PC compartilhado. Os valores possíveis são: `notConfigured`, `enabled`, `disabled`.|
|allowLocalStorage|Boolean|Especifica se o armazenamento local é permitido em um PC compartilhado.|
|setAccountManager|[Capacitação](../resources/intune-deviceconfig-enablement.md)|Desabilita o gerente de contas para o modo de PC compartilhado. Os valores possíveis são: `notConfigured`, `enabled`, `disabled`.|
|disableAccountManager|Boolean|Desabilita o gerente de contas para o modo de PC compartilhado.|
|setEduPolicies|[Capacitação](../resources/intune-deviceconfig-enablement.md)|Especifica se as políticas de ambiente de educação do computador compartilhado padrão devem ser habilitadas/desabilitadas/não configuradas. Para o Windows 10 RS2 e posterior, essa política será aplicada sem configurar Enabled como true. Os valores possíveis são: `notConfigured`, `enabled`, `disabled`.|
...
|setPowerPolicies|[Capacitação](../resources/intune-deviceconfig-enablement.md)|Especifica se as políticas de energia do computador compartilhado padrão devem ser habilitadas/desabilitadas. Os valores possíveis são: `notConfigured`, `enabled`, `disabled`.|
|disablePowerPolicies|Boolean|Especifica se as políticas padrão de energia do PC compartilhado devem ser desabilitadas.|
|signInOnResume|[Capacitação](../resources/intune-deviceconfig-enablement.md)|Especifica o requisito de entrar sempre que o dispositivo é ativado do modo de compatibilidade. Os valores possíveis são: `notConfigured`, `enabled`, `disabled`.|
...
|fastFirstSignIn|[Capacitação](../resources/intune-deviceconfig-enablement.md)|Especifica se é necessário conectar automaticamente novas contas não administrativas Azure AD contas locais candidatas pré-configuradas. Os valores possíveis são: `notConfigured`, `enabled`, `disabled`.|
