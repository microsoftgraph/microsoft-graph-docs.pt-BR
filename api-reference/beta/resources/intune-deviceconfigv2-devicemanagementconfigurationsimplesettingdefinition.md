...
|valueDefinition|[deviceManagementConfigurationSettingValueDefinition](../resources/intune-shared-devicemanagementconfigurationsettingvaluedefinition.md)|Definição do valor dessa configuração|
|Defaultvalue|[deviceManagementConfigurationSettingValue](../resources/intune-shared-devicemanagementconfigurationsettingvalue.md)|Valor de configuração padrão para essa configuração|
|dependentOn|[Coleção deviceManagementConfigurationDependentOn](../resources/intune-shared-devicemanagementconfigurationdependenton.md)|lista de configurações pai de que essa configuração depende|
