...
description: A análise de experiência do usuário funciona de qualquer lugar Windows 10 de dispositivos.
author: dougeby
...
A análise de experiência do usuário funciona de qualquer lugar Windows 10 de dispositivos.

## <a name="properties"></a>Propriedades
|Propriedade|Tipo|Descrição|
|:---|:---|:---|
|unsupportedOSversionDeviceCount|Int32|A contagem de Windows 10 que têm versões do sistema operacional sem suporte.|
