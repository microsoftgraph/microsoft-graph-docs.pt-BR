...
|[Listar anexos de uma tarefa do Outlook](../api/outlooktask-list-attachments.md) (preterido) | Coleção [anexo](attachment.md) | Obter uma lista de anexos para uma tarefa do Outlook. |
