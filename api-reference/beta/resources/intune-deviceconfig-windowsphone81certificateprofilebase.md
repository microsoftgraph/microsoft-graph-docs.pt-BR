...
description: Perfil Windows Phone de certificado 8.1+.
author: dougeby
...
Perfil Windows Phone de certificado 8.1+.
...
|certificateValidityPeriodValue|Int32|Valor para o Período válido do certificado.|
