...
Perfil de certificado base do Windows Phone 8.1 +.
...
|:---|:---|:---|
|[Listar windowsPhone81CertificateProfileBases](../api/intune-deviceconfig-windowsphone81certificateprofilebase-list.md)|coleção [windowsPhone81CertificateProfileBase](../resources/intune-deviceconfig-windowsphone81certificateprofilebase.md)|Listar Propriedades e relações dos objetos [windowsPhone81CertificateProfileBase](../resources/intune-deviceconfig-windowsphone81certificateprofilebase.md) .|
...
|keyStorageProvider|[keyStorageProviderOption](../resources/intune-deviceconfig-keystorageprovideroption.md)|Provedor de armazenamento de chaves (KSP). Os valores possíveis são: `useTpmKspOtherwiseUseSoftwareKsp`, `useTpmKspOtherwiseFail`, `usePassportForWorkKspOtherwiseFail`, `useSoftwareKsp`.|
