...
| startTime | Cadeia de caracteres (TimeOfDay) | A hora do dia em que o usuário começa a trabalhar. |
| endTime | Cadeia de caracteres (TimeOfDay) | A hora do dia em que o usuário para de trabalhar. |
