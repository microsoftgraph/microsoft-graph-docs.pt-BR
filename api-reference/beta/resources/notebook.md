...
|[getNotebookFromWebUrl](../api/notebook-getnotebookfromweburl.md) | [Notebook](notebook.md) | Recupere as propriedades e relacionamentos de um objeto de bloco de anotações usando o caminho da URL. |
