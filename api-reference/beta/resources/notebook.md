...
|[Listar seções](../api/notebook_list_sections.md) |Coleção [Section](section.md)| Obtenha uma coleção de seções no bloco de anotações especificado.|
|[copyNotebook](../api/notebook_copynotebook.md)| None | Copia um bloco de anotações.|
