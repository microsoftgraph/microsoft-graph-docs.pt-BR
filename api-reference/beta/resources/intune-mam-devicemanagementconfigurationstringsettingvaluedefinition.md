...
|maximumLength|Int64|Comprimento máximo da cadeia de caracteres|
|Minimumlength|Int64|Comprimento mínimo da cadeia de caracteres|
|isSecret|Booliano|Especifica se a configuração precisa ser tratada como um segredo. As configurações marcadas como sim serão criptografadas em trânsito e em repouso e serão exibidas como asteriscos quando representadas na experiência do usuário.|
