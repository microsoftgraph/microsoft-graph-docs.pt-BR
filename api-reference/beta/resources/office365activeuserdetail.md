...
| hasExchangeLicense                | Boolean           | Se o usuário recebeu uma licença de Exchange. |
| hasOneDriveLicense                | Boolean           | Se o usuário recebeu uma licença de OneDrive. |
| hasSharePointLicense              | Boolean           | Se o usuário recebeu uma licença de SharePoint. |
| hasSkypeForBusinessLicense        | Boolean           | Se o usuário recebeu uma licença Skype for Business. |
| hasYammerLicense                  | Boolean           | Se o usuário recebeu uma licença de Yammer. |
| hasTeamsLicense                   | Boolean           | Se o usuário recebeu uma licença de Teams. |
