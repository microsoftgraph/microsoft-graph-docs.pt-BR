...
|:-------------|:------------|:------------|
|contentData|String|Conteúdo do arquivo de email .eml codificado em Base64. O conteúdo do arquivo não pode ser buscado de volta porque não está armazenado.|
