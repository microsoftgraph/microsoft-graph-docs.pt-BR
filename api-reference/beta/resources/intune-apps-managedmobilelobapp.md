...
|[Acessar managedMobileLobApp](../api/intune-apps-managedmobilelobapp-get.md)|[managedMobileLobApp](../resources/intune-apps-managedmobilelobapp.md)|Propriedades de leitura e relações do objeto [managedMobileLobApp](../resources/intune-apps-managedmobilelobapp.md).|
...
|notes|Cadeia de caracteres|Anotações do aplicativo. Herdada de [mobileApp](../resources/intune-apps-mobileapp.md)|
