...
|esimBlockModification|Boolean|Indica se a adição ou remoção de planos de rede celular será ou não permitir o eSIM de um dispositivo supervisionado.|
...
|privacyForceLimitAdTracking|Boolean|Indica se o rastreamento de dados é limitado. (iOS 7.0 e posterior).|
|enterpriseBookBlockBackup|Boolean|Indica se o back-up do livro Corporativo está bloqueado ou não.|
