...
|**Política de Grupo Analytics**|
|groupPolicyObjectFiles|[coleção groupPolicyObjectFile](../resources/intune-gpanalyticsservice-grouppolicyobjectfile.md)|Uma lista de arquivos Política de Grupo Object carregados.|
|**Integração**|
...
|androidManagedStoreAppConfigurationSchemas|[coleção androidManagedStoreAppConfigurationSchema](../resources/intune-androidforwork-androidmanagedstoreappconfigurationschema.md)|Entidades Enterprise de configuração de aplicativos do Android.|
|**Auditoria**|
...
|windowsAutopilotSettings|[windowsAutopilotSettings](../resources/intune-enrollment-windowsautopilotsettings.md)|As Windows de conta do piloto automático.|
|**SIM incorporado**|
...
|intuneBrandingProfiles|[Coleção intuneBrandingProfile](../resources/intune-wip-intunebrandingprofile.md)|Intune perfis de identidade visual direcionados a AAD grupos|
