...
|deviceUpdateStates|coleção [windowsUpdateState](../resources/intune-deviceconfig-windowsupdatestate.md)|Estados do dispositivo de configuração do Windows Update para empresas.|
