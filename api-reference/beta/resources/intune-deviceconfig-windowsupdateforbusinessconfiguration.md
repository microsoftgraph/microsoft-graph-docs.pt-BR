...
|qualityUpdatesPauseStartDateTime|String|Qualidade pausa de atualizações iniciar datetime|
|featureUpdatesPauseStartDateTime|String|Recurso Iniciar de pausar atualizações datetime|
