...
|deviceUpdateStates|coleção [windowsUpdateState](../resources/intune-shared-windowsupdatestate.md)|Estados do dispositivo de configuração do Windows Update para empresas.|
