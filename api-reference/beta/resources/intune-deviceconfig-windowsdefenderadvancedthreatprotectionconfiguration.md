...
|advancedThreatProtectionOnboardingBlob|Cadeia de Caracteres|Windows Defender blob de integração advancedThreatProtection.|
...
|advancedThreatProtectionAutoPopulateOnboardingBlob|Booleano|Preencher automaticamente o blob de integração programaticamente do serviço proteção avançada contra ameaças|
...
|advancedThreatProtectionOffboardingBlob|Cadeia de Caracteres|Windows Defender Blob de Remoção de AdvancedThreatProtection.|
