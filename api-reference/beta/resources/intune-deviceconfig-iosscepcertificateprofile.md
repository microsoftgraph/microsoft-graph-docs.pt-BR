...
|[Obter iosScepCertificateProfile](../api/intune-deviceconfig-iosscepcertificateprofile-get.md)|[iosScepCertificateProfile](../resources/intune-deviceconfig-iosscepcertificateprofile.md)|Ler propriedades e relações do objeto [iosScepCertificateProfile](../resources/intune-deviceconfig-iosscepcertificateprofile.md) .|
...
|customSubjectAlternativeNames|[coleção customSubjectAlternativeName](../resources/intune-deviceconfig-customsubjectalternativename.md)|Configurações de Nome Alternativo da Entidade Personalizada. A variável OnPremisesUserPrincipalName é compatível, bem como outras documentadas aqui: https://go.microsoft.com/fwlink/?LinkId=2027630. Esta coleção pode conter um máximo de 500 elementos.|
