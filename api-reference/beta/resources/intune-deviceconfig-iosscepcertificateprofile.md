...
|[Excluir iosScepCertificateProfile](../api/intune-deviceconfig-iosscepcertificateprofile-delete.md)|Nenhum(a)|Exclui um [iosScepCertificateProfile](../resources/intune-deviceconfig-iosscepcertificateprofile.md).|
