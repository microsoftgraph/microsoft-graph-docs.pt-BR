...
|[Excluir dataSharingConsent](../api/intune-devices-datasharingconsent-delete.md)|Nenhum(a)|Exclui um [dataSharingConsent](../resources/intune-devices-datasharingconsent.md).|
