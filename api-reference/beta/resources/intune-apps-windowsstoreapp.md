...
---
# <a name="windowsstoreapp-resource-type"></a>tipo de recurso de windowsStoreApp

> **Importante:** as APIs na versão /beta no Microsoft Graph estão em visualização e estão sujeitas a alterações. Não há suporte para o uso dessas APIs em aplicativos de produção.

> **Observação:** O uso das APIs do Microsoft Graph para configurar controles e políticas do Intune ainda exige que o serviço do Intune seja [corretamente licenciado](https://go.microsoft.com/fwlink/?linkid=839381) pelo cliente.

Contém propriedades e as propriedades herdadas para aplicativos da Windows Store.
...
|:---|:---|:---|
|[Lista windowsStoreApps](../api/intune-apps-windowsstoreapp-list.md)|coleção [windowsStoreApp](../resources/intune-apps-windowsstoreapp.md)|Lista as propriedades e os relacionamentos dos objetos [windowsStoreApp](../resources/intune-apps-windowsstoreapp.md) .|
|[Obter windowsStoreApp](../api/intune-apps-windowsstoreapp-get.md)|[windowsStoreApp](../resources/intune-apps-windowsstoreapp.md)|Leia as propriedades e os relacionamentos do objeto [windowsStoreApp](../resources/intune-apps-windowsstoreapp.md) .|
|[Criar windowsStoreApp](../api/intune-apps-windowsstoreapp-create.md)|[windowsStoreApp](../resources/intune-apps-windowsstoreapp.md)|Crie um novo objeto de [windowsStoreApp](../resources/intune-apps-windowsstoreapp.md) .|
|[Excluir windowsStoreApp](../api/intune-apps-windowsstoreapp-delete.md)|Nenhum|Exclui um [windowsStoreApp](../resources/intune-apps-windowsstoreapp.md).|
|[Atualizar windowsStoreApp](../api/intune-apps-windowsstoreapp-update.md)|[windowsStoreApp](../resources/intune-apps-windowsstoreapp.md)|Atualize as propriedades de um objeto [windowsStoreApp](../resources/intune-apps-windowsstoreapp.md) .|
...
|appStoreUrl|String|A URL de repositório de aplicativo do Windows.|
