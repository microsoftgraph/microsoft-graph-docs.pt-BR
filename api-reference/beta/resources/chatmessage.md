...
|:---------------|:--------|:----------|
|id|String| Somente leitura. Identificação exclusiva da mensagem.|
...
|messageType|String|Os valores de tipo de mensagem, atual com suporte são: mensagem, chatEvent, digitando|
