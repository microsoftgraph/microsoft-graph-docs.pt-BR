...
description: Lista a API Graph microsoft para pontos de extremidade do Intune (REST) que definem termos e condições para uma organização de locatários.
