...
| givenName                    | Cadeia de caracteres                                                     | Nome para esse contato organizacional.                                                                                                                                                                                                                                                                                                                                     |
...
|Email|Cadeia de caracteres| O endereço SMTP do contato, por exemplo, "jeff@contoso.onmicrosoft.com". |
| mailNickname                 | Cadeia de caracteres                                                     | Alias de email (parte do endereço de email previamente pendente o símbolo @) para esse contato organizacional.                                                                                                                                                                                                                                                                                |
