...
---
# <a name="androidcertificateprofilebase-resource-type"></a>tipo de recurso de androidCertificateProfileBase

> **Importante:** as APIs na versão /beta no Microsoft Graph estão em visualização e estão sujeitas a alterações. Não há suporte para o uso dessas APIs em aplicativos de produção.

> **Observação:** O uso das APIs do Microsoft Graph para configurar controles e políticas do Intune ainda exige que o serviço do Intune seja [corretamente licenciado](https://go.microsoft.com/fwlink/?linkid=839381) pelo cliente.

Perfil de certificado Android base.
...
|:---|:---|:---|
|[Lista androidCertificateProfileBases](../api/intune-deviceconfig-androidcertificateprofilebase-list.md)|coleção [androidCertificateProfileBase](../resources/intune-deviceconfig-androidcertificateprofilebase.md)|Lista as propriedades e os relacionamentos dos objetos [androidCertificateProfileBase](../resources/intune-deviceconfig-androidcertificateprofilebase.md) .|
|[Obter androidCertificateProfileBase](../api/intune-deviceconfig-androidcertificateprofilebase-get.md)|[androidCertificateProfileBase](../resources/intune-deviceconfig-androidcertificateprofilebase.md)|Leia as propriedades e os relacionamentos do objeto [androidCertificateProfileBase](../resources/intune-deviceconfig-androidcertificateprofilebase.md) .|
