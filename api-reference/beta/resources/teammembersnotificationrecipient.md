...
---
# <a name="teammembersnotificationrecipient-resource-type"></a>Tipo de recurso teamMembersNotificationRecipient

Namespace: microsoft.graph

[!INCLUDE [beta-disclaimer](../../includes/beta-disclaimer.md)]

Representa o destinatário de uma notificação enviada em um feed Microsoft Teams atividade. O destinatário consiste nos membros da equipe.
...
|:---|:---|:---|
|teamId|String|O identificador da equipe.|
