...
|:-------------|:------------|:------------|
|ação|Cadeia de caracteres|Indica o nome da atividade ou o nome da operação (por exemplo, Criar usuário, Adicionar membro ao grupo). Para uma lista de atividades registradas, consulte a lista de atividades do Azure AD.|
...
|changeId|Cadeia de caracteres|ID exclusiva dessa alteração neste ciclo.|
|cycleId|Cadeia de caracteres|ID exclusiva por iteração de trabalho.|
...
|jobId|Cadeia de caracteres|A ID exclusiva para todo o trabalho de provisionamento.|
