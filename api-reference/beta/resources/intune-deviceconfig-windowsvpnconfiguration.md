...
|[Obter windowsVpnConfiguration](../api/intune-deviceconfig-windowsvpnconfiguration-get.md)|[windowsVpnConfiguration](../resources/intune-deviceconfig-windowsvpnconfiguration.md)|Ler propriedades e relações do objeto [windowsVpnConfiguration](../resources/intune-deviceconfig-windowsvpnconfiguration.md) .|
...
|customXml|Binária|Comandos XML personalizados que configuram a conexão VPN. (Matriz de bytes codificados em UTF8)|
