...
|excludeList|Coleção String|Somente Zscaler. Lista de endereços de rede que não são enviados pela nuvem Zscaler. Herdado [do iosVpnConfiguration](../resources/intune-deviceconfig-iosvpnconfiguration.md)|
