...
|excludedDomains|Coleção String|Domínios que são acessados por meio da Internet pública em vez de via VPN, mesmo quando a VPN por aplicativo é ativada herdada de [appleVpnConfiguration](../resources/intune-deviceconfig-applevpnconfiguration.md)|
...
|Excludelistpara|Coleção String|Zscaler apenas. Lista de endereços de rede que não são enviados pela nuvem do Zscaler. Herdado de [iosVpnConfiguration](../resources/intune-deviceconfig-iosvpnconfiguration.md)|
...
|microsoftTunnelSiteId|Cadeia de caracteres|ID de site de túnel da Microsoft. Herdado de [iosVpnConfiguration](../resources/intune-deviceconfig-iosvpnconfiguration.md)|
