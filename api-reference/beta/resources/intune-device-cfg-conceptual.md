...
- [Configuração empresarial do proprietário do dispositivo Android Wi-Fi dispositivo Android](intune-deviceconfig-androiddeviceownerenterprisewificonfiguration.md)
...
- [Navegação do sistema de personalização do quiosque do proprietário do dispositivo Android](intune-deviceconfig-androiddeviceownerkioskcustomizationsystemnavigation.md)
...
- [Pasta gerenciada do modo gerenciado do modo de quiosque do proprietário do dispositivo Android](intune-deviceconfig-androiddeviceownerkioskmodemanagedfolder.md)
...
- [Tipo de botão página principal virtual do proprietário do dispositivo Android](intune-deviceconfig-androiddeviceownervirtualhomebuttontype.md)
...
- [Configuração always on da VPN da Apple](intune-deviceconfig-applevpnalwaysonconfiguration.md)
...
- [Extensão de credencial de login único](intune-deviceconfig-credentialsinglesignonextension.md)
...
- [Operador de script de conformidade do dispositivo](intune-deviceconfig-devicecompliancescriptruloperator.md)
...
- [Modo de dispositivo de regra de aplicabilidade de gerenciamento de dispositivos](intune-deviceconfig-devicemanagementapplicabilityruledevicemode.md)
...
- [Categoria da política de grupo](intune-grouppolicy-grouppolicycategory.md)
...
- [Extensão de single sign on do azure ad do iOS](intune-deviceconfig-iosazureadsinglesignonextension.md)
...
- [Extensão de login único de credencial do iOS](intune-deviceconfig-ioscredentialsinglesignonextension.md)
...
- [Configuração de verificação expedida do iOS](intune-deviceconfig-iosexpeditedcheckinconfiguration.md)
...
- [Extensão de single sign on kerberos do iOS](intune-deviceconfig-ioskerberossinglesignonextension.md)
- [Tipo de aplicativo do modo de quiosque do iOS](intune-deviceconfig-ioskioskmodeapptype.md)
...
- [Extensão de single sign on do iOS](intune-deviceconfig-iossinglesignonextension.md)
...
- [Extensão de single sign on Kerberos](intune-deviceconfig-kerberossinglesignonextension.md)
- [Par de valores boolianas principais](intune-deviceconfig-keybooleanvaluepair.md)
...
- [Receptor de eventos da apple macOS](intune-deviceconfig-macosappleeventreceiver.md)
- [Item de domínios associados ao macOS](intune-deviceconfig-macosassociateddomainsitem.md)
- [Extensão de single sign on do azure ad do macOS](intune-deviceconfig-macosazureadsinglesignonextension.md)
...
- [Política de cliente de cache de conteúdo do macOS](intune-deviceconfig-macoscontentcachingclientpolicy.md)
- [Política de seleção pai do cache de conteúdo do macOS](intune-deviceconfig-macoscontentcachingparentselectionpolicy.md)
...
- [Extensão de single sign on da credencial do macOS](intune-deviceconfig-macoscredentialsinglesignonextension.md)
...
- [Tipos de chave de recuperação do arquivo macOS](intune-deviceconfig-macosfilevaultrecoverykeytypes.md)
...
- [Extensão de single sign on kerberos do macOS](intune-deviceconfig-macoskerberossinglesignonextension.md)
...
- [Extensão de sinal único de redirecionamento do macOS](intune-deviceconfig-macosredirectsinglesignonextension.md)
- [Perfil de certificado do SCEP do macOS](intune-deviceconfig-macosscepcertificateprofile.md)
- [Extensão de single sign on do macOS](intune-deviceconfig-macossinglesignonextension.md)
- [Resumo da conta de atualização de software do macOS](intune-deviceconfig-macossoftwareupdateaccountsummary.md)
- [Comportamento de atualização de software do macOS](intune-deviceconfig-macossoftwareupdatebehavior.md)
- [Categoria de atualização de software do macOS](intune-deviceconfig-macossoftwareupdatecategory.md)
- [Resumo da categoria de atualização de software do macOS](intune-deviceconfig-macossoftwareupdatecategorysummary.md)
- [Configuração de atualização de software do macOS](intune-deviceconfig-macossoftwareupdateconfiguration.md)
- [Política de atraso de atualização de software do macOS](intune-deviceconfig-macossoftwareupdatedelaypolicy.md)
- [Tipo de agendamento de atualização de software do macOS](intune-deviceconfig-macossoftwareupdatescheduletype.md)
- [Estado de atualização de software do macOS](intune-deviceconfig-macossoftwareupdatestate.md)
...
- [Carga criptografada no prem](intune-raimportcerts-onpremencryptedpayload.md)
...
- [Redirecionar extensão de sinal único](intune-deviceconfig-redirectsinglesignonextension.md)
...
- [Dispositivo gerenciado agendado para desaposente](intune-deviceconfig-retirescheduledmanageddevice.md)
- [Tipo de filtro de pesquisa segura](intune-deviceconfig-safesearchfiltertype.md)
- [Estado de desaposente agendado](intune-deviceconfig-scheduledretirestate.md)
...
- [Extensão de single sign on](intune-deviceconfig-singlesignonextension.md)
...
- [Plug-ins de rede cativos especificados](intune-deviceconfig-specifiedcaptivenetworkplugins.md)
...
- [Taxa de detecção de ponto morto de VPN](intune-deviceconfig-vpndeadpeerdetectionrate.md)
...
- [Tipo de autenticação de Wi-Fi](intune-deviceconfig-wifiauthenticationtype.md)
...
- [Agenda de atualização force do quiosque do Windows](intune-deviceconfig-windowskioskforceupdateschedule.md)
