...
description: Perfil experimental para aumentar a taxa de check-ins de dispositivos por dia de dispositivos iOS/macOS.
author: dougeby
...
Perfil experimental para aumentar a taxa de check-ins de dispositivos por dia de dispositivos iOS/macOS.
...
|enableExpeditedCheckin|Booleano|Obtém ou define se os check-ins de dispositivo agilizarão devem ser habilitados.|
