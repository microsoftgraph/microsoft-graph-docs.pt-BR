...
Ao fornecer as configurações nesse perfil, você pode instruir o Windows Phone 8.1 a se conectar ao ponto de extremidade vpn desejado. Especificando o método de autenticação e os tipos de segurança esperados pelo ponto de extremidade VPN, você pode tornar a conexão VPN perfeita para o usuário final.
...
|enableSplitTunneling|Booliano|Habilite o túnel dividido para a VPN. Herdado [do windows81VpnConfiguration](../resources/intune-deviceconfig-windows81vpnconfiguration.md)|
...
|bypassVpnOnHomeWifi|Booliano|Ignorar VPN no Wi-Fi doméstico.|
