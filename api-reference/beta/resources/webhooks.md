...
| [Conversa][] em grupo do Microsoft 365 | Alterações nas conversas de um grupo:<br>`groups/{id}/conversations` | Não |
...
| [callRecord][] do Teams | Alterações em _todos os_ registros de chamadas:`/communications/callRecords` | Não |
