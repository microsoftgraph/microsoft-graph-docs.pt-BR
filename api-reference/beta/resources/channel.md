...
|isFavoriteByDefault|Boolean|Se o canal deve ser marcado automaticamente 'favorito' para todos os membros da equipe. Padrão: `false`.|
|email|Boolean| O endereço de email de mensagens enviadas para o canal. Somente leitura.|
