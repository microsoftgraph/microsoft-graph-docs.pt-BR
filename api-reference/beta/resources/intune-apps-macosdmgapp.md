...
|[Obter macOSDmgApp](../api/intune-apps-macosdmgapp-get.md)|[macOSDmgApp](../resources/intune-apps-macosdmgapp.md)|Ler propriedades e relações do objeto [macOSDmgApp](../resources/intune-apps-macosdmgapp.md) .|
...
|primaryBundleId|String|O CFBundleIdentifier primário do DMG.|
|primaryBundleVersion|String|O CFBundleVersion primário do DMG.|
|includedApps|[Coleção macOSIncludedApp](../resources/intune-apps-macosincludedapp.md)|A lista de aplicativos que devem ser instalados pelo DMG.|
|ignoreVersionDetection|Boolean|Um valor que indica se a versão do aplicativo será usada para detectar o aplicativo depois que ele for instalado em um dispositivo. Defina isso como true para aplicativos que usam um recurso de auto-atualização. Defina isso como false para instalar o aplicativo quando ele ainda não estiver instalado no dispositivo ou se o número de versão do aplicativo de implantação não corresponder à versão que já está instalada no dispositivo.|
