...
|:---------------|:--------|:----------|
|font|[ChartFont](chartfont.md)|Representa os atributos de fonte de um elemento do eixo do gráfico, como nome, tamanho, cor, etc. Somente leitura.|
|line|[ChartLineFormat](chartlineformat.md)|Representa a formatação de linha do gráfico. Somente leitura.|
