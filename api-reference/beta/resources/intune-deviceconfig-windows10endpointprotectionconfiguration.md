...
|localSecurityOptionsClientDigitallySignCommunicationsAlways|Booliano|Essa configuração de segurança determina se a assinatura de pacote é necessária pelo componente cliente SMB.|
