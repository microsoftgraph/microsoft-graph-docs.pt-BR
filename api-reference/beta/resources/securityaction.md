...
|:-------------|:------------|:------------|
| [Obter a ação de segurança](../api/securityaction-get.md) | [securityAction](securityaction.md) | Ler propriedades e relações do objeto securityAction. |
...
|[Cancelar ação de segurança](../api/securityaction-cancelsecurityaction.md)|Nenhum(a)|Cancele uma operação de segurança.|
...
|parameters|Coleção [keyValuePair](keyvaluepair.md)| Coleção de parâmetros (pares de valores-chave) necessários para invocar a ação, por exemplo, URL ou fileHash para bloquear, etc.). **Required**|
