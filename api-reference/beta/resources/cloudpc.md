...
|[Solucionar problemas](../api/cloudpc-troubleshoot.md)|Nenhum|Solucionar problemas de um [objeto cloudPC](../resources/cloudpc.md) específico. Use essa API para verificar o status de saúde do computador na nuvem e do host da sessão.|
...
|id|Cadeia de caracteres|O identificador exclusivo para o Cloud PC. Somente leitura.|
