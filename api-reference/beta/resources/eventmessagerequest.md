...
|[move](../api/message-move.md)|[Message](message.md)|Mover a mensagem para um mailFolder.|
|[reply](../api/message-reply.md)|Nenhum|Responde ao remetente de uma mensagem. A mensagem é então salva na pasta Itens Enviados.|
