...
|:---|:---|:---|
|corpo|[itemBody](../resources/itembody.md)|Corpo da tarefa que normalmente contém informações sobre a tarefa. Herdado [de baseTask](../resources/basetask.md).|
...
|displayName|String|O nome da tarefa. Herdado [de baseTask](../resources/basetask.md).|
...
|personalProperties|[personalTaskProperties](../resources/personaltaskproperties.md)|Propriedades que são pessoais para um usuário, como reminderDateTime. Herdado [de baseTask](../resources/basetask.md).|
