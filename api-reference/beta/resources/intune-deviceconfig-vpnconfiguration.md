...
description: Perfil de configuração de VPN base.
author: dougeby
...
Perfil de configuração de VPN base.
...
|[Obter vpnConfiguration](../api/intune-deviceconfig-vpnconfiguration-get.md)|[vpnConfiguration](../resources/intune-deviceconfig-vpnconfiguration.md)|Ler propriedades e relações do objeto [vpnConfiguration](../resources/intune-deviceconfig-vpnconfiguration.md) .|
