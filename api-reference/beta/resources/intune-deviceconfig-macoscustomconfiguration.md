...
|roleScopeTagIds|Conjunto de cadeias de caracteres|Lista de marcas de escopo para esta instância de entidade. Herdada de [deviceConfiguration](../resources/intune-deviceconfig-deviceconfiguration.md)|
...
|deploymentChannel|[appleDeploymentChannel](../resources/intune-deviceconfig-appledeploymentchannel.md)|Indica o canal usado para implantar o perfil de configuração. As opções disponíveis são DeviceChannel, UserChannel. Os valores possíveis são: `deviceChannel`, `userChannel`.|
