...
description: Contém propriedades e propriedades herdadas para Windows Phone aplicativos AppX Line Of Business 8.1.
author: dougeby
...
Contém propriedades e propriedades herdadas para Windows Phone aplicativos AppX Line Of Business 8.1.
...
|[Obter windowsPhone81AppX](../api/intune-apps-windowsphone81appx-get.md)|[windowsPhone81AppX](../resources/intune-apps-windowsphone81appx.md)|Ler propriedades e relações do objeto [windowsPhone81AppX](../resources/intune-apps-windowsphone81appx.md) .|
...
|phonePublisherId|String|A ID do Editor de Telefone.|
