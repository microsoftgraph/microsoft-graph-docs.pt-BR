...
|blockMicrophone|Boleano|Bloquear o acesso ao microfone.|
...
|blockListenEvent|Boleano|Impedir que o aplicativo ou o processo ouça eventos de dispositivos de entrada, como mouse, teclado e trackpad. Requer macOS 10.15 ou posterior.|
