...
|supervisedModeEnabled|Booliano|Modo supervisionado, True para habilitar, false caso contrário. Consulte [Registro de dispositivo do Intune](/mem/intune/enrollment/device-enrollment) para obter informações adicionais. Herdado [de depEnrollmentBaseProfile](../resources/intune-enrollment-depenrollmentbaseprofile.md)|
...
|companyPortalVppTokenId|Cadeia de caracteres|Se definido, indica qual token Vpp deve ser usado para implantar o Portal da Empresa w/device licensing. 'enableAuthenticationViaCompanyPortal' deve ser definido para que essa propriedade seja definida.|
...
|expressLanguageScreenDisabled|Booliano|Indica se a tela linguagem expressa está desabilitada|
...
|userlessSharedAadModeEnabled|Booliano|Indica que esse dispositivo apple é designado para dar suporte a cenários de "modo de dispositivo compartilhado". Isso é distinto do cenário de "iPad compartilhado". Consulte [Dispositivos iOS e iPadOS compartilhados](/mem/intune/enrollment/device-enrollment-shared-ios)|
