---
title: Tipo de número emailSyncDuration
description: Valores possíveis para a duração da sincronização de email.
author: dougeby
...
Valores possíveis para a duração da sincronização de email.
