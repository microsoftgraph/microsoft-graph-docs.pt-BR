...
|usernameLableCustom|Cadeia de caracteres|Esse rótulo substitui o nome de usuário mostrado na extensão Kerberos. Você pode inserir um nome para corresponder ao nome da sua empresa ou organização. Disponível para dispositivos que executam versões 11 e posteriores do macOS.|
