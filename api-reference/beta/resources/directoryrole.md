...
|[Remover um membro](../api/directoryrole-delete-member.md) |[directoryObject](directoryobject.md)| Remover um usuário da função de diretório.|
...
|[delta](../api/directoryrole-delta.md)|Coleção directoryRole| Obter alterações incrementais para funções de diretório. |
