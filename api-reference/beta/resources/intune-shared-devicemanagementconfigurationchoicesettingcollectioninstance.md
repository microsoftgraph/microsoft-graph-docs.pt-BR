...
|choiceSettingCollectionValue|[Coleção deviceManagementConfigurationChoiceSettingValue](../resources/intune-shared-devicemanagementconfigurationchoicesettingvalue.md)|Valor da coleção de configuração de escolha|
