...
Contém propriedades e propriedades herdadas para aplicativos de linha de negócios XAP do Windows Phone.
...
|[Atualizar windowsPhoneXAP](../api/intune-apps-windowsphonexap-update.md)|[windowsPhoneXAP](../resources/intune-apps-windowsphonexap.md)|Atualizar as propriedades de um [objeto windowsPhoneXAP.](../resources/intune-apps-windowsphonexap.md)|
