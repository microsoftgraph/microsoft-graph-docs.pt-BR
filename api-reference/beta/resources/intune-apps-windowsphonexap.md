...
description: Contém propriedades e propriedades herdadas para Windows Phone XAP Line Of Business.
author: dougeby
...
Contém propriedades e propriedades herdadas para Windows Phone XAP Line Of Business.
...
|[Obter windowsPhoneXAP](../api/intune-apps-windowsphonexap-get.md)|[windowsPhoneXAP](../resources/intune-apps-windowsphonexap.md)|Ler propriedades e relações do objeto [windowsPhoneXAP](../resources/intune-apps-windowsphonexap.md) .|
