...
|:---------------|:--------|:----------|
|alternateUrl|String| Se você estiver configurando um gerenciador de tráfego na frente de vários aplicativos proxy de aplicativo, o alternateUrl será a URL amigável que apontará para o gerente de tráfego. |
