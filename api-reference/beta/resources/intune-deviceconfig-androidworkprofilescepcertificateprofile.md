...
---
# <a name="androidworkprofilescepcertificateprofile-resource-type"></a>tipo de recurso Entidadeandroidworkprofilescepcertificateprofile
...
Perfil de certificado SCEP de perfil de trabalho do Android
...
|:---|:---|:---|
|[Listar androidWorkProfileScepCertificateProfiles](../api/intune-deviceconfig-androidworkprofilescepcertificateprofile-list.md)|coleção [entidadeandroidworkprofilescepcertificateprofile](../resources/intune-deviceconfig-androidworkprofilescepcertificateprofile.md)|Listar Propriedades e relações dos objetos [entidadeandroidworkprofilescepcertificateprofile](../resources/intune-deviceconfig-androidworkprofilescepcertificateprofile.md) .|
|[Obter Entidadeandroidworkprofilescepcertificateprofile](../api/intune-deviceconfig-androidworkprofilescepcertificateprofile-get.md)|[androidWorkProfileScepCertificateProfile](../resources/intune-deviceconfig-androidworkprofilescepcertificateprofile.md)|Leia as propriedades e as relações do objeto [entidadeandroidworkprofilescepcertificateprofile](../resources/intune-deviceconfig-androidworkprofilescepcertificateprofile.md) .|
|[Criar Entidadeandroidworkprofilescepcertificateprofile](../api/intune-deviceconfig-androidworkprofilescepcertificateprofile-create.md)|[androidWorkProfileScepCertificateProfile](../resources/intune-deviceconfig-androidworkprofilescepcertificateprofile.md)|Criar um novo objeto [entidadeandroidworkprofilescepcertificateprofile](../resources/intune-deviceconfig-androidworkprofilescepcertificateprofile.md) .|
|[Excluir Entidadeandroidworkprofilescepcertificateprofile](../api/intune-deviceconfig-androidworkprofilescepcertificateprofile-delete.md)|Nenhum|Exclui [entidadeandroidworkprofilescepcertificateprofile](../resources/intune-deviceconfig-androidworkprofilescepcertificateprofile.md).|
|[Atualizar Entidadeandroidworkprofilescepcertificateprofile](../api/intune-deviceconfig-androidworkprofilescepcertificateprofile-update.md)|[androidWorkProfileScepCertificateProfile](../resources/intune-deviceconfig-androidworkprofilescepcertificateprofile.md)|Atualiza as propriedades de um objeto [entidadeandroidworkprofilescepcertificateprofile](../resources/intune-deviceconfig-androidworkprofilescepcertificateprofile.md) .|
...
|scepServerUrls|String collection|URL (s) do servidor de SCEP|
