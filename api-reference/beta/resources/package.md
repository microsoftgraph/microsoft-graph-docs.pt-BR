...
| <span data-ttu-id="74537-108">Nome da Propriedade</span><span class="sxs-lookup"><span data-stu-id="74537-108">Property Name</span></span> | <span data-ttu-id="74537-109">Tipo</span><span class="sxs-lookup"><span data-stu-id="74537-109">Type</span></span>   | <span data-ttu-id="74537-110">Descrição</span><span class="sxs-lookup"><span data-stu-id="74537-110">Description</span></span>                                                                                                                                                                      |
|:--------------|:-------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="74537-111">**type**</span><span class="sxs-lookup"><span data-stu-id="74537-111">**type**</span></span>      | <span data-ttu-id="74537-112">string</span><span class="sxs-lookup"><span data-stu-id="74537-112">string</span></span> | <span data-ttu-id="74537-p102">Uma cadeia de caracteres indicando o tipo de pacote. Embora `oneNote` seja o único valor definido atualmente, você deve esperar que outros tipos de pacote sejam retornados e lidar com eles da forma apropriada.</span><span class="sxs-lookup"><span data-stu-id="74537-p102">An string indicating the type of package. While `oneNote` is the only currently defined value, you should expect other package types to be returned and handle them accordingly.</span></span> |

## <a name="remarks"></a><span data-ttu-id="74537-115">Comentários</span><span class="sxs-lookup"><span data-stu-id="74537-115">Remarks</span></span> 

<span data-ttu-id="74537-116">Para saber mais sobre as facetas de um DriveItem, confira [DriveItem](driveitem.md).</span><span class="sxs-lookup"><span data-stu-id="74537-116">For more information about the facets on a DriveItem, see [DriveItem](driveitem.md).</span></span>
