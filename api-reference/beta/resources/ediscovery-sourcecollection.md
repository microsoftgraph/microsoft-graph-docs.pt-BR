...
|[Limpar dados](../api/ediscovery-sourcecollection-purgedata.md)|Nenhum|Execute uma operação de limpeza de dados Teams dados contidos na coleção de origem.|
...
|allTenantSites|Inclua todos os sites de **locatários na sourceCollection**.|
...
|custodianSources|[coleção microsoft.graph.ediscovery.dataSource](../resources/ediscovery-datasource.md)|**Fontes custodiadas** incluídas na **sourceCollection**.|
