...
|value|Cadeia de caracteres|Valor de configuração de opção: uma OptionDefinition ItemId.|
|children|[Coleção deviceManagementConfigurationSettingInstance](../resources/intune-shared-devicemanagementconfigurationsettinginstance.md)|Configurações filho.|
