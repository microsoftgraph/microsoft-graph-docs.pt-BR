...
Contém propriedades e propriedades herdadas para o aplicativo LOB do MacOS.
...
|[Obter macOSLobApp](../api/intune-apps-macoslobapp-get.md)|[macOSLobApp](../resources/intune-apps-macoslobapp.md)|Ler propriedades e relações do objeto [macOSLobApp](../resources/intune-apps-macoslobapp.md) .|
...
|buildNumber|String|O número de build do aplicativo De Linha de Negócios do MacOS (LoB).|
...
|ignoreVersionDetection|Boolean|Um booliano para controlar se a versão do aplicativo será usada para detectar o aplicativo depois que ele for instalado em um dispositivo. Defina isso como true para aplicativos de Linha de Negócios (LoB) do macOS que usam um recurso de auto-atualização.|
