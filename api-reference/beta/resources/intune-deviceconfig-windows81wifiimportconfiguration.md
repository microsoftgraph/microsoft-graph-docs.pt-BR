...
description: Windows 8.1+ Wi-Fi configuração de importação. Ao configurar esse perfil, você pode instruir Windows 8.1 dispositivos (e posteriores) a se conectar ao ponto de extremidade Wi-Fi desejado. Conexão um Windows 8.1 para a rede Wi-Fi desejada e extraia o XML desse dispositivo para posteriormente inserir nesse perfil Wi-Fi.
author: dougeby
...
Windows 8.1+ Wi-Fi configuração de importação. Ao configurar esse perfil, você pode instruir Windows 8.1 dispositivos (e posteriores) a se conectar ao ponto de extremidade Wi-Fi desejado. Conexão um Windows 8.1 para a rede Wi-Fi desejada e extraia o XML desse dispositivo para posteriormente inserir nesse perfil Wi-Fi.
...
|[Excluir windows81WifiImportConfiguration](../api/intune-deviceconfig-windows81wifiimportconfiguration-delete.md)|Nenhum(a)|Exclui um [windows81WifiImportConfiguration](../resources/intune-deviceconfig-windows81wifiimportconfiguration.md).|
...
|profileName|Cadeia de caracteres|Nome de perfil exibido na interface do usuário.|
|payload|Binária|Carga. (matriz de byte codificado UTF8). Este é o arquivo XML salvo no dispositivo que você usou para se conectar ao Wi-Fi ponto de extremidade.|
