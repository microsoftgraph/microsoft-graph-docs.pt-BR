...
As expressões de caminho de recurso suportadas para cada recurso-que pode ser usado na propriedade de **recurso** da assinatura-estão documentadas no [artigo de visão geral](webhooks.md).
