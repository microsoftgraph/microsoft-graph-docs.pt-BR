...
description: Contém propriedades e propriedades herdadas para aplicativos do Windows AppX Line Of Business.
author: dougeby
...
Contém propriedades e propriedades herdadas para aplicativos do Windows AppX Line Of Business.
...
|[Obter windowsAppX](../api/intune-apps-windowsappx-get.md)|[windowsAppX](../resources/intune-apps-windowsappx.md)|Ler propriedades e relações do objeto [windowsAppX](../resources/intune-apps-windowsappx.md) .|
