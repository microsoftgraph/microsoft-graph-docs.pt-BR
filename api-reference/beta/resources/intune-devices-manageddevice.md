...
|userDisplayName|String|Nome de exibição do usuário. Essa propriedade é somente leitura.|
...
|usuários|coleção de usuários|Os usuários primários associados ao dispositivo gerenciado.|
