...
description: Perfil de certificado do Mac OS.
author: dougeby
...
Perfil de certificado do Mac OS.
...
|renewalThresholdPercentage|Int32|Percentual de limite de renovação de certificado.|
|subjectNameFormat|[appleSubjectNameFormat](../resources/intune-deviceconfig-applesubjectnameformat.md)|Formato de nome da entidade do certificado. Os possíveis valores são: `commonName`, `commonNameAsEmail`, `custom`, `commonNameIncludingEmail`, `commonNameAsIMEI`, `commonNameAsSerialNumber`.|
