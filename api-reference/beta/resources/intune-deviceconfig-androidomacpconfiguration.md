...
description: Ao fornecer uma configuração nesse perfil, você pode configurar dispositivos Android que dão suporte a OMA-CP.
author: dougeby
...
Ao fornecer uma configuração nesse perfil, você pode configurar dispositivos Android que dão suporte a OMA-CP.
...
|[Obter androidOmaCpConfiguration](../api/intune-deviceconfig-androidomacpconfiguration-get.md)|[androidOmaCpConfiguration](../resources/intune-deviceconfig-androidomacpconfiguration.md)|Ler propriedades e relações do objeto [androidOmaCpConfiguration](../resources/intune-deviceconfig-androidomacpconfiguration.md) .|
...
|[Excluir androidOmaCpConfiguration](../api/intune-deviceconfig-androidomacpconfiguration-delete.md)|Nenhum|Exclui um [androidOmaCpConfiguration](../resources/intune-deviceconfig-androidomacpconfiguration.md).|
...
|configurationXml|Binária|XML de configuração que será aplicado ao dispositivo. Quando lido, ele fornece apenas uma cadeia de caracteres de espaço reservado, pois os dados originais são criptografados e armazenados.|
