...
description: Base de perfil de certificado do iOS.
author: dougeby
...
Base de perfil de certificado do iOS.
...
|:---|:---|:---|
|[Listar iosCertificateProfileBases](../api/intune-deviceconfig-ioscertificateprofilebase-list.md)|[Coleção iosCertificateProfileBase](../resources/intune-deviceconfig-ioscertificateprofilebase.md)|Listar propriedades e relações dos objetos [iosCertificateProfileBase](../resources/intune-deviceconfig-ioscertificateprofilebase.md) .|
|[Obter iosCertificateProfileBase](../api/intune-deviceconfig-ioscertificateprofilebase-get.md)|[iosCertificateProfileBase](../resources/intune-deviceconfig-ioscertificateprofilebase.md)|Ler propriedades e relações do objeto [iosCertificateProfileBase](../resources/intune-deviceconfig-ioscertificateprofilebase.md) .|
