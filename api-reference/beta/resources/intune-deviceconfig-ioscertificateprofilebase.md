...
---
# <a name="ioscertificateprofilebase-resource-type"></a>tipo de recurso de iosCertificateProfileBase

> **Importante:** as APIs na versão /beta no Microsoft Graph estão em visualização e estão sujeitas a alterações. Não há suporte para o uso dessas APIs em aplicativos de produção.

> **Observação:** O uso das APIs do Microsoft Graph para configurar controles e políticas do Intune ainda exige que o serviço do Intune seja [corretamente licenciado](https://go.microsoft.com/fwlink/?linkid=839381) pelo cliente.

perfil de certificado iOS base.
...
|:---|:---|:---|
|[Lista iosCertificateProfileBases](../api/intune-deviceconfig-ioscertificateprofilebase-list.md)|coleção [iosCertificateProfileBase](../resources/intune-deviceconfig-ioscertificateprofilebase.md)|Lista as propriedades e os relacionamentos dos objetos [iosCertificateProfileBase](../resources/intune-deviceconfig-ioscertificateprofilebase.md) .|
|[Obter iosCertificateProfileBase](../api/intune-deviceconfig-ioscertificateprofilebase-get.md)|[iosCertificateProfileBase](../resources/intune-deviceconfig-ioscertificateprofilebase.md)|Leia as propriedades e os relacionamentos do objeto [iosCertificateProfileBase](../resources/intune-deviceconfig-ioscertificateprofilebase.md) .|
