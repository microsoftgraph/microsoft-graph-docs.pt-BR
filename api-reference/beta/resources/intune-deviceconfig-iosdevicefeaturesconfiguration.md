...
|contentFilterSettings|[iosWebContentFilterBase](../resources/intune-deviceconfig-ioswebcontentfilterbase.md)|Obtém ou define as configurações do Filtro de Conteúdo da Web do iOS, somente no modo supervisionado|
...
|homeScreenGridWidth|Int32|Obtém ou define o número de colunas a serem renderizadas ao definir as configurações de layout da tela inicial do iOS. Se esse valor estiver configurado, homeScreenGridHeight também deverá ser configurado.|
|homeScreenGridHeight|Int32|Obtém ou define o número de linhas a serem renderizadas ao definir as configurações de layout da tela inicial do iOS. Se esse valor estiver configurado, homeScreenGridWidth também deverá ser configurado.|
...
|singleSignOnSettings|[iosSingleSignOnSettings](../resources/intune-deviceconfig-iossinglesignonsettings.md)|As configurações de logon do Kerberos que permitem que os aplicativos no recebimento de dispositivos se autentiquem sem problemas.|
...
|wallpaperImage|[mimeContent](../resources/intune-shared-mimecontent.md)|Uma imagem de papel de parede deve estar no formato PNG ou JPEG. Ele requer um dispositivo supervisionado com o iOS 8 ou versão posterior.|
|singleSignOnExtension|[singleSignOnExtension](../resources/intune-deviceconfig-singlesignonextension.md)|Obtém ou define um perfil de extensão de logon único. Preterido: use IOSSingleSignOnExtension.|
...
|identityCertificateForClientAuthentication|[iosCertificateProfileBase](../resources/intune-deviceconfig-ioscertificateprofilebase.md)|Certificado de identidade para a renovação do tíquete Kerberos usado nas configurações de logon único.|
|singleSignOnExtensionPkinitCertificate|[iosCertificateProfileBase](../resources/intune-deviceconfig-ioscertificateprofilebase.md)|Certificado PKINIT para a autenticação com configurações de extensão de logon único.|
