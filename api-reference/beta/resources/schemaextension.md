...
|[Listar](../api/schemaextension-list.md) | schemaExtension |Liste as definições de schemaExtension avaialbe e suas propriedades.|
...
|targetTypes|Coleção de cadeias de caracteres|Conjunto de tipos do Microsoft Graph (que podem suportar extensões) que a extensão do esquema pode ser aplicada a. Selecione **administrativeUnit**, **entre em contato**, **dispositivo**, **evento**, **grupo**, **mensagem**, **organização**, **postar**ou **usuário**.|
