...
| [Atribuir homeRealmDiscoveryPolicy](../api/serviceprincipal-post-homerealmdiscoverypolicies.md) | Nenhum | Atribua um objeto homeRealmDiscoveryPolicy a um [objeto servicePrincipal](serviceprincipal.md) . |
...
| [Remover homeRealmDiscoveryPolicy](../api/serviceprincipal-delete-homerealmdiscoverypolicies.md) | Nenhum | Remova um objeto homeRealmDiscoveryPolicy de [um objeto servicePrincipal](serviceprincipal.md) . |
