...
description: Contém propriedades e propriedades herdadas para o aplicativo MDATP (Proteção Avançada contra Ameaças) do Microsoft Defender macOS.
author: dougeby
...
Contém propriedades e propriedades herdadas para o aplicativo MDATP (Proteção Avançada contra Ameaças) do Microsoft Defender macOS.
...
|[Obter macOSMdatpApp](../api/intune-apps-macosmdatpapp-get.md)|[macOSMdatpApp](../resources/intune-apps-macosmdatpapp.md)|Leia propriedades e relações do [objeto macOSMdatpApp.](../resources/intune-apps-macosmdatpapp.md)|
...
|[Excluir macOSMdatpApp](../api/intune-apps-macosmdatpapp-delete.md)|Nenhum(a)|Exclui um [macOSMdatpApp](../resources/intune-apps-macosmdatpapp.md).|
