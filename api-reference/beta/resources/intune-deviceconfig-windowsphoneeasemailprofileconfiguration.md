...
description: Ao fornecer configurações nesse perfil, você pode instruir o cliente de email nativo no Windows Phone a se comunicar com um servidor Exchange e obter emails, contatos, calendário e tarefas. Além disso, você também pode especificar a quantidade de emails a serem sincronizados e a frequência com que o dispositivo deve ser sincronizado.
author: dougeby
...
Ao fornecer configurações nesse perfil, você pode instruir o cliente de email nativo no Windows Phone a se comunicar com um servidor Exchange e obter emails, contatos, calendário e tarefas. Além disso, você também pode especificar a quantidade de emails a serem sincronizados e a frequência com que o dispositivo deve ser sincronizado.
