...
|:---|:---|:---|
|assignmentFilterEvaluationStatusDetails|[coleção assignmentFilterEvaluationStatusDetails](../resources/intune-policyset-assignmentfilterevaluationstatusdetails.md)|Estados de configuração de aplicativo móvel de dispositivo gerenciado para este dispositivo.|
