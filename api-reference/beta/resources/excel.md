...
**Observação:** A API REST do Excel oferece suporte somente a pastas de trabalho formatadas em arquivo Office Open XML. Não há suporte para pastas de trabalho de extensão `.xls`. 
