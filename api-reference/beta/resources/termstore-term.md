...
|[Excluir termo](../api/termstore-term-delete.md)|Nenhum|Excluir um objeto term em um armazenamento de [termos.]|
...
|id|String|Identificador exclusivo do termo. Read-Only|
|labels|[coleção microsoft.graph.termStore.localizedLabel](../resources/termstore-localizedlabel.md)|Metadados de rótulo para um termo|
