...
|usuários|Coleção [user](../resources/intune-shared-user.md)|Os usuários primários associados ao dispositivo gerenciado. Herdado de [managedDevice](../resources/intune-devices-manageddevice.md)|
