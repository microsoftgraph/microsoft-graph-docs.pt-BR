...
description: Windows que são gerenciados ou pré-inscritos por meio de Intune
author: dougeby
...
Windows que são gerenciados ou pré-inscritos por meio de Intune
