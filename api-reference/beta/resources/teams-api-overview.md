...
- Bate-papo persistente está disponível somente para Teams da Microsoft. Esse recurso hierarquicamente é representado pelos recursos de [canal](../resources/channel.md), [chatThread](../resources/chatthread.md)e [chatMessage](../resources/chatmessage.md) .
- Conversas de grupo estão disponíveis somente para grupos do Office 365. Esse recurso hierarquicamente é representado pelos recursos de [conversa](../resources/conversation.md), [conversationThread](../resources/conversationthread.md)e [Lançar](../resources/post.md) . 
- O método [lista ingressou equipes](../api/user-list-joinedteams.md) só se aplica a Teams da Microsoft.
- [Chamada e APIs de reunião online](./calls-api-overview.md) se aplicam apenas ao Microsoft Teams.
...
| Lenta | https://graph.microsoft.com/beta/groups/{02bd9fd6-8f93-4758-87c3-1fb73740a315}/members/{48d31887-5fad-4d73-a9f5-3c356e68a038}/$ref | 
