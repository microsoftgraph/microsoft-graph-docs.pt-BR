...
description: Ao fornecer configurações neste perfil, você pode instruir o cliente de email Nine Work em dispositivos Android For Work a se comunicar com um servidor Exchange e obter emails, contatos, calendário, tarefas e anotações. Além disso, você também pode especificar a quantidade de emails a serem sincronizados e a frequência com que o dispositivo deve ser sincronizado.
author: dougeby
...
Ao fornecer configurações neste perfil, você pode instruir o cliente de email Nine Work em dispositivos Android For Work a se comunicar com um servidor Exchange e obter emails, contatos, calendário, tarefas e anotações. Além disso, você também pode especificar a quantidade de emails a serem sincronizados e a frequência com que o dispositivo deve ser sincronizado.
