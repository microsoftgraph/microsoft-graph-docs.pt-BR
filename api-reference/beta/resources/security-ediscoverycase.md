...
description: No contexto da Descoberta Eletrônica, contém custodiantes, retenções, coleções, conjuntos de revisão e exportações.
author: SeunginLyu
...
|[Criar ediscoveryHoldPolicy](../api/security-ediscoverycase-post-legalholds.md)|[microsoft.graph.security.ediscoveryHoldPolicy](../resources/security-ediscoveryholdpolicy.md)|Crie um novo objeto ediscoveryHoldPolicy.|
