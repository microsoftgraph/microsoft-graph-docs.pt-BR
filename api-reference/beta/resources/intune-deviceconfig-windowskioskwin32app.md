...
|nome|String|Representa o nome amigável de um aplicativo Herdado do [windowsKioskAppBase](../resources/intune-deviceconfig-windowskioskappbase.md)|
...
|autoLaunch|Booliano|Permitir que o aplicativo seja lançado automaticamente no modo de quiosque de vários aplicativos Herdado do [windowsKioskAppBase](../resources/intune-deviceconfig-windowskioskappbase.md)|
|classicAppPath|String|Este é o classicapppath a ser usado pelo aplicativo v4 Win32 enquanto estiver no modo Quiosque|
|edgeNoFirstRun|Booliano|Sinalizador de primeira corrida de borda para o modo de quiosque de borda|
...
|edgeKiosk|String|Quiosque de borda (url) para o modo de quiosque de borda|
