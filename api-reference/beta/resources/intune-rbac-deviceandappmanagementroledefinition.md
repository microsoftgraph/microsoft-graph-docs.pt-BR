...
|roleScopeTagIds|Coleção de cadeias de caracteres|Lista de marcas de escopo para esta instância entity. Herdado de [roleDefinition](../resources/intune-rbac-roledefinition.md)|
