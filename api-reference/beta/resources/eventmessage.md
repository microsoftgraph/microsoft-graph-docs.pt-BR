...
|:---------------|:--------|:----------|
|attachments|Coleção [anexo](attachment.md)|A coleção de [fileAttachment](fileattachment.md), [itemAttachment](itemattachment.md)e [referenceAttachment](referenceattachment.md) anexos da mensagem. Somente leitura. Anulável.|
