...
|[Cancelar assinatura](../api/message-unsubscribe.md)|Nenhum|Envie uma mensagem usando os dados e o endereço especificado no primeiro comando mailto no cabeçalho da lista de cancelamento de inscrição.|
|**Anexos**| | |
