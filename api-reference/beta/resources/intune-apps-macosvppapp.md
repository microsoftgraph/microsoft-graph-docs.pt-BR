...
description: Contém propriedades e propriedades herdadas para Aplicativos Volume-Purchased MacOS (VPP).
author: dougeby
...
Contém propriedades e propriedades herdadas para Aplicativos Volume-Purchased MacOS (VPP).
...
|[Obter macOsVppApp](../api/intune-apps-macosvppapp-get.md)|[macOsVppApp](../resources/intune-apps-macosvppapp.md)|Ler propriedades e relações do objeto [macOsVppApp](../resources/intune-apps-macosvppapp.md) .|
