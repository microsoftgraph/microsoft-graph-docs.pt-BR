...
Representa as configurações padrão da impressora. Verifique os [recursos](printercapabilities.md) da impressora para ver todos os valores que ele suporta.
...
|outputBin|String|O compartimento de saída padrão a ser inserido é impresso no. Confira os [recursos](printercapabilities.md) da impressora para obter uma lista de bandejas de saída suportadas.|
