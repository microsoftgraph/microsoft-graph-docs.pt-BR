...
Você pode usar o [ponto de extremidade do Azure AD v2.0](https://graph.microsoft.io/en-us/docs/authorization/converged_auth) para autenticar chamadas da API REST do Excel. Todas as APIs exigem o cabeçalho HTTP `Authorization: Bearer {access-token}`.   
  
Um dos seguintes [escopos de permissão](https://graph.microsoft.io/en-us/docs/authorization/permission_scopes) é obrigatório para se usar o recurso do Excel:
