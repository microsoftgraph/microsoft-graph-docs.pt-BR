...
O conteúdo é um dos principais campos que influenciam na [relevância](/graph/concepts/search-index-manage-schema.md) nas experiências da Microsoft. Oferecemos suporte para o tipo de conteúdo `text` e `HTML`. Se sua fonte de dados tiver arquivos binários, você poderá analisá-los como texto antes de adicioná-los ao Microsoft Graph.
