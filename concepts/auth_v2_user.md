...
| client_id |obrigatório |A Id de Aplicativo que o portal de registro ([apps.dev.microsoft.com](https://apps.dev.microsoft.com/?referrer=https://azure.microsoft.com/documentation/articles&deeplink=/appList)) atribuiu a seu aplicativo. |
...
- Seu aplicativo exigirá uma Id de aplicativo diferente (Id de cliente) para cada plataforma.
