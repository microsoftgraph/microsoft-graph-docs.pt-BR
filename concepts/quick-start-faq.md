...
> **Observação:** Estamos no processo de gerar tutoriais para cada uma das plataformas que atualmente têm um início rápido. Algumas com início rápido não têm o tutoriais correspondentes.
...
|-------------|----------|-------------------|
| Android | Nenhum | [GitHub](https://github.com/microsoftgraph/android-java-connect-sample) |
...
| Xamarin | Nenhum | [GitHub](https://github.com/microsoftgraph/uwp-csharp-connect-sample) |
...
Os exemplos de início rápido oferecem uma introdução à autenticação e às chamadas à API do Microsoft Graph. Saiba mais sobre outros fluxos de autenticação na documentação [Azure Active Directory](https://docs.microsoft.com/azure/active-directory/develop/authentication-scenarios).
