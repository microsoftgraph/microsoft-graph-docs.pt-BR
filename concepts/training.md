...
---
# <a name="microsoft-graph-training"></a>Treinamento do Microsoft Graph

Os exercícios de treinamento do Microsoft Graph são tutoriais passo a passo que orientam você na criação de um aplicativo básico que usa a autenticação do Azure Active Directory e acessa dados por meio do Microsoft Graph.

Os seguintes tutoriais de treinamento estão disponíveis no momento.
