...
description: Você pode usar a API REST do Excel no Microsoft Graph para estender seus dados, cálculos, relatórios e painéis do Excel.
...
> [!NOTE]
> API REST do Excel só oferece suporte para pastas de trabalho formatadas pelo arquivo do Office Open XML (arquivos com a extensão `.xlsx`). Não há suporte para pastas de trabalho de extensão `.xls`.

### <a name="use-the-excel-rest-api"></a>Usar a API REST do Excel
...
- [API do Excel no Microsoft Graph v1.0](/graph/api/resources/excel?view=graph-rest-1.0&preserve-view=true)
- [API do Excel no Microsoft Graph beta](/graph/api/resources/excel?view=graph-rest-beta&preserve-view=true)
