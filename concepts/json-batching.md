...
description: Use o lote JSON para otimizar seu aplicativo combinando várias solicitações em um único objeto JSON, salvando uma latência significativa na rede do aplicativo.
author: FaithOmbongi
