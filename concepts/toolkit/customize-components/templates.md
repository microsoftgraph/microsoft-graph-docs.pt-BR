...
A maioria dos componentes do kit de ferramentas do Microsoft Graph oferece suporte ao uso de modelos personalizados para modificar o conteúdo de um componente.
...
Se você estiver usando os componentes de reagir do Microsoft Graph Toolkit, você poderá usar o reagir para modelos de criação. Para obter detalhes, consulte [usar o kit de ferramentas com reagir](../get-started/mgt-react.md).
