...
Para obter mais informações sobre a criação de páginas, confira [Criar páginas do OneNote](onenote-create-page.md). Para obter mais informações sobre a atualização de páginas, confira [Atualizar páginas do OneNote](onenote_update_page.md).
