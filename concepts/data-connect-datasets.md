...
Data Connect dá suporte para extração de dados de diversas regiões do Office 365. Para migrar os dados com sucesso do Data Center do Office 365 para seu armazenamento do Microsoft Azure, a instância do Azure Data Factory e o local de armazenamento do Azure devem mapear para uma região com suporte para o local dos dados do Office 365. A tabela a seguir indica quais regiões do Office 365 têm suporte e as regiões do Azure correspondentes necessárias para a movimentação de dados. 
...
- A autenticação da entidade de serviço é o único mecanismo de autenticação com suporte para todos os tipos de coletores em uma atividade de cópia com o Office 365 como a origem.
