...
Use `img` com `src="http://image-url"` e especifique a URL de uma imagem acessível ao público. Renderiza a imagem na página do OneNote.
...
Use `img` com `data-render-src="http://webpage-url"` e especifique a URL de uma página da Web. Renderiza um instantâneo da página da Web inteira na página do OneNote.
