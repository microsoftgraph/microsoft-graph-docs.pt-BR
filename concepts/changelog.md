...
| Alteração | beta | Recurso do [usuário](/graph/api/resources/user) atualizado com esclarecimento entre o [MailboxSettings](/graph/api/resources/mailboxsettings?view=graph-rest-beta) e o [regionalAndLanguageSettings](/graph/api/resources/regionalandlanguagesettings).|
...
|Exclusão|beta|Removida a propriedade de navegação **healthSummary** da entidade [windowsManagementApp](/graph/api/resources/intune-devices-windowsmanagementapp?view=graph-rest-beta)||Adição|beta|Adicionada a propriedade **shareUserExperienceAnalyticsData** ao tipo complexo [adminConsent](/graph/api/resources/intune-devices-adminconsent?view=graph-rest-beta)|
...
| Adição        | v1.0 e beta | A propriedade _internetMessageHeaders_ foi adicionada à entidade **mensagem**. A ID da mensagem no formato especificado por [RFC2822](https://www.ietf.org/rfc/rfc2822.txt). |F>>
