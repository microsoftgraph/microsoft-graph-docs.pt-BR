...
| **Tipo de alteração** | **Versão** | **Descrição**                                                                                                                 |
| :-------------- | :---------- | :------------------------------------------------------------------------------------------------------------------------------ |
| Adição        | Beta        | Adiciona [presença](/api/resources/presence) (visualização) a recursos suportados para [notificações de alteração](/graph/webhooks).          |
...
| **Tipo de alteração** | **Versão**   | **Descrição**                          |
| :-------------- | :------------ | :--------------------------------------- |
| Adição | beta | A propriedade de navegação **Settings** foi adicionada à entidade [Organization](/graph/api/resources/organization?view=graph-rest-beta) . |
| Adição | beta | A entidade [organizationSettings](/graph/api/resources/organizationsettings?view=graph-rest-beta) foi adicionada.  |
| Adição | beta | A propriedade de navegação **profileCardProperties** foi adicionada à entidade **organizationSettings** . |
| Adição | beta | A entidade **profileCardProperty** e as seguintes operações foram adicionadas: <br/> [List](/graph/api/organizationsettings-list-profilecardproperties) <br/> [Create](/graph/api/organizationsettings-post-profilecardproperties) <br/> [Obtenha](/graph/api/profilecardproperty-get?view=graph-rest-beta) a entidade profileCardProperty. <br/> [Atualizar profileCardProperty](/graph/api/profilecardproperty-update?view=graph-rest-beta) <br/> [Delete](/graph/api/profilecardproperty-delete) |
...
| **Tipo de alteração** | **Versão** | **Descrição**                          |
| :-------------- | :---------- | :--------------------------------------- |
| Addition | v1.0 | Foram adicionados os recursos [changeNotification](/graph/api/resources/changenotification), [changeNotificationCollection](/graph/api/resources/changenotificationcollection)e [resourceData](/graph/api/resources/resourcedata) à API de [notificação de alteração](/graph/api/concepts/webhooks) . |

### <a name="cloud-communications"></a>Comunicações na nuvem
| **Tipo de alteração** | **Versão**   | **Descrição**                          |
| :-------------- | :------------ | :--------------------------------------- |
| Addition | v1.0 | Adicionado o método [onlineMeeting: createOrGet](/graph/api/onlinemeeting-createorget).|
...
|Addition | v1.0 | Adicionado um `Accept-Language`cabeçalho opcional para [reuniões online](/graph/api/resources/onlinemeeting).|
...
| **Tipo de alteração** | **Versão**   | **Descrição**                          |
| :-------------- | :------------ | :--------------------------------------- |
| Addition | v1.0 | Adicionou o recurso [geolocationColumn](/graph/api/resources/geolocationcolumn?view=graph-rest-1.0) . O recurso **geolocationColumn** se aplica ao recurso [columnDefinition](/graph/api/resources/columnDefinition?view=graph-rest-1.0) . |
...
|Adição | beta | Adicionou a propriedade de navegação [Members](/graph/api/team-post-members?view=graph-rest-beta) ao tipo de recurso [Team](/graph/api/resources/team?view=graph-rest-beta) , permitindo que os membros sejam adicionados com maior confiabilidade e menor latência.|
...
| **Tipo de alteração** | **Versão** | **Descrição**                          |
| :-------------- | :---------- | :--------------------------------------- |
| Adição        | v1.0        | Foram adicionadas as ações [fazer check-in](/graph/api/driveitem-checkin?view=graph-rest-1.0) e [fazer check-out](/graph/api/driveitem-checkin?view=graph-rest-1.0) no recurso [driveItem](/graph/api/resources/driveitem?view=graph-rest-1.0). |
| **Tipo de alteração** | **Versão**   | **Descrição**                          |
| :-------------- | :------------ | :--------------------------------------- |
...
| Adição | v1.0 | Adicionado o suporte para [consultas delta para aplicativos](/graph/api/application-delta?view=graph-rest-1.0).|
...
| Adição        | v1.0        | Foi adicionada a ação [seguir](/graph/api/driveitem-follow?view=graph-rest-1.0) em [driveItem](/graph/api/resources/driveitem?view=graph-rest-1.0). |
| Adição        | v1.0        | Foi adicionada a ação [deixar de seguir](/graph/api/driveitem-unfollow?view=graph-rest-1.0) em [driveItem](/graph/api/resources/driveitem?view=graph-rest-1.0). |
...
|Addition | v1.0 | A nova propriedade **workingHours** foi adicionada a [mailboxSettings](/graph/api/resources/mailboxsettings?view=graph-rest-1.0). Confira [tipo de recurso workingHours](/graph/api/resources/workinghours?view=graph-rest-1.0) para saber mais sobre casos de uso com suporte.|
