...
|:---|:---|:---|
|Adição|beta|Foram adicionadas novas entidades:<br/>[appleVppTokenTroubleshootingEvent] (/ graph api/recursos /
intune-troubleshooting-applevpptokentroubleshootingevent?view=graph-rest-beta)<br/>[appLogCollectionRequest](/graph/api/resources/ intune-devices-applogcollectionrequest?view=graph-rest-beta)<br/>[windowsUpdateState](/graph/api/resources/ intune-deviceconfig-windowsupdatestate?view=graph-rest-beta)<br/>| | Adição | beta | Adicionado novos tipos complexos:<br/>[appLogCollectionDownloadDetails](/graph/api/resources/ intune-devices-applogcollectiondownloaddetails?view=graph-rest-beta)<br/>**deviceManagementTroubleshootingErrorDetails**<br/>[deviceManagementTroubleshootingErrorResource](/graph/api/resources/ intune-troubleshooting-devicemanagementtroubleshootingerrorresource?view=graph-rest-beta)<br/>[win32LobAppAssignmentSettings](/graph/api/resources/ intune-apps-win32lobappassignmentsettings?view=graph-rest-beta)<br/>| | Adição | beta | Adicionado novos tipos de enumeração:<br/>[appLogDecryptionAlgorithm](/graph/api/resources/ intune-devices-applogdecryptionalgorithm?view=graph-rest-beta)<br/>[appLogUploadState](/graph/api/resources/ intune-devices-apploguploadstate?view=graph-rest-beta)<br/>[win32LobAppNotification](/graph/api/resources/ intune-apps-win32lobappnotification?view=graph-rest-beta)<br/>[windowsUpdateStatus](/graph/api/resources/ intune-deviceconfig-windowsupdatestatus?view=graph-rest-beta)<br/>| | Adição | beta | Adicionar o **createDownloadUrl** ações em [appLogCollectionRequest](/graph/api/resources/ intune-devices-applogcollectionrequest?view=graph-rest-beta) | Exclusão | beta | Remover as entidades a seguir:<br/>**deviceManagementApplicabilityRuleOsEdition**<br/>**deviceManagementApplicabilityRuleOsVersion**<br/>| |Adição|beta|Adicionar o **passwordSignInFailureCountBeforeFactoryReset** propriedade a [androidCompliancePolicy] (/ api/graph/recursos/androidcompliancepolicy de deviceconfig intune? modo de exibição = beta de restante graph) entidade | |Adição|beta|Adicionar o **passwordSignInFailureCountBeforeFactoryReset** propriedade a [androidForWorkCompliancePolicy] (/ api/graph/recursos/androidforworkcompliancepolicy de deviceconfig intune? modo de exibição = beta de restante graph) entidade | | Adição | beta | Adicionar o **passwordSignInFailureCountBeforeFactoryReset** propriedade para o [androidWorkProfileCompliancePolicy] (/ api/graph/recursos/androidworkprofilecompliancepolicy de deviceconfig intune? exibir = entidade restante beta Graph) | | Exclusão | beta | Removido a **defaultProfileDisplayName** propriedade no [depOnboardingSetting] (/ api/graph/recursos/intune de registro de deponboardingsetting? modo de exibição = beta de restante graph) entidade | | Adição | beta | Adicionar o **runAs32Bit** propriedade para o [deviceManagementScript] (/ api/graph/recursos/devicemanagementscript de dispositivos intune? modo de exibição = beta de restante graph) entidade | |Adição|beta|Adicionar o **troubleshootingErrorDetails**, **eventName** e **informações adicionais** propriedades [deviceManagementTroubleshootingEvent](/graph/api/resources/ intune-troubleshooting-devicemanagementtroubleshootingevent?view=graph-rest-beta) entity| |Change|beta|Changed the following properties on the [macOSCertificateProfileBase](/graph/api/resources/ intune-deviceconfig-macoscertificateprofilebase?view=graph-rest-beta) entity:ta de restante graph) entidade:<br/>**subjectAlternativeNameType** de obrigatória para opcional<br/>| | Adição | beta | Adicionar o **certificateStore** e **customSubjectAlternativeNames** propriedades a [macOSScepCertificateProfile] (/ api/graph/recursos/macosscepcertificateprofile de deviceconfig intune ? Exibir = beta de restante graph) entidade | | Adição | beta | Adicionar o **officeConfigurationXml** propriedade a [officeSuiteApp] (/ api/graph/recursos/officesuiteapp de aplicativos do intune? modo de exibição = beta de restante graph) entidade | | Adição | beta | Adicionar o **createdDateTime** propriedade a [organização] (/ api/graph/recursos/intune de integração de organização? modo de exibição = beta de restante graph) entidade | | Adição | beta | Adicionar o **bitLockerAllowStandardUserEncryption** propriedade para o [windows10EndpointProtectionConfiguration] (/ api/graph/recursos/windows10endpointprotectionconfiguration de deviceconfig intune? exibir = entidade restante beta Graph) | | Exclusão | beta | Remover o **localSecurityOptionsEnableAdministratorAccount**, **localSecurityOptionsEnableGuestAccount** e ** lanManagerWorkstationEnableInsecureGuestLogons** propriedades da [windows10EndpointProtectionConfiguration] (/ api/graph/recursos/windows10endpointprotectionconfiguration de deviceconfig intune? exibir = beta de restante graph ) entidade | | Adição | beta | Adicionar o **useSecurityKeyForSignin** propriedade para a [windowsIdentityProtectionConfiguration] (/ api/graph/recursos/windowsidentityprotectionconfiguration de deviceconfig intune? modo de exibição = graph de restante de beta) entidade | | Adição | beta | Adicionar o **mobileAppTroubleshootingEvents** propriedade de navegação para o [deviceManagement] (/ api/graph/recursos/devicemanagement de androidforwork intune? modo de exibição = beta de restante graph) entidade | | Adição | beta | Adicionar o **appLogCollectionRequests** propriedade de navegação para o [mobileAppTroubleshootingEvent] (/ api/graph/recursos/mobileapptroubleshootingevent de dispositivos do intune? modo de exibição = beta de restante graph) entidade |
...
|Adição|beta|Adicionada a propriedade **lastUpdateDateTime** propriedade para o [windowsMalwareStateCount](/graph/api/resources/intune-devices-windowsmalwarestatecount?view=graph-rest-beta) tipo complexo|
...
|Alteração| beta | A propriedade de contexto em[teamsApp](/graph/api/resources/teamsapp?view=graph-rest-beta) foram renomeados como distributionMethod.|
