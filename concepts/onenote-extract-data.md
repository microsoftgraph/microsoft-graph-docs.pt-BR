...
Para extrações de cartão de visita, a imagem é enviada como uma parte nomeada em uma solicitação múltiplas. Confira [Adicionar imagens e arquivos](onenote_images_files.md) para ver exemplos que mostram como enviar uma imagem em uma solicitação.
