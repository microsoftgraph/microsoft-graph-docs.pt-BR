...
Ao executar uma [operação GET para recuperar uma imagem de gráfico](/api-reference/v1.0/api/chart_image.md), a API do Excel retorna a imagem como uma cadeia de caracteres de Base 64.
