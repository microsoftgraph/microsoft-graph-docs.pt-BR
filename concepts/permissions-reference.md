...
|_OnlineMeetingTranscript.Read.All_|Leia todas as transcrições das reuniões online.|Permite que o aplicativo leia todas as transcrições de reuniões online em nome do usuário conectado. |Sim|Não|
...
|_OnlineMeetingTranscript.Read.All_|Leia todas as transcrições das reuniões online.|Permite que o aplicativo leia todas as transcrições de todas as reuniões online, sem um usuário conectado. |Sim|
