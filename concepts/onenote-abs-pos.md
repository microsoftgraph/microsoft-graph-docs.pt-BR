---
title: Criar elementos posicionados absolutos em páginas do OneNote usando a API do OneNote
description: Use os atributos de estilo e habilitados para dados absolutos para criar elementos posicionados absolutos em uma página, incluindo vários elementos div, img e filho de objeto diretos.
...
---
# <a name="create-absolute-positioned-elements-on-onenote-pages"></a>Criar elementos posicionados absolutos em páginas do OneNote
