...
2. **matriz_tabela** (obrigatório): o intervalo de células em que se encontra o valor a pesquisar. Lembre-se de que o valor a pesquisar sempre deve estar na primeira coluna no intervalo para que PROCV funcione corretamente. Por exemplo, se o valor a pesquisar estiver na célula C2, o intervalo deve começar com C.
...
(Consulte a documentação para a função do Excel [PROCV](https://support.office.com/pt-BR/article/VLOOKUP-function-0bbc8083-26fe-4963-8ab8-93a18ad188a1)).
...
(Consulte a documentação para a função [MED](https://support.office.com/pt-BR/article/MEDIAN-function-d0916313-4753-414c-8537-ce85bdd967d2)).
