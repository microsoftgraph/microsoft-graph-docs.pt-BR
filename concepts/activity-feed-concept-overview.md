...
- [Usar a API de feed de atividades para retomar as atividades de um usuário entre dispositivos](../api-reference/v1.0/resources/activity-feed-api-overview.md)
- [Publicar atividades e itens de histórico com uma solicitação usando deep insert](https://developer.microsoft.com/pt-BR/graph/docs/api-reference/v1.0/api/projectrome_put_activity#example-2---deep-insert)
