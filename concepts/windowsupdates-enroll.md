...
Você pode desatar um dispositivo do serviço completamente excluindo o objeto device. Quando um dispositivo é sem registro, ele é automaticamente desinteressado do gerenciamento pelo serviço para todas as categorias de atualização e removido de todos os públicos de implantação e [grupos updateableAsset.](/graph/api/resources/windowsupdates-updatableasset)
