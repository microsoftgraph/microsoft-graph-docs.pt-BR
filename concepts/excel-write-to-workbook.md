...
Para saber mais sobre como acessar arquivos em pastas do OneDrive, confira o [tipo de recurso DriveItem](https://developer.microsoft.com/pt-BR/graph/docs/api-reference/v1.0/resources/driveitem) em nossa documentação de referência.
...
Você pode testar essa consulta com sua própria conta do OneDrive carregando o arquivo demo.xlsx para sua pasta raiz do OneDrive e executar essa consulta no [Explorador do Microsoft Graph](https://developer.microsoft.com/pt-BR/graph/graph-explorer).
