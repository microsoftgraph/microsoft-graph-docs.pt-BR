...
### <a name="remarks"></a>Comentários
Somente as Permissões delegadas _Contacts.Read_ e _Contacts.ReadWrite_ são válidas para contas da Microsoft. 
...
Essa permissão é válida apenas para aplicativos direcionados a organizações.
...
## <a name="microsoft-intune-device-management-permissions"></a>Permissões de Gerenciamento de Dispositivos do Microsoft Intune
...
| _offline_access_ |    Acessar dados do usuário a qualquer momento (visualização) | Permite ao aplicativo ler e atualizar dados do usuário, mesmo quando eles não estiver usando o aplicativo.| Não |
| _openid_ |    Conectar os usuários (visualização) | Permite aos usuários entrar no aplicativo com contas corporativas ou de estudante e permite ao aplicativo ver informações básicas do perfil do usuário.| Não |
...
- userPrincipalName
 ...
 As Permissões delegadas _User.ReadWrite_ e _User.Readwrite.All_ permitem que o aplicativo atualize as seguintes propriedades de perfil de contas corporativas ou de estudante:
