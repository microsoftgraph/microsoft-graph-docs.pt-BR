...
- [Saiba mais sobre a API de retransmissão de dispositivos](../api-reference/beta/resources/project_rome_overview.md)
- [Saiba mais sobre o Project Rome](http://aka.ms/projectrome)
