...
- Todas as solicitações GET começam com a [URL raiz de serviço raiz](../api-reference/v1.0/resources/onenote-api-overview.md#root-url). <br/><br/>**Exemplos**: `https://www.onenote.com/api/v1.0/me/notes` e `https://www.onenote.com/api/v1.0/myOrganization/siteCollections/{id}/sites/{id}/notes/`
