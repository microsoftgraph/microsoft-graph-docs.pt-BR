...
A API do Microsoft Graph é compatível com o acesso aos dados nas caixas de correio _principais_ e em [caixas de correio compartilhadas](https://support.office.com/article/open-and-use-a-shared-mailbox-in-outlook-d94a8e9e-21f1-4240-808b-de9c9c088afd) do usuário. Os dados podem ser calendário, email ou contatos pessoais na nuvem no Exchange Online como parte do Office 365, ou no Exchange no local em uma [implantação híbrida](/graph/hybrid-rest-support).
